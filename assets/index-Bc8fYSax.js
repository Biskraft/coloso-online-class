 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Tp=L,Pp=Symbol.for("react.element"),Ip=Symbol.for("react.fragment"),Ep=Object.prototype.hasOwnProperty,Op=Tp.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Ap={key:!0,ref:!0,__self:!0,__source:!0};function sd(n,r,e){var t,o={},i=null,s=null;e!==void 0&&(i=""+e),r.key!==void 0&&(i=""+r.key),r.ref!==void 0&&(s=r.ref);for(t in r)Ep.call(r,t)&&!Ap.hasOwnProperty(t)&&(o[t]=r[t]);if(n&&n.defaultProps)for(t in r=n.defaultProps,r)o[t]===void 0&&(o[t]=r[t]);return{$$typeof:Pp,type:n,key:i,ref:s,props:o,_owner:Op.current}}ji.Fragment=Ip;ji.jsx=sd;ji.jsxs=sd;Qu.exports=ji;var u=Qu.exports,Bs={},ad={exports:{}},Un={},ld={exports:{}},cd={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(n){function r(T,b){var M=T.length;T.push(b);n:for(;0<M;){var B=M-1>>>1,W=T[B];if(0<o(W,b))T[B]=b,T[M]=W,M=B;else break n}}function e(T){return T.length===0?null:T[0]}function t(T){if(T.length===0)return null;var b=T[0],M=T.pop();if(M!==b){T[0]=M;n:for(var B=0,W=T.length,vn=W>>>1;B<vn;){var q=2*(B+1)-1,wn=T[q],nn=q+1,dn=T[nn];if(0>o(wn,M))nn<W&&0>o(dn,wn)?(T[B]=dn,T[nn]=M,B=nn):(T[B]=wn,T[q]=M,B=q);else if(nn<W&&0>o(dn,M))T[B]=dn,T[nn]=M,B=nn;else break n}}return b}function o(T,b){var M=T.sortIndex-b.sortIndex;return M!==0?M:T.id-b.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;n.unstable_now=function(){return i.now()}}else{var s=Date,a=s.now();n.unstable_now=function(){return s.now()-a}}var l=[],c=[],d=1,h=null,g=3,v=!1,y=!1,w=!1,O=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,p=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function m(T){for(var b=e(c);b!==null;){if(b.callback===null)t(c);else if(b.startTime<=T)t(c),b.sortIndex=b.expirationTime,r(l,b);else break;b=e(c)}}function x(T){if(w=!1,m(T),!y)if(e(l)!==null)y=!0,I(C);else{var b=e(c);b!==null&&j(x,b.startTime-T)}}function C(T,b){y=!1,w&&(w=!1,f(E),E=-1),v=!0;var M=g;try{for(m(b),h=e(l);h!==null&&(!(h.expirationTime>b)||T&&!Y());){var B=h.callback;if(typeof B=="function"){h.callback=null,g=h.priorityLevel;var W=B(h.expirationTime<=b);b=n.unstable_now(),typeof W=="function"?h.callback=W:h===e(l)&&t(l),m(b)}else t(l);h=e(l)}if(h!==null)var vn=!0;else{var q=e(c);q!==null&&j(x,q.startTime-b),vn=!1}return vn}finally{h=null,g=M,v=!1}}var k=!1,S=null,E=-1,$=5,F=-1;function Y(){return!(n.unstable_now()-F<$)}function X(){if(S!==null){var T=n.unstable_now();F=T;var b=!0;try{b=S(!0,T)}finally{b?V():(k=!1,S=null)}}else k=!1}var V;if(typeof p=="function")V=function(){p(X)};else if(typeof MessageChannel<"u"){var _=new MessageChannel,Z=_.port2;_.port1.onmessage=X,V=function(){Z.postMessage(null)}}else V=function(){O(X,0)};function I(T){S=T,k||(k=!0,V())}function j(T,b){E=O(function(){T(n.unstable_now())},b)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(T){T.callback=null},n.unstable_continueExecution=function(){y||v||(y=!0,I(C))},n.unstable_forceFrameRate=function(T){0>T||125<T?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):$=0<T?Math.floor(1e3/T):5},n.unstable_getCurrentPriorityLevel=function(){return g},n.unstable_getFirstCallbackNode=function(){return e(l)},n.unstable_next=function(T){switch(g){case 1:case 2:case 3:var b=3;break;default:b=g}var M=g;g=b;try{return T()}finally{g=M}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=function(){},n.unstable_runWithPriority=function(T,b){switch(T){case 1:case 2:case 3:case 4:case 5:break;default:T=3}var M=g;g=T;try{return b()}finally{g=M}},n.unstable_scheduleCallback=function(T,b,M){var B=n.unstable_now();switch(typeof M=="object"&&M!==null?(M=M.delay,M=typeof M=="number"&&0<M?B+M:B):M=B,T){case 1:var W=-1;break;case 2:W=250;break;case 5:W=1073741823;break;case 4:W=1e4;break;default:W=5e3}return W=M+W,T={id:d++,callback:b,priorityLevel:T,startTime:M,expirationTime:W,sortIndex:-1},M>B?(T.sortIndex=M,r(c,T),e(l)===null&&T===e(c)&&(w?(f(E),E=-1):w=!0,j(x,M-B))):(T.sortIndex=W,r(l,T),y||v||(y=!0,I(C))),T},n.unstable_shouldYield=Y,n.unstable_wrapCallback=function(T){var b=g;return function(){var M=g;g=b;try{return T.apply(this,arguments)}finally{g=M}}}})(cd);ld.exports=cd;var Np=ld.exports;/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var nt=L;function jg(n,r){return n===r&&(n!==0||1/n===1/r)||n!==n&&r!==r}var Dg=typeof Object.is=="function"?Object.is:jg,Rg=nt.useState,Fg=nt.useEffect,Hg=nt.useLayoutEffect,$g=nt.useDebugValue;function Bg(n,r){var e=r(),t=Rg({inst:{value:e,getSnapshot:r}}),o=t[0].inst,i=t[1];return Hg(function(){o.value=e,o.getSnapshot=r,bs(o)&&i({inst:o})},[n,e,r]),Fg(function(){return bs(o)&&i({inst:o}),n(function(){bs(o)&&i({inst:o})})},[n]),$g(e),e}function bs(n){var r=n.getSnapshot;n=n.value;try{var e=r();return!Dg(n,e)}catch{return!0}}function zg(n,r){return r()}var Wg=typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"?zg:Bg;ff.useSyncExternalStore=nt.useSyncExternalStore!==void 0?nt.useSyncExternalStore:Wg;hf.exports=ff;var Gg=hf.exports;/**
 * @license React
...
`,By=`# S27: Hospital Nightmare - Top-down Map 상세 설계\r
\r
> **"이곳은 사람을 살리는 곳이었다. 지금은 아니다."**\r
\r
## 설계 개요\r
