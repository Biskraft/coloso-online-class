 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(n){function r(w,M){var z=w.length;w.push(M);n:for(;0<z;){var U=z-1>>>1,T=w[U];if(0<o(T,M))w[U]=M,w[z]=T,z=U;else break n}}function e(w){return w.length===0?null:w[0]}function t(w){if(w.length===0)return null;var M=w[0],z=w.pop();if(z!==M){w[0]=z;n:for(var U=0,T=w.length,pn=T>>>1;U<pn;){var X=2*(U+1)-1,en=w[X],Q=X+1,ln=w[Q];if(0>o(en,z))Q<T&&0>o(ln,en)?(w[U]=ln,w[Q]=z,U=Q):(w[U]=en,w[X]=z,U=X);else if(Q<T&&0>o(ln,z))w[U]=ln,w[Q]=z,U=Q;else break n}}return M}function o(w,M){var z=w.sortIndex-M.sortIndex;return z!==0?z:w.id-M.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;n.unstable_now=function(){return i.now()}}else{var s=Date,a=s.now();n.unstable_now=function(){return s.now()-a}}var l=[],c=[],d=1,h=null,f=3,m=!1,y=!1,x=!1,N=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,p=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(w){for(var M=e(c);M!==null;){if(M.callback===null)t(c);else if(M.startTime<=w)t(c),M.sortIndex=M.expirationTime,r(l,M);else break;M=e(c)}}function S(w){if(x=!1,v(w),!y)if(e(l)!==null)y=!0,j(b);else{var M=e(c);M!==null&&A(S,M.startTime-w)}}function b(w,M){y=!1,x&&(x=!1,g(Z),Z=-1),m=!0;var z=f;try{for(v(M),h=e(l);h!==null&&(!(h.expirationTime>M)||w&&!P());){var U=h.callback;if(typeof U=="function"){h.callback=null,f=h.priorityLevel;var T=U(h.expirationTime<=M);M=n.unstable_now(),typeof T=="function"?h.callback=T:h===e(l)&&t(l),v(M)}else t(l);h=e(l)}if(h!==null)var pn=!0;else{var X=e(c);X!==null&&A(S,X.startTime-M),pn=!1}return pn}finally{h=null,f=z,m=!1}}var O=!1,I=null,Z=-1,F=5,K=-1;function P(){return!(n.unstable_now()-K<F)}function Y(){if(I!==null){var w=n.unstable_now();K=w;var M=!0;try{M=I(!0,w)}finally{M?H():(O=!1,I=null)}}else O=!1}var H;if(typeof p=="function")H=function(){p(Y)};else if(typeof MessageChannel<"u"){var k=new MessageChannel,R=k.port2;k.port1.onmessage=Y,H=function(){R.postMessage(null)}}else H=function(){N(Y,0)};function j(w){I=w,O||(O=!0,H())}function A(w,M){Z=N(function(){w(n.unstable_now())},M)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(w){w.callback=null},n.unstable_continueExecution=function(){y||m||(y=!0,j(b))},n.unstable_forceFrameRate=function(w){0>w||125<w?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):F=0<w?Math.floor(1e3/w):5},n.unstable_getCurrentPriorityLevel=function(){return f},n.unstable_getFirstCallbackNode=function(){return e(l)},n.unstable_next=function(w){switch(f){case 1:case 2:case 3:var M=3;break;default:M=f}var z=f;f=M;try{return w()}finally{f=z}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=function(){},n.unstable_runWithPriority=function(w,M){switch(w){case 1:case 2:case 3:case 4:case 5:break;default:w=3}var z=f;f=w;try{return M()}finally{f=z}},n.unstable_scheduleCallback=function(w,M,z){var U=n.unstable_now();switch(typeof z=="object"&&z!==null?(z=z.delay,z=typeof z=="number"&&0<z?U+z:U):z=U,w){case 1:var T=-1;break;case 2:T=250;break;case 5:T=1073741823;break;case 4:T=1e4;break;default:T=5e3}return T=z+T,w={id:d++,callback:M,priorityLevel:w,startTime:z,expirationTime:T,sortIndex:-1},z>U?(w.sortIndex=z,r(c,w),e(l)===null&&w===e(c)&&(x?(g(Z),Z=-1):x=!0,A(S,z-U))):(w.sortIndex=T,r(l,w),y||m||(y=!0,j(b))),w},n.unstable_shouldYield=P,n.unstable_wrapCallback=function(w){var M=f;return function(){var z=f;f=M;try{return w.apply(this,arguments)}finally{f=z}}}})(hm);dm.exports=hm;var x1=dm.exports;/**
 * @license React
...
`;function lC(){var Sn;const n=E.useRef(null),r=B($=>$.project.nodes),e=B($=>$.project.edges),t=B($=>$.project.decorations??[]),o=B($=>$.project.images??[]),i=B($=>$.addImage),s=B($=>$.moveImage),a=B($=>$.resizeImage),l=B($=>$.groupSelection),c=B($=>$.setGroupSelection),d=B($=>$.moveGroup),h=B($=>$.addDecoration),f=B($=>$.updateDecoration),m=B($=>$.moveDecoration),y=B($=>$.project.view),x=B($=>$.selection),N=B($=>$.moveNode),g=B($=>$.resizeNode),p=B($=>$.setNodeAspect),v=B($=>$.addEdge),S=B($=>$.select),b=B($=>$.addNode),O=B($=>$.promotePostit),{transform:I,fitTo:Z,reset:F,zoomBy:K}=tC(n),[P,Y]=E.useState({kind:"none"}),[H,k]=E.useState(!1),R=E.useCallback(($,tn)=>{if(!n.current)return;const J=n.current.getBoundingClientRect(),C=xe(I,$.clientX-J.left,$.clientY-J.top),rn=B.getState();if(rn.groupSelection.includes(tn)){Y({kind:"group",startWorld:C,cursorWorld:C}),$.target.setPointerCapture($.pointerId);return}const yn=rn.project.nodes.find(bn=>bn.id===tn);yn&&(Y({kind:"node",nodeId:tn,startWorld:C,nodeStart:{x:yn.x,y:yn.y}}),$.target.setPointerCapture($.pointerId))},[I]),j=E.useCallback(($,tn)=>{if(!n.current)return;const J=n.current.getBoundingClientRect(),C=xe(I,$.clientX-J.left,$.clientY-J.top);Y({kind:"edge",edgeFrom:tn,cursorWorld:C}),$.target.setPointerCapture($.pointerId)},[I]),A=E.useCallback(($,tn)=>{Y({kind:"resize",nodeId:tn}),$.target.setPointerCapture($.pointerId)},[]),w=E.useCallback(($,tn)=>{if(!n.current)return;const J=n.current.getBoundingClientRect(),C=xe(I,$.clientX-J.left,$.clientY-J.top),rn=B.getState();if(rn.groupSelection.includes(tn)){Y({kind:"group",startWorld:C,cursorWorld:C}),$.target.setPointerCapture($.pointerId);return}const yn=rn.project.decorations.find(bn=>bn.id===tn);yn&&(Y({kind:"deco-move",decId:tn,startWorld:C,decStart:{x:yn.x,y:yn.y,x2:yn.x2,y2:yn.y2,width:yn.width,height:yn.height}}),$.target.setPointerCapture($.pointerId))},[I]),M=E.useCallback(($,tn,J)=>{$.stopPropagation(),Y({kind:"deco-arrow",decId:tn,arrowEndpoint:J}),$.target.setPointerCapture($.pointerId)},[]),z=E.useCallback(($,tn)=>{$.stopPropagation(),Y({kind:"deco-resize",decId:tn}),$.target.setPointerCapture($.pointerId)},[]),U=E.useCallback(($,tn)=>{if(!n.current)return;const J=n.current.getBoundingClientRect(),C=xe(I,$.clientX-J.left,$.clientY-J.top),rn=B.getState();if(rn.groupSelection.includes(tn)){Y({kind:"group",startWorld:C,cursorWorld:C}),$.target.setPointerCapture($.pointerId);return}const yn=(rn.project.images??[]).find(bn=>bn.id===tn);yn&&(Y({kind:"img-move",imgId:tn,startWorld:C,imgStart:{x:yn.x,y:yn.y,width:yn.width,height:yn.height}}),$.target.setPointerCapture($.pointerId))},[I]),T=E.useCallback(($,tn)=>{if($.stopPropagation(),!n.current)return;const C=(B.getState().project.images??[]).find(rn=>rn.id===tn);C&&(Y({kind:"img-resize",imgId:tn,imgStart:{x:C.x,y:C.y,width:C.width,height:C.height}}),$.target.setPointerCapture($.pointerId))},[]),pn=E.useCallback($=>{if(P.kind==="none"||!n.current)return;const tn=n.current.getBoundingClientRect(),J=xe(I,$.clientX-tn.left,$.clientY-tn.top);if(P.kind==="node"&&P.nodeId&&P.startWorld&&P.nodeStart){const C=P.nodeStart.x+(J.x-P.startWorld.x),rn=P.nodeStart.y+(J.y-P.startWorld.y);N(P.nodeId,C,rn)}else if(P.kind==="edge")Y({...P,cursorWorld:J});else if(P.kind==="resize"&&P.nodeId){const C=B.getState().project.nodes.find(fl=>fl.id===P.nodeId);if(!C)return;const rn=Fe[C.type],yn=Math.abs(J.x-C.x),bn=Math.abs(J.y-C.y),In=Math.SQRT2,sr=Math.max(20,(yn-4)*In),oe=Math.max(15,(bn-4)*In),kr=Math.sqrt(sr*oe/(rn.rx*rn.ry)),Oo=sr*rn.ry/(oe*rn.rx);g(P.nodeId,kr),p(P.nodeId,Oo)}else if(P.kind==="deco-move"&&P.decId&&P.startWorld&&P.decStart){const C=P.decStart.x+(J.x-P.startWorld.x),rn=P.decStart.y+(J.y-P.startWorld.y);m(P.decId,C,rn)}else if(P.kind==="deco-arrow"&&P.decId&&P.arrowEndpoint)P.arrowEndpoint==="start"?f(P.decId,{x:J.x,y:J.y}):f(P.decId,{x2:J.x,y2:J.y});else if(P.kind==="deco-resize"&&P.decId){const C=B.getState().project.decorations.find(bn=>bn.id===P.decId);if(!C)return;const rn=Math.max(40,(J.x-C.x)*2),yn=Math.max(20,(J.y-C.y)*2);f(P.decId,{width:rn,height:yn})}else if(P.kind==="img-move"&&P.imgId&&P.startWorld&&P.imgStart){const C=P.imgStart.x+(J.x-P.startWorld.x),rn=P.imgStart.y+(J.y-P.startWorld.y);s(P.imgId,C,rn)}else if(P.kind==="img-resize"&&P.imgId&&P.imgStart){const C=P.imgStart.width/P.imgStart.height||1,rn=Math.max(np,(J.x-P.imgStart.x)*2),yn=Math.max(np/C,rn/C);a(P.imgId,Math.round(rn),Math.round(yn))}else if(P.kind==="group"&&P.startWorld&&P.cursorWorld){const C=J.x-P.cursorWorld.x,rn=J.y-P.cursorWorld.y;d(C,rn),Y({...P,cursorWorld:J})}else P.kind==="box-select"&&P.startWorld&&Y({...P,boxRect:{x0:Math.min(P.startWorld.x,J.x),y0:Math.min(P.startWorld.y,J.y),x1:Math.max(P.startWorld.x,J.x),y1:Math.max(P.startWorld.y,J.y)}})},[P,I,N,g,p,m,f,s,a]),X=E.useCallback($=>{if(P.kind==="edge"&&P.edgeFrom){const tn=document.elementFromPoint($.clientX,$.clientY),J=tn==null?void 0:tn.closest("[data-node]"),C=J==null?void 0:J.getAttribute("data-node");C&&C!==P.edgeFrom&&v(P.edgeFrom,C,"open")}else if(P.kind==="box-select"&&P.boxRect){const{x0:tn,y0:J,x1:C,y1:rn}=P.boxRect,yn=B.getState(),bn=[];yn.project.nodes.forEach(In=>{In.x>=tn&&In.x<=C&&In.y>=J&&In.y<=rn&&bn.push(In.id)}),(yn.project.decorations??[]).forEach(In=>{In.x>=tn&&In.x<=C&&In.y>=J&&In.y<=rn&&bn.push(In.id)}),(yn.project.images??[]).forEach(In=>{In.x>=tn&&In.x<=C&&In.y>=J&&In.y<=rn&&bn.push(In.id)}),bn.length>0?c(bn):c([])}Y({kind:"none"})},[P,v,c]),en=E.useCallback($=>{if($.target===n.current||$.target.hasAttribute("data-bg"))if($.shiftKey&&n.current){const tn=n.current.getBoundingClientRect(),J=xe(I,$.clientX-tn.left,$.clientY-tn.top);Y({kind:"box-select",startWorld:J,boxRect:{x0:J.x,y0:J.y,x1:J.x,y1:J.y}})}else S({kind:"none"}),c([])},[S,I,c]),Q=$=>{const tn=$.dataTransfer.types;(tn.includes("application/x-postit-id")||tn.includes("Files"))&&($.preventDefault(),$.dataTransfer.dropEffect="copy",k(!0))},ln=()=>k(!1),cn=$=>{if($.preventDefault(),k(!1),!n.current)return;const tn=n.current.getBoundingClientRect(),J=xe(I,$.clientX-tn.left,$.clientY-tn.top),C=Array.from($.dataTransfer.files??[]).filter(yn=>yn.type.startsWith("image/"));if(C.length>0){C.forEach(async(yn,bn)=>{try{const In=await rp(yn);In&&i(J.x+bn*24,J.y+bn*24,In.src,In.width,In.height)}catch(In){console.warn("이미지 드롭 실패",In)}});return}const rn=$.dataTransfer.getData("application/x-postit-id");rn&&O(rn,J.x,J.y)};E.useEffect(()=>{const $=tn=>{var sr,oe;const J=(sr=tn.target)==null?void 0:sr.tagName;if(J==="INPUT"||J==="TEXTAREA")return;const C=(oe=tn.clipboardData)==null?void 0:oe.items;if(!C||!n.current)return;const rn=Array.from(C).find(kr=>kr.kind==="file"&&kr.type.startsWith("image/"));if(!rn)return;const yn=rn.getAsFile();if(!yn)return;tn.preventDefault();const bn=n.current.getBoundingClientRect(),In=xe(I,bn.width/2,bn.height/2);rp(yn).then(kr=>{kr&&i(In.x,In.y,kr.src,kr.width,kr.height)}).catch(kr=>console.warn("이미지 붙여넣기 실패",kr))};return window.addEventListener("paste",$),()=>window.removeEventListener("paste",$)},[I,i]);const wn=E.useMemo(()=>{const $=t.filter(C=>C.kind==="text"),tn=t.filter(C=>C.kind==="arrow");return[...t.filter(C=>C.kind==="ellipse"),...tn,...$]},[t]),Nn=E.useMemo(()=>{const $=new Map;e.forEach(J=>{const C=[J.from,J.to].sort().join("::");$.has(C)||$.set(C,[]),$.get(C).push(J.id)});const tn=14;return e.map(J=>{const C=[J.from,J.to].sort().join("::"),rn=$.get(C);if(rn.length<2)return{edge:J,offset:0};const bn=(rn.indexOf(J.id)-(rn.length-1)/2)*tn;return{edge:J,offset:bn}})},[e]),Fn=E.useCallback(()=>{if(r.length===0)return F();let $=1/0,tn=1/0,J=-1/0,C=-1/0;for(const rn of r)$=Math.min($,rn.x-100),tn=Math.min(tn,rn.y-80),J=Math.max(J,rn.x+100),C=Math.max(C,rn.y+80);Z({x:$,y:tn,w:J-$,h:C-tn})},[r,Z,F]),dn=$=>{if(!n.current)return;const tn=n.current.getBoundingClientRect(),J=xe(I,tn.width/2,tn.height/2),C=(Math.random()-.5)*60,rn=(Math.random()-.5)*60;b({x:J.x+C,y:J.y+rn,type:$,name:uC($)})},un=$=>{if(!n.current)return;const tn=n.current.getBoundingClientRect(),J=xe(I,tn.width/2,tn.height/2),C=(Math.random()-.5)*80,rn=(Math.random()-.5)*80;h($,J.x+C,J.y+rn)},kn=(Sn=n.current)==null?void 0:Sn.getBoundingClientRect(),Pn=kn?{x:-I.x/I.k,y:-I.y/I.k,w:kn.width/I.k,h:kn.height/I.k}:{x:0,y:0,w:0,h:0};return u.jsxs("div",{className:`canvas-wrap blueprint-grid ${H?"is-drop-hover":""}`,onDragOver:Q,onDragLeave:ln,onDrop:cn,children:[u.jsxs("svg",{ref:n,className:"canvas-svg",onPointerDown:en,onPointerMove:pn,onPointerUp:X,children:[u.jsx("style",{children:aC}),u.jsx("defs",{children:u.jsx("pattern",{id:"dots",width:"20",height:"20",patternUnits:"userSpaceOnUse",children:u.jsx("circle",{cx:"1",cy:"1",r:"0.6",fill:"rgba(44, 95, 124, 0.20)"})})}),u.jsx("rect",{"data-bg":!0,x:"-100000",y:"-100000",width:"200000",height:"200000",fill:"transparent"}),u.jsxs("g",{"data-cv-world":!0,transform:`translate(${I.x} ${I.y}) scale(${I.k})`,children:[o.map($=>u.jsx(Ek,{image:$,selected:x.kind==="image"&&x.id===$.id||l.includes($.id),onPointerDown:U,onResizeDown:T},$.id)),wn.map($=>u.jsx(Ck,{dec:$,selected:x.kind==="decoration"&&x.id===$.id||l.includes($.id),onPointerDown:w,onArrowEndpointDown:M,onResizeDown:z},$.id)),Nn.map(({edge:$,offset:tn})=>{const J=r.find(rn=>rn.id===$.from),C=r.find(rn=>rn.id===$.to);return!J||!C?null:u.jsx(wk,{edge:$,from:J,to:C,rough:y.edgeStyle==="rough",selected:x.kind==="edge"&&x.id===$.id,offset:tn,onSelect:rn=>S({kind:"edge",id:rn})},$.id)}),P.kind==="edge"&&P.edgeFrom&&P.cursorWorld&&u.jsx(cC,{fromId:P.edgeFrom,cursor:P.cursorWorld}),r.map($=>u.jsx(xk,{node:$,rough:y.edgeStyle==="rough",selected:x.kind==="node"&&x.id===$.id||l.includes($.id),onPointerDownNode:R,onHandlePointerDown:j,onResizePointerDown:A},$.id)),P.kind==="box-select"&&P.boxRect&&u.jsx("rect",{x:P.boxRect.x0,y:P.boxRect.y0,width:P.boxRect.x1-P.boxRect.x0,height:P.boxRect.y1-P.boxRect.y0,fill:"rgba(207, 85, 71, 0.10)",stroke:"var(--brick)",strokeWidth:"1.4",strokeDasharray:"6 4",pointerEvents:"none"})]})]}),r.length===0&&o.length===0&&t.length===0&&u.jsx("div",{className:"canvas-empty",children:u.jsxs("div",{className:"canvas-empty-card",children:[u.jsx("h2",{className:"hand",children:"캔버스가 비어 있습니다"}),u.jsxs("p",{children:["왼쪽 포스트잇을 끌어 와서 노드로 만들거나,",u.jsx("br",{}),"아래에서 노드 타입을 선택해 추가하세요."]}),u.jsxs("div",{className:"canvas-empty-actions",children:[u.jsx("button",{onClick:()=>dn("room"),children:"+ 방"}),u.jsx("button",{onClick:()=>dn("vista"),children:"+ 전망"}),u.jsx("button",{onClick:()=>dn("boss"),children:"+ 보스"})]})]})}),u.jsxs("div",{className:"canvas-toolbar",children:[u.jsxs("div",{className:"ct-group",role:"group","aria-label":"노드 추가",children:[u.jsx("button",{onClick:()=>dn("room"),title:"방 추가",children:"방"}),u.jsx("button",{onClick:()=>dn("vista"),title:"전망",children:"전망"}),u.jsx("button",{onClick:()=>dn("treasure"),title:"보물",children:"보물"}),u.jsx("button",{onClick:()=>dn("boss"),title:"보스",children:"보스"}),u.jsx("button",{onClick:()=>dn("hub"),title:"허브",children:"허브"}),u.jsx("button",{onClick:()=>dn("save"),title:"세이브",children:"세이브"})]}),u.jsx("span",{className:"ct-sep"}),u.jsxs("div",{className:"ct-group",role:"group","aria-label":"데코 추가",children:[u.jsx("button",{onClick:()=>un("arrow"),title:"화살표",children:"↗ 화살표"}),u.jsx("button",{onClick:()=>un("ellipse"),title:"회색 타원",children:"○ 타원"}),u.jsx("button",{onClick:()=>un("text"),title:"텍스트",children:"A 텍스트"})]}),u.jsx("span",{className:"ct-sep"}),u.jsx("button",{onClick:Fn,title:"화면 맞춤",children:"⇲ 맞춤"}),u.jsx("button",{onClick:()=>K(1.25),title:"확대",children:"＋"}),u.jsx("button",{onClick:()=>K(.8),title:"축소",children:"−"}),u.jsxs("span",{className:"ct-zoom caption",children:[Math.round(I.k*100),"%"]})]}),y.showMinimap&&r.length>0&&u.jsx("div",{className:"canvas-minimap",children:u.jsx(bk,{nodes:r,edges:e,viewBox:Pn})}),H&&u.jsx("div",{className:"canvas-drop-banner hand",children:"여기에 놓기 — 포스트잇은 노드로, 이미지는 캔버스에 배치"})]})}function cC({fromId:n,cursor:r}){const e=B(t=>t.project.nodes.find(o=>o.id===n));return e?u.jsx("line",{x1:e.x,y1:e.y,x2:r.x,y2:r.y,stroke:"var(--brick)",strokeWidth:"1.6",strokeDasharray:"4 3",opacity:"0.8",pointerEvents:"none"}):null}function uC(n){return{room:"새 방",vista:"전망 지점",treasure:"보물 챔버",boss:"보스 챔버",hub:"허브 광장",save:"세이브 포인트"}[n]}const dC=["room","vista","treasure","boss","hub","save"],hC=["open","locked","oneway","ability","vista"],fC={room:"일반 방. 전투·통과·환경 인터랙션.",vista:"풍경/예고 공간. 플레이어에게 목표나 비밀을 보여줌.",treasure:"보상/획득 공간. 보물, 능력, 정보.",boss:"거대 인카운터. 일반적으로 페이싱의 클라이맥스.",hub:"여러 경로가 모이는 허브.",save:"체크포인트, 회복, 휴식."},pC={open:"열린 통로. 양방향 자유 통행.",locked:"잠금문. 키를 획득해야 통과.",oneway:"일방통행. 반대로 돌아갈 수 없음.",ability:"능력 게이트. 특정 능력 보유 시만 통과.",vista:"전망. 다른 공간이 시각적으로 보이지만 이동 불가."};function mC({onClose:n}){return u.jsxs("aside",{className:"legend",role:"dialog","aria-label":"범례",children:[u.jsxs("header",{className:"lg-head",children:[u.jsx("h3",{className:"hand",children:"표기 규약"}),u.jsx("button",{onClick:n,className:"lg-x","aria-label":"닫기",children:"×"})]}),u.jsx("p",{className:"lg-intro caption",children:"3D 게임 레벨 디자인 노드·간선 표기 규약"}),u.jsx("h4",{children:"노드"}),u.jsx("ul",{className:"lg-list",children:dC.map(r=>{const e=Fe[r];return u.jsxs("li",{children:[u.jsxs("svg",{width:"48",height:"32",viewBox:"-32 -22 64 44",children:[u.jsx("ellipse",{cx:"0",cy:"0",rx:"24",ry:"16",fill:e.fill,stroke:e.stroke,strokeWidth:e.strokeWidth}),u.jsx("text",{x:"0",y:"3",textAnchor:"middle",fontSize:"11",fill:"var(--ink-900)",children:e.icon})]}),u.jsxs("div",{children:[u.jsx("strong",{children:e.label}),u.jsx("span",{children:fC[r]})]})]},r)})}),u.jsx("h4",{children:"간선"}),u.jsx("ul",{className:"lg-list",children:hC.map(r=>{const e=Yi[r];return u.jsxs("li",{children:[u.jsxs("svg",{width:"48",height:"32",viewBox:"0 0 48 32",children:[u.jsx("path",{d:"M 4 16 Q 24 4, 44 16",fill:"none",stroke:e.stroke,strokeWidth:e.width,strokeDasharray:e.dash,strokeLinecap:"round"}),(r==="oneway"||r==="ability"||r==="locked")&&u.jsx("polygon",{points:"38,12 44,16 38,20",fill:e.stroke})]}),u.jsxs("div",{children:[u.jsx("strong",{children:e.label}),u.jsx("span",{children:pC[r]})]})]},r)})})]})}function gC(){const n=B(d=>d.project.view),r=B(d=>d.setView),e=B(d=>{var h;return((h=d.project.theme)==null?void 0:h.hueShift)??0}),t=B(d=>{var h;return((h=d.project.theme)==null?void 0:h.satScale)??1}),o=B(d=>d.setHueShift),i=B(d=>d.setSatScale),s=B(d=>d.resetTheme),a=e!==0||t!==1,[l,c]=E.useState(!1);return u.jsxs("main",{className:"canvas-shell",children:[u.jsxs("div",{className:"cs-topbar",children:[u.jsxs("div",{className:"cs-view-toggles",children:[u.jsx(ac,{label:"펜떨림",value:n.edgeStyle==="rough",onChange:d=>r({edgeStyle:d?"rough":"clean"}),hint:"손그림 느낌의 거친 곡선"}),u.jsx(ac,{label:"그리드",value:n.showGrid,onChange:d=>r({showGrid:d})}),u.jsx(ac,{label:"미니맵",value:n.showMinimap,onChange:d=>r({showMinimap:d})})]}),u.jsxs("div",{className:"cs-right",children:[u.jsxs("div",{className:"cs-theme",title:"학생별 고유 팔레트 — HUE는 색조, SAT는 채도",children:[u.jsxs("div",{className:"cs-theme-row",children:[u.jsx("span",{className:"cs-theme-label",children:"HUE"}),u.jsx("input",{className:"cs-theme-slider cs-theme-slider--hue",type:"range",min:-180,max:180,step:1,value:e,onChange:d=>o(parseInt(d.target.value,10)),style:{background:`linear-gradient(to right,
                    hsl(0,70%,55%) 0%,
                    hsl(60,70%,55%) 16.66%,
                    hsl(120,70%,55%) 33.33%,
                    hsl(180,70%,55%) 50%,
