...
위의 [+ 새 메모]로 시작하세요.`:"검색 결과 없음"})}),w.map(_=>{const N=(y==null?void 0:y.id)===_.id&&h&&h!==_.id?`is-drop-${y.pos}`:"";return u.jsx("li",{className:`pp-item ${h===_.id?"is-dragging":""} ${N}`,onDragStart:()=>S&&f(_.id),onDragOver:j=>m(j,_.id),onDrop:j=>g(j,_.id),onDragEnd:p,children:u.jsx(N0,{postit:_})},_.id)})]})]})}function Cf(n){let r=n|0;return()=>{r=r+1831565813|0;let e=r;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}}function Tf(n){let r=2166136261;for(let e=0;e<n.length;e++)r^=n.charCodeAt(e),r=Math.imul(r,16777619);return r>>>0}function Ei(n,r){const e=.6+n()*1.4,t=2+n()*2,o=4+n()*3,i=n()*Math.PI*2,s=n()*Math.PI*2,a=n()*Math.PI*2;return l=>Math.sin(l*e*Math.PI*2*r+i)*.6+Math.sin(l*t*Math.PI*2*r+s)*.3+Math.sin(l*o*Math.PI*2*r+a)*.15}const Ly=n=>Math.sin(n*Math.PI);function Pf(n){if(n.length<2)return"";const r=o=>o.toFixed(2);let e=`M ${r(n[0][0])} ${r(n[0][1])}`;if(n.length===2)return e+=` L ${r(n[1][0])} ${r(n[1][1])}`,e;e+=` L ${r((n[0][0]+n[1][0])/2)} ${r((n[0][1]+n[1][1])/2)}`;for(let o=1;o<n.length-1;o++){const i=(n[o][0]+n[o+1][0])/2,s=(n[o][1]+n[o+1][1])/2;e+=` Q ${r(n[o][0])} ${r(n[o][1])}, ${r(i)} ${r(s)}`}const t=n[n.length-1];return e+=` L ${r(t[0])} ${r(t[1])}`,e}function Zy(n,r,e,t,o){const i=o.roughness??1.4,s=o.bowing,a=o.passes;if(i<=0&&s<=0)return[`M ${n} ${r} L ${e} ${t}`];const l=e-n,c=t-r,d=Math.hypot(l,c);if(d<.5)return[`M ${n} ${r} L ${e} ${t}`];const h=l/d,y=-(c/d),x=h,S=Math.max(8,Math.min(48,Math.floor(d/12)));return Array.from({length:a},(M,m)=>{const g=Cf(Tf(`${o.seed}|L|${m}`)),p=m%2===0?1:-1,v=s*Math.min(d,200)*.04*p*(.7+g()*.6),k=(g()-.5)*i*.8,T=(g()-.5)*i*.8,w=Ei(g,.7),_=Ei(g,2.2),N=[];N.push([n+y*k,r+x*k]);for(let j=1;j<S;j++){const z=j/S,G=Ly(z),Y=v*G,C=(w(z)*.65+_(z)*.35)*i*G,D=Y+C,E=n+l*z,R=r+c*z;N.push([E+y*D,R+x*D])}return N.push([e+y*T,t+x*T]),Pf(N)})}function Dy(n,r,e,t,o){const i=o.roughness,s=o.passes,a=Math.PI*(3*(e+t)-Math.sqrt((3*e+t)*(e+3*t))),l=Math.max(20,Math.min(64,Math.floor(a/10)));return Array.from({length:s},(c,d)=>{const h=Cf(Tf(`${o.seed}|E|${d}`)),f=(d*.35+h()*.6)*Math.PI,y=-(.05+h()*.12),x=.08+h()*.18,S=Math.PI*2+x-y,M=Ei(h,.8),m=Ei(h,2.5),g=1+(h()-.5)*.025,p=1+(h()-.5)*.025,v=(h()-.5)*.6,k=(h()-.5)*.6,T=[];for(let w=0;w<=l;w++){const _=w/l,N=f+y+S*_,j=(M(_)*.7+m(_)*.3)*i,z=e*g+j,G=t*p+j;T.push([n+v+Math.cos(N)*z,r+k+Math.sin(N)*G])}return Pf(T)})}const Qn="#1A1814",Jr={room:{label:"방",icon:"◯",rx:56,ry:56,fill:"#7AA8C2",stroke:Qn,strokeWidth:3.6,textColor:Qn},vista:{label:"전망",icon:"◇",rx:62,ry:62,fill:"#A88BB8",stroke:Qn,strokeWidth:3.6,textColor:Qn},treasure:{label:"보물",icon:"✦",rx:56,ry:56,fill:"#D9823A",stroke:Qn,strokeWidth:3.2,textColor:Qn},boss:{label:"보스",icon:"✚",rx:74,ry:74,fill:"#CF5547",stroke:Qn,strokeWidth:4.2,textColor:Qn},hub:{label:"허브",icon:"⌬",rx:62,ry:62,fill:"#E8C552",stroke:Qn,strokeWidth:3.6,textColor:Qn},save:{label:"세이브",icon:"⚑",rx:48,ry:48,fill:"#8AAE52",stroke:Qn,strokeWidth:3.2,textColor:Qn}};function ve(n,r=1,e=1){const t=Jr[n],o=Math.sqrt(e);return{rx:t.rx*r*o,ry:t.ry*r/o}}function Ry(n){const{rx:r,ry:e}=ve(n.type,n.size??1,n.aspect??1);return n.rough?Dy(n.cx,n.cy,r,e,{seed:n.seed,roughness:2.8,passes:2}):[Fy(n.cx,n.cy,r,e)]}function Fy(n,r,e,t){return`M ${n-e} ${r}
          ...
          a ${e} ${t} 0 1 0 ${-e*2} 0 Z`.replace(/\s+/g," ")}function Hy(n){const r=n.replace("#",""),e=r.length===3?r.split("").map(t=>t+t).join(""):r;return{r:parseInt(e.slice(0,2),16),g:parseInt(e.slice(2,4),16),b:parseInt(e.slice(4,6),16)}}function $y(n,r,e){const t=o=>Math.round(Math.max(0,Math.min(255,o))).toString(16).padStart(2,"0");return`#${t(n)}${t(r)}${t(e)}`}function By(n,r,e){const t=n/255,o=r/255,i=e/255,s=Math.max(t,o,i),a=Math.min(t,o,i),l=(s+a)/2;let c=0,d=0;if(s!==a){const h=s-a;switch(d=l>.5?h/(2-s-a):h/(s+a),s){case t:c=(o-i)/h+(o<i?6:0);break;case o:c=(i-t)/h+2;break;case i:c=(t-o)/h+4;break}c*=60}return{h:c,s:d,l}}function zy(n,r,e){const t=(1-Math.abs(2*e-1))*r,o=n/60,i=t*(1-Math.abs(o%2-1));let s=0,a=0,l=0;o>=0&&o<1?(s=t,a=i):o<2?(s=i,a=t):o<3?(a=t,l=i):o<4?(a=i,l=t):o<5?(s=i,l=t):(s=t,l=i);const c=e-t/2;return{r:(s+c)*255,g:(a+c)*255,b:(l+c)*255}}function If(n,r,e){if(r===0&&e===1)return n;const{r:t,g:o,b:i}=Hy(n),{h:s,s:a,l}=By(t,o,i);if(a<.04)return n;const c=((s+r)%360+360)%360,d=Math.max(0,Math.min(1,a*e)),h=zy(c,d,l);return $y(h.r,h.g,h.b)}function Wy({node:n,rough:r,selected:e,onPointerDownNode:t,onHandlePointerDown:o,onResizePointerDown:i}){const s=Jr[n.type],a=b(w=>{var _;return((_=w.project.theme)==null?void 0:_.hueShift)??0}),l=b(w=>{var _;return((_=w.project.theme)==null?void 0:_.satScale)??1}),c=a!==0||l!==1?{...s,fill:If(s.fill,a,l)}:s,d=n.size??1,h=n.aspect??1,{rx:f,ry:y}=ve(n.type,d,h),x=Ry({cx:0,cy:0,type:n.type,size:d,aspect:h,rough:r,seed:n.id}),S=b(w=>w.select),[M,m]=Z.useState(!1),p=_f()==="dark"?"#FFFFFF":c.stroke,v=[{id:"e",x:f+6,y:0,ax:-2.5,ay:-2,bx:1.5,by:0,cx:-2.5,cy:2},{id:"w",x:-f-6,y:0,ax:2.5,ay:-2,bx:-1.5,by:0,cx:2.5,cy:2},{id:"n",x:0,y:-y-6,ax:-2,ay:2.5,bx:0,by:-1.5,cx:2,cy:2.5},{id:"s",x:0,y:y+6,ax:-2,ay:-2.5,bx:0,by:1.5,cx:2,cy:-2.5}],k=Math.PI*.25,T={x:f*Math.cos(k)+4,y:y*Math.sin(k)+4};return u.jsxs("g",{"data-node":n.id,transform:`translate(${n.x} ${n.y})`,onPointerDown:w=>{w.stopPropagation(),e||S({kind:"node",id:n.id}),t(w,n.id)},onPointerEnter:()=>m(!0),onPointerLeave:()=>m(!1),className:"bn",children:[u.jsx("ellipse",{cx:"0",cy:"0",rx:f,ry:y,fill:c.fill,stroke:"none",className:"bn-fill"}),x.map((w,_)=>u.jsx("path",{d:w,fill:"none",stroke:p,strokeWidth:r?e?c.strokeWidth+.6:c.strokeWidth*.92:e?c.strokeWidth+1.4:c.strokeWidth,strokeLinejoin:"round",strokeLinecap:"round",className:_===0?"bn-shape":"bn-shape-overlay"},_)),e&&u.jsx("ellipse",{cx:"0",cy:"0",rx:f+9,ry:y+7,fill:"none",stroke:"var(--select-outline)",strokeWidth:"1.4",strokeDasharray:"5 4",pointerEvents:"none"}),u.jsx("text",{y:-12*d,textAnchor:"middle",fontSize:16*Math.sqrt(d),fill:c.textColor,fontFamily:"var(--font-display)",pointerEvents:"none",children:c.icon}),u.jsx("foreignObject",{x:-f+8,y:2,width:f*2-16,height:y,children:u.jsx("div",{className:"bn-name",style:{fontSize:`${13*Math.sqrt(d)}px`},children:n.name})}),u.jsx("text",{y:y-8,textAnchor:"middle",fontSize:9,fill:"var(--ink-500)",fontFamily:"var(--font-mono)",letterSpacing:"0.12em",pointerEvents:"none",style:{textTransform:"uppercase"},children:c.label}),n.icons.length>0&&(()=>{const w=Math.min(n.icons.length,8),N=Math.max(1,Math.ceil(w/4))*18+10;return u.jsx("foreignObject",{x:-f-30,y:y+6,width:f*2+60,height:N,children:u.jsxs("div",{className:"bn-icon-tags",children:[n.icons.slice(0,8).map(j=>u.jsx("span",{className:"bn-icon-chip",children:j},j)),n.icons.length>8&&u.jsxs("span",{className:"bn-icon-more",children:["+",n.icons.length-8]})]})})})(),(M||e)&&v.map(w=>u.jsxs("g",{"data-handle":"out",children:[u.jsx("circle",{cx:w.x,cy:w.y,r:"6",fill:"var(--paper-50)",stroke:"var(--brick)",strokeWidth:"1.4",className:"bn-handle",onPointerDown:_=>{_.stopPropagation(),o(_,n.id)}}),u.jsx("path",{d:`M ${w.x+w.ax} ${w.y+w.ay} L ${w.x+w.bx} ${w.y+w.by} L ${w.x+w.cx} ${w.y+w.cy}`,fill:"none",stroke:"var(--brick)",strokeWidth:"1.2",strokeLinecap:"round",strokeLinejoin:"round",pointerEvents:"none"})]},w.id)),(M||e)&&u.jsxs("g",{"data-handle":"resize",children:[u.jsx("circle",{cx:T.x,cy:T.y,r:"6",fill:"var(--paper-50)",stroke:"var(--blueprint)",strokeWidth:"1.4",className:"bn-handle bn-handle-resize",onPointerDown:w=>{w.stopPropagation(),i(w,n.id)}}),u.jsx("path",{d:`M ${T.x-2} ${T.y-2} L ${T.x+2} ${T.y+2}
                M ${T.x+2} ${T.y-2} L ${T.x-2} ${T.y+2}`,stroke:"var(--blueprint)",strokeWidth:"1.1",strokeLinecap:"round",pointerEvents:"none",opacity:"0.7"})]})]})}const lo={open:{stroke:"#1A1814",width:4.8,label:"통로"},locked:{stroke:"#8F7740",width:2.8,dash:"8 5",label:"잠금"},oneway:{stroke:"#6B6760",width:1.8,label:"일방"},ability:{stroke:"#8A3D3A",width:2.2,dash:"3 4",label:"능력"},vista:{stroke:"#6B4F87",width:1.6,dash:"2 6",label:"전망"}},Gy={open:"#FFFFFF",oneway:"#C7C0B4"};function yu(n,r,e,t,o,i){const s=Math.sqrt(o*o/(e*e)+i*i/(t*t));return s===0?{x:n,y:r}:{x:n+o/s,y:r+i/s}}function Vy({edge:n,from:r,to:e,rough:t,selected:o,offset:i=0,onSelect:s}){const a=lo[n.type],l=_f(),c=l==="dark"&&Gy[n.type]||a.stroke,d=l==="dark"?"#14110D":"#1A1814",{startX:h,startY:f,endX:y,endY:x,arrowX:S,arrowY:M,angle:m}=Z.useMemo(()=>{const _=e.x-r.x,N=e.y-r.y,j=Math.hypot(_,N)||1,z=_/j,G=N/j,Y=r.id<e.id?1:-1,C=-G*Y,D=z*Y,E=C*i,R=D*i,P=ve(r.type,r.size??1,r.aspect??1),A=ve(e.type,e.size??1,e.aspect??1),L=yu(r.x,r.y,P.rx,P.ry,_,N),$=yu(e.x,e.y,A.rx,A.ry,-_,-N),V=6,dn=2;return{startX:L.x-z*V+E,startY:L.y-G*V+R,endX:$.x+z*V+E,endY:$.y+G*V+R,arrowX:$.x-z*dn+E,arrowY:$.y-G*dn+R,angle:Math.atan2(N,_)*180/Math.PI}},[r.x,r.y,e.x,e.y,r.id,e.id,r.type,r.size,r.aspect,e.type,e.size,e.aspect,i]),g=Z.useMemo(()=>Zy(h,f,y,x,{seed:n.id,roughness:t?4.8:0,bowing:0,passes:1}),[h,f,y,x,n.id,t]),p=Math.max(13,Math.min(18,a.width*3)),v=`${-p},${-p*.6} ${p*.45},0 ${-p},${p*.6}`,k=n.type==="oneway"||n.type==="ability"||n.type==="locked",T=(h+y)/2,w=(f+x)/2;return u.jsxs("g",{"data-edge":n.id,className:"eg",onClick:_=>{_.stopPropagation(),s(n.id)},children:[u.jsx("path",{d:g[0],fill:"none",stroke:"transparent",strokeWidth:"14"}),o&&g.map((_,N)=>u.jsx("path",{d:_,fill:"none",stroke:"#CF5547",strokeWidth:a.width+8,strokeLinecap:"round",strokeLinejoin:"round"},`halo-${N}`)),g.map((_,N)=>u.jsx("path",{d:_,fill:"none",stroke:c,strokeWidth:o?a.width+1.4:a.width,strokeDasharray:a.dash,strokeLinecap:"round",strokeLinejoin:"round"},N)),k&&u.jsx("polygon",{points:v,fill:o?"#CF5547":c,stroke:d,strokeWidth:o?2:1.4,strokeLinejoin:"round",strokeLinecap:"round",transform:`translate(${S} ${M}) rotate(${m})`}),(n.keyId||n.abilityId||n.label)&&u.jsx(Uy,{x:T,y:w,text:n.label??n.keyId??n.abilityId??"",color:c})]})}function Uy({x:n,y:r,text:e,color:t}){const o=(e.match(/[가-힯ㄱ-ㅎㅏ-ㅣ]/g)||[]).length,i=e.length-o,a=Math.max(46,o*15+i*8+28),l=26;return u.jsx("foreignObject",{x:n-a/2,y:r-l/2,width:a,height:l,style:{overflow:"visible"},children:u.jsx("div",{className:"edge-label",style:{borderColor:t,color:t},children:u.jsx("span",{children:e})})})}const Ky=180,Qy=130;function Xy({nodes:n,edges:r,viewBox:e}){if(n.length===0)return null;const t=new Map(n.map(h=>[h.id,h]));let o=1/0,i=1/0,s=-1/0,a=-1/0;for(const h of n){const f=ve(h.type,h.size??1,h.aspect??1);o=Math.min(o,h.x-f.rx),i=Math.min(i,h.y-f.ry),s=Math.max(s,h.x+f.rx),a=Math.max(a,h.y+f.ry)}const l=Math.max(1,s-o),c=Math.max(1,a-i),d=20;return u.jsxs("svg",{className:"minimap",width:Ky,height:Qy,viewBox:`${o-d} ${i-d} ${l+d*2} ${c+d*2}`,preserveAspectRatio:"xMidYMid meet",children:[u.jsx("rect",{x:o-d,y:i-d,width:l+d*2,height:c+d*2,fill:"rgba(244, 239, 230, 0.94)"}),r.map(h=>{const f=t.get(h.from),y=t.get(h.to);if(!f||!y)return null;const x=lo[h.type];return u.jsx("line",{x1:f.x,y1:f.y,x2:y.x,y2:y.y,stroke:x.stroke,strokeWidth:2.5,strokeDasharray:x.dash,strokeLinecap:"round"},h.id)}),n.map(h=>{const f=Jr[h.type],y=ve(h.type,h.size??1,h.aspect??1);return u.jsx("ellipse",{cx:h.x,cy:h.y,rx:y.rx,ry:y.ry,fill:f.fill,stroke:f.stroke,strokeWidth:"2"},h.id)}),u.jsx("rect",{x:e.x,y:e.y,width:e.w,height:e.h,fill:"none",stroke:"var(--brick)",strokeWidth:"2",strokeDasharray:"6 4"})]})}function Yy({dec:n,selected:r,onPointerDown:e,onArrowEndpointDown:t,onResizeDown:o}){const i=b(a=>a.select),s=a=>{a.stopPropagation(),r||i({kind:"decoration",id:n.id}),e(a,n.id)};return n.kind==="arrow"?u.jsx(Jy,{dec:n,selected:r,onSelect:s,onEndpointDown:t}):n.kind==="ellipse"?u.jsx(qy,{dec:n,selected:r,onSelect:s,onResizeDown:o}):u.jsx(nv,{dec:n,selected:r,onSelect:s,onResizeDown:o})}function Jy({dec:n,selected:r,onSelect:e,onEndpointDown:t}){const o=b(w=>{var _;return((_=w.project.theme)==null?void 0:_.hueShift)??0}),i=b(w=>{var _;return((_=w.project.theme)==null?void 0:_.satScale)??1}),s=n.x,a=n.y,l=n.x2??n.x+140,c=n.y2??n.y,d=l-s,h=c-a,f=Math.hypot(d,h)||1,y=d/f,x=h/f,S=Math.atan2(h,d)*180/Math.PI,M=o!==0||i!==1?If("#E5202B",o,i):"#E5202B",m=r?28:24,g=44,p=g*.85,v=l-y*p,k=c-x*p,T=`${-g},${-g*.7} ${g*.5},0 ${-g},${g*.7}`;return u.jsxs("g",{"data-decoration":n.id,className:"deco",children:[u.jsx("line",{x1:s,y1:a,x2:l,y2:c,stroke:"transparent",strokeWidth:Math.max(m+16,g+12),strokeLinecap:"butt",onPointerDown:e}),u.jsx("line",{x1:s,y1:a,x2:v,y2:k,stroke:M,strokeWidth:m,strokeLinecap:"butt",pointerEvents:"none"}),u.jsx("polygon",{points:T,fill:M,stroke:"none",strokeLinejoin:"round",transform:`translate(${l} ${c}) rotate(${S})`,pointerEvents:"none"}),r&&u.jsxs(u.Fragment,{children:[u.jsx("circle",{cx:s,cy:a,r:"6",fill:"var(--paper-50)",stroke:"var(--brick)",strokeWidth:"1.4",className:"deco-handle",onPointerDown:w=>t(w,n.id,"start")}),u.jsx("circle",{cx:l,cy:c,r:"6",fill:"var(--paper-50)",stroke:"var(--brick)",strokeWidth:"1.4",className:"deco-handle",onPointerDown:w=>t(w,n.id,"end")})]})]})}function qy({dec:n,selected:r,onSelect:e,onResizeDown:t}){const o=n.width??140,i=n.height??90,s=o/2,a=i/2;return u.jsxs("g",{"data-decoration":n.id,transform:`translate(${n.x} ${n.y})`,className:"deco",onPointerDown:e,children:[u.jsx("ellipse",{cx:"0",cy:"0",rx:s+10,ry:a+10,fill:"transparent",stroke:"none"}),u.jsx("ellipse",{cx:"0",cy:"0",rx:s,ry:a,fill:"#C9C4B8",stroke:"none",pointerEvents:"none"}),r&&u.jsx("ellipse",{cx:"0",cy:"0",rx:s+6,ry:a+6,fill:"none",stroke:"var(--brick)",strokeWidth:"1.4",strokeDasharray:"5 4",pointerEvents:"none"}),r&&u.jsx("circle",{cx:s*.707+4,cy:a*.707+4,r:"6",fill:"var(--paper-50)",stroke:"var(--blueprint)",strokeWidth:"1.4",className:"deco-handle deco-handle-resize",onPointerDown:l=>t(l,n.id)})]})}function nv({dec:n,selected:r,onSelect:e,onResizeDown:t}){const o=b(m=>m.updateDecoration),i=n.width??180,s=n.height??40,a=n.text??"텍스트",[l,c]=Z.useState(!1),d=Z.useRef(null),h=Math.max(1,a.length),f=(a.match(/[가-힯]/g)||[]).length,y=(f*1.5+(h-f))/h,x=Math.min(48,Math.max(12,s*.7)),S=Math.min(48,Math.max(12,i/h/y*1.4)),M=Math.min(x,S);return Z.useEffect(()=>{l&&d.current&&(d.current.focus(),d.current.select())},[l]),u.jsxs("g",{"data-decoration":n.id,transform:`translate(${n.x} ${n.y})`,className:"deco",onPointerDown:m=>{l||e(m)},onDoubleClick:m=>{m.stopPropagation(),c(!0)},children:[u.jsx("rect",{x:-i/2-8,y:-s/2-8,width:i+16,height:s+16,fill:"transparent",stroke:"none"}),u.jsx("foreignObject",{x:-i/2,y:-s/2,width:i,height:s,style:{overflow:"visible"},children:l?u.jsx("textarea",{ref:d,className:"deco-text-input",style:{fontSize:`${M}px`,width:"100%",height:"100%"},value:a,onChange:m=>o(n.id,{text:m.target.value}),onBlur:()=>c(!1),onKeyDown:m=>{m.key==="Escape"&&c(!1)}}):u.jsx("div",{className:"deco-text",style:{fontSize:`${M}px`,width:"100%",height:"100%"},children:a||u.jsx("span",{className:"deco-text-placeholder",children:"더블클릭으로 편집"})})}),r&&u.jsxs(u.Fragment,{children:[u.jsx("rect",{x:-i/2-4,y:-s/2-4,width:i+8,height:s+8,fill:"none",stroke:"var(--brick)",strokeWidth:"1.4",strokeDasharray:"5 4",pointerEvents:"none"}),u.jsx("circle",{cx:i/2+4,cy:s/2+4,r:"6",fill:"var(--paper-50)",stroke:"var(--blueprint)",strokeWidth:"1.4",className:"deco-handle deco-handle-resize",onPointerDown:m=>t(m,n.id)})]})]})}var Da="http://www.w3.org/1999/xhtml";const vu={svg:"http://www.w3.org/2000/svg",xhtml:Da,xlink:"http://www.w3.org/1999/xlink",xml:"http://www.w3.org/XML/1998/namespace",xmlns:"http://www.w3.org/2000/xmlns/"};function rs(n){var r=n+="",e=r.indexOf(":");return e>=0&&(r=n.slice(0,e))!=="xmlns"&&(n=n.slice(e+1)),vu.hasOwnProperty(r)?{space:vu[r],local:n}:n}function rv(n){return function(){var r=this.ownerDocument,e=this.namespaceURI;return e===Da&&r.documentElement.namespaceURI===Da?r.createElement(n):r.createElementNS(e,n)}}function ev(n){return function(){return this.ownerDocument.createElementNS(n.space,n.local)}}function Ef(n){var r=rs(n);return(r.local?ev:rv)(r)}function tv(){}function Bl(n){return n==null?tv:function(){return this.querySelector(n)}}function ov(n){typeof n!="function"&&(n=Bl(n));for(var r=this._groups,e=r.length,t=new Array(e),o=0;o<e;++o)for(var i=r[o],s=i.length,a=t[o]=new Array(s),l,c,d=0;d<s;++d)(l=i[d])&&(c=n.call(l,l.__data__,d,i))&&("__data__"in l&&(c.__data__=l.__data__),a[d]=c);return new Vn(t,this._parents)}function iv(n){return n==null?[]:Array.isArray(n)?n:Array.from(n)}function sv(){return[]}function bf(n){return n==null?sv:function(){return this.querySelectorAll(n)}}function av(n){return function(){return iv(n.apply(this,arguments))}}function lv(n){typeof n=="function"?n=av(n):n=bf(n);for(var r=this._groups,e=r.length,t=[],o=[],i=0;i<e;++i)for(var s=r[i],a=s.length,l,c=0;c<a;++c)(l=s[c])&&(t.push(n.call(l,l.__data__,c,s)),o.push(l));return new Vn(t,o)}function Nf(n){return function(){return this.matches(n)}}function Of(n){return function(r){return r.matches(n)}}var cv=Array.prototype.find;function uv(n){return function(){return cv.call(this.children,n)}}function dv(){return this.firstElementChild}function hv(n){return this.select(n==null?dv:uv(typeof n=="function"?n:Of(n)))}var fv=Array.prototype.filter;function pv(){return Array.from(this.children)}function mv(n){return function(){return fv.call(this.children,n)}}function gv(n){return this.selectAll(n==null?pv:mv(typeof n=="function"?n:Of(n)))}function yv(n){typeof n!="function"&&(n=Nf(n));for(var r=this._groups,e=r.length,t=new Array(e),o=0;o<e;++o)for(var i=r[o],s=i.length,a=t[o]=[],l,c=0;c<s;++c)(l=i[c])&&n.call(l,l.__data__,c,i)&&a.push(l);return new Vn(t,this._parents)}function Af(n){return new Array(n.length)}function vv(){return new Vn(this._enter||this._groups.map(Af),this._parents)}function bi(n,r){this.ownerDocument=n.ownerDocument,this.namespaceURI=n.namespaceURI,this._next=null,this._parent=n,this.__data__=r}bi.prototype={constructor:bi,appendChild:function(n){return this._parent.insertBefore(n,this._next)},insertBefore:function(n,r){return this._parent.insertBefore(n,r)},querySelector:function(n){return this._parent.querySelector(n)},querySelectorAll:function(n){return this._parent.querySelectorAll(n)}};function wv(n){return function(){return n}}function xv(n,r,e,t,o,i){for(var s=0,a,l=r.length,c=i.length;s<c;++s)(a=r[s])?(a.__data__=i[s],t[s]=a):e[s]=new bi(n,i[s]);for(;s<l;++s)(a=r[s])&&(o[s]=a)}function Sv(n,r,e,t,o,i,s){var a,l,c=new Map,d=r.length,h=i.length,f=new Array(d),y;for(a=0;a<d;++a)(l=r[a])&&(f[a]=y=s.call(l,l.__data__,a,r)+"",c.has(y)?o[a]=l:c.set(y,l));for(a=0;a<h;++a)y=s.call(n,i[a],a,i)+"",(l=c.get(y))?(t[a]=l,l.__data__=i[a],c.delete(y)):e[a]=new bi(n,i[a]);for(a=0;a<d;++a)(l=r[a])&&c.get(f[a])===l&&(o[a]=l)}function _v(n){return n.__data__}function kv(n,r){if(!arguments.length)return Array.from(this,_v);var e=r?Sv:xv,t=this._parents,o=this._groups;typeof n!="function"&&(n=wv(n));for(var i=o.length,s=new Array(i),a=new Array(i),l=new Array(i),c=0;c<i;++c){var d=t[c],h=o[c],f=h.length,y=Cv(n.call(d,d&&d.__data__,c,t)),x=y.length,S=a[c]=new Array(x),M=s[c]=new Array(x),m=l[c]=new Array(f);e(d,h,S,M,m,y,r);for(var g=0,p=0,v,k;g<x;++g)if(v=S[g]){for(g>=p&&(p=g+1);!(k=M[p])&&++p<x;);v._next=k||null}}return s=new Vn(s,t),s._enter=a,s._exit=l,s}function Cv(n){return typeof n=="object"&&"length"in n?n:Array.from(n)}function Tv(){return new Vn(this._exit||this._groups.map(Af),this._parents)}function Pv(n,r,e){var t=this.enter(),o=this,i=this.exit();return typeof n=="function"?(t=n(t),t&&(t=t.selection())):t=t.append(n+""),r!=null&&(o=r(o),o&&(o=o.selection())),e==null?i.remove():e(i),t&&o?t.merge(o).order():o}function Iv(n){for(var r=n.selection?n.selection():n,e=this._groups,t=r._groups,o=e.length,i=t.length,s=Math.min(o,i),a=new Array(o),l=0;l<s;++l)for(var c=e[l],d=t[l],h=c.length,f=a[l]=new Array(h),y,x=0;x<h;++x)(y=c[x]||d[x])&&(f[x]=y);for(;l<o;++l)a[l]=e[l];return new Vn(a,this._parents)}function Ev(){for(var n=this._groups,r=-1,e=n.length;++r<e;)for(var t=n[r],o=t.length-1,i=t[o],s;--o>=0;)(s=t[o])&&(i&&s.compareDocumentPosition(i)^4&&i.parentNode.insertBefore(s,i),i=s);return this}function bv(n){n||(n=Nv);function r(h,f){return h&&f?n(h.__data__,f.__data__):!h-!f}for(var e=this._groups,t=e.length,o=new Array(t),i=0;i<t;++i){for(var s=e[i],a=s.length,l=o[i]=new Array(a),c,d=0;d<a;++d)(c=s[d])&&(l[d]=c);l.sort(r)}return new Vn(o,this._parents).order()}function Nv(n,r){return n<r?-1:n>r?1:n>=r?0:NaN}function Ov(){var n=arguments[0];return arguments[0]=this,n.apply(null,arguments),this}function Av(){return Array.from(this)}function Mv(){for(var n=this._groups,r=0,e=n.length;r<e;++r)for(var t=n[r],o=0,i=t.length;o<i;++o){var s=t[o];if(s)return s}return null}function jv(){let n=0;for(const r of this)++n;return n}function Lv(){return!this.node()}function Zv(n){for(var r=this._groups,e=0,t=r.length;e<t;++e)for(var o=r[e],i=0,s=o.length,a;i<s;++i)(a=o[i])&&n.call(a,a.__data__,i,o);return this}function Dv(n){return function(){this.removeAttribute(n)}}function Rv(n){return function(){this.removeAttributeNS(n.space,n.local)}}function Fv(n,r){return function(){this.setAttribute(n,r)}}function Hv(n,r){return function(){this.setAttributeNS(n.space,n.local,r)}}function $v(n,r){return function(){var e=r.apply(this,arguments);e==null?this.removeAttribute(n):this.setAttribute(n,e)}}function Bv(n,r){return function(){var e=r.apply(this,arguments);e==null?this.removeAttributeNS(n.space,n.local):this.setAttributeNS(n.space,n.local,e)}}function zv(n,r){var e=rs(n);if(arguments.length<2){var t=this.node();return e.local?t.getAttributeNS(e.space,e.local):t.getAttribute(e)}return this.each((r==null?e.local?Rv:Dv:typeof r=="function"?e.local?Bv:$v:e.local?Hv:Fv)(e,r))}function Mf(n){return n.ownerDocument&&n.ownerDocument.defaultView||n.document&&n||n.defaultView}function Wv(n){return function(){this.style.removeProperty(n)}}function Gv(n,r,e){return function(){this.style.setProperty(n,r,e)}}function Vv(n,r,e){return function(){var t=r.apply(this,arguments);t==null?this.style.removeProperty(n):this.style.setProperty(n,t,e)}}function Uv(n,r,e){return arguments.length>1?this.each((r==null?Wv:typeof r=="function"?Vv:Gv)(n,r,e??"")):rt(this.node(),n)}function rt(n,r){return n.style.getPropertyValue(r)||Mf(n).getComputedStyle(n,null).getPropertyValue(r)}function Kv(n){return function(){delete this[n]}}function Qv(n,r){return function(){this[n]=r}}function Xv(n,r){return function(){var e=r.apply(this,arguments);e==null?delete this[n]:this[n]=e}}function Yv(n,r){return arguments.length>1?this.each((r==null?Kv:typeof r=="function"?Xv:Qv)(n,r)):this.node()[n]}function jf(n){return n.trim().split(/^|\s+/)}function zl(n){return n.classList||new Lf(n)}function Lf(n){this._node=n,this._names=jf(n.getAttribute("class")||"")}Lf.prototype={add:function(n){var r=this._names.indexOf(n);r<0&&(this._names.push(n),this._node.setAttribute("class",this._names.join(" ")))},remove:function(n){var r=this._names.indexOf(n);r>=0&&(this._names.splice(r,1),this._node.setAttribute("class",this._names.join(" ")))},contains:function(n){return this._names.indexOf(n)>=0}};function Zf(n,r){for(var e=zl(n),t=-1,o=r.length;++t<o;)e.add(r[t])}function Df(n,r){for(var e=zl(n),t=-1,o=r.length;++t<o;)e.remove(r[t])}function Jv(n){return function(){Zf(this,n)}}function qv(n){return function(){Df(this,n)}}function nw(n,r){return function(){(r.apply(this,arguments)?Zf:Df)(this,n)}}function rw(n,r){var e=jf(n+"");if(arguments.length<2){for(var t=zl(this.node()),o=-1,i=e.length;++o<i;)if(!t.contains(e[o]))return!1;return!0}return this.each((typeof r=="function"?nw:r?Jv:qv)(e,r))}function ew(){this.textContent=""}function tw(n){return function(){this.textContent=n}}function ow(n){return function(){var r=n.apply(this,arguments);this.textContent=r??""}}function iw(n){return arguments.length?this.each(n==null?ew:(typeof n=="function"?ow:tw)(n)):this.node().textContent}function sw(){this.innerHTML=""}function aw(n){return function(){this.innerHTML=n}}function lw(n){return function(){var r=n.apply(this,arguments);this.innerHTML=r??""}}function cw(n){return arguments.length?this.each(n==null?sw:(typeof n=="function"?lw:aw)(n)):this.node().innerHTML}function uw(){this.nextSibling&&this.parentNode.appendChild(this)}function dw(){return this.each(uw)}function hw(){this.previousSibling&&this.parentNode.insertBefore(this,this.parentNode.firstChild)}function fw(){return this.each(hw)}function pw(n){var r=typeof n=="function"?n:Ef(n);return this.select(function(){return this.appendChild(r.apply(this,arguments))})}function mw(){return null}function gw(n,r){var e=typeof n=="function"?n:Ef(n),t=r==null?mw:typeof r=="function"?r:Bl(r);return this.select(function(){return this.insertBefore(e.apply(this,arguments),t.apply(this,arguments)||null)})}function yw(){var n=this.parentNode;n&&n.removeChild(this)}function vw(){return this.each(yw)}function ww(){var n=this.cloneNode(!1),r=this.parentNode;return r?r.insertBefore(n,this.nextSibling):n}function xw(){var n=this.cloneNode(!0),r=this.parentNode;return r?r.insertBefore(n,this.nextSibling):n}function Sw(n){return this.select(n?xw:ww)}function _w(n){return arguments.length?this.property("__data__",n):this.node().__data__}function kw(n){return function(r){n.call(this,r,this.__data__)}}function Cw(n){return n.trim().split(/^|\s+/).map(function(r){var e="",t=r.indexOf(".");return t>=0&&(e=r.slice(t+1),r=r.slice(0,t)),{type:r,name:e}})}function Tw(n){return function(){var r=this.__on;if(r){for(var e=0,t=-1,o=r.length,i;e<o;++e)i=r[e],(!n.type||i.type===n.type)&&i.name===n.name?this.removeEventListener(i.type,i.listener,i.options):r[++t]=i;++t?r.length=t:delete this.__on}}}function Pw(n,r,e){return function(){var t=this.__on,o,i=kw(r);if(t){for(var s=0,a=t.length;s<a;++s)if((o=t[s]).type===n.type&&o.name===n.name){this.removeEventListener(o.type,o.listener,o.options),this.addEventListener(o.type,o.listener=i,o.options=e),o.value=r;return}}this.addEventListener(n.type,i,e),o={type:n.type,name:n.name,value:r,listener:i,options:e},t?t.push(o):this.__on=[o]}}function Iw(n,r,e){var t=Cw(n+""),o,i=t.length,s;if(arguments.length<2){var a=this.node().__on;if(a){for(var l=0,c=a.length,d;l<c;++l)for(o=0,d=a[l];o<i;++o)if((s=t[o]).type===d.type&&s.name===d.name)return d.value}return}for(a=r?Pw:Tw,o=0;o<i;++o)this.each(a(t[o],r,e));return this}function Rf(n,r,e){var t=Mf(n),o=t.CustomEvent;typeof o=="function"?o=new o(r,e):(o=t.document.createEvent("Event"),e?(o.initEvent(r,e.bubbles,e.cancelable),o.detail=e.detail):o.initEvent(r,!1,!1)),n.dispatchEvent(o)}function Ew(n,r){return function(){return Rf(this,n,r)}}function bw(n,r){return function(){return Rf(this,n,r.apply(this,arguments))}}function Nw(n,r){return this.each((typeof r=="function"?bw:Ew)(n,r))}function*Ow(){for(var n=this._groups,r=0,e=n.length;r<e;++r)for(var t=n[r],o=0,i=t.length,s;o<i;++o)(s=t[o])&&(yield s)}var Ff=[null];function Vn(n,r){this._groups=n,this._parents=r}function co(){return new Vn([[document.documentElement]],Ff)}function Aw(){return this}Vn.prototype=co.prototype={constructor:Vn,select:ov,selectAll:lv,selectChild:hv,selectChildren:gv,filter:yv,data:kv,enter:vv,exit:Tv,join:Pv,merge:Iv,selection:Aw,order:Ev,sort:bv,call:Ov,nodes:Av,node:Mv,size:jv,empty:Lv,each:Zv,attr:zv,style:Uv,property:Yv,classed:rw,text:iw,html:cw,raise:dw,lower:fw,append:pw,insert:gw,remove:vw,clone:Sw,datum:_w,on:Iw,dispatch:Nw,[Symbol.iterator]:Ow};function sr(n){return typeof n=="string"?new Vn([[document.querySelector(n)]],[document.documentElement]):new Vn([[n]],Ff)}function Mw(n){let r;for(;r=n.sourceEvent;)n=r;return n}function ee(n,r){if(n=Mw(n),r===void 0&&(r=n.currentTarget),r){var e=r.ownerSVGElement||r;if(e.createSVGPoint){var t=e.createSVGPoint();return t.x=n.clientX,t.y=n.clientY,t=t.matrixTransform(r.getScreenCTM().inverse()),[t.x,t.y]}if(r.getBoundingClientRect){var o=r.getBoundingClientRect();return[n.clientX-o.left-r.clientLeft,n.clientY-o.top-r.clientTop]}}return[n.pageX,n.pageY]}var jw={value:()=>{}};function Wl(){for(var n=0,r=arguments.length,e={},t;n<r;++n){if(!(t=arguments[n]+"")||t in e||/[\s.]/.test(t))throw new Error("illegal type: "+t);e[t]=[]}return new Yo(e)}function Yo(n){this._=n}function Lw(n,r){return n.trim().split(/^|\s+/).map(function(e){var t="",o=e.indexOf(".");if(o>=0&&(t=e.slice(o+1),e=e.slice(0,o)),e&&!r.hasOwnProperty(e))throw new Error("unknown type: "+e);return{type:e,name:t}})}Yo.prototype=Wl.prototype={constructor:Yo,on:function(n,r){var e=this._,t=Lw(n+"",e),o,i=-1,s=t.length;if(arguments.length<2){for(;++i<s;)if((o=(n=t[i]).type)&&(o=Zw(e[o],n.name)))return o;return}if(r!=null&&typeof r!="function")throw new Error("invalid callback: "+r);for(;++i<s;)if(o=(n=t[i]).type)e[o]=wu(e[o],n.name,r);else if(r==null)for(o in e)e[o]=wu(e[o],n.name,null);return this},copy:function(){var n={},r=this._;for(var e in r)n[e]=r[e].slice();return new Yo(n)},call:function(n,r){if((o=arguments.length-2)>0)for(var e=new Array(o),t=0,o,i;t<o;++t)e[t]=arguments[t+2];if(!this._.hasOwnProperty(n))throw new Error("unknown type: "+n);for(i=this._[n],t=0,o=i.length;t<o;++t)i[t].value.apply(r,e)},apply:function(n,r,e){if(!this._.hasOwnProperty(n))throw new Error("unknown type: "+n);for(var t=this._[n],o=0,i=t.length;o<i;++o)t[o].value.apply(r,e)}};function Zw(n,r){for(var e=0,t=n.length,o;e<t;++e)if((o=n[e]).name===r)return o.value}function wu(n,r,e){for(var t=0,o=n.length;t<o;++t)if(n[t].name===r){n[t]=jw,n=n.slice(0,t).concat(n.slice(t+1));break}return e!=null&&n.push({name:r,value:e}),n}const Ra={capture:!0,passive:!1};function Fa(n){n.preventDefault(),n.stopImmediatePropagation()}function Dw(n){var r=n.document.documentElement,e=sr(n).on("dragstart.drag",Fa,Ra);"onselectstart"in r?e.on("selectstart.drag",Fa,Ra):(r.__noselect=r.style.MozUserSelect,r.style.MozUserSelect="none")}function Rw(n,r){var e=n.document.documentElement,t=sr(n).on("dragstart.drag",null);r&&(t.on("click.drag",Fa,Ra),setTimeout(function(){t.on("click.drag",null)},0)),"onselectstart"in e?t.on("selectstart.drag",null):(e.style.MozUserSelect=e.__noselect,delete e.__noselect)}function Gl(n,r,e){n.prototype=r.prototype=e,e.constructor=n}function Hf(n,r){var e=Object.create(n.prototype);for(var t in r)e[t]=r[t];return e}function uo(){}var Jt=.7,Ni=1/Jt,Ge="\\s*([+-]?\\d+)\\s*",qt="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*",yr="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*",Fw=/^#([0-9a-f]{3,8})$/,Hw=new RegExp(`^rgb\\(${Ge},${Ge},${Ge}\\)$`),$w=new RegExp(`^rgb\\(${yr},${yr},${yr}\\)$`),Bw=new RegExp(`^rgba\\(${Ge},${Ge},${Ge},${qt}\\)$`),zw=new RegExp(`^rgba\\(${yr},${yr},${yr},${qt}\\)$`),Ww=new RegExp(`^hsl\\(${qt},${yr},${yr}\\)$`),Gw=new RegExp(`^hsla\\(${qt},${yr},${yr},${qt}\\)$`),xu={aliceblue:15792383,antiquewhite:16444375,aqua:65535,aquamarine:8388564,azure:15794175,beige:16119260,bisque:16770244,black:0,blanchedalmond:16772045,blue:255,blueviolet:9055202,brown:10824234,burlywood:14596231,cadetblue:6266528,chartreuse:8388352,chocolate:13789470,coral:16744272,cornflowerblue:6591981,cornsilk:16775388,crimson:14423100,cyan:65535,darkblue:139,darkcyan:35723,darkgoldenrod:12092939,darkgray:11119017,darkgreen:25600,darkgrey:11119017,darkkhaki:12433259,darkmagenta:9109643,darkolivegreen:5597999,darkorange:16747520,darkorchid:10040012,darkred:9109504,darksalmon:15308410,darkseagreen:9419919,darkslateblue:4734347,darkslategray:3100495,darkslategrey:3100495,darkturquoise:52945,darkviolet:9699539,deeppink:16716947,deepskyblue:49151,dimgray:6908265,dimgrey:6908265,dodgerblue:2003199,firebrick:11674146,floralwhite:16775920,forestgreen:2263842,fuchsia:16711935,gainsboro:14474460,ghostwhite:16316671,gold:16766720,goldenrod:14329120,gray:8421504,green:32768,greenyellow:11403055,grey:8421504,honeydew:15794160,hotpink:16738740,indianred:13458524,indigo:4915330,ivory:16777200,khaki:15787660,lavender:15132410,lavenderblush:16773365,lawngreen:8190976,lemonchiffon:16775885,lightblue:11393254,lightcoral:15761536,lightcyan:14745599,lightgoldenrodyellow:16448210,lightgray:13882323,lightgreen:9498256,lightgrey:13882323,lightpink:16758465,lightsalmon:16752762,lightseagreen:2142890,lightskyblue:8900346,lightslategray:7833753,lightslategrey:7833753,lightsteelblue:11584734,lightyellow:16777184,lime:65280,limegreen:3329330,linen:16445670,magenta:16711935,maroon:8388608,mediumaquamarine:6737322,mediumblue:205,mediumorchid:12211667,mediumpurple:9662683,mediumseagreen:3978097,mediumslateblue:8087790,mediumspringgreen:64154,mediumturquoise:4772300,mediumvioletred:13047173,midnightblue:1644912,mintcream:16121850,mistyrose:16770273,moccasin:16770229,navajowhite:16768685,navy:128,oldlace:16643558,olive:8421376,olivedrab:7048739,orange:16753920,orangered:16729344,orchid:14315734,palegoldenrod:15657130,palegreen:10025880,paleturquoise:11529966,palevioletred:14381203,papayawhip:16773077,peachpuff:16767673,peru:13468991,pink:16761035,plum:14524637,powderblue:11591910,purple:8388736,rebeccapurple:6697881,red:16711680,rosybrown:12357519,royalblue:4286945,saddlebrown:9127187,salmon:16416882,sandybrown:16032864,seagreen:3050327,seashell:16774638,sienna:10506797,silver:12632256,skyblue:8900331,slateblue:6970061,slategray:7372944,slategrey:7372944,snow:16775930,springgreen:65407,steelblue:4620980,tan:13808780,teal:32896,thistle:14204888,tomato:16737095,turquoise:4251856,violet:15631086,wheat:16113331,white:16777215,whitesmoke:16119285,yellow:16776960,yellowgreen:10145074};Gl(uo,no,{copy(n){return Object.assign(new this.constructor,this,n)},displayable(){return this.rgb().displayable()},hex:Su,formatHex:Su,formatHex8:Vw,formatHsl:Uw,formatRgb:_u,toString:_u});function Su(){return this.rgb().formatHex()}function Vw(){return this.rgb().formatHex8()}function Uw(){return $f(this).formatHsl()}function _u(){return this.rgb().formatRgb()}function no(n){var r,e;return n=(n+"").trim().toLowerCase(),(r=Fw.exec(n))?(e=r[1].length,r=parseInt(r[1],16),e===6?ku(r):e===3?new Ln(r>>8&15|r>>4&240,r>>4&15|r&240,(r&15)<<4|r&15,1):e===8?Mo(r>>24&255,r>>16&255,r>>8&255,(r&255)/255):e===4?Mo(r>>12&15|r>>8&240,r>>8&15|r>>4&240,r>>4&15|r&240,((r&15)<<4|r&15)/255):null):(r=Hw.exec(n))?new Ln(r[1],r[2],r[3],1):(r=$w.exec(n))?new Ln(r[1]*255/100,r[2]*255/100,r[3]*255/100,1):(r=Bw.exec(n))?Mo(r[1],r[2],r[3],r[4]):(r=zw.exec(n))?Mo(r[1]*255/100,r[2]*255/100,r[3]*255/100,r[4]):(r=Ww.exec(n))?Pu(r[1],r[2]/100,r[3]/100,1):(r=Gw.exec(n))?Pu(r[1],r[2]/100,r[3]/100,r[4]):xu.hasOwnProperty(n)?ku(xu[n]):n==="transparent"?new Ln(NaN,NaN,NaN,0):null}function ku(n){return new Ln(n>>16&255,n>>8&255,n&255,1)}function Mo(n,r,e,t){return t<=0&&(n=r=e=NaN),new Ln(n,r,e,t)}function Kw(n){return n instanceof uo||(n=no(n)),n?(n=n.rgb(),new Ln(n.r,n.g,n.b,n.opacity)):new Ln}function Ha(n,r,e,t){return arguments.length===1?Kw(n):new Ln(n,r,e,t??1)}function Ln(n,r,e,t){this.r=+n,this.g=+r,this.b=+e,this.opacity=+t}Gl(Ln,Ha,Hf(uo,{brighter(n){return n=n==null?Ni:Math.pow(Ni,n),new Ln(this.r*n,this.g*n,this.b*n,this.opacity)},darker(n){return n=n==null?Jt:Math.pow(Jt,n),new Ln(this.r*n,this.g*n,this.b*n,this.opacity)},rgb(){return this},clamp(){return new Ln(he(this.r),he(this.g),he(this.b),Oi(this.opacity))},displayable(){return-.5<=this.r&&this.r<255.5&&-.5<=this.g&&this.g<255.5&&-.5<=this.b&&this.b<255.5&&0<=this.opacity&&this.opacity<=1},hex:Cu,formatHex:Cu,formatHex8:Qw,formatRgb:Tu,toString:Tu}));function Cu(){return`#${ce(this.r)}${ce(this.g)}${ce(this.b)}`}function Qw(){return`#${ce(this.r)}${ce(this.g)}${ce(this.b)}${ce((isNaN(this.opacity)?1:this.opacity)*255)}`}function Tu(){const n=Oi(this.opacity);return`${n===1?"rgb(":"rgba("}${he(this.r)}, ${he(this.g)}, ${he(this.b)}${n===1?")":`, ${n})`}`}function Oi(n){return isNaN(n)?1:Math.max(0,Math.min(1,n))}function he(n){return Math.max(0,Math.min(255,Math.round(n)||0))}function ce(n){return n=he(n),(n<16?"0":"")+n.toString(16)}function Pu(n,r,e,t){return t<=0?n=r=e=NaN:e<=0||e>=1?n=r=NaN:r<=0&&(n=NaN),new ar(n,r,e,t)}function $f(n){if(n instanceof ar)return new ar(n.h,n.s,n.l,n.opacity);if(n instanceof uo||(n=no(n)),!n)return new ar;if(n instanceof ar)return n;n=n.rgb();var r=n.r/255,e=n.g/255,t=n.b/255,o=Math.min(r,e,t),i=Math.max(r,e,t),s=NaN,a=i-o,l=(i+o)/2;return a?(r===i?s=(e-t)/a+(e<t)*6:e===i?s=(t-r)/a+2:s=(r-e)/a+4,a/=l<.5?i+o:2-i-o,s*=60):a=l>0&&l<1?0:s,new ar(s,a,l,n.opacity)}function Xw(n,r,e,t){return arguments.length===1?$f(n):new ar(n,r,e,t??1)}function ar(n,r,e,t){this.h=+n,this.s=+r,this.l=+e,this.opacity=+t}Gl(ar,Xw,Hf(uo,{brighter(n){return n=n==null?Ni:Math.pow(Ni,n),new ar(this.h,this.s,this.l*n,this.opacity)},darker(n){return n=n==null?Jt:Math.pow(Jt,n),new ar(this.h,this.s,this.l*n,this.opacity)},rgb(){var n=this.h%360+(this.h<0)*360,r=isNaN(n)||isNaN(this.s)?0:this.s,e=this.l,t=e+(e<.5?e:1-e)*r,o=2*e-t;return new Ln(Ds(n>=240?n-240:n+120,o,t),Ds(n,o,t),Ds(n<120?n+240:n-120,o,t),this.opacity)},clamp(){return new ar(Iu(this.h),jo(this.s),jo(this.l),Oi(this.opacity))},displayable(){return(0<=this.s&&this.s<=1||isNaN(this.s))&&0<=this.l&&this.l<=1&&0<=this.opacity&&this.opacity<=1},formatHsl(){const n=Oi(this.opacity);return`${n===1?"hsl(":"hsla("}${Iu(this.h)}, ${jo(this.s)*100}%, ${jo(this.l)*100}%${n===1?")":`, ${n})`}`}}));function Iu(n){return n=(n||0)%360,n<0?n+360:n}function jo(n){return Math.max(0,Math.min(1,n||0))}function Ds(n,r,e){return(n<60?r+(e-r)*n/60:n<180?e:n<240?r+(e-r)*(240-n)/60:r)*255}const Bf=n=>()=>n;function Yw(n,r){return function(e){return n+e*r}}function Jw(n,r,e){return n=Math.pow(n,e),r=Math.pow(r,e)-n,e=1/e,function(t){return Math.pow(n+t*r,e)}}function qw(n){return(n=+n)==1?zf:function(r,e){return e-r?Jw(r,e,n):Bf(isNaN(r)?e:r)}}function zf(n,r){var e=r-n;return e?Yw(n,e):Bf(isNaN(n)?r:n)}const Eu=function n(r){var e=qw(r);function t(o,i){var s=e((o=Ha(o)).r,(i=Ha(i)).r),a=e(o.g,i.g),l=e(o.b,i.b),c=zf(o.opacity,i.opacity);return function(d){return o.r=s(d),o.g=a(d),o.b=l(d),o.opacity=c(d),o+""}}return t.gamma=n,t}(1);function Zr(n,r){return n=+n,r=+r,function(e){return n*(1-e)+r*e}}var $a=/[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,Rs=new RegExp($a.source,"g");function nx(n){return function(){return n}}function rx(n){return function(r){return n(r)+""}}function ex(n,r){var e=$a.lastIndex=Rs.lastIndex=0,t,o,i,s=-1,a=[],l=[];for(n=n+"",r=r+"";(t=$a.exec(n))&&(o=Rs.exec(r));)(i=o.index)>e&&(i=r.slice(e,i),a[s]?a[s]+=i:a[++s]=i),(t=t[0])===(o=o[0])?a[s]?a[s]+=o:a[++s]=o:(a[++s]=null,l.push({i:s,x:Zr(t,o)})),e=Rs.lastIndex;return e<r.length&&(i=r.slice(e),a[s]?a[s]+=i:a[++s]=i),a.length<2?l[0]?rx(l[0].x):nx(r):(r=l.length,function(c){for(var d=0,h;d<r;++d)a[(h=l[d]).i]=h.x(c);return a.join("")})}var bu=180/Math.PI,Ba={translateX:0,translateY:0,rotate:0,skewX:0,scaleX:1,scaleY:1};function Wf(n,r,e,t,o,i){var s,a,l;return(s=Math.sqrt(n*n+r*r))&&(n/=s,r/=s),(l=n*e+r*t)&&(e-=n*l,t-=r*l),(a=Math.sqrt(e*e+t*t))&&(e/=a,t/=a,l/=a),n*t<r*e&&(n=-n,r=-r,l=-l,s=-s),{translateX:o,translateY:i,rotate:Math.atan2(r,n)*bu,skewX:Math.atan(l)*bu,scaleX:s,scaleY:a}}var Lo;function tx(n){const r=new(typeof DOMMatrix=="function"?DOMMatrix:WebKitCSSMatrix)(n+"");return r.isIdentity?Ba:Wf(r.a,r.b,r.c,r.d,r.e,r.f)}function ox(n){return n==null||(Lo||(Lo=document.createElementNS("http://www.w3.org/2000/svg","g")),Lo.setAttribute("transform",n),!(n=Lo.transform.baseVal.consolidate()))?Ba:(n=n.matrix,Wf(n.a,n.b,n.c,n.d,n.e,n.f))}function Gf(n,r,e,t){function o(c){return c.length?c.pop()+" ":""}function i(c,d,h,f,y,x){if(c!==h||d!==f){var S=y.push("translate(",null,r,null,e);x.push({i:S-4,x:Zr(c,h)},{i:S-2,x:Zr(d,f)})}else(h||f)&&y.push("translate("+h+r+f+e)}function s(c,d,h,f){c!==d?(c-d>180?d+=360:d-c>180&&(c+=360),f.push({i:h.push(o(h)+"rotate(",null,t)-2,x:Zr(c,d)})):d&&h.push(o(h)+"rotate("+d+t)}function a(c,d,h,f){c!==d?f.push({i:h.push(o(h)+"skewX(",null,t)-2,x:Zr(c,d)}):d&&h.push(o(h)+"skewX("+d+t)}function l(c,d,h,f,y,x){if(c!==h||d!==f){var S=y.push(o(y)+"scale(",null,",",null,")");x.push({i:S-4,x:Zr(c,h)},{i:S-2,x:Zr(d,f)})}else(h!==1||f!==1)&&y.push(o(y)+"scale("+h+","+f+")")}return function(c,d){var h=[],f=[];return c=n(c),d=n(d),i(c.translateX,c.translateY,d.translateX,d.translateY,h,f),s(c.rotate,d.rotate,h,f),a(c.skewX,d.skewX,h,f),l(c.scaleX,c.scaleY,d.scaleX,d.scaleY,h,f),c=d=null,function(y){for(var x=-1,S=f.length,M;++x<S;)h[(M=f[x]).i]=M.x(y);return h.join("")}}}var ix=Gf(tx,"px, ","px)","deg)"),sx=Gf(ox,", ",")",")"),ax=1e-12;function Nu(n){return((n=Math.exp(n))+1/n)/2}function lx(n){return((n=Math.exp(n))-1/n)/2}function cx(n){return((n=Math.exp(2*n))-1)/(n+1)}const ux=function n(r,e,t){function o(i,s){var a=i[0],l=i[1],c=i[2],d=s[0],h=s[1],f=s[2],y=d-a,x=h-l,S=y*y+x*x,M,m;if(S<ax)m=Math.log(f/c)/r,M=function(w){return[a+w*y,l+w*x,c*Math.exp(r*w*m)]};else{var g=Math.sqrt(S),p=(f*f-c*c+t*S)/(2*c*e*g),v=(f*f-c*c-t*S)/(2*f*e*g),k=Math.log(Math.sqrt(p*p+1)-p),T=Math.log(Math.sqrt(v*v+1)-v);m=(T-k)/r,M=function(w){var _=w*m,N=Nu(k),j=c/(e*g)*(N*cx(r*_+k)-lx(k));return[a+j*y,l+j*x,c*N/Nu(r*_+k)]}}return M.duration=m*1e3*r/Math.SQRT2,M}return o.rho=function(i){var s=Math.max(.001,+i),a=s*s,l=a*a;return n(s,a,l)},o}(Math.SQRT2,2,4);var et=0,_t=0,mt=0,Vf=1e3,Ai,kt,Mi=0,we=0,es=0,ro=typeof performance=="object"&&performance.now?performance:Date,Uf=typeof window=="object"&&window.requestAnimationFrame?window.requestAnimationFrame.bind(window):function(n){setTimeout(n,17)};function Vl(){return we||(Uf(dx),we=ro.now()+es)}function dx(){we=0}function ji(){this._call=this._time=this._next=null}ji.prototype=Kf.prototype={constructor:ji,restart:function(n,r,e){if(typeof n!="function")throw new TypeError("callback is not a function");e=(e==null?Vl():+e)+(r==null?0:+r),!this._next&&kt!==this&&(kt?kt._next=this:Ai=this,kt=this),this._call=n,this._time=e,za()},stop:function(){this._call&&(this._call=null,this._time=1/0,za())}};function Kf(n,r,e){var t=new ji;return t.restart(n,r,e),t}function hx(){Vl(),++et;for(var n=Ai,r;n;)(r=we-n._time)>=0&&n._call.call(void 0,r),n=n._next;--et}function Ou(){we=(Mi=ro.now())+es,et=_t=0;try{hx()}finally{et=0,px(),we=0}}function fx(){var n=ro.now(),r=n-Mi;r>Vf&&(es-=r,Mi=n)}function px(){for(var n,r=Ai,e,t=1/0;r;)r._call?(t>r._time&&(t=r._time),n=r,r=r._next):(e=r._next,r._next=null,r=n?n._next=e:Ai=e);kt=n,za(t)}function za(n){if(!et){_t&&(_t=clearTimeout(_t));var r=n-we;r>24?(n<1/0&&(_t=setTimeout(Ou,n-ro.now()-es)),mt&&(mt=clearInterval(mt))):(mt||(Mi=ro.now(),mt=setInterval(fx,Vf)),et=1,Uf(Ou))}}function Au(n,r,e){var t=new ji;return r=r==null?0:+r,t.restart(o=>{t.stop(),n(o+r)},r,e),t}var mx=Wl("start","end","cancel","interrupt"),gx=[],Qf=0,Mu=1,Wa=2,Jo=3,ju=4,Ga=5,qo=6;function ts(n,r,e,t,o,i){var s=n.__transition;if(!s)n.__transition={};else if(e in s)return;yx(n,e,{name:r,index:t,group:o,on:mx,tween:gx,time:i.time,delay:i.delay,duration:i.duration,ease:i.ease,timer:null,state:Qf})}function Ul(n,r){var e=dr(n,r);if(e.state>Qf)throw new Error("too late; already scheduled");return e}function vr(n,r){var e=dr(n,r);if(e.state>Jo)throw new Error("too late; already running");return e}function dr(n,r){var e=n.__transition;if(!e||!(e=e[r]))throw new Error("transition not found");return e}function yx(n,r,e){var t=n.__transition,o;t[r]=e,e.timer=Kf(i,0,e.time);function i(c){e.state=Mu,e.timer.restart(s,e.delay,e.time),e.delay<=c&&s(c-e.delay)}function s(c){var d,h,f,y;if(e.state!==Mu)return l();for(d in t)if(y=t[d],y.name===e.name){if(y.state===Jo)return Au(s);y.state===ju?(y.state=qo,y.timer.stop(),y.on.call("interrupt",n,n.__data__,y.index,y.group),delete t[d]):+d<r&&(y.state=qo,y.timer.stop(),y.on.call("cancel",n,n.__data__,y.index,y.group),delete t[d])}if(Au(function(){e.state===Jo&&(e.state=ju,e.timer.restart(a,e.delay,e.time),a(c))}),e.state=Wa,e.on.call("start",n,n.__data__,e.index,e.group),e.state===Wa){for(e.state=Jo,o=new Array(f=e.tween.length),d=0,h=-1;d<f;++d)(y=e.tween[d].value.call(n,n.__data__,e.index,e.group))&&(o[++h]=y);o.length=h+1}}function a(c){for(var d=c<e.duration?e.ease.call(null,c/e.duration):(e.timer.restart(l),e.state=Ga,1),h=-1,f=o.length;++h<f;)o[h].call(n,d);e.state===Ga&&(e.on.call("end",n,n.__data__,e.index,e.group),l())}function l(){e.state=qo,e.timer.stop(),delete t[r];for(var c in t)return;delete n.__transition}}function ni(n,r){var e=n.__transition,t,o,i=!0,s;if(e){r=r==null?null:r+"";for(s in e){if((t=e[s]).name!==r){i=!1;continue}o=t.state>Wa&&t.state<Ga,t.state=qo,t.timer.stop(),t.on.call(o?"interrupt":"cancel",n,n.__data__,t.index,t.group),delete e[s]}i&&delete n.__transition}}function vx(n){return this.each(function(){ni(this,n)})}function wx(n,r){var e,t;return function(){var o=vr(this,n),i=o.tween;if(i!==e){t=e=i;for(var s=0,a=t.length;s<a;++s)if(t[s].name===r){t=t.slice(),t.splice(s,1);break}}o.tween=t}}function xx(n,r,e){var t,o;if(typeof e!="function")throw new Error;return function(){var i=vr(this,n),s=i.tween;if(s!==t){o=(t=s).slice();for(var a={name:r,value:e},l=0,c=o.length;l<c;++l)if(o[l].name===r){o[l]=a;break}l===c&&o.push(a)}i.tween=o}}function Sx(n,r){var e=this._id;if(n+="",arguments.length<2){for(var t=dr(this.node(),e).tween,o=0,i=t.length,s;o<i;++o)if((s=t[o]).name===n)return s.value;return null}return this.each((r==null?wx:xx)(e,n,r))}function Kl(n,r,e){var t=n._id;return n.each(function(){var o=vr(this,t);(o.value||(o.value={}))[r]=e.apply(this,arguments)}),function(o){return dr(o,t).value[r]}}function Xf(n,r){var e;return(typeof r=="number"?Zr:r instanceof no?Eu:(e=no(r))?(r=e,Eu):ex)(n,r)}function _x(n){return function(){this.removeAttribute(n)}}function kx(n){return function(){this.removeAttributeNS(n.space,n.local)}}function Cx(n,r,e){var t,o=e+"",i;return function(){var s=this.getAttribute(n);return s===o?null:s===t?i:i=r(t=s,e)}}function Tx(n,r,e){var t,o=e+"",i;return function(){var s=this.getAttributeNS(n.space,n.local);return s===o?null:s===t?i:i=r(t=s,e)}}function Px(n,r,e){var t,o,i;return function(){var s,a=e(this),l;return a==null?void this.removeAttribute(n):(s=this.getAttribute(n),l=a+"",s===l?null:s===t&&l===o?i:(o=l,i=r(t=s,a)))}}function Ix(n,r,e){var t,o,i;return function(){var s,a=e(this),l;return a==null?void this.removeAttributeNS(n.space,n.local):(s=this.getAttributeNS(n.space,n.local),l=a+"",s===l?null:s===t&&l===o?i:(o=l,i=r(t=s,a)))}}function Ex(n,r){var e=rs(n),t=e==="transform"?sx:Xf;return this.attrTween(n,typeof r=="function"?(e.local?Ix:Px)(e,t,Kl(this,"attr."+n,r)):r==null?(e.local?kx:_x)(e):(e.local?Tx:Cx)(e,t,r))}function bx(n,r){return function(e){this.setAttribute(n,r.call(this,e))}}function Nx(n,r){return function(e){this.setAttributeNS(n.space,n.local,r.call(this,e))}}function Ox(n,r){var e,t;function o(){var i=r.apply(this,arguments);return i!==t&&(e=(t=i)&&Nx(n,i)),e}return o._value=r,o}function Ax(n,r){var e,t;function o(){var i=r.apply(this,arguments);return i!==t&&(e=(t=i)&&bx(n,i)),e}return o._value=r,o}function Mx(n,r){var e="attr."+n;if(arguments.length<2)return(e=this.tween(e))&&e._value;if(r==null)return this.tween(e,null);if(typeof r!="function")throw new Error;var t=rs(n);return this.tween(e,(t.local?Ox:Ax)(t,r))}function jx(n,r){return function(){Ul(this,n).delay=+r.apply(this,arguments)}}function Lx(n,r){return r=+r,function(){Ul(this,n).delay=r}}function Zx(n){var r=this._id;return arguments.length?this.each((typeof n=="function"?jx:Lx)(r,n)):dr(this.node(),r).delay}function Dx(n,r){return function(){vr(this,n).duration=+r.apply(this,arguments)}}function Rx(n,r){return r=+r,function(){vr(this,n).duration=r}}function Fx(n){var r=this._id;return arguments.length?this.each((typeof n=="function"?Dx:Rx)(r,n)):dr(this.node(),r).duration}function Hx(n,r){if(typeof r!="function")throw new Error;return function(){vr(this,n).ease=r}}function $x(n){var r=this._id;return arguments.length?this.each(Hx(r,n)):dr(this.node(),r).ease}function Bx(n,r){return function(){var e=r.apply(this,arguments);if(typeof e!="function")throw new Error;vr(this,n).ease=e}}function zx(n){if(typeof n!="function")throw new Error;return this.each(Bx(this._id,n))}function Wx(n){typeof n!="function"&&(n=Nf(n));for(var r=this._groups,e=r.length,t=new Array(e),o=0;o<e;++o)for(var i=r[o],s=i.length,a=t[o]=[],l,c=0;c<s;++c)(l=i[c])&&n.call(l,l.__data__,c,i)&&a.push(l);return new Nr(t,this._parents,this._name,this._id)}function Gx(n){if(n._id!==this._id)throw new Error;for(var r=this._groups,e=n._groups,t=r.length,o=e.length,i=Math.min(t,o),s=new Array(t),a=0;a<i;++a)for(var l=r[a],c=e[a],d=l.length,h=s[a]=new Array(d),f,y=0;y<d;++y)(f=l[y]||c[y])&&(h[y]=f);for(;a<t;++a)s[a]=r[a];return new Nr(s,this._parents,this._name,this._id)}function Vx(n){return(n+"").trim().split(/^|\s+/).every(function(r){var e=r.indexOf(".");return e>=0&&(r=r.slice(0,e)),!r||r==="start"})}function Ux(n,r,e){var t,o,i=Vx(r)?Ul:vr;return function(){var s=i(this,n),a=s.on;a!==t&&(o=(t=a).copy()).on(r,e),s.on=o}}function Kx(n,r){var e=this._id;return arguments.length<2?dr(this.node(),e).on.on(n):this.each(Ux(e,n,r))}function Qx(n){return function(){var r=this.parentNode;for(var e in this.__transition)if(+e!==n)return;r&&r.removeChild(this)}}function Xx(){return this.on("end.remove",Qx(this._id))}function Yx(n){var r=this._name,e=this._id;typeof n!="function"&&(n=Bl(n));for(var t=this._groups,o=t.length,i=new Array(o),s=0;s<o;++s)for(var a=t[s],l=a.length,c=i[s]=new Array(l),d,h,f=0;f<l;++f)(d=a[f])&&(h=n.call(d,d.__data__,f,a))&&("__data__"in d&&(h.__data__=d.__data__),c[f]=h,ts(c[f],r,e,f,c,dr(d,e)));return new Nr(i,this._parents,r,e)}function Jx(n){var r=this._name,e=this._id;typeof n!="function"&&(n=bf(n));for(var t=this._groups,o=t.length,i=[],s=[],a=0;a<o;++a)for(var l=t[a],c=l.length,d,h=0;h<c;++h)if(d=l[h]){for(var f=n.call(d,d.__data__,h,l),y,x=dr(d,e),S=0,M=f.length;S<M;++S)(y=f[S])&&ts(y,r,e,S,f,x);i.push(f),s.push(d)}return new Nr(i,s,r,e)}var qx=co.prototype.constructor;function n2(){return new qx(this._groups,this._parents)}function r2(n,r){var e,t,o;return function(){var i=rt(this,n),s=(this.style.removeProperty(n),rt(this,n));return i===s?null:i===e&&s===t?o:o=r(e=i,t=s)}}function Yf(n){return function(){this.style.removeProperty(n)}}function e2(n,r,e){var t,o=e+"",i;return function(){var s=rt(this,n);return s===o?null:s===t?i:i=r(t=s,e)}}function t2(n,r,e){var t,o,i;return function(){var s=rt(this,n),a=e(this),l=a+"";return a==null&&(l=a=(this.style.removeProperty(n),rt(this,n))),s===l?null:s===t&&l===o?i:(o=l,i=r(t=s,a))}}function o2(n,r){var e,t,o,i="style."+r,s="end."+i,a;return function(){var l=vr(this,n),c=l.on,d=l.value[i]==null?a||(a=Yf(r)):void 0;(c!==e||o!==d)&&(t=(e=c).copy()).on(s,o=d),l.on=t}}function i2(n,r,e){var t=(n+="")=="transform"?ix:Xf;return r==null?this.styleTween(n,r2(n,t)).on("end.style."+n,Yf(n)):typeof r=="function"?this.styleTween(n,t2(n,t,Kl(this,"style."+n,r))).each(o2(this._id,n)):this.styleTween(n,e2(n,t,r),e).on("end.style."+n,null)}function s2(n,r,e){return function(t){this.style.setProperty(n,r.call(this,t),e)}}function a2(n,r,e){var t,o;function i(){var s=r.apply(this,arguments);return s!==o&&(t=(o=s)&&s2(n,s,e)),t}return i._value=r,i}function l2(n,r,e){var t="style."+(n+="");if(arguments.length<2)return(t=this.tween(t))&&t._value;if(r==null)return this.tween(t,null);if(typeof r!="function")throw new Error;return this.tween(t,a2(n,r,e??""))}function c2(n){return function(){this.textContent=n}}function u2(n){return function(){var r=n(this);this.textContent=r??""}}function d2(n){return this.tween("text",typeof n=="function"?u2(Kl(this,"text",n)):c2(n==null?"":n+""))}function h2(n){return function(r){this.textContent=n.call(this,r)}}function f2(n){var r,e;function t(){var o=n.apply(this,arguments);return o!==e&&(r=(e=o)&&h2(o)),r}return t._value=n,t}function p2(n){var r="text";if(arguments.length<1)return(r=this.tween(r))&&r._value;if(n==null)return this.tween(r,null);if(typeof n!="function")throw new Error;return this.tween(r,f2(n))}function m2(){for(var n=this._name,r=this._id,e=Jf(),t=this._groups,o=t.length,i=0;i<o;++i)for(var s=t[i],a=s.length,l,c=0;c<a;++c)if(l=s[c]){var d=dr(l,r);ts(l,n,e,c,s,{time:d.time+d.delay+d.duration,delay:0,duration:d.duration,ease:d.ease})}return new Nr(t,this._parents,n,e)}function g2(){var n,r,e=this,t=e._id,o=e.size();return new Promise(function(i,s){var a={value:s},l={value:function(){--o===0&&i()}};e.each(function(){var c=vr(this,t),d=c.on;d!==n&&(r=(n=d).copy(),r._.cancel.push(a),r._.interrupt.push(a),r._.end.push(l)),c.on=r}),o===0&&i()})}var y2=0;function Nr(n,r,e,t){this._groups=n,this._parents=r,this._name=e,this._id=t}function Jf(){return++y2}var wr=co.prototype;Nr.prototype={constructor:Nr,select:Yx,selectAll:Jx,selectChild:wr.selectChild,selectChildren:wr.selectChildren,filter:Wx,merge:Gx,selection:n2,transition:m2,call:wr.call,nodes:wr.nodes,node:wr.node,size:wr.size,empty:wr.empty,each:wr.each,on:Kx,attr:Ex,attrTween:Mx,style:i2,styleTween:l2,text:d2,textTween:p2,remove:Xx,tween:Sx,delay:Zx,duration:Fx,ease:$x,easeVarying:zx,end:g2,[Symbol.iterator]:wr[Symbol.iterator]};function v2(n){return((n*=2)<=1?n*n*n:(n-=2)*n*n+2)/2}var w2={time:null,delay:0,duration:250,ease:v2};function x2(n,r){for(var e;!(e=n.__transition)||!(e=e[r]);)if(!(n=n.parentNode))throw new Error(`transition ${r} not found`);return e}function S2(n){var r,e;n instanceof Nr?(r=n._id,n=n._name):(r=Jf(),(e=w2).time=Vl(),n=n==null?null:n+"");for(var t=this._groups,o=t.length,i=0;i<o;++i)for(var s=t[i],a=s.length,l,c=0;c<a;++c)(l=s[c])&&ts(l,n,r,c,s,e||x2(l,r));return new Nr(t,this._parents,n,r)}co.prototype.interrupt=vx;co.prototype.transition=S2;const Zo=n=>()=>n;function _2(n,{sourceEvent:r,target:e,transform:t,dispatch:o}){Object.defineProperties(this,{type:{value:n,enumerable:!0,configurable:!0},sourceEvent:{value:r,enumerable:!0,configurable:!0},target:{value:e,enumerable:!0,configurable:!0},transform:{value:t,enumerable:!0,configurable:!0},_:{value:o}})}function Cr(n,r,e){this.k=n,this.x=r,this.y=e}Cr.prototype={constructor:Cr,scale:function(n){return n===1?this:new Cr(this.k*n,this.x,this.y)},translate:function(n,r){return n===0&r===0?this:new Cr(this.k,this.x+this.k*n,this.y+this.k*r)},apply:function(n){return[n[0]*this.k+this.x,n[1]*this.k+this.y]},applyX:function(n){return n*this.k+this.x},applyY:function(n){return n*this.k+this.y},invert:function(n){return[(n[0]-this.x)/this.k,(n[1]-this.y)/this.k]},invertX:function(n){return(n-this.x)/this.k},invertY:function(n){return(n-this.y)/this.k},rescaleX:function(n){return n.copy().domain(n.range().map(this.invertX,this).map(n.invert,n))},rescaleY:function(n){return n.copy().domain(n.range().map(this.invertY,this).map(n.invert,n))},toString:function(){return"translate("+this.x+","+this.y+") scale("+this.k+")"}};var Mt=new Cr(1,0,0);Cr.prototype;function Fs(n){n.stopImmediatePropagation()}function gt(n){n.preventDefault(),n.stopImmediatePropagation()}function k2(n){return(!n.ctrlKey||n.type==="wheel")&&!n.button}function C2(){var n=this;return n instanceof SVGElement?(n=n.ownerSVGElement||n,n.hasAttribute("viewBox")?(n=n.viewBox.baseVal,[[n.x,n.y],[n.x+n.width,n.y+n.height]]):[[0,0],[n.width.baseVal.value,n.height.baseVal.value]]):[[0,0],[n.clientWidth,n.clientHeight]]}function Lu(){return this.__zoom||Mt}function T2(n){return-n.deltaY*(n.deltaMode===1?.05:n.deltaMode?1:.002)*(n.ctrlKey?10:1)}function P2(){return navigator.maxTouchPoints||"ontouchstart"in this}function I2(n,r,e){var t=n.invertX(r[0][0])-e[0][0],o=n.invertX(r[1][0])-e[1][0],i=n.invertY(r[0][1])-e[0][1],s=n.invertY(r[1][1])-e[1][1];return n.translate(o>t?(t+o)/2:Math.min(0,t)||Math.max(0,o),s>i?(i+s)/2:Math.min(0,i)||Math.max(0,s))}function E2(){var n=k2,r=C2,e=I2,t=T2,o=P2,i=[0,1/0],s=[[-1/0,-1/0],[1/0,1/0]],a=250,l=ux,c=Wl("start","zoom","end"),d,h,f,y=500,x=150,S=0,M=10;function m(C){C.property("__zoom",Lu).on("wheel.zoom",_,{passive:!1}).on("mousedown.zoom",N).on("dblclick.zoom",j).filter(o).on("touchstart.zoom",z).on("touchmove.zoom",G).on("touchend.zoom touchcancel.zoom",Y).style("-webkit-tap-highlight-color","rgba(0,0,0,0)")}m.transform=function(C,D,E,R){var P=C.selection?C.selection():C;P.property("__zoom",Lu),C!==P?k(C,D,E,R):P.interrupt().each(function(){T(this,arguments).event(R).start().zoom(null,typeof D=="function"?D.apply(this,arguments):D).end()})},m.scaleBy=function(C,D,E,R){m.scaleTo(C,function(){var P=this.__zoom.k,A=typeof D=="function"?D.apply(this,arguments):D;return P*A},E,R)},m.scaleTo=function(C,D,E,R){m.transform(C,function(){var P=r.apply(this,arguments),A=this.__zoom,L=E==null?v(P):typeof E=="function"?E.apply(this,arguments):E,$=A.invert(L),V=typeof D=="function"?D.apply(this,arguments):D;return e(p(g(A,V),L,$),P,s)},E,R)},m.translateBy=function(C,D,E,R){m.transform(C,function(){return e(this.__zoom.translate(typeof D=="function"?D.apply(this,arguments):D,typeof E=="function"?E.apply(this,arguments):E),r.apply(this,arguments),s)},null,R)},m.translateTo=function(C,D,E,R,P){m.transform(C,function(){var A=r.apply(this,arguments),L=this.__zoom,$=R==null?v(A):typeof R=="function"?R.apply(this,arguments):R;return e(Mt.translate($[0],$[1]).scale(L.k).translate(typeof D=="function"?-D.apply(this,arguments):-D,typeof E=="function"?-E.apply(this,arguments):-E),A,s)},R,P)};function g(C,D){return D=Math.max(i[0],Math.min(i[1],D)),D===C.k?C:new Cr(D,C.x,C.y)}function p(C,D,E){var R=D[0]-E[0]*C.k,P=D[1]-E[1]*C.k;return R===C.x&&P===C.y?C:new Cr(C.k,R,P)}function v(C){return[(+C[0][0]+ +C[1][0])/2,(+C[0][1]+ +C[1][1])/2]}function k(C,D,E,R){C.on("start.zoom",function(){T(this,arguments).event(R).start()}).on("interrupt.zoom end.zoom",function(){T(this,arguments).event(R).end()}).tween("zoom",function(){var P=this,A=arguments,L=T(P,A).event(R),$=r.apply(P,A),V=E==null?v($):typeof E=="function"?E.apply(P,A):E,dn=Math.max($[1][0]-$[0][0],$[1][1]-$[0][1]),q=P.__zoom,wn=typeof D=="function"?D.apply(P,A):D,nn=l(q.invert(V).concat(dn/q.k),wn.invert(V).concat(dn/wn.k));return function(hn){if(hn===1)hn=wn;else{var Hn=nn(hn),st=dn/Hn[2];hn=new Cr(st,V[0]-Hn[0]*st,V[1]-Hn[1]*st)}L.zoom(null,hn)}})}function T(C,D,E){return!E&&C.__zooming||new w(C,D)}function w(C,D){this.that=C,this.args=D,this.active=0,this.sourceEvent=null,this.extent=r.apply(C,D),this.taps=0}w.prototype={event:function(C){return C&&(this.sourceEvent=C),this},start:function(){return++this.active===1&&(this.that.__zooming=this,this.emit("start")),this},zoom:function(C,D){return this.mouse&&C!=="mouse"&&(this.mouse[1]=D.invert(this.mouse[0])),this.touch0&&C!=="touch"&&(this.touch0[1]=D.invert(this.touch0[0])),this.touch1&&C!=="touch"&&(this.touch1[1]=D.invert(this.touch1[0])),this.that.__zoom=D,this.emit("zoom"),this},end:function(){return--this.active===0&&(delete this.that.__zooming,this.emit("end")),this},emit:function(C){var D=sr(this.that).datum();c.call(C,this.that,new _2(C,{sourceEvent:this.sourceEvent,target:m,transform:this.that.__zoom,dispatch:c}),D)}};function _(C,...D){if(!n.apply(this,arguments))return;var E=T(this,D).event(C),R=this.__zoom,P=Math.max(i[0],Math.min(i[1],R.k*Math.pow(2,t.apply(this,arguments)))),A=ee(C);if(E.wheel)(E.mouse[0][0]!==A[0]||E.mouse[0][1]!==A[1])&&(E.mouse[1]=R.invert(E.mouse[0]=A)),clearTimeout(E.wheel);else{if(R.k===P)return;E.mouse=[A,R.invert(A)],ni(this),E.start()}gt(C),E.wheel=setTimeout(L,x),E.zoom("mouse",e(p(g(R,P),E.mouse[0],E.mouse[1]),E.extent,s));function L(){E.wheel=null,E.end()}}function N(C,...D){if(f||!n.apply(this,arguments))return;var E=C.currentTarget,R=T(this,D,!0).event(C),P=sr(C.view).on("mousemove.zoom",V,!0).on("mouseup.zoom",dn,!0),A=ee(C,E),L=C.clientX,$=C.clientY;Dw(C.view),Fs(C),R.mouse=[A,this.__zoom.invert(A)],ni(this),R.start();function V(q){if(gt(q),!R.moved){var wn=q.clientX-L,nn=q.clientY-$;R.moved=wn*wn+nn*nn>S}R.event(q).zoom("mouse",e(p(R.that.__zoom,R.mouse[0]=ee(q,E),R.mouse[1]),R.extent,s))}function dn(q){P.on("mousemove.zoom mouseup.zoom",null),Rw(q.view,R.moved),gt(q),R.event(q).end()}}function j(C,...D){if(n.apply(this,arguments)){var E=this.__zoom,R=ee(C.changedTouches?C.changedTouches[0]:C,this),P=E.invert(R),A=E.k*(C.shiftKey?.5:2),L=e(p(g(E,A),R,P),r.apply(this,D),s);gt(C),a>0?sr(this).transition().duration(a).call(k,L,R,C):sr(this).call(m.transform,L,R,C)}}function z(C,...D){if(n.apply(this,arguments)){var E=C.touches,R=E.length,P=T(this,D,C.changedTouches.length===R).event(C),A,L,$,V;for(Fs(C),L=0;L<R;++L)$=E[L],V=ee($,this),V=[V,this.__zoom.invert(V),$.identifier],P.touch0?!P.touch1&&P.touch0[2]!==V[2]&&(P.touch1=V,P.taps=0):(P.touch0=V,A=!0,P.taps=1+!!d);d&&(d=clearTimeout(d)),A&&(P.taps<2&&(h=V[0],d=setTimeout(function(){d=null},y)),ni(this),P.start())}}function G(C,...D){if(this.__zooming){var E=T(this,D).event(C),R=C.changedTouches,P=R.length,A,L,$,V;for(gt(C),A=0;A<P;++A)L=R[A],$=ee(L,this),E.touch0&&E.touch0[2]===L.identifier?E.touch0[0]=$:E.touch1&&E.touch1[2]===L.identifier&&(E.touch1[0]=$);if(L=E.that.__zoom,E.touch1){var dn=E.touch0[0],q=E.touch0[1],wn=E.touch1[0],nn=E.touch1[1],hn=(hn=wn[0]-dn[0])*hn+(hn=wn[1]-dn[1])*hn,Hn=(Hn=nn[0]-q[0])*Hn+(Hn=nn[1]-q[1])*Hn;L=g(L,Math.sqrt(hn/Hn)),$=[(dn[0]+wn[0])/2,(dn[1]+wn[1])/2],V=[(q[0]+nn[0])/2,(q[1]+nn[1])/2]}else if(E.touch0)$=E.touch0[0],V=E.touch0[1];else return;E.zoom("touch",e(p(L,$,V),E.extent,s))}}function Y(C,...D){if(this.__zooming){var E=T(this,D).event(C),R=C.changedTouches,P=R.length,A,L;for(Fs(C),f&&clearTimeout(f),f=setTimeout(function(){f=null},y),A=0;A<P;++A)L=R[A],E.touch0&&E.touch0[2]===L.identifier?delete E.touch0:E.touch1&&E.touch1[2]===L.identifier&&delete E.touch1;if(E.touch1&&!E.touch0&&(E.touch0=E.touch1,delete E.touch1),E.touch0)E.touch0[1]=this.__zoom.invert(E.touch0[0]);else if(E.end(),E.taps===2&&(L=ee(L,this),Math.hypot(h[0]-L[0],h[1]-L[1])<M)){var $=sr(this).on("dblclick.zoom");$&&$.apply(this,arguments)}}}return m.wheelDelta=function(C){return arguments.length?(t=typeof C=="function"?C:Zo(+C),m):t},m.filter=function(C){return arguments.length?(n=typeof C=="function"?C:Zo(!!C),m):n},m.touchable=function(C){return arguments.length?(o=typeof C=="function"?C:Zo(!!C),m):o},m.extent=function(C){return arguments.length?(r=typeof C=="function"?C:Zo([[+C[0][0],+C[0][1]],[+C[1][0],+C[1][1]]]),m):r},m.scaleExtent=function(C){return arguments.length?(i[0]=+C[0],i[1]=+C[1],m):[i[0],i[1]]},m.translateExtent=function(C){return arguments.length?(s[0][0]=+C[0][0],s[1][0]=+C[1][0],s[0][1]=+C[0][1],s[1][1]=+C[1][1],m):[[s[0][0],s[0][1]],[s[1][0],s[1][1]]]},m.constrain=function(C){return arguments.length?(e=C,m):e},m.duration=function(C){return arguments.length?(a=+C,m):a},m.interpolate=function(C){return arguments.length?(l=C,m):l},m.on=function(){var C=c.on.apply(c,arguments);return C===c?m:C},m.clickDistance=function(C){return arguments.length?(S=(C=+C)*C,m):Math.sqrt(S)},m.tapDistance=function(C){return arguments.length?(M=+C,m):M},m}function b2(n){const[r,e]=Z.useState({x:0,y:0,k:1}),t=Z.useRef(null);return Z.useEffect(()=>{const a=n.current;if(!a)return;const l=sr(a),c=E2().scaleExtent([.2,3]).filter(d=>{const h=d.target;return h&&(h.closest("[data-node]")||h.closest("[data-edge]")||h.closest("[data-handle]")||h.closest("[data-decoration]"))?d.type==="wheel":d.shiftKey&&d.type!=="wheel"?!1:!d.button}).on("zoom",d=>{const h=d.transform;e({x:h.x,y:h.y,k:h.k})});return t.current=c,l.call(c),l.call(c.transform,Mt.translate(r.x,r.y).scale(r.k)),()=>{l.on(".zoom",null)}},[]),{transform:r,fitTo:a=>{const l=n.current,c=t.current;if(!l||!c)return;const d=l.getBoundingClientRect(),h=80,f=Math.min((d.width-h*2)/a.w,(d.height-h*2)/a.h,1.5),y=d.width/2-(a.x+a.w/2)*f,x=d.height/2-(a.y+a.h/2)*f;sr(l).call(c.transform,Mt.translate(y,x).scale(f))},reset:()=>{const a=n.current,l=t.current;!a||!l||sr(a).call(l.transform,Mt)},zoomBy:a=>{const l=n.current,c=t.current;!l||!c||sr(l).call(c.scaleBy,a)}}}function Mr(n,r,e){return{x:(r-n.x)/n.k,y:(e-n.y)/n.k}}function N2(){var Yl;const n=Z.useRef(null),r=b(I=>I.project.nodes),e=b(I=>I.project.edges),t=b(I=>I.project.decorations??[]),o=b(I=>I.groupSelection),i=b(I=>I.setGroupSelection),s=b(I=>I.moveGroup),a=b(I=>I.addDecoration),l=b(I=>I.updateDecoration),c=b(I=>I.moveDecoration),d=b(I=>I.project.view),h=b(I=>I.selection),f=b(I=>I.moveNode),y=b(I=>I.resizeNode),x=b(I=>I.setNodeAspect),S=b(I=>I.addEdge),M=b(I=>I.select),m=b(I=>I.addNode),g=b(I=>I.promotePostit),{transform:p,fitTo:v,reset:k,zoomBy:T}=b2(n),[w,_]=Z.useState({kind:"none"}),[N,j]=Z.useState(!1),z=Z.useCallback((I,W)=>{if(!n.current)return;const F=n.current.getBoundingClientRect(),B=Mr(p,I.clientX-F.left,I.clientY-F.top),U=b.getState();if(U.groupSelection.includes(W)){_({kind:"group",startWorld:B,cursorWorld:B}),I.target.setPointerCapture(I.pointerId);return}const pn=U.project.nodes.find(On=>On.id===W);pn&&(_({kind:"node",nodeId:W,startWorld:B,nodeStart:{x:pn.x,y:pn.y}}),I.target.setPointerCapture(I.pointerId))},[p]),G=Z.useCallback((I,W)=>{if(!n.current)return;const F=n.current.getBoundingClientRect(),B=Mr(p,I.clientX-F.left,I.clientY-F.top);_({kind:"edge",edgeFrom:W,cursorWorld:B}),I.target.setPointerCapture(I.pointerId)},[p]),Y=Z.useCallback((I,W)=>{_({kind:"resize",nodeId:W}),I.target.setPointerCapture(I.pointerId)},[]),C=Z.useCallback((I,W)=>{if(!n.current)return;const F=n.current.getBoundingClientRect(),B=Mr(p,I.clientX-F.left,I.clientY-F.top),U=b.getState();if(U.groupSelection.includes(W)){_({kind:"group",startWorld:B,cursorWorld:B}),I.target.setPointerCapture(I.pointerId);return}const pn=U.project.decorations.find(On=>On.id===W);pn&&(_({kind:"deco-move",decId:W,startWorld:B,decStart:{x:pn.x,y:pn.y,x2:pn.x2,y2:pn.y2,width:pn.width,height:pn.height}}),I.target.setPointerCapture(I.pointerId))},[p]),D=Z.useCallback((I,W,F)=>{I.stopPropagation(),_({kind:"deco-arrow",decId:W,arrowEndpoint:F}),I.target.setPointerCapture(I.pointerId)},[]),E=Z.useCallback((I,W)=>{I.stopPropagation(),_({kind:"deco-resize",decId:W}),I.target.setPointerCapture(I.pointerId)},[]),R=Z.useCallback(I=>{if(w.kind==="none"||!n.current)return;const W=n.current.getBoundingClientRect(),F=Mr(p,I.clientX-W.left,I.clientY-W.top);if(w.kind==="node"&&w.nodeId&&w.startWorld&&w.nodeStart){const B=w.nodeStart.x+(F.x-w.startWorld.x),U=w.nodeStart.y+(F.y-w.startWorld.y);f(w.nodeId,B,U)}else if(w.kind==="edge")_({...w,cursorWorld:F});else if(w.kind==="resize"&&w.nodeId){const B=b.getState().project.nodes.find(mp=>mp.id===w.nodeId);if(!B)return;const U=Jr[B.type],pn=Math.abs(F.x-B.x),On=Math.abs(F.y-B.y),An=Math.SQRT2,Jl=Math.max(20,(pn-4)*An),ql=Math.max(15,(On-4)*An),fp=Math.sqrt(Jl*ql/(U.rx*U.ry)),pp=Jl*U.ry/(ql*U.rx);y(w.nodeId,fp),x(w.nodeId,pp)}else if(w.kind==="deco-move"&&w.decId&&w.startWorld&&w.decStart){const B=w.decStart.x+(F.x-w.startWorld.x),U=w.decStart.y+(F.y-w.startWorld.y);c(w.decId,B,U)}else if(w.kind==="deco-arrow"&&w.decId&&w.arrowEndpoint)w.arrowEndpoint==="start"?l(w.decId,{x:F.x,y:F.y}):l(w.decId,{x2:F.x,y2:F.y});else if(w.kind==="deco-resize"&&w.decId){const B=b.getState().project.decorations.find(On=>On.id===w.decId);if(!B)return;const U=Math.max(40,(F.x-B.x)*2),pn=Math.max(20,(F.y-B.y)*2);l(w.decId,{width:U,height:pn})}else if(w.kind==="group"&&w.startWorld&&w.cursorWorld){const B=F.x-w.cursorWorld.x,U=F.y-w.cursorWorld.y;s(B,U),_({...w,cursorWorld:F})}else w.kind==="box-select"&&w.startWorld&&_({...w,boxRect:{x0:Math.min(w.startWorld.x,F.x),y0:Math.min(w.startWorld.y,F.y),x1:Math.max(w.startWorld.x,F.x),y1:Math.max(w.startWorld.y,F.y)}})},[w,p,f,y,x,c,l]),P=Z.useCallback(I=>{if(w.kind==="edge"&&w.edgeFrom){const W=document.elementFromPoint(I.clientX,I.clientY),F=W==null?void 0:W.closest("[data-node]"),B=F==null?void 0:F.getAttribute("data-node");B&&B!==w.edgeFrom&&S(w.edgeFrom,B,"open")}else if(w.kind==="box-select"&&w.boxRect){const{x0:W,y0:F,x1:B,y1:U}=w.boxRect,pn=b.getState(),On=[];pn.project.nodes.forEach(An=>{An.x>=W&&An.x<=B&&An.y>=F&&An.y<=U&&On.push(An.id)}),(pn.project.decorations??[]).forEach(An=>{An.x>=W&&An.x<=B&&An.y>=F&&An.y<=U&&On.push(An.id)}),On.length>0?i(On):i([])}_({kind:"none"})},[w,S,i]),A=Z.useCallback(I=>{if(I.target===n.current||I.target.hasAttribute("data-bg"))if(I.shiftKey&&n.current){const W=n.current.getBoundingClientRect(),F=Mr(p,I.clientX-W.left,I.clientY-W.top);_({kind:"box-select",startWorld:F,boxRect:{x0:F.x,y0:F.y,x1:F.x,y1:F.y}})}else M({kind:"none"}),i([])},[M,p,i]),L=I=>{I.dataTransfer.types.includes("application/x-postit-id")&&(I.preventDefault(),I.dataTransfer.dropEffect="copy",j(!0))},$=()=>j(!1),V=I=>{I.preventDefault(),j(!1);const W=I.dataTransfer.getData("application/x-postit-id");if(!W||!n.current)return;const F=n.current.getBoundingClientRect(),B=Mr(p,I.clientX-F.left,I.clientY-F.top);g(W,B.x,B.y)},dn=Z.useMemo(()=>{const I=t.filter(B=>B.kind==="text"),W=t.filter(B=>B.kind==="arrow");return[...t.filter(B=>B.kind==="ellipse"),...W,...I]},[t]),q=Z.useMemo(()=>{const I=new Map;e.forEach(F=>{const B=[F.from,F.to].sort().join("::");I.has(B)||I.set(B,[]),I.get(B).push(F.id)});const W=14;return e.map(F=>{const B=[F.from,F.to].sort().join("::"),U=I.get(B);if(U.length<2)return{edge:F,offset:0};const On=(U.indexOf(F.id)-(U.length-1)/2)*W;return{edge:F,offset:On}})},[e]),wn=Z.useCallback(()=>{if(r.length===0)return k();let I=1/0,W=1/0,F=-1/0,B=-1/0;for(const U of r)I=Math.min(I,U.x-100),W=Math.min(W,U.y-80),F=Math.max(F,U.x+100),B=Math.max(B,U.y+80);v({x:I,y:W,w:F-I,h:B-W})},[r,v,k]),nn=I=>{if(!n.current)return;const W=n.current.getBoundingClientRect(),F=Mr(p,W.width/2,W.height/2),B=(Math.random()-.5)*60,U=(Math.random()-.5)*60;m({x:F.x+B,y:F.y+U,type:I,name:A2(I)})},hn=I=>{if(!n.current)return;const W=n.current.getBoundingClientRect(),F=Mr(p,W.width/2,W.height/2),B=(Math.random()-.5)*80,U=(Math.random()-.5)*80;a(I,F.x+B,F.y+U)},Hn=(Yl=n.current)==null?void 0:Yl.getBoundingClientRect(),st=Hn?{x:-p.x/p.k,y:-p.y/p.k,w:Hn.width/p.k,h:Hn.height/p.k}:{x:0,y:0,w:0,h:0};return u.jsxs("div",{className:`canvas-wrap blueprint-grid ${N?"is-drop-hover":""}`,onDragOver:L,onDragLeave:$,onDrop:V,children:[u.jsxs("svg",{ref:n,className:"canvas-svg",onPointerDown:A,onPointerMove:R,onPointerUp:P,children:[u.jsx("defs",{children:u.jsx("pattern",{id:"dots",width:"20",height:"20",patternUnits:"userSpaceOnUse",children:u.jsx("circle",{cx:"1",cy:"1",r:"0.6",fill:"rgba(44, 95, 124, 0.20)"})})}),u.jsx("rect",{"data-bg":!0,x:"-100000",y:"-100000",width:"200000",height:"200000",fill:"transparent"}),u.jsxs("g",{"data-cv-world":!0,transform:`translate(${p.x} ${p.y}) scale(${p.k})`,children:[dn.map(I=>u.jsx(Yy,{dec:I,selected:h.kind==="decoration"&&h.id===I.id||o.includes(I.id),onPointerDown:C,onArrowEndpointDown:D,onResizeDown:E},I.id)),q.map(({edge:I,offset:W})=>{const F=r.find(U=>U.id===I.from),B=r.find(U=>U.id===I.to);return!F||!B?null:u.jsx(Vy,{edge:I,from:F,to:B,rough:d.edgeStyle==="rough",selected:h.kind==="edge"&&h.id===I.id,offset:W,onSelect:U=>M({kind:"edge",id:U})},I.id)}),w.kind==="edge"&&w.edgeFrom&&w.cursorWorld&&u.jsx(O2,{fromId:w.edgeFrom,cursor:w.cursorWorld}),r.map(I=>u.jsx(Wy,{node:I,rough:d.edgeStyle==="rough",selected:h.kind==="node"&&h.id===I.id||o.includes(I.id),onPointerDownNode:z,onHandlePointerDown:G,onResizePointerDown:Y},I.id)),w.kind==="box-select"&&w.boxRect&&u.jsx("rect",{x:w.boxRect.x0,y:w.boxRect.y0,width:w.boxRect.x1-w.boxRect.x0,height:w.boxRect.y1-w.boxRect.y0,fill:"rgba(207, 85, 71, 0.10)",stroke:"var(--brick)",strokeWidth:"1.4",strokeDasharray:"6 4",pointerEvents:"none"})]})]}),r.length===0&&u.jsx("div",{className:"canvas-empty",children:u.jsxs("div",{className:"canvas-empty-card",children:[u.jsx("h2",{className:"hand",children:"캔버스가 비어 있습니다"}),u.jsxs("p",{children:["왼쪽 포스트잇을 끌어 와서 노드로 만들거나,",u.jsx("br",{}),"아래에서 노드 타입을 선택해 추가하세요."]}),u.jsxs("div",{className:"canvas-empty-actions",children:[u.jsx("button",{onClick:()=>nn("room"),children:"+ 방"}),u.jsx("button",{onClick:()=>nn("vista"),children:"+ 전망"}),u.jsx("button",{onClick:()=>nn("boss"),children:"+ 보스"})]})]})}),u.jsxs("div",{className:"canvas-toolbar",children:[u.jsxs("div",{className:"ct-group",role:"group","aria-label":"노드 추가",children:[u.jsx("button",{onClick:()=>nn("room"),title:"방 추가",children:"방"}),u.jsx("button",{onClick:()=>nn("vista"),title:"전망",children:"전망"}),u.jsx("button",{onClick:()=>nn("treasure"),title:"보물",children:"보물"}),u.jsx("button",{onClick:()=>nn("boss"),title:"보스",children:"보스"}),u.jsx("button",{onClick:()=>nn("hub"),title:"허브",children:"허브"}),u.jsx("button",{onClick:()=>nn("save"),title:"세이브",children:"세이브"})]}),u.jsx("span",{className:"ct-sep"}),u.jsxs("div",{className:"ct-group",role:"group","aria-label":"데코 추가",children:[u.jsx("button",{onClick:()=>hn("arrow"),title:"화살표",children:"↗ 화살표"}),u.jsx("button",{onClick:()=>hn("ellipse"),title:"회색 타원",children:"○ 타원"}),u.jsx("button",{onClick:()=>hn("text"),title:"텍스트",children:"A 텍스트"})]}),u.jsx("span",{className:"ct-sep"}),u.jsx("button",{onClick:wn,title:"화면 맞춤",children:"⇲ 맞춤"}),u.jsx("button",{onClick:()=>T(1.25),title:"확대",children:"＋"}),u.jsx("button",{onClick:()=>T(.8),title:"축소",children:"−"}),u.jsxs("span",{className:"ct-zoom caption",children:[Math.round(p.k*100),"%"]})]}),d.showMinimap&&r.length>0&&u.jsx("div",{className:"canvas-minimap",children:u.jsx(Xy,{nodes:r,edges:e,viewBox:st})}),N&&u.jsx("div",{className:"canvas-drop-banner hand",children:"여기에 놓아 노드로 승격"})]})}function O2({fromId:n,cursor:r}){const e=b(t=>t.project.nodes.find(o=>o.id===n));return e?u.jsx("line",{x1:e.x,y1:e.y,x2:r.x,y2:r.y,stroke:"var(--brick)",strokeWidth:"1.6",strokeDasharray:"4 3",opacity:"0.8",pointerEvents:"none"}):null}function A2(n){return{room:"새 방",vista:"전망 지점",treasure:"보물 챔버",boss:"보스 챔버",hub:"허브 광장",save:"세이브 포인트"}[n]}const M2=["room","vista","treasure","boss","hub","save"],j2=["open","locked","oneway","ability","vista"],L2={room:"일반 방. 전투·통과·환경 인터랙션.",vista:"풍경/예고 공간. 플레이어에게 목표나 비밀을 보여줌.",treasure:"보상/획득 공간. 보물, 능력, 정보.",boss:"거대 인카운터. 일반적으로 페이싱의 클라이맥스.",hub:"여러 경로가 모이는 허브.",save:"체크포인트, 회복, 휴식."},Z2={open:"열린 통로. 양방향 자유 통행.",locked:"잠금문. 키를 획득해야 통과.",oneway:"일방통행. 반대로 돌아갈 수 없음.",ability:"능력 게이트. 특정 능력 보유 시만 통과.",vista:"전망. 다른 공간이 시각적으로 보이지만 이동 불가."};function D2({onClose:n}){return u.jsxs("aside",{className:"legend",role:"dialog","aria-label":"범례",children:[u.jsxs("header",{className:"lg-head",children:[u.jsx("h3",{className:"hand",children:"표기 규약"}),u.jsx("button",{onClick:n,className:"lg-x","aria-label":"닫기",children:"×"})]}),u.jsx("p",{className:"lg-intro caption",children:"3D 게임 레벨 디자인 노드·간선 표기 규약"}),u.jsx("h4",{children:"노드"}),u.jsx("ul",{className:"lg-list",children:M2.map(r=>{const e=Jr[r];return u.jsxs("li",{children:[u.jsxs("svg",{width:"48",height:"32",viewBox:"-32 -22 64 44",children:[u.jsx("ellipse",{cx:"0",cy:"0",rx:"24",ry:"16",fill:e.fill,stroke:e.stroke,strokeWidth:e.strokeWidth}),u.jsx("text",{x:"0",y:"3",textAnchor:"middle",fontSize:"11",fill:"var(--ink-900)",children:e.icon})]}),u.jsxs("div",{children:[u.jsx("strong",{children:e.label}),u.jsx("span",{children:L2[r]})]})]},r)})}),u.jsx("h4",{children:"간선"}),u.jsx("ul",{className:"lg-list",children:j2.map(r=>{const e=lo[r];return u.jsxs("li",{children:[u.jsxs("svg",{width:"48",height:"32",viewBox:"0 0 48 32",children:[u.jsx("path",{d:"M 4 16 Q 24 4, 44 16",fill:"none",stroke:e.stroke,strokeWidth:e.width,strokeDasharray:e.dash,strokeLinecap:"round"}),(r==="oneway"||r==="ability"||r==="locked")&&u.jsx("polygon",{points:"38,12 44,16 38,20",fill:e.stroke})]}),u.jsxs("div",{children:[u.jsx("strong",{children:e.label}),u.jsx("span",{children:Z2[r]})]})]},r)})})]})}function R2(){const n=b(d=>d.project.view),r=b(d=>d.setView),e=b(d=>{var h;return((h=d.project.theme)==null?void 0:h.hueShift)??0}),t=b(d=>{var h;return((h=d.project.theme)==null?void 0:h.satScale)??1}),o=b(d=>d.setHueShift),i=b(d=>d.setSatScale),s=b(d=>d.resetTheme),a=e!==0||t!==1,[l,c]=Z.useState(!1);return u.jsxs("main",{className:"canvas-shell",children:[u.jsxs("div",{className:"cs-topbar",children:[u.jsxs("div",{className:"cs-view-toggles",children:[u.jsx(Hs,{label:"펜떨림",value:n.edgeStyle==="rough",onChange:d=>r({edgeStyle:d?"rough":"clean"}),hint:"손그림 느낌의 거친 곡선"}),u.jsx(Hs,{label:"그리드",value:n.showGrid,onChange:d=>r({showGrid:d})}),u.jsx(Hs,{label:"미니맵",value:n.showMinimap,onChange:d=>r({showMinimap:d})})]}),u.jsxs("div",{className:"cs-right",children:[u.jsxs("div",{className:"cs-theme",title:"학생별 고유 팔레트 — HUE는 색조, SAT는 채도",children:[u.jsxs("div",{className:"cs-theme-row",children:[u.jsx("span",{className:"cs-theme-label",children:"HUE"}),u.jsx("input",{className:"cs-theme-slider cs-theme-slider--hue",type:"range",min:-180,max:180,step:1,value:e,onChange:d=>o(parseInt(d.target.value,10)),style:{background:`linear-gradient(to right,
                    ...
                    hsl(15,0%,55%) 0%,
                    hsl(15,50%,55%) 50%,
                    hsl(15,100%,55%) 100%)`}}),u.jsxs("span",{className:"cs-theme-value",children:[t.toFixed(2),"×"]})]}),u.jsx("button",{type:"button",className:"cs-theme-reset",onClick:s,disabled:!a,title:"기본 팔레트로 복원",children:"기본"})]}),u.jsxs("button",{className:`cs-legend-btn ${l?"is-on":""}`,onClick:()=>c(!l),children:["범례 ",l?"▾":"▸"]})]})]}),u.jsx("div",{className:`cs-canvas-area ${n.showGrid?"":"no-grid"}`,children:u.jsx(N2,{})}),l&&u.jsx(D2,{onClose:()=>c(!1)})]})}function Hs({label:n,value:r,onChange:e,hint:t}){return u.jsxs("label",{className:`cs-toggle ${r?"is-on":""}`,title:t,children:[u.jsx("input",{type:"checkbox",checked:r,onChange:o=>e(o.target.checked)}),u.jsx("span",{className:"cs-toggle-knob","aria-hidden":!0}),u.jsx("span",{className:"cs-toggle-label",children:n})]})}const Zu=50,Du=1500;function F2(){const n=b(t=>t.project.ai);if(n.provider!=="gemini")return u.jsxs("div",{className:"usage",children:[u.jsx("span",{className:"caption",children:"AI"}),u.jsx("span",{className:"usage-off",children:"오프라인 모드"})]});const r=Math.min(100,n.usage.proUsedToday/Zu*100),e=Math.min(100,n.usage.flashUsedToday/Du*100);return u.jsxs("div",{className:"usage",children:[u.jsx("span",{className:"caption",children:"오늘 사용량"}),u.jsxs("div",{className:"usage-row",children:[u.jsx("span",{className:"usage-label",children:"Pro"}),u.jsx("div",{className:"usage-bar",children:u.jsx("div",{className:"usage-fill usage-fill--pro",style:{width:`${r}%`}})}),u.jsxs("span",{className:"usage-num",children:[n.usage.proUsedToday,"/",Zu]})]}),u.jsxs("div",{className:"usage-row",children:[u.jsx("span",{className:"usage-label",children:"Flash"}),u.jsx("div",{className:"usage-bar",children:u.jsx("div",{className:"usage-fill usage-fill--flash",style:{width:`${e}%`}})}),u.jsxs("span",{className:"usage-num",children:[n.usage.flashUsedToday,"/",Du]})]})]})}const H2=["gemini-2.5-pro","gemini-2.5-flash","gemini-2.5-flash-lite","gemini-2.0-flash"],$2=["gemini-2.5-flash","gemini-2.5-flash-lite","gemini-2.0-flash","gemini-2.5-pro"],B2="https://generativelanguage.googleapis.com/v1beta/models";class qf extends Error{constructor(r){super(`Quota exceeded for ${r}`),this.model=r}}class xe extends Error{constructor(r,e){super(`Transient ${e} on ${r}`),this.model=r,this.status=e}}class eo extends Error{constructor(){super("Gemini API key가 설정되지 않았습니다.")}}async function z2(n,r,e){var l,c,d,h;const t=`${B2}/${n}:generateContent?key=${encodeURIComponent(r)}`,o={systemInstruction:{parts:[{text:e.system}]},contents:[{role:"user",parts:[{text:e.user}]}],generationConfig:{maxOutputTokens:e.maxTokens??1024,temperature:.8}};e.responseSchema&&(o.generationConfig.responseMimeType="application/json",o.generationConfig.responseSchema=e.responseSchema,o.generationConfig.temperature=.4);const i=await fetch(t,{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify(o),signal:e.signal});if(!i.ok){if(i.status===429)throw new qf(n);if(i.status===503||i.status===502||i.status===504)throw new xe(n,i.status);const f=await i.text();throw new Error(`Gemini ${n} ${i.status}: ${f.slice(0,200)}`)}const s=await i.json(),a=((h=(d=(c=(l=s==null?void 0:s.candidates)==null?void 0:l[0])==null?void 0:c.content)==null?void 0:d.parts)==null?void 0:h.map(f=>f.text??"").join(""))??"";if(!a)throw new Error("Gemini 응답이 비어 있습니다.");return a}async function W2(n,r,e,t=2){let o;for(let i=0;i<=t;i++)try{return await z2(n,r,e)}catch(s){if(o=s,s instanceof xe&&i<t){const a=500*Math.pow(2,i);await new Promise(l=>setTimeout(l,a));continue}throw s}throw o??new Error("재시도 실패")}async function Ve(n){const r=b.getState(),e=r.project.ai.apiKey;if(!e)throw new eo;const t=n.preferModel==="gemini-2.5-flash"?$2:H2;let o;for(let i=0;i<t.length;i++){const s=t[i];try{const a=await W2(s,e,n);return r.bumpUsage(s==="gemini-2.5-pro"?"pro":"flash"),{text:a,modelUsed:s,fallback:i>0}}catch(a){if(o=a,a instanceof qf||a instanceof xe)continue;throw a}}throw o??new Error("알 수 없는 오류")}function Ru(n){if(!n)return null;let r=n.replace(/```(?:json|JSON)?\s*/g,"").replace(/\s*```/g,"").trim();try{return JSON.parse(r)}catch{}const e=r.indexOf("{"),t=r.indexOf("["),o=e<0?t:t<0?e:Math.min(e,t);if(o<0)return null;const s=r[o]==="{"?"}":"]",a=r.lastIndexOf(s);if(a<=o)return null;const l=r.slice(o,a+1);try{return JSON.parse(l)}catch{}const c=l.replace(/,\s*([}\]])/g,"$1");try{return JSON.parse(c)}catch{return null}}const os=`
...
`;function K2(n){return`다음 시드로 컨셉을 생성해 주세요:

"${n}"`}function Q2(n){return`다음 컨셉의 포스트잇 시드:
${JSON.stringify(n.concept,null,2)}`}function X2(n){return JSON.stringify({concept:n.concept,nodes:n.nodes.map(r=>({id:r.id,name:r.name,type:r.type,icons:r.icons,notes:r.notes})),edges:n.edges.map(r=>({from:r.from,to:r.to,type:r.type,key:r.keyId,ability:r.abilityId}))},null,2)}function Y2(n,r){return`다이어그램 요약:
${X2(n)}
