 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(n){function r(w,N){var z=w.length;w.push(N);n:for(;0<z;){var U=z-1>>>1,T=w[U];if(0<o(T,N))w[U]=N,w[z]=T,z=U;else break n}}function e(w){return w.length===0?null:w[0]}function t(w){if(w.length===0)return null;var N=w[0],z=w.pop();if(z!==N){w[0]=z;n:for(var U=0,T=w.length,pn=T>>>1;U<pn;){var X=2*(U+1)-1,en=w[X],Q=X+1,ln=w[Q];if(0>o(en,z))Q<T&&0>o(ln,en)?(w[U]=ln,w[Q]=z,U=Q):(w[U]=en,w[X]=z,U=X);else if(Q<T&&0>o(ln,z))w[U]=ln,w[Q]=z,U=Q;else break n}}return N}function o(w,N){var z=w.sortIndex-N.sortIndex;return z!==0?z:w.id-N.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;n.unstable_now=function(){return i.now()}}else{var s=Date,a=s.now();n.unstable_now=function(){return s.now()-a}}var l=[],c=[],d=1,h=null,f=3,m=!1,x=!1,y=!1,E=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,p=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(w){for(var N=e(c);N!==null;){if(N.callback===null)t(c);else if(N.startTime<=w)t(c),N.sortIndex=N.expirationTime,r(l,N);else break;N=e(c)}}function S(w){if(y=!1,v(w),!x)if(e(l)!==null)x=!0,j(C);else{var N=e(c);N!==null&&A(S,N.startTime-w)}}function C(w,N){x=!1,y&&(y=!1,g(Z),Z=-1),m=!0;var z=f;try{for(v(N),h=e(l);h!==null&&(!(h.expirationTime>N)||w&&!P());){var U=h.callback;if(typeof U=="function"){h.callback=null,f=h.priorityLevel;var T=U(h.expirationTime<=N);N=n.unstable_now(),typeof T=="function"?h.callback=T:h===e(l)&&t(l),v(N)}else t(l);h=e(l)}if(h!==null)var pn=!0;else{var X=e(c);X!==null&&A(S,X.startTime-N),pn=!1}return pn}finally{h=null,f=z,m=!1}}var O=!1,I=null,Z=-1,F=5,K=-1;function P(){return!(n.unstable_now()-K<F)}function Y(){if(I!==null){var w=n.unstable_now();K=w;var N=!0;try{N=I(!0,w)}finally{N?H():(O=!1,I=null)}}else O=!1}var H;if(typeof p=="function")H=function(){p(Y)};else if(typeof MessageChannel<"u"){var k=new MessageChannel,R=k.port2;k.port1.onmessage=Y,H=function(){R.postMessage(null)}}else H=function(){E(Y,0)};function j(w){I=w,O||(O=!0,H())}function A(w,N){Z=E(function(){w(n.unstable_now())},N)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(w){w.callback=null},n.unstable_continueExecution=function(){x||m||(x=!0,j(C))},n.unstable_forceFrameRate=function(w){0>w||125<w?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):F=0<w?Math.floor(1e3/w):5},n.unstable_getCurrentPriorityLevel=function(){return f},n.unstable_getFirstCallbackNode=function(){return e(l)},n.unstable_next=function(w){switch(f){case 1:case 2:case 3:var N=3;break;default:N=f}var z=f;f=N;try{return w()}finally{f=z}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=function(){},n.unstable_runWithPriority=function(w,N){switch(w){case 1:case 2:case 3:case 4:case 5:break;default:w=3}var z=f;f=w;try{return N()}finally{f=z}},n.unstable_scheduleCallback=function(w,N,z){var U=n.unstable_now();switch(typeof z=="object"&&z!==null?(z=z.delay,z=typeof z=="number"&&0<z?U+z:U):z=U,w){case 1:var T=-1;break;case 2:T=250;break;case 5:T=1073741823;break;case 4:T=1e4;break;default:T=5e3}return T=z+T,w={id:d++,callback:N,priorityLevel:w,startTime:z,expirationTime:T,sortIndex:-1},z>U?(w.sortIndex=z,r(c,w),e(l)===null&&w===e(c)&&(y?(g(Z),Z=-1):y=!0,A(S,z-U))):(w.sortIndex=T,r(l,w),x||m||(x=!0,j(C))),w},n.unstable_shouldYield=P,n.unstable_wrapCallback=function(w){var N=f;return function(){var z=f;f=N;try{return w.apply(this,arguments)}finally{f=z}}}})(hm);dm.exports=hm;var x1=dm.exports;/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Io=M;function _v(n,r){return n===r&&(n!==0||1/n===1/r)||n!==n&&r!==r}var bv=typeof Object.is=="function"?Object.is:_v,Cv=Io.useState,Pv=Io.useEffect,Tv=Io.useLayoutEffect,Iv=Io.useDebugValue;function Ev(n,r){var e=r(),t=Cv({inst:{value:e,getSnapshot:r}}),o=t[0].inst,i=t[1];return Tv(function(){o.value=e,o.getSnapshot=r,Vl(o)&&i({inst:o})},[n,e,r]),Pv(function(){return Vl(o)&&i({inst:o}),n(function(){Vl(o)&&i({inst:o})})},[n]),Iv(e),e}function Vl(n){var r=n.getSnapshot;n=n.value;try{var e=r();return!bv(n,e)}catch{return!0}}function Mv(n,r){return r()}var Nv=typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"?Mv:Ev;m0.useSyncExternalStore=Io.useSyncExternalStore!==void 0?Io.useSyncExternalStore:Nv;p0.exports=m0;var jv=p0.exports;/**
 * @license React
...
`,v2=`\uFEFF# S14: Revenge of the Fallen (타락한 자의 복수)
...
`,vS=`# S20: The Last Stand - Top-down Map 상세 설계\r
\r
> **"이 선을 넘는 놈들은 다 죽는다."**\r
\r
## 설계 개요\r
...
`;function lC(){var Sn;const n=M.useRef(null),r=B($=>$.project.nodes),e=B($=>$.project.edges),t=B($=>$.project.decorations??[]),o=B($=>$.project.images??[]),i=B($=>$.addImage),s=B($=>$.moveImage),a=B($=>$.resizeImage),l=B($=>$.groupSelection),c=B($=>$.setGroupSelection),d=B($=>$.moveGroup),h=B($=>$.addDecoration),f=B($=>$.updateDecoration),m=B($=>$.moveDecoration),x=B($=>$.project.view),y=B($=>$.selection),E=B($=>$.moveNode),g=B($=>$.resizeNode),p=B($=>$.setNodeAspect),v=B($=>$.addEdge),S=B($=>$.select),C=B($=>$.addNode),O=B($=>$.promotePostit),{transform:I,fitTo:Z,reset:F,zoomBy:K}=tC(n),[P,Y]=M.useState({kind:"none"}),[H,k]=M.useState(!1),R=M.useCallback(($,tn)=>{if(!n.current)return;const J=n.current.getBoundingClientRect(),b=xe(I,$.clientX-J.left,$.clientY-J.top),rn=B.getState();if(rn.groupSelection.includes(tn)){Y({kind:"group",startWorld:b,cursorWorld:b}),$.target.setPointerCapture($.pointerId);return}const yn=rn.project.nodes.find(bn=>bn.id===tn);yn&&(Y({kind:"node",nodeId:tn,startWorld:b,nodeStart:{x:yn.x,y:yn.y}}),$.target.setPointerCapture($.pointerId))},[I]),j=M.useCallback(($,tn)=>{if(!n.current)return;const J=n.current.getBoundingClientRect(),b=xe(I,$.clientX-J.left,$.clientY-J.top);Y({kind:"edge",edgeFrom:tn,cursorWorld:b}),$.target.setPointerCapture($.pointerId)},[I]),A=M.useCallback(($,tn)=>{Y({kind:"resize",nodeId:tn}),$.target.setPointerCapture($.pointerId)},[]),w=M.useCallback(($,tn)=>{if(!n.current)return;const J=n.current.getBoundingClientRect(),b=xe(I,$.clientX-J.left,$.clientY-J.top),rn=B.getState();if(rn.groupSelection.includes(tn)){Y({kind:"group",startWorld:b,cursorWorld:b}),$.target.setPointerCapture($.pointerId);return}const yn=rn.project.decorations.find(bn=>bn.id===tn);yn&&(Y({kind:"deco-move",decId:tn,startWorld:b,decStart:{x:yn.x,y:yn.y,x2:yn.x2,y2:yn.y2,width:yn.width,height:yn.height}}),$.target.setPointerCapture($.pointerId))},[I]),N=M.useCallback(($,tn,J)=>{$.stopPropagation(),Y({kind:"deco-arrow",decId:tn,arrowEndpoint:J}),$.target.setPointerCapture($.pointerId)},[]),z=M.useCallback(($,tn)=>{$.stopPropagation(),Y({kind:"deco-resize",decId:tn}),$.target.setPointerCapture($.pointerId)},[]),U=M.useCallback(($,tn)=>{if(!n.current)return;const J=n.current.getBoundingClientRect(),b=xe(I,$.clientX-J.left,$.clientY-J.top),rn=B.getState();if(rn.groupSelection.includes(tn)){Y({kind:"group",startWorld:b,cursorWorld:b}),$.target.setPointerCapture($.pointerId);return}const yn=(rn.project.images??[]).find(bn=>bn.id===tn);yn&&(Y({kind:"img-move",imgId:tn,startWorld:b,imgStart:{x:yn.x,y:yn.y,width:yn.width,height:yn.height}}),$.target.setPointerCapture($.pointerId))},[I]),T=M.useCallback(($,tn)=>{if($.stopPropagation(),!n.current)return;const b=(B.getState().project.images??[]).find(rn=>rn.id===tn);b&&(Y({kind:"img-resize",imgId:tn,imgStart:{x:b.x,y:b.y,width:b.width,height:b.height}}),$.target.setPointerCapture($.pointerId))},[]),pn=M.useCallback($=>{if(P.kind==="none"||!n.current)return;const tn=n.current.getBoundingClientRect(),J=xe(I,$.clientX-tn.left,$.clientY-tn.top);if(P.kind==="node"&&P.nodeId&&P.startWorld&&P.nodeStart){const b=P.nodeStart.x+(J.x-P.startWorld.x),rn=P.nodeStart.y+(J.y-P.startWorld.y);E(P.nodeId,b,rn)}else if(P.kind==="edge")Y({...P,cursorWorld:J});else if(P.kind==="resize"&&P.nodeId){const b=B.getState().project.nodes.find(fl=>fl.id===P.nodeId);if(!b)return;const rn=Fe[b.type],yn=Math.abs(J.x-b.x),bn=Math.abs(J.y-b.y),In=Math.SQRT2,sr=Math.max(20,(yn-4)*In),oe=Math.max(15,(bn-4)*In),kr=Math.sqrt(sr*oe/(rn.rx*rn.ry)),Oo=sr*rn.ry/(oe*rn.rx);g(P.nodeId,kr),p(P.nodeId,Oo)}else if(P.kind==="deco-move"&&P.decId&&P.startWorld&&P.decStart){const b=P.decStart.x+(J.x-P.startWorld.x),rn=P.decStart.y+(J.y-P.startWorld.y);m(P.decId,b,rn)}else if(P.kind==="deco-arrow"&&P.decId&&P.arrowEndpoint)P.arrowEndpoint==="start"?f(P.decId,{x:J.x,y:J.y}):f(P.decId,{x2:J.x,y2:J.y});else if(P.kind==="deco-resize"&&P.decId){const b=B.getState().project.decorations.find(bn=>bn.id===P.decId);if(!b)return;const rn=Math.max(40,(J.x-b.x)*2),yn=Math.max(20,(J.y-b.y)*2);f(P.decId,{width:rn,height:yn})}else if(P.kind==="img-move"&&P.imgId&&P.startWorld&&P.imgStart){const b=P.imgStart.x+(J.x-P.startWorld.x),rn=P.imgStart.y+(J.y-P.startWorld.y);s(P.imgId,b,rn)}else if(P.kind==="img-resize"&&P.imgId&&P.imgStart){const b=P.imgStart.width/P.imgStart.height||1,rn=Math.max(np,(J.x-P.imgStart.x)*2),yn=Math.max(np/b,rn/b);a(P.imgId,Math.round(rn),Math.round(yn))}else if(P.kind==="group"&&P.startWorld&&P.cursorWorld){const b=J.x-P.cursorWorld.x,rn=J.y-P.cursorWorld.y;d(b,rn),Y({...P,cursorWorld:J})}else P.kind==="box-select"&&P.startWorld&&Y({...P,boxRect:{x0:Math.min(P.startWorld.x,J.x),y0:Math.min(P.startWorld.y,J.y),x1:Math.max(P.startWorld.x,J.x),y1:Math.max(P.startWorld.y,J.y)}})},[P,I,E,g,p,m,f,s,a]),X=M.useCallback($=>{if(P.kind==="edge"&&P.edgeFrom){const tn=document.elementFromPoint($.clientX,$.clientY),J=tn==null?void 0:tn.closest("[data-node]"),b=J==null?void 0:J.getAttribute("data-node");b&&b!==P.edgeFrom&&v(P.edgeFrom,b,"open")}else if(P.kind==="box-select"&&P.boxRect){const{x0:tn,y0:J,x1:b,y1:rn}=P.boxRect,yn=B.getState(),bn=[];yn.project.nodes.forEach(In=>{In.x>=tn&&In.x<=b&&In.y>=J&&In.y<=rn&&bn.push(In.id)}),(yn.project.decorations??[]).forEach(In=>{In.x>=tn&&In.x<=b&&In.y>=J&&In.y<=rn&&bn.push(In.id)}),(yn.project.images??[]).forEach(In=>{In.x>=tn&&In.x<=b&&In.y>=J&&In.y<=rn&&bn.push(In.id)}),bn.length>0?c(bn):c([])}Y({kind:"none"})},[P,v,c]),en=M.useCallback($=>{if($.target===n.current||$.target.hasAttribute("data-bg"))if($.shiftKey&&n.current){const tn=n.current.getBoundingClientRect(),J=xe(I,$.clientX-tn.left,$.clientY-tn.top);Y({kind:"box-select",startWorld:J,boxRect:{x0:J.x,y0:J.y,x1:J.x,y1:J.y}})}else S({kind:"none"}),c([])},[S,I,c]),Q=$=>{const tn=$.dataTransfer.types;(tn.includes("application/x-postit-id")||tn.includes("Files"))&&($.preventDefault(),$.dataTransfer.dropEffect="copy",k(!0))},ln=()=>k(!1),cn=$=>{if($.preventDefault(),k(!1),!n.current)return;const tn=n.current.getBoundingClientRect(),J=xe(I,$.clientX-tn.left,$.clientY-tn.top),b=Array.from($.dataTransfer.files??[]).filter(yn=>yn.type.startsWith("image/"));if(b.length>0){b.forEach(async(yn,bn)=>{try{const In=await rp(yn);In&&i(J.x+bn*24,J.y+bn*24,In.src,In.width,In.height)}catch(In){console.warn("이미지 드롭 실패",In)}});return}const rn=$.dataTransfer.getData("application/x-postit-id");rn&&O(rn,J.x,J.y)};M.useEffect(()=>{const $=tn=>{var sr,oe;const J=(sr=tn.target)==null?void 0:sr.tagName;if(J==="INPUT"||J==="TEXTAREA")return;const b=(oe=tn.clipboardData)==null?void 0:oe.items;if(!b||!n.current)return;const rn=Array.from(b).find(kr=>kr.kind==="file"&&kr.type.startsWith("image/"));if(!rn)return;const yn=rn.getAsFile();if(!yn)return;tn.preventDefault();const bn=n.current.getBoundingClientRect(),In=xe(I,bn.width/2,bn.height/2);rp(yn).then(kr=>{kr&&i(In.x,In.y,kr.src,kr.width,kr.height)}).catch(kr=>console.warn("이미지 붙여넣기 실패",kr))};return window.addEventListener("paste",$),()=>window.removeEventListener("paste",$)},[I,i]);const wn=M.useMemo(()=>{const $=t.filter(b=>b.kind==="text"),tn=t.filter(b=>b.kind==="arrow");return[...t.filter(b=>b.kind==="ellipse"),...tn,...$]},[t]),Nn=M.useMemo(()=>{const $=new Map;e.forEach(J=>{const b=[J.from,J.to].sort().join("::");$.has(b)||$.set(b,[]),$.get(b).push(J.id)});const tn=14;return e.map(J=>{const b=[J.from,J.to].sort().join("::"),rn=$.get(b);if(rn.length<2)return{edge:J,offset:0};const bn=(rn.indexOf(J.id)-(rn.length-1)/2)*tn;return{edge:J,offset:bn}})},[e]),Fn=M.useCallback(()=>{if(r.length===0)return F();let $=1/0,tn=1/0,J=-1/0,b=-1/0;for(const rn of r)$=Math.min($,rn.x-100),tn=Math.min(tn,rn.y-80),J=Math.max(J,rn.x+100),b=Math.max(b,rn.y+80);Z({x:$,y:tn,w:J-$,h:b-tn})},[r,Z,F]),dn=$=>{if(!n.current)return;const tn=n.current.getBoundingClientRect(),J=xe(I,tn.width/2,tn.height/2),b=(Math.random()-.5)*60,rn=(Math.random()-.5)*60;C({x:J.x+b,y:J.y+rn,type:$,name:uC($)})},un=$=>{if(!n.current)return;const tn=n.current.getBoundingClientRect(),J=xe(I,tn.width/2,tn.height/2),b=(Math.random()-.5)*80,rn=(Math.random()-.5)*80;h($,J.x+b,J.y+rn)},kn=(Sn=n.current)==null?void 0:Sn.getBoundingClientRect(),Pn=kn?{x:-I.x/I.k,y:-I.y/I.k,w:kn.width/I.k,h:kn.height/I.k}:{x:0,y:0,w:0,h:0};return u.jsxs("div",{className:`canvas-wrap blueprint-grid ${H?"is-drop-hover":""}`,onDragOver:Q,onDragLeave:ln,onDrop:cn,children:[u.jsxs("svg",{ref:n,className:"canvas-svg",onPointerDown:en,onPointerMove:pn,onPointerUp:X,children:[u.jsx("style",{children:aC}),u.jsx("defs",{children:u.jsx("pattern",{id:"dots",width:"20",height:"20",patternUnits:"userSpaceOnUse",children:u.jsx("circle",{cx:"1",cy:"1",r:"0.6",fill:"rgba(44, 95, 124, 0.20)"})})}),u.jsx("rect",{"data-bg":!0,x:"-100000",y:"-100000",width:"200000",height:"200000",fill:"transparent"}),u.jsxs("g",{"data-cv-world":!0,transform:`translate(${I.x} ${I.y}) scale(${I.k})`,children:[o.map($=>u.jsx(Ek,{image:$,selected:y.kind==="image"&&y.id===$.id||l.includes($.id),onPointerDown:U,onResizeDown:T},$.id)),wn.map($=>u.jsx(Ck,{dec:$,selected:y.kind==="decoration"&&y.id===$.id||l.includes($.id),onPointerDown:w,onArrowEndpointDown:N,onResizeDown:z},$.id)),Nn.map(({edge:$,offset:tn})=>{const J=r.find(rn=>rn.id===$.from),b=r.find(rn=>rn.id===$.to);return!J||!b?null:u.jsx(wk,{edge:$,from:J,to:b,rough:x.edgeStyle==="rough",selected:y.kind==="edge"&&y.id===$.id,offset:tn,onSelect:rn=>S({kind:"edge",id:rn})},$.id)}),P.kind==="edge"&&P.edgeFrom&&P.cursorWorld&&u.jsx(cC,{fromId:P.edgeFrom,cursor:P.cursorWorld}),r.map($=>u.jsx(xk,{node:$,rough:x.edgeStyle==="rough",selected:y.kind==="node"&&y.id===$.id||l.includes($.id),onPointerDownNode:R,onHandlePointerDown:j,onResizePointerDown:A},$.id)),P.kind==="box-select"&&P.boxRect&&u.jsx("rect",{x:P.boxRect.x0,y:P.boxRect.y0,width:P.boxRect.x1-P.boxRect.x0,height:P.boxRect.y1-P.boxRect.y0,fill:"rgba(207, 85, 71, 0.10)",stroke:"var(--brick)",strokeWidth:"1.4",strokeDasharray:"6 4",pointerEvents:"none"})]})]}),r.length===0&&o.length===0&&t.length===0&&u.jsx("div",{className:"canvas-empty",children:u.jsxs("div",{className:"canvas-empty-card",children:[u.jsx("h2",{className:"hand",children:"캔버스가 비어 있습니다"}),u.jsxs("p",{children:["왼쪽 포스트잇을 끌어 와서 노드로 만들거나,",u.jsx("br",{}),"아래에서 노드 타입을 선택해 추가하세요."]}),u.jsxs("div",{className:"canvas-empty-actions",children:[u.jsx("button",{onClick:()=>dn("room"),children:"+ 방"}),u.jsx("button",{onClick:()=>dn("vista"),children:"+ 전망"}),u.jsx("button",{onClick:()=>dn("boss"),children:"+ 보스"})]})]})}),u.jsxs("div",{className:"canvas-toolbar",children:[u.jsxs("div",{className:"ct-group",role:"group","aria-label":"노드 추가",children:[u.jsx("button",{onClick:()=>dn("room"),title:"방 추가",children:"방"}),u.jsx("button",{onClick:()=>dn("vista"),title:"전망",children:"전망"}),u.jsx("button",{onClick:()=>dn("treasure"),title:"보물",children:"보물"}),u.jsx("button",{onClick:()=>dn("boss"),title:"보스",children:"보스"}),u.jsx("button",{onClick:()=>dn("hub"),title:"허브",children:"허브"}),u.jsx("button",{onClick:()=>dn("save"),title:"세이브",children:"세이브"})]}),u.jsx("span",{className:"ct-sep"}),u.jsxs("div",{className:"ct-group",role:"group","aria-label":"데코 추가",children:[u.jsx("button",{onClick:()=>un("arrow"),title:"화살표",children:"↗ 화살표"}),u.jsx("button",{onClick:()=>un("ellipse"),title:"회색 타원",children:"○ 타원"}),u.jsx("button",{onClick:()=>un("text"),title:"텍스트",children:"A 텍스트"})]}),u.jsx("span",{className:"ct-sep"}),u.jsx("button",{onClick:Fn,title:"화면 맞춤",children:"⇲ 맞춤"}),u.jsx("button",{onClick:()=>K(1.25),title:"확대",children:"＋"}),u.jsx("button",{onClick:()=>K(.8),title:"축소",children:"−"}),u.jsxs("span",{className:"ct-zoom caption",children:[Math.round(I.k*100),"%"]})]}),x.showMinimap&&r.length>0&&u.jsx("div",{className:"canvas-minimap",children:u.jsx(bk,{nodes:r,edges:e,viewBox:Pn})}),H&&u.jsx("div",{className:"canvas-drop-banner hand",children:"여기에 놓기 — 포스트잇은 노드로, 이미지는 캔버스에 배치"})]})}function cC({fromId:n,cursor:r}){const e=B(t=>t.project.nodes.find(o=>o.id===n));return e?u.jsx("line",{x1:e.x,y1:e.y,x2:r.x,y2:r.y,stroke:"var(--brick)",strokeWidth:"1.6",strokeDasharray:"4 3",opacity:"0.8",pointerEvents:"none"}):null}function uC(n){return{room:"새 방",vista:"전망 지점",treasure:"보물 챔버",boss:"보스 챔버",hub:"허브 광장",save:"세이브 포인트"}[n]}const dC=["room","vista","treasure","boss","hub","save"],hC=["open","locked","oneway","ability","vista"],fC={room:"일반 방. 전투·통과·환경 인터랙션.",vista:"풍경/예고 공간. 플레이어에게 목표나 비밀을 보여줌.",treasure:"보상/획득 공간. 보물, 능력, 정보.",boss:"거대 인카운터. 일반적으로 페이싱의 클라이맥스.",hub:"여러 경로가 모이는 허브.",save:"체크포인트, 회복, 휴식."},pC={open:"열린 통로. 양방향 자유 통행.",locked:"잠금문. 키를 획득해야 통과.",oneway:"일방통행. 반대로 돌아갈 수 없음.",ability:"능력 게이트. 특정 능력 보유 시만 통과.",vista:"전망. 다른 공간이 시각적으로 보이지만 이동 불가."};function mC({onClose:n}){return u.jsxs("aside",{className:"legend",role:"dialog","aria-label":"범례",children:[u.jsxs("header",{className:"lg-head",children:[u.jsx("h3",{className:"hand",children:"표기 규약"}),u.jsx("button",{onClick:n,className:"lg-x","aria-label":"닫기",children:"×"})]}),u.jsx("p",{className:"lg-intro caption",children:"3D 게임 레벨 디자인 노드·간선 표기 규약"}),u.jsx("h4",{children:"노드"}),u.jsx("ul",{className:"lg-list",children:dC.map(r=>{const e=Fe[r];return u.jsxs("li",{children:[u.jsxs("svg",{width:"48",height:"32",viewBox:"-32 -22 64 44",children:[u.jsx("ellipse",{cx:"0",cy:"0",rx:"24",ry:"16",fill:e.fill,stroke:e.stroke,strokeWidth:e.strokeWidth}),u.jsx("text",{x:"0",y:"3",textAnchor:"middle",fontSize:"11",fill:"var(--ink-900)",children:e.icon})]}),u.jsxs("div",{children:[u.jsx("strong",{children:e.label}),u.jsx("span",{children:fC[r]})]})]},r)})}),u.jsx("h4",{children:"간선"}),u.jsx("ul",{className:"lg-list",children:hC.map(r=>{const e=Yi[r];return u.jsxs("li",{children:[u.jsxs("svg",{width:"48",height:"32",viewBox:"0 0 48 32",children:[u.jsx("path",{d:"M 4 16 Q 24 4, 44 16",fill:"none",stroke:e.stroke,strokeWidth:e.width,strokeDasharray:e.dash,strokeLinecap:"round"}),(r==="oneway"||r==="ability"||r==="locked")&&u.jsx("polygon",{points:"38,12 44,16 38,20",fill:e.stroke})]}),u.jsxs("div",{children:[u.jsx("strong",{children:e.label}),u.jsx("span",{children:pC[r]})]})]},r)})})]})}function gC(){const n=B(d=>d.project.view),r=B(d=>d.setView),e=B(d=>{var h;return((h=d.project.theme)==null?void 0:h.hueShift)??0}),t=B(d=>{var h;return((h=d.project.theme)==null?void 0:h.satScale)??1}),o=B(d=>d.setHueShift),i=B(d=>d.setSatScale),s=B(d=>d.resetTheme),a=e!==0||t!==1,[l,c]=M.useState(!1);return u.jsxs("main",{className:"canvas-shell",children:[u.jsxs("div",{className:"cs-topbar",children:[u.jsxs("div",{className:"cs-view-toggles",children:[u.jsx(ac,{label:"펜떨림",value:n.edgeStyle==="rough",onChange:d=>r({edgeStyle:d?"rough":"clean"}),hint:"손그림 느낌의 거친 곡선"}),u.jsx(ac,{label:"그리드",value:n.showGrid,onChange:d=>r({showGrid:d})}),u.jsx(ac,{label:"미니맵",value:n.showMinimap,onChange:d=>r({showMinimap:d})})]}),u.jsxs("div",{className:"cs-right",children:[u.jsxs("div",{className:"cs-theme",title:"학생별 고유 팔레트 — HUE는 색조, SAT는 채도",children:[u.jsxs("div",{className:"cs-theme-row",children:[u.jsx("span",{className:"cs-theme-label",children:"HUE"}),u.jsx("input",{className:"cs-theme-slider cs-theme-slider--hue",type:"range",min:-180,max:180,step:1,value:e,onChange:d=>o(parseInt(d.target.value,10)),style:{background:`linear-gradient(to right,
                    hsl(0,70%,55%) 0%,
                    hsl(60,70%,55%) 16.66%,
                    hsl(120,70%,55%) 33.33%,
                    hsl(180,70%,55%) 50%,
                    ...
                    hsl(15,0%,55%) 0%,
                    hsl(15,50%,55%) 50%,
                    hsl(15,100%,55%) 100%)`}}),u.jsxs("span",{className:"cs-theme-value",children:[t.toFixed(2),"×"]})]}),u.jsx("button",{type:"button",className:"cs-theme-reset",onClick:s,disabled:!a,title:"기본 팔레트로 복원",children:"기본"})]}),u.jsxs("button",{className:`cs-legend-btn ${l?"is-on":""}`,onClick:()=>c(!l),children:["범례 ",l?"▾":"▸"]})]})]}),u.jsx("div",{className:`cs-canvas-area ${n.showGrid?"":"no-grid"}`,children:u.jsx(lC,{})}),l&&u.jsx(mC,{onClose:()=>c(!1)})]})}function ac({label:n,value:r,onChange:e,hint:t}){return u.jsxs("label",{className:`cs-toggle ${r?"is-on":""}`,title:t,children:[u.jsx("input",{type:"checkbox",checked:r,onChange:o=>e(o.target.checked)}),u.jsx("span",{className:"cs-toggle-knob","aria-hidden":!0}),u.jsx("span",{className:"cs-toggle-label",children:n})]})}const ip=50,sp=1500;function yC(){const n=B(t=>t.project.ai);if(n.provider!=="gemini")return u.jsxs("div",{className:"usage",children:[u.jsx("span",{className:"caption",children:"AI"}),u.jsx("span",{className:"usage-off",children:"오프라인 모드"})]});const r=Math.min(100,n.usage.proUsedToday/ip*100),e=Math.min(100,n.usage.flashUsedToday/sp*100);return u.jsxs("div",{className:"usage",children:[u.jsx("span",{className:"caption",children:"오늘 사용량"}),u.jsxs("div",{className:"usage-row",children:[u.jsx("span",{className:"usage-label",children:"Pro"}),u.jsx("div",{className:"usage-bar",children:u.jsx("div",{className:"usage-fill usage-fill--pro",style:{width:`${r}%`}})}),u.jsxs("span",{className:"usage-num",children:[n.usage.proUsedToday,"/",ip]})]}),u.jsxs("div",{className:"usage-row",children:[u.jsx("span",{className:"usage-label",children:"Flash"}),u.jsx("div",{className:"usage-bar",children:u.jsx("div",{className:"usage-fill usage-fill--flash",style:{width:`${e}%`}})}),u.jsxs("span",{className:"usage-num",children:[n.usage.flashUsedToday,"/",sp]})]})]})}const xC=["gemini-2.5-pro","gemini-2.5-flash","gemini-2.5-flash-lite","gemini-2.0-flash"],vC=["gemini-2.5-flash","gemini-2.5-flash-lite","gemini-2.0-flash","gemini-2.5-pro"],wC="https://generativelanguage.googleapis.com/v1beta/models";class ty extends Error{constructor(r){super(`Quota exceeded for ${r}`),this.model=r}}class zt extends Error{constructor(r,e){super(`Transient ${e} on ${r}`),this.model=r,this.status=e}}class Bi extends Error{constructor(){super("Gemini API key가 설정되지 않았습니다.")}}async function SC(n,r,e){var l,c,d,h;const t=`${wC}/${n}:generateContent?key=${encodeURIComponent(r)}`,o={systemInstruction:{parts:[{text:e.system}]},contents:[{role:"user",parts:[{text:e.user}]}],generationConfig:{maxOutputTokens:e.maxTokens??1024,temperature:.8}};e.responseSchema&&(o.generationConfig.responseMimeType="application/json",o.generationConfig.responseSchema=e.responseSchema,o.generationConfig.temperature=.4);const i=await fetch(t,{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify(o),signal:e.signal});if(!i.ok){if(i.status===429)throw new ty(n);if(i.status===503||i.status===502||i.status===504)throw new zt(n,i.status);const f=await i.text();throw new Error(`Gemini ${n} ${i.status}: ${f.slice(0,200)}`)}const s=await i.json(),a=((h=(d=(c=(l=s==null?void 0:s.candidates)==null?void 0:l[0])==null?void 0:c.content)==null?void 0:d.parts)==null?void 0:h.map(f=>f.text??"").join(""))??"";if(!a)throw new Error("Gemini 응답이 비어 있습니다.");return a}async function kC(n,r,e,t=2){let o;for(let i=0;i<=t;i++)try{return await SC(n,r,e)}catch(s){if(o=s,s instanceof zt&&i<t){const a=500*Math.pow(2,i);await new Promise(l=>setTimeout(l,a));continue}throw s}throw o??new Error("재시도 실패")}async function wo(n){const r=B.getState(),e=r.project.ai.apiKey;if(!e)throw new Bi;const t=n.preferModel==="gemini-2.5-flash"?vC:xC;let o;for(let i=0;i<t.length;i++){const s=t[i];try{const a=await kC(s,e,n);return r.bumpUsage(s==="gemini-2.5-pro"?"pro":"flash"),{text:a,modelUsed:s,fallback:i>0}}catch(a){if(o=a,a instanceof ty||a instanceof zt)continue;throw a}}throw o??new Error("알 수 없는 오류")}function ap(n){if(!n)return null;let r=n.replace(/```(?:json|JSON)?\s*/g,"").replace(/\s*```/g,"").trim();try{return JSON.parse(r)}catch{}const e=r.indexOf("{"),t=r.indexOf("["),o=e<0?t:t<0?e:Math.min(e,t);if(o<0)return null;const s=r[o]==="{"?"}":"]",a=r.lastIndexOf(s);if(a<=o)return null;const l=r.slice(o,a+1);try{return JSON.parse(l)}catch{}const c=l.replace(/,\s*([}\]])/g,"$1");try{return JSON.parse(c)}catch{return null}}const ul=`
...
`;function PC(n){return`다음 시드로 컨셉을 생성해 주세요:

"${n}"`}function TC(n){return`다음 컨셉의 포스트잇 시드:
${JSON.stringify(n.concept,null,2)}`}function IC(n){return JSON.stringify({concept:n.concept,nodes:n.nodes.map(r=>({id:r.id,name:r.name,type:r.type,icons:r.icons,notes:r.notes})),edges:n.edges.map(r=>({from:r.from,to:r.to,type:r.type,key:r.keyId,ability:r.abilityId}))},null,2)}function EC(n,r){return`다이어그램 요약:
${IC(n)}
...
파라미터: ${e}`}function MC(){const n=B(g=>g.project.ai),r=B(g=>g.setApiKey),e=B(g=>g.setConcept),t=B(g=>g.project),o=B(g=>g.addPostit),i=B(g=>g.updatePostit),[s,a]=M.useState(""),[l,c]=M.useState(null),[d,h]=M.useState(null),[f,m]=M.useState(""),x=!!n.apiKey,y=async()=>{if(!s.trim()){h("시드를 입력해 주세요.");return}c("concept"),h(null);try{const g=await wo({system:_C,user:PC(s.trim()),responseSchema:{type:"object",properties:{theme:{type:"string"},intent:{type:"string"},coreMechanic:{type:"string"},learningGoals:{type:"array",items:{type:"string"}},pacing:{type:"string"},fantasyHook:{type:"string"}},required:["theme","intent","coreMechanic","learningGoals","pacing"]},maxTokens:1200}),p=ap(g.text);p?(e(p),h(`컨셉 생성 완료 (${g.modelUsed}${g.fallback?" · 폴백":""})`)):h("응답을 JSON으로 해석하지 못함")}catch(g){h(g instanceof Bi?"키를 먼저 등록하세요.":g instanceof zt?"Gemini 모델이 일시적으로 혼잡합니다. 잠시 후 다시 시도해 주세요.":`실패: ${g.message??g}`)}finally{c(null)}},E=async()=>{c("seed"),h(null);try{const g=await wo({system:bC,user:TC(t),responseSchema:{type:"object",properties:{postits:{type:"array",items:{type:"object",properties:{text:{type:"string"},type:{type:"string"},color:{type:"string"},tags:{type:"array",items:{type:"string"}}},required:["text"]}}},required:["postits"]},maxTokens:1500}),p=ap(g.text);let v=[];if(Array.isArray(p)?v=p:p&&typeof p=="object"&&(v=p.postits??p.items??p.cards??[]),v=v.filter(S=>S&&typeof S.text=="string"&&S.text.trim()),v.length===0){h("AI 응답에서 포스트잇을 추출하지 못함 — 컨셉을 조금 더 채운 뒤 다시 시도");return}v.forEach(S=>{var O;const C=o(S.text,S.color??"yellow");(O=S.tags)!=null&&O.length&&i(C,{tags:S.tags})}),h(`포스트잇 ${v.length}장 추가 (${g.modelUsed}${g.fallback?" · 폴백":""})`)}catch(g){h(g instanceof Bi?"키를 먼저 등록하세요.":g instanceof zt?"Gemini 모델이 일시적으로 혼잡합니다. 잠시 후 다시 시도해 주세요.":`실패: ${g.message??g}`)}finally{c(null)}};return u.jsxs("div",{className:"ai-panel",children:[!x&&u.jsxs("div",{className:"ai-key-prompt",children:[u.jsx("p",{className:"caption",children:"AI 키 미등록 — 오프라인 모드"}),u.jsx("p",{className:"ai-hint",children:"아래에 Gemini API 키를 붙여넣으면 AI 기능이 활성화됩니다."}),u.jsxs("div",{className:"ai-key-row",children:[u.jsx("input",{type:"password",placeholder:"AIzaSy…",value:f,onChange:g=>m(g.target.value),className:"ai-key-input"}),u.jsx("button",{onClick:()=>{f.trim()&&r(f.trim())},disabled:!f.trim(),className:"ai-key-btn",children:"등록"})]}),u.jsx("a",{href:"https://aistudio.google.com/app/apikey",target:"_blank",rel:"noreferrer",className:"ai-key-link caption",children:"키 발급 → aistudio.google.com/app/apikey"})]}),x&&u.jsxs("div",{className:"ai-key-prompt is-on",children:[u.jsx("p",{className:"caption",children:"AI 활성화됨 · Gemini"}),u.jsx("button",{onClick:()=>{r(void 0)},className:"ai-key-remove",children:"키 제거"})]}),u.jsxs("section",{className:"ai-section",children:[u.jsx("h4",{children:"① 컨셉 생성"}),u.jsx("p",{className:"ai-section-hint",children:"시드 한 줄을 던지면 AI가 테마·의도·메커닉·학습목표·페이싱을 구조화해 채웁니다."}),u.jsx("textarea",{rows:3,value:s,onChange:g=>a(g.target.value),placeholder:"예: 3D 액션 어드벤처, 침수된 우주 정거장, 중력 조절 능력 획득",className:"ai-textarea"}),u.jsx("button",{onClick:y,disabled:l!==null,className:"ai-action",children:l==="concept"?"생성 중…":"컨셉 생성 (Pro)"})]}),u.jsxs("section",{className:"ai-section",children:[u.jsx("h4",{children:"② 포스트잇 시드"}),u.jsx("p",{className:"ai-section-hint",children:"컨셉으로부터 8~12장의 포스트잇 후보를 만들어 패드에 추가합니다."}),u.jsx("button",{onClick:E,disabled:l!==null||!t.concept.theme,className:"ai-action",children:l==="seed"?"생성 중…":"시드 추가 (Pro)"})]}),d&&u.jsx("p",{className:"ai-note",children:d})]})}function NC(n,r){if(n.match(/^[a-z]+:\/\//i))return n;if(n.match(/^\/\//))return window.location.protocol+n;if(n.match(/^[a-z]+:/i))return n;const e=document.implementation.createHTMLDocument(),t=e.createElement("base"),o=e.createElement("a");return e.head.appendChild(t),e.body.appendChild(o),r&&(t.href=r),o.href=n,o.href}const jC=(()=>{let n=0;const r=()=>`0000${(Math.random()*36**4<<0).toString(36)}`.slice(-4);return()=>(n+=1,`u${r()}${n}`)})();function ft(n){const r=[];for(let e=0,t=n.length;e<t;e++)r.push(n[e]);return r}let Xt=null;function oy(n={}){return Xt||(n.includeStyleProperties?(Xt=n.includeStyleProperties,Xt):(Xt=ft(window.getComputedStyle(document.documentElement)),Xt))}function Da(n,r){const t=(n.ownerDocument.defaultView||window).getComputedStyle(n).getPropertyValue(r);return t?parseFloat(t.replace("px","")):0}function AC(n){const r=Da(n,"border-left-width"),e=Da(n,"border-right-width");return n.clientWidth+r+e}function OC(n){const r=Da(n,"border-top-width"),e=Da(n,"border-bottom-width");return n.clientHeight+r+e}function iy(n,r={}){const e=r.width||AC(n),t=r.height||OC(n);return{width:e,height:t}}function RC(){let n,r;try{r=process}catch{}const e=r&&r.env?r.env.devicePixelRatio:null;return e&&(n=parseInt(e,10),Number.isNaN(n)&&(n=1)),n||window.devicePixelRatio||1}const zr=16384;function LC(n){(n.width>zr||n.height>zr)&&(n.width>zr&&n.height>zr?n.width>n.height?(n.height*=zr/n.width,n.width=zr):(n.width*=zr/n.height,n.height=zr):n.width>zr?(n.height*=zr/n.width,n.width=zr):(n.width*=zr/n.height,n.height=zr))}function Za(n){return new Promise((r,e)=>{const t=new Image;t.onload=()=>{t.decode().then(()=>{requestAnimationFrame(()=>r(t))})},t.onerror=e,t.crossOrigin="anonymous",t.decoding="async",t.src=n})}async function DC(n){return Promise.resolve().then(()=>new XMLSerializer().serializeToString(n)).then(encodeURIComponent).then(r=>`data:image/svg+xml;charset=utf-8,${r}`)}async function ZC(n,r,e){const t="http://www.w3.org/2000/svg",o=document.createElementNS(t,"svg"),i=document.createElementNS(t,"foreignObject");return o.setAttribute("width",`${r}`),o.setAttribute("height",`${e}`),o.setAttribute("viewBox",`0 0 ${r} ${e}`),i.setAttribute("width","100%"),i.setAttribute("height","100%"),i.setAttribute("x","0"),i.setAttribute("y","0"),i.setAttribute("externalResourcesRequired","true"),o.appendChild(i),i.appendChild(n),DC(o)}const $r=(n,r)=>{if(n instanceof r)return!0;const e=Object.getPrototypeOf(n);return e===null?!1:e.constructor.name===r.name||$r(e,r)};function FC(n){const r=n.getPropertyValue("content");return`${n.cssText} content: '${r.replace(/'|"/g,"")}';`}function $C(n,r){return oy(r).map(e=>{const t=n.getPropertyValue(e),o=n.getPropertyPriority(e);return`${e}: ${t}${o?" !important":""};`}).join(" ")}function zC(n,r,e,t){const o=`.${n}:${r}`,i=e.cssText?FC(e):$C(e,t);return document.createTextNode(`${o}{${i}}`)}function up(n,r,e,t){const o=window.getComputedStyle(n,e),i=o.getPropertyValue("content");if(i===""||i==="none")return;const s=jC();try{r.className=`${r.className} ${s}`}catch{return}const a=document.createElement("style");a.appendChild(zC(s,e,o,t)),r.appendChild(a)}function BC(n,r,e){up(n,r,":before",e),up(n,r,":after",e)}const dp="application/font-woff",hp="image/jpeg",HC={woff:dp,woff2:dp,ttf:"application/font-truetype",eot:"application/vnd.ms-fontobject",png:"image/png",jpg:hp,jpeg:hp,gif:"image/gif",tiff:"image/tiff",svg:"image/svg+xml",webp:"image/webp"};function WC(n){const r=/\.([^./]*?)$/g.exec(n);return r?r[1]:""}function Rd(n){const r=WC(n).toLowerCase();return HC[r]||""}function GC(n){return n.split(/,/)[1]}function Iu(n){return n.search(/^(data:)/)!==-1}function VC(n,r){return`data:${r};base64,${n}`}async function sy(n,r,e){const t=await fetch(n,r);if(t.status===404)throw new Error(`Resource "${t.url}" not found`);const o=await t.blob();return new Promise((i,s)=>{const a=new FileReader;a.onerror=s,a.onloadend=()=>{try{i(e({res:t,result:a.result}))}catch(l){s(l)}},a.readAsDataURL(o)})}const lc={};function UC(n,r,e){let t=n.replace(/\?.*/,"");return e&&(t=n),/ttf|otf|eot|woff2?/i.test(t)&&(t=t.replace(/.*\//,"")),r?`[${r}]${t}`:t}async function Ld(n,r,e){const t=UC(n,r,e.includeQueryParams);if(lc[t]!=null)return lc[t];e.cacheBust&&(n+=(/\?/.test(n)?"&":"?")+new Date().getTime());let o;try{const i=await sy(n,e.fetchRequestInit,({res:s,result:a})=>(r||(r=s.headers.get("Content-Type")||""),GC(a)));o=VC(i,r)}catch(i){o=e.imagePlaceholder||"";let s=`Failed to fetch resource: ${n}`;i&&(s=typeof i=="string"?i:i.message),s&&console.warn(s)}return lc[t]=o,o}async function KC(n){const r=n.toDataURL();return r==="data:,"?n.cloneNode(!1):Za(r)}async function XC(n,r){if(n.currentSrc){const i=document.createElement("canvas"),s=i.getContext("2d");i.width=n.clientWidth,i.height=n.clientHeight,s==null||s.drawImage(n,0,0,i.width,i.height);const a=i.toDataURL();return Za(a)}const e=n.poster,t=Rd(e),o=await Ld(e,t,r);return Za(o)}async function YC(n,r){var e;try{if(!((e=n==null?void 0:n.contentDocument)===null||e===void 0)&&e.body)return await dl(n.contentDocument.body,r,!0)}catch{}return n.cloneNode(!1)}async function QC(n,r){return $r(n,HTMLCanvasElement)?KC(n):$r(n,HTMLVideoElement)?XC(n,r):$r(n,HTMLIFrameElement)?YC(n,r):n.cloneNode(ay(n))}const JC=n=>n.tagName!=null&&n.tagName.toUpperCase()==="SLOT",ay=n=>n.tagName!=null&&n.tagName.toUpperCase()==="SVG";async function qC(n,r,e){var t,o;if(ay(r))return r;let i=[];return JC(n)&&n.assignedNodes?i=ft(n.assignedNodes()):$r(n,HTMLIFrameElement)&&(!((t=n.contentDocument)===null||t===void 0)&&t.body)?i=ft(n.contentDocument.body.childNodes):i=ft(((o=n.shadowRoot)!==null&&o!==void 0?o:n).childNodes),i.length===0||$r(n,HTMLVideoElement)||await i.reduce((s,a)=>s.then(()=>dl(a,e)).then(l=>{l&&r.appendChild(l)}),Promise.resolve()),r}function nP(n,r,e){const t=r.style;if(!t)return;const o=window.getComputedStyle(n);o.cssText?(t.cssText=o.cssText,t.transformOrigin=o.transformOrigin):oy(e).forEach(i=>{let s=o.getPropertyValue(i);i==="font-size"&&s.endsWith("px")&&(s=`${Math.floor(parseFloat(s.substring(0,s.length-2)))-.1}px`),$r(n,HTMLIFrameElement)&&i==="display"&&s==="inline"&&(s="block"),i==="d"&&r.getAttribute("d")&&(s=`path(${r.getAttribute("d")})`),t.setProperty(i,s,o.getPropertyPriority(i))})}function rP(n,r){$r(n,HTMLTextAreaElement)&&(r.innerHTML=n.value),$r(n,HTMLInputElement)&&r.setAttribute("value",n.value)}function eP(n,r){if($r(n,HTMLSelectElement)){const e=r,t=Array.from(e.children).find(o=>n.value===o.getAttribute("value"));t&&t.setAttribute("selected","")}}function tP(n,r,e){return $r(r,Element)&&(nP(n,r,e),BC(n,r,e),rP(n,r),eP(n,r)),r}async function oP(n,r){const e=n.querySelectorAll?n.querySelectorAll("use"):[];if(e.length===0)return n;const t={};for(let i=0;i<e.length;i++){const a=e[i].getAttribute("xlink:href");if(a){const l=n.querySelector(a),c=document.querySelector(a);!l&&c&&!t[a]&&(t[a]=await dl(c,r,!0))}}const o=Object.values(t);if(o.length){const i="http://www.w3.org/1999/xhtml",s=document.createElementNS(i,"svg");s.setAttribute("xmlns",i),s.style.position="absolute",s.style.width="0",s.style.height="0",s.style.overflow="hidden",s.style.display="none";const a=document.createElementNS(i,"defs");s.appendChild(a);for(let l=0;l<o.length;l++)a.appendChild(o[l]);n.appendChild(s)}return n}async function dl(n,r,e){return!e&&r.filter&&!r.filter(n)?null:Promise.resolve(n).then(t=>QC(t,r)).then(t=>qC(n,t,r)).then(t=>tP(n,t,r)).then(t=>oP(t,r))}const ly=/url\((['"]?)([^'"]+?)\1\)/g,iP=/url\([^)]+\)\s*format\((["']?)([^"']+)\1\)/g,sP=/src:\s*(?:url\([^)]+\)\s*format\([^)]+\)[,;]\s*)+/g;function aP(n){const r=n.replace(/([.*+?^${}()|\[\]\/\\])/g,"\\$1");return new RegExp(`(url\\(['"]?)(${r})(['"]?\\))`,"g")}function lP(n){const r=[];return n.replace(ly,(e,t,o)=>(r.push(o),e)),r.filter(e=>!Iu(e))}async function cP(n,r,e,t,o){try{const i=e?NC(r,e):r,s=Rd(r);let a;return o||(a=await Ld(i,s,t)),n.replace(aP(r),`$1${a}$3`)}catch{}return n}function uP(n,{preferredFontFormat:r}){return r?n.replace(sP,e=>{for(;;){const[t,,o]=iP.exec(e)||[];if(!o)return"";if(o===r)return`src: ${t};`}}):n}function cy(n){return n.search(ly)!==-1}async function uy(n,r,e){if(!cy(n))return n;const t=uP(n,e);return lP(t).reduce((i,s)=>i.then(a=>cP(a,s,r,e)),Promise.resolve(t))}async function Yt(n,r,e){var t;const o=(t=r.style)===null||t===void 0?void 0:t.getPropertyValue(n);if(o){const i=await uy(o,null,e);return r.style.setProperty(n,i,r.style.getPropertyPriority(n)),!0}return!1}async function dP(n,r){await Yt("background",n,r)||await Yt("background-image",n,r),await Yt("mask",n,r)||await Yt("-webkit-mask",n,r)||await Yt("mask-image",n,r)||await Yt("-webkit-mask-image",n,r)}async function hP(n,r){const e=$r(n,HTMLImageElement);if(!(e&&!Iu(n.src))&&!($r(n,SVGImageElement)&&!Iu(n.href.baseVal)))return;const t=e?n.src:n.href.baseVal,o=await Ld(t,Rd(t),r);await new Promise((i,s)=>{n.onload=i,n.onerror=r.onImageErrorHandler?(...l)=>{try{i(r.onImageErrorHandler(...l))}catch(c){s(c)}}:s;const a=n;a.decode&&(a.decode=i),a.loading==="lazy"&&(a.loading="eager"),e?(n.srcset="",n.src=o):n.href.baseVal=o})}async function fP(n,r){const t=ft(n.childNodes).map(o=>dy(o,r));await Promise.all(t).then(()=>n)}async function dy(n,r){$r(n,Element)&&(await dP(n,r),await hP(n,r),await fP(n,r))}function pP(n,r){const{style:e}=n;r.backgroundColor&&(e.backgroundColor=r.backgroundColor),r.width&&(e.width=`${r.width}px`),r.height&&(e.height=`${r.height}px`);const t=r.style;return t!=null&&Object.keys(t).forEach(o=>{e[o]=t[o]}),n}const fp={};async function pp(n){let r=fp[n];if(r!=null)return r;const t=await(await fetch(n)).text();return r={url:n,cssText:t},fp[n]=r,r}async function mp(n,r){let e=n.cssText;const t=/url\(["']?([^"')]+)["']?\)/g,i=(e.match(/url\([^)]+\)/g)||[]).map(async s=>{let a=s.replace(t,"$1");return a.startsWith("https://")||(a=new URL(a,n.url).href),sy(a,r.fetchRequestInit,({result:l})=>(e=e.replace(s,`url(${l})`),[s,l]))});return Promise.all(i).then(()=>e)}function gp(n){if(n==null)return[];const r=[],e=/(\/\*[\s\S]*?\*\/)/gi;let t=n.replace(e,"");const o=new RegExp("((@.*?keyframes [\\s\\S]*?){([\\s\\S]*?}\\s*?)})","gi");for(;;){const l=o.exec(t);if(l===null)break;r.push(l[0])}t=t.replace(o,"");const i=/@import[\s\S]*?url\([^)]*\)[\s\S]*?;/gi,s="((\\s*?(?:\\/\\*[\\s\\S]*?\\*\\/)?\\s*?@media[\\s\\S]*?){([\\s\\S]*?)}\\s*?})|(([\\s\\S]*?){([\\s\\S]*?)})",a=new RegExp(s,"gi");for(;;){let l=i.exec(t);if(l===null){if(l=a.exec(t),l===null)break;i.lastIndex=a.lastIndex}else a.lastIndex=i.lastIndex;r.push(l[0])}return r}async function mP(n,r){const e=[],t=[];return n.forEach(o=>{if("cssRules"in o)try{ft(o.cssRules||[]).forEach((i,s)=>{if(i.type===CSSRule.IMPORT_RULE){let a=s+1;const l=i.href,c=pp(l).then(d=>mp(d,r)).then(d=>gp(d).forEach(h=>{try{o.insertRule(h,h.startsWith("@import")?a+=1:o.cssRules.length)}catch(f){console.error("Error inserting rule from remote css",{rule:h,error:f})}})).catch(d=>{console.error("Error loading remote css",d.toString())});t.push(c)}})}catch(i){const s=n.find(a=>a.href==null)||document.styleSheets[0];o.href!=null&&t.push(pp(o.href).then(a=>mp(a,r)).then(a=>gp(a).forEach(l=>{s.insertRule(l,s.cssRules.length)})).catch(a=>{console.error("Error loading remote stylesheet",a)})),console.error("Error inlining remote css file",i)}}),Promise.all(t).then(()=>(n.forEach(o=>{if("cssRules"in o)try{ft(o.cssRules||[]).forEach(i=>{e.push(i)})}catch(i){console.error(`Error while reading CSS rules from ${o.href}`,i)}}),e))}function gP(n){return n.filter(r=>r.type===CSSRule.FONT_FACE_RULE).filter(r=>cy(r.style.getPropertyValue("src")))}async function yP(n,r){if(n.ownerDocument==null)throw new Error("Provided element is not within a Document");const e=ft(n.ownerDocument.styleSheets),t=await mP(e,r);return gP(t)}function hy(n){return n.trim().replace(/["']/g,"")}function xP(n){const r=new Set;function e(t){(t.style.fontFamily||getComputedStyle(t).fontFamily).split(",").forEach(i=>{r.add(hy(i))}),Array.from(t.children).forEach(i=>{i instanceof HTMLElement&&e(i)})}return e(n),r}async function vP(n,r){const e=await yP(n,r),t=xP(n);return(await Promise.all(e.filter(i=>t.has(hy(i.style.fontFamily))).map(i=>{const s=i.parentStyleSheet?i.parentStyleSheet.href:null;return uy(i.cssText,s,r)}))).join(`
`)}async function wP(n,r){const e=r.fontEmbedCSS!=null?r.fontEmbedCSS:r.skipFonts?null:await vP(n,r);if(e){const t=document.createElement("style"),o=document.createTextNode(e);t.appendChild(o),n.firstChild?n.insertBefore(t,n.firstChild):n.appendChild(t)}}async function SP(n,r={}){const{width:e,height:t}=iy(n,r),o=await dl(n,r,!0);return await wP(o,r),await dy(o,r),pP(o,r),await ZC(o,e,t)}async function kP(n,r={}){const{width:e,height:t}=iy(n,r),o=await SP(n,r),i=await Za(o),s=document.createElement("canvas"),a=s.getContext("2d"),l=r.pixelRatio||RC(),c=r.canvasWidth||e,d=r.canvasHeight||t;return s.width=c*l,s.height=d*l,r.skipAutoScale||LC(s),s.style.width=`${c}`,s.style.height=`${d}`,r.backgroundColor&&(a.fillStyle=r.backgroundColor,a.fillRect(0,0,s.width,s.height)),a.drawImage(i,0,0,s.width,s.height),s}async function Eu(n,r={}){return(await kP(n,r)).toDataURL()}function _P(n){var o,i,s;const r=[];r.push(`# ${n.name}`),r.push(""),r.push(`> 생성일: ${new Date(n.updatedAt).toLocaleString("ko-KR")}`),r.push(""),r.push("## 컨셉");const e=n.concept;if(e.theme&&r.push(`- **테마**: ${e.theme}`),e.intent&&r.push(`- **의도**: ${e.intent}`),e.coreMechanic&&r.push(`- **코어 메커닉**: ${e.coreMechanic}`),e.pacing&&r.push(`- **페이싱**: ${e.pacing}`),(o=e.learningGoals)!=null&&o.length&&(r.push("- **학습 목표**:"),e.learningGoals.forEach(a=>r.push(`  - ${a}`))),e.fantasyHook&&r.push(`- **판타지 후크**: ${e.fantasyHook}`),r.push(""),n.nodes.length>0){r.push("## 룸 명세"),r.push("");for(const a of n.nodes){const l=Fe[a.type];r.push(`### ${l.icon} ${a.name} — _${l.label}_`),r.push(""),a.icons.length>0&&r.push(`- 태그: ${a.icons.map(c=>`\`${c}\``).join(", ")}`),a.notes&&(r.push(""),r.push(a.notes)),a.mjPrompt&&(r.push(""),r.push("**Midjourney**:"),r.push("```"),r.push(a.mjPrompt),r.push("```")),r.push("")}}if(n.edges.length>0){r.push("## 동선"),r.push(""),r.push("| 출발 | → | 도착 | 타입 | 메타 |"),r.push("|:--|:--|:--|:--|:--|");for(const a of n.edges){const l=((i=n.nodes.find(f=>f.id===a.from))==null?void 0:i.name)??"?",c=((s=n.nodes.find(f=>f.id===a.to))==null?void 0:s.name)??"?",d=Yi[a.type],h=a.keyId?`🔑 ${a.keyId}`:a.abilityId?`✦ ${a.abilityId}`:a.label??"";r.push(`| ${l} | → | ${c} | ${d.label} | ${h} |`)}r.push("")}n.mjMasterPrompt&&(r.push("## 마스터 Midjourney 프롬프트"),r.push(""),r.push("```"),r.push(n.mjMasterPrompt),r.push("```"),r.push(""));const t=n.postits.filter(a=>!a.promoted);if(t.length>0){r.push("## 보류 메모"),r.push("");for(const a of t)r.push(`- ${a.text}${a.tags.length?` _(${a.tags.join(", ")})_`:""}`);r.push("")}return r.join(`
`)}function bP(){const n=B(S=>S.project),[r,e]=M.useState(!1),[t,o]=M.useState(null),[i,s]=M.useState(!0),[a,l]=M.useState(!0),[c,d]=M.useState(2048),h=async S=>{if(!a)return S();const C=document.documentElement,O=C.dataset.theme;if(O==="light")return S();C.dataset.theme="light",await new Promise(I=>requestAnimationFrame(()=>requestAnimationFrame(I)));try{return await S()}finally{O===void 0?delete C.dataset.theme:C.dataset.theme=O}},f=(S,C)=>{const O=URL.createObjectURL(S),I=document.createElement("a");I.href=O,I.download=C,I.click(),URL.revokeObjectURL(O)},m=async()=>{e(!0),o(null);try{await h(async()=>{const S=document.querySelector(".canvas-wrap");if(!S)throw new Error("캔버스를 찾을 수 없음");const C={pixelRatio:2,filter:Z=>{var F,K,P,Y;return!(Z instanceof HTMLElement&&((F=Z.classList)!=null&&F.contains("canvas-minimap")||(K=Z.classList)!=null&&K.contains("canvas-toolbar")||(P=Z.classList)!=null&&P.contains("canvas-drop-banner")||(Y=Z.classList)!=null&&Y.contains("canvas-empty")))}};i?(C.backgroundColor=void 0,C.style={background:"transparent",backgroundColor:"transparent",backgroundImage:"none"}):C.backgroundColor="#F4EFE6";const O=await Eu(S,C),I=document.createElement("a");I.href=O,I.download=`${n.name||"level"}${i?"_transparent":""}.png`,I.click()}),o(i?"PNG 저장 완료 (투명 배경)":"PNG 저장 완료")}catch(S){o(`PNG 실패: ${S.message??S}`)}finally{e(!1)}},x=()=>{let S=1/0,C=1/0,O=-1/0,I=-1/0,Z=!1;for(const F of n.nodes){const{rx:K,ry:P}=$e(F.type,F.size??1,F.aspect??1),Y=F.icons.length>0?Math.ceil(Math.min(F.icons.length,8)/4):0,H=Y*18+(Y>0?10:0);S=Math.min(S,F.x-K-12),C=Math.min(C,F.y-P-12),O=Math.max(O,F.x+K+12),I=Math.max(I,F.y+P+12+H),Z=!0}for(const F of n.decorations){if(F.kind==="arrow"){const K=F.x2??F.x+140,P=F.y2??F.y;S=Math.min(S,F.x-32,K-32),C=Math.min(C,F.y-32,P-32),O=Math.max(O,F.x+32,K+32),I=Math.max(I,F.y+32,P+32)}else{const K=(F.width??180)/2+8,P=(F.height??(F.kind==="text"?40:90))/2+8;S=Math.min(S,F.x-K),C=Math.min(C,F.y-P),O=Math.max(O,F.x+K),I=Math.max(I,F.y+P)}Z=!0}for(const F of n.images??[])S=Math.min(S,F.x-F.width/2-8),C=Math.min(C,F.y-F.height/2-8),O=Math.max(O,F.x+F.width/2+8),I=Math.max(I,F.y+F.height/2+8),Z=!0;return Z?{minX:S,minY:C,maxX:O,maxY:I}:null},y=async S=>{e(!0),o(null);try{const C=x();if(!C){o("내보낼 노드/데코가 없음");return}await h(async()=>{const O=document.querySelector(".canvas-svg");if(!O)throw new Error("SVG를 찾을 수 없음");const I=C.maxX-C.minX,Z=C.maxY-C.minY,F=Math.max(I,Z),K=F*.08,P=F+K*2,Y=(C.minX+C.maxX)/2,H=(C.minY+C.maxY)/2,k=Y-P/2,R=H-P/2,j=O.cloneNode(!0);j.setAttribute("xmlns","http://www.w3.org/2000/svg"),j.setAttribute("width",String(S)),j.setAttribute("height",String(S)),j.setAttribute("viewBox",`${k} ${R} ${P} ${P}`),j.setAttribute("preserveAspectRatio","xMidYMid meet");const A=j.querySelector("[data-cv-world]");A&&A.removeAttribute("transform"),j.querySelectorAll("[data-handle]").forEach(U=>U.remove()),j.querySelectorAll(".deco-handle").forEach(U=>U.remove()),j.querySelectorAll(".img-handle").forEach(U=>U.remove()),j.querySelectorAll(".bn-handle").forEach(U=>U.remove()),j.querySelectorAll("[data-bg]").forEach(U=>U.remove());const w=document.createElement("div");w.style.cssText=`position:fixed;left:-99999px;top:0;width:${S}px;height:${S}px;pointer-events:none;background:transparent;`,w.appendChild(j),document.body.appendChild(w);let N;try{N=await Eu(j,{width:S,height:S,canvasWidth:S,canvasHeight:S,pixelRatio:1,backgroundColor:i?void 0:"#F4EFE6",style:i?{background:"transparent",backgroundColor:"transparent",backgroundImage:"none"}:{background:"#F4EFE6"}})}finally{document.body.removeChild(w)}const z=document.createElement("a");z.href=N,z.download=`${n.name||"level"}_${S}${i?"_transparent":""}.png`,z.click()}),o(`PNG ${S}×${S} 저장 완료`)}catch(C){o(`PNG ${S} 실패: ${C.message??C}`)}finally{e(!1)}},E=async()=>{e(!0),o(null);try{const S=document.querySelector(".canvas-svg");if(!S)throw new Error("SVG를 찾을 수 없음");const C=S.cloneNode(!0);C.setAttribute("xmlns","http://www.w3.org/2000/svg");const I=new XMLSerializer().serializeToString(C),Z=new Blob([`<?xml version="1.0"?>
${I}`],{type:"image/svg+xml"});f(Z,`${n.name||"level"}.svg`),o("SVG 저장 완료")}catch(S){o(`SVG 실패: ${S.message??S}`)}finally{e(!1)}},g=()=>{const S=_P(n),C=new Blob([S],{type:"text/markdown"});f(C,`${n.name||"level"}.md`),o("Markdown 저장 완료")},p=()=>{il(n,`${n.name||"level"}.json`),o("JSON 저장 완료")},v={nodes:n.nodes.length,edges:n.edges.length,postits:n.postits.length};return u.jsxs("div",{className:"exp-panel",children:[u.jsxs("section",{className:"exp-stats",children:[u.jsxs("div",{children:[u.jsx("strong",{children:v.nodes}),u.jsx("span",{children:"노드"})]}),u.jsxs("div",{children:[u.jsx("strong",{children:v.edges}),u.jsx("span",{children:"간선"})]}),u.jsxs("div",{children:[u.jsx("strong",{children:v.postits}),u.jsx("span",{children:"포스트잇"})]})]}),u.jsxs("div",{className:"exp-buttons",children:[u.jsx("button",{onClick:m,disabled:r,className:"exp-btn exp-btn--primary",children:r?"저장 중…":`PNG 이미지${i?" (투명)":""}`}),u.jsxs("div",{className:"exp-square",children:[u.jsx("div",{className:"exp-square-label",children:"정사각 PNG (콘텐츠 자동 맞춤·8% 여백)"}),u.jsx("div",{className:"exp-seg",children:[512,1024,2048,4096].map(S=>u.jsx("button",{className:`exp-seg-btn ${c===S?"is-on":""}`,onClick:()=>d(S),disabled:r,type:"button",children:S},S))}),u.jsx("button",{onClick:()=>y(c),disabled:r,className:"exp-btn exp-btn--primary",children:r?"저장 중…":`PNG ${c}×${c}${i?" (투명)":""}`})]}),u.jsxs("label",{className:"exp-opt",children:[u.jsx("input",{type:"checkbox",checked:i,onChange:S=>s(S.target.checked)}),u.jsx("span",{children:"투명 배경 (언리얼/포토샵 임포트용)"})]}),u.jsxs("label",{className:"exp-opt",children:[u.jsx("input",{type:"checkbox",checked:a,onChange:S=>l(S.target.checked)}),u.jsx("span",{children:"라이트 테마로 강제 출력 (포트폴리오·인쇄용)"})]}),u.jsx("button",{onClick:E,disabled:r,className:"exp-btn",children:"SVG 벡터"}),u.jsx("button",{onClick:g,disabled:r,className:"exp-btn",children:"Markdown 명세서"}),u.jsx("button",{onClick:p,disabled:r,className:"exp-btn",children:"JSON 프로젝트"})]}),t&&u.jsx("p",{className:"exp-note caption",children:t}),u.jsxs("details",{className:"exp-help",children:[u.jsx("summary",{children:"도움말"}),u.jsxs("ul",{children:[u.jsxs("li",{children:[u.jsx("strong",{children:"PNG"})," — 현재 캔버스 뷰 그대로. 기본은 투명 배경, 체크 해제 시 종이톤 포함. 그리드·미니맵 항상 제외."]}),u.jsxs("li",{children:[u.jsx("strong",{children:"라이트 강제"})," — 화면이 다크 모드여도 PNG는 항상 라이트로 출력. 포트폴리오 PDF·인쇄·면접관 화면 호환 보장. 출력 직후 화면은 원래 테마로 복원."]}),u.jsxs("li",{children:[u.jsx("strong",{children:"정사각 PNG"})," — 모든 노드/데코를 정사각 프레임에 8% 여백으로 자동 맞춤. 512 / 1024 / 2048 / 4096 중 선택. 언리얼 Texture2D 표준 크기 (BC7 호환)."]}),u.jsxs("li",{children:[u.jsx("strong",{children:"SVG"})," — 벡터. Illustrator/Figma 추가 편집용."]}),u.jsxs("li",{children:[u.jsx("strong",{children:"Markdown"})," — 룸 명세서 텍스트. 포트폴리오 README용."]}),u.jsxs("li",{children:[u.jsx("strong",{children:"JSON"})," — 프로젝트 원본. 동료에게 공유·백업용."]})]})]})]})}const CP={room:"an interior chamber with stone walls and ambient lighting",vista:"a sweeping vista with distant landmark and dramatic depth",treasure:"a treasure chamber, gilded relic on a pedestal, beams of light",boss:"a vast boss arena, towering silhouette, atmospheric tension",hub:"a central hub plaza with multiple converging paths",save:"a small sanctuary with a glowing altar, restful warmth"},fy={chasm:"wide chasm splitting the floor",treasure_visible:"distant treasure glimmering across the gap",dash_required:"narrow leap of faith over a void",key:"ornate key resting on stone",lock:"massive locked door, iron bolts",oneway:"one-way drop, no return",ability_gate:"mystical barrier of light",enemy:"silhouettes of patrolling enemies",trap:"trap mechanism, blades or arrows",pressure_plate:"ancient pressure plate on the floor",switch:"lever mechanism set in the wall",save_altar:"glowing save altar",vista:"panoramic view, distant landmark",water:"reflective water surface",fire:"flickering fire and embers",ice:"frozen ice crystals everywhere",shadow:"long dramatic shadows",light:"shafts of warm light"},py=[{match:/사원|temple/i,keywords:["ancient temple ruins","weathered stone columns","overgrown vegetation","shafts of warm sunlight"]},{match:/성당|cathedral/i,keywords:["shattered cathedral","gothic arches","stained glass shards on the floor","dust motes in light"]},{match:/협곡|canyon/i,keywords:["desert canyon","wind-eroded sandstone","rope bridges","golden hour"]},{match:/묘소|crypt|catacomb/i,keywords:["underground crypt","low torchlit ceilings","sarcophagi","cold stone"]},{match:/화산|volcano/i,keywords:["active volcano interior","molten lava rivers","obsidian formations","ember haze"]},{match:/시계탑|clock tower/i,keywords:["victorian clock tower","giant brass gears","pendulum chamber","amber gaslight"]},{match:/해|sea|ocean|침수/i,keywords:["flooded fortress","half-submerged corridors","coral and barnacles","shafts of blue light through water"]},{match:/첨탑|spire/i,keywords:["windswept spire","wrought iron walkways","cloud sea below","piercing sun"]},{match:/저택|manor|mansion/i,keywords:["victorian manor","baroque wallpaper","flickering candelabra","long oak halls"]},{match:/창고|warehouse/i,keywords:["rainy night warehouse","shipping containers","sodium vapor lights","wet concrete reflections"]},{match:/성|castle/i,keywords:["medieval castle interior","tapestries and torchlight","cold stone walls"]},{match:/우주|space|sci-fi/i,keywords:["derelict space station","flickering emergency lighting","panel readouts","cold metal corridors"]},{match:/신전|shrine/i,keywords:["jungle temple","mossy stone","shafts of green light through canopy"]},{match:/감옥|prison/i,keywords:["stone prison interior","iron bars","damp torchlit corridors"]},{match:/동굴|cave/i,keywords:["crystal cave","bioluminescent flora","damp stone"]},{match:/숲|forest/i,keywords:["ancient forest","colossal trees","soft beams of sunlight","leaf litter"]},{match:/마을|village/i,keywords:["fog-shrouded village","wooden buildings","lantern light","low rooftops"]},{match:/항구|harbor|port/i,keywords:["old harbor","wooden piers","fog and gulls"]},{match:/기지|base|station/i,keywords:["arctic research base","snow drifts","cold blue light"]},{match:/사막|desert/i,keywords:["vast desert","shifting dunes","mirage haze"]},{match:/쇼핑몰|mall/i,keywords:["abandoned shopping mall","broken neon signs","overturned carts"]},{match:/병원|hospital/i,keywords:["dim hospital corridor","flickering fluorescent","gurneys"]},{match:/피라미드|pyramid/i,keywords:["ancient pyramid interior","hieroglyph walls","shafts of golden light"]}],PP=[{match:/잔잔|평온|차분/i,keywords:["contemplative atmosphere","soft ambient lighting"]},{match:/긴장|위기|불안/i,keywords:["ominous atmosphere","high contrast lighting","heavy shadows"]},{match:/클라이맥스|보스|결전/i,keywords:["climactic dramatic atmosphere","volumetric light shafts","epic scale"]},{match:/느림|느린|slow/i,keywords:["unhurried mood","still air"]},{match:/빠름|추격|chase/i,keywords:["dynamic motion","sense of speed","kinetic energy"]}],uo="--ar 16:9 --v 8.1 --style raw --stylize 250 --chaos 8",TP=/[가-힯㄰-㆏ᄀ-ᇿ]/,my=n=>TP.test(n);function xi(n){return n.replace(/[가-힯㄰-㆏ᄀ-ᇿ]+/g,"").replace(/[一-龥]+/g,"").replace(/[ぁ-んァ-ヶー]+/g,"").replace(/,\s*,/g,",").replace(/,\s*$/g,"").replace(/\s+/g," ").trim()}const IP=[{match:/능력|ability|power|skill/i,keywords:["ability acquisition moment","ritualistic discovery"]},{match:/스텔스|stealth|잠입|infilt/i,keywords:["stealthy infiltration","tense quiet atmosphere"]},{match:/퍼즐|puzzle|수수께끼/i,keywords:["puzzle setting","intricate mechanisms"]},{match:/전투|combat|battle|싸움/i,keywords:["combat arena energy","kinetic tension"]},{match:/탐험|exploration|발견|discover/i,keywords:["exploratory wonder","rewarding discovery"]},{match:/생존|survival|위기/i,keywords:["survival pressure","scarce resources"]},{match:/감정|narrative|이야기|drama/i,keywords:["emotional atmosphere","narrative weight"]},{match:/추격|chase|escape/i,keywords:["high-speed chase","urgent momentum"]},{match:/보스|boss|클라이맥스|climax/i,keywords:["climactic boss encounter","epic confrontation"]}];function Es(n,r){const{concept:e,nodes:t}=n,o=`${e.theme} ${e.intent} ${e.pacing} ${e.coreMechanic}`,i=Js(o,py),s=Js(e.pacing+" "+e.intent,PP),a=Js(o,IP),l=new Map;t.forEach(C=>C.icons.forEach(O=>{l.set(O,(l.get(O)??0)+1)}));const c=[...l.entries()].sort((C,O)=>O[1]-C[1]).slice(0,5).map(([C])=>fy[C]).filter(Boolean),d=EP(e.pacing,t),h=MP(t),f=e.theme&&!my(e.theme)?e.theme.slice(0,60):"",m=f?`a cohesive game world set in ${f}`:i.length>0?`a cohesive game world featuring ${i.slice(0,2).join(" and ")}`:"a cohesive game world atmosphere",x=[...i.slice(0,3),...c].slice(0,5),y=a.length>0?`gameplay feeling: ${a.slice(0,2).join(", ")}`:"",E=d.atmosphere,g=d.lighting,p=NP(i,h),S=[m,x.join(", "),y,E,g,p,s.join(", "),"key art mood board for a video game, promotional poster composition, painterly digital illustration, cinematic wide shot, layered atmospheric depth, masterful color theory"].filter(Boolean);return xi(`${S.join(", ")} ${uo}`)}function EP(n,r){const e=r.filter(s=>s.type==="boss").length,t=r.filter(s=>s.type==="save").length,o=r.filter(s=>s.type==="vista").length,i=n.toLowerCase();return e>=2||/클라이맥스|climax|결전|epic/i.test(i)?{atmosphere:"epic dramatic atmosphere with rising tension across the world",lighting:"cinematic high-contrast lighting, god rays, deep shadows"}:o>=2||/탐험|exploration|평온|벨앙스/i.test(i)?{atmosphere:"contemplative serene atmosphere with awe-inspiring scale",lighting:"soft volumetric light, golden hour ambient glow"}:t>=2||/휴식|차분|stillness/i.test(i)?{atmosphere:"restful intimate atmosphere with quiet beats",lighting:"warm ambient lantern light, soft shadows"}:{atmosphere:"balanced adventurous atmosphere with shifting moods",lighting:"naturalistic cinematic lighting with subtle gradients"}}function MP(n){const r={};return n.forEach(e=>{r[e.type]=(r[e.type]??0)+1}),r}function NP(n,r){const e=n.join(" ").toLowerCase();return/lava|volcano|ember|molten/.test(e)?"molten orange and obsidian black palette with ember accents":/snow|arctic|ice|frozen|blizzard/.test(e)?"icy blue and stark white palette with cold cyan accents":/jungle|forest|moss/.test(e)?"deep green and weathered stone palette with shafts of warm light":/desert|dune|sandstone/.test(e)?"golden amber and rust palette with mirage haze":/space|station|metal|sci.?fi|cyber/.test(e)?"cool steel blue and neon accent palette":/cathedral|gothic|stone/.test(e)?"cold stone gray and stained-glass jewel-tone palette":/manor|victorian|mansion/.test(e)?"sepia and oak wood palette with candlelight gold":/water|ocean|flooded|coral/.test(e)?"submerged teal and bone-white palette with refracted caustics":(r.boss??0)>=2?"high-contrast crimson and charcoal palette":(r.vista??0)>=2?"wide naturalistic palette with horizon depth":"cohesive painterly palette with harmonized accent colors"}function Xo(n,r,e){const{concept:t}=r,o=`${t.theme} ${t.intent} ${t.coreMechanic}`,i=Js(o,py),s=n.name&&!my(n.name)?n.name:"",a=CP[n.type],l=s||a,c=n.icons.map(h=>fy[h]).filter(Boolean),d=[l,s?a:"",c.join(", "),i.slice(0,3).join(", "),"video game concept art, painterly digital illustration, cinematic lighting, atmospheric depth"].filter(Boolean);return xi(`${d.join(", ")} ${uo}`)}function Js(n,r){const e=[];for(const{match:t,keywords:o}of r)t.test(n)&&e.push(...o);return Array.from(new Set(e))}const jP=["room","vista","treasure","boss","hub","save"],AP=["open","locked","oneway","ability","vista"],OP=["chasm","treasure_visible","dash_required","key","lock","oneway","ability_gate","enemy","trap","pressure_plate","switch","save_altar","vista","water","fire","ice","shadow","light"];function RP(){const n=B(l=>l.selection),r=B(l=>l.project),e=n.kind==="node"?r.nodes.find(l=>l.id===n.id):null,t=n.kind==="edge"?r.edges.find(l=>l.id===n.id):null,o=n.kind==="postit"?r.postits.find(l=>l.id===n.id):null,i=n.kind==="decoration"?(r.decorations??[]).find(l=>l.id===n.id):null,[s,a]=M.useState("inspect");return u.jsxs("aside",{className:"inspector edge-left",children:[u.jsxs("div",{className:"ins-tabs",children:[u.jsx("button",{className:s==="inspect"?"is-active":"",onClick:()=>a("inspect"),children:"속성"}),u.jsx("button",{className:s==="mj"?"is-active":"",onClick:()=>a("mj"),children:"MJ 프롬프트"}),u.jsx("button",{className:s==="ai"?"is-active":"",onClick:()=>a("ai"),children:"AI"}),u.jsx("button",{className:s==="export"?"is-active":"",onClick:()=>a("export"),children:"Export"})]}),u.jsxs("div",{className:"ins-body",children:[s==="inspect"&&u.jsxs(u.Fragment,{children:[e&&u.jsx(DP,{node:e}),t&&u.jsx(ZP,{edge:t}),o&&u.jsx(FP,{postitId:o.id}),i&&u.jsx($P,{dec:i}),!e&&!t&&!o&&!i&&u.jsx(LP,{})]}),s==="mj"&&u.jsx(zP,{nodeId:e==null?void 0:e.id}),s==="ai"&&u.jsx(MC,{}),s==="export"&&u.jsx(bP,{})]}),u.jsx(yC,{})]})}function LP(){return u.jsxs("div",{className:"ins-empty",children:[u.jsx("p",{className:"hand",children:"아무것도 선택되지 않았습니다."}),u.jsxs("ul",{className:"ins-empty-tips caption",children:[u.jsx("li",{children:"· 노드를 클릭 → 속성 편집"}),u.jsx("li",{children:"· 노드 우측 핸들에서 드래그 → 엣지 그리기"}),u.jsx("li",{children:"· 포스트잇을 캔버스로 드래그 → 노드로 승격"})]})]})}function DP({node:n}){const r=B(f=>f.updateNode),e=B(f=>f.removeNode),t=B(f=>f.resizeNode),o=B(f=>f.setNodeAspect),i=B(f=>f.bringNodeToFront),s=B(f=>f.sendNodeToBack),a=n.size??1,l=n.aspect??1,c=Fe[n.type],d=Math.round(c.rx*a*Math.sqrt(l)),h=Math.round(c.ry*a/Math.sqrt(l));return u.jsxs("div",{className:"ins-section",children:[u.jsxs("div",{className:"ins-section-head",children:[u.jsx("span",{className:"caption",children:"노드"}),u.jsx("button",{className:"ins-del",onClick:()=>e(n.id),children:"삭제"})]}),u.jsxs("label",{className:"ins-field",children:[u.jsx("span",{children:"이름"}),u.jsx("input",{value:n.name,onChange:f=>r(n.id,{name:f.target.value})})]}),u.jsxs("label",{className:"ins-field",children:[u.jsx("span",{children:"레이어 순서"}),u.jsxs("div",{className:"ins-z-row",children:[u.jsx("button",{onClick:()=>s(n.id),className:"ins-z-btn",title:"다른 노드 뒤로",children:"▽ 맨 뒤로"}),u.jsx("button",{onClick:()=>i(n.id),className:"ins-z-btn",title:"다른 노드 앞으로",children:"△ 맨 앞으로"})]})]}),u.jsxs("label",{className:"ins-field",children:[u.jsxs("span",{children:["크기 · ",Math.round(a*100),"% · ",d,"×",h]}),u.jsxs("div",{className:"ins-size-row",children:[u.jsx("input",{type:"range",min:"0.5",max:"2.5",step:"0.05",value:a,onChange:f=>t(n.id,parseFloat(f.target.value)),className:"ins-size-slider"}),u.jsx("button",{onClick:()=>{t(n.id,1),o(n.id,1)},className:"ins-size-reset",title:"크기·형태 모두 기본값",children:"↻"})]}),u.jsx("p",{className:"ins-hint-mini",children:"캔버스의 파란 핸들을 드래그하면 가로·세로를 자유롭게 조절"})]}),u.jsxs("label",{className:"ins-field",children:[u.jsx("span",{children:"타입"}),u.jsx("div",{className:"ins-chips",children:jP.map(f=>{const m=Fe[f];return u.jsxs("button",{className:`ins-chip ${n.type===f?"is-active":""}`,onClick:()=>r(n.id,{type:f}),style:{borderColor:n.type===f?m.stroke:void 0},children:[u.jsx("span",{className:"ins-chip-icon",children:m.icon})," ",m.label]},f)})})]}),u.jsxs("label",{className:"ins-field",children:[u.jsx("span",{children:"키워드 태그 (노드 아래·MJ 프롬프트에 반영)"}),u.jsx("div",{className:"ins-chips ins-chips--small",children:OP.map(f=>{const m=n.icons.includes(f);return u.jsx("button",{className:`ins-chip ins-chip--small ${m?"is-active":""}`,onClick:()=>{const x=m?n.icons.filter(y=>y!==f):[...n.icons,f];r(n.id,{icons:x})},children:f},f)})})]}),u.jsxs("label",{className:"ins-field",children:[u.jsx("span",{children:"노트"}),u.jsx("textarea",{rows:5,value:n.notes,onChange:f=>r(n.id,{notes:f.target.value}),placeholder:"이 방에서 일어나는 일, 적, 환경 디테일…"})]})]})}function ZP({edge:n}){const r=B(s=>s.updateEdge),e=B(s=>s.removeEdge),t=B(s=>s.project.nodes),o=t.find(s=>s.id===n.from),i=t.find(s=>s.id===n.to);return u.jsxs("div",{className:"ins-section",children:[u.jsxs("div",{className:"ins-section-head",children:[u.jsx("span",{className:"caption",children:"간선"}),u.jsx("button",{className:"ins-del",onClick:()=>e(n.id),children:"삭제"})]}),u.jsxs("div",{className:"ins-edge-flow",children:[u.jsx("span",{children:(o==null?void 0:o.name)??"?"}),u.jsx("span",{className:"ins-arrow",children:"→"}),u.jsx("span",{children:(i==null?void 0:i.name)??"?"})]}),u.jsxs("label",{className:"ins-field",children:[u.jsx("span",{children:"타입"}),u.jsx("div",{className:"ins-chips",children:AP.map(s=>{const a=Yi[s];return u.jsx("button",{className:`ins-chip ${n.type===s?"is-active":""}`,onClick:()=>r(n.id,{type:s}),style:{borderColor:n.type===s?a.stroke:void 0},children:a.label},s)})})]}),n.type==="locked"&&u.jsxs("label",{className:"ins-field",children:[u.jsx("span",{children:"키 ID"}),u.jsx("input",{value:n.keyId??"",onChange:s=>r(n.id,{keyId:s.target.value}),placeholder:"예: dragon_key"})]}),n.type==="ability"&&u.jsxs("label",{className:"ins-field",children:[u.jsx("span",{children:"능력 ID"}),u.jsx("input",{value:n.abilityId??"",onChange:s=>r(n.id,{abilityId:s.target.value}),placeholder:"예: dash"})]}),u.jsxs("label",{className:"ins-field",children:[u.jsx("span",{children:"라벨 (선택)"}),u.jsx("input",{value:n.label??"",onChange:s=>r(n.id,{label:s.target.value})})]})]})}function FP({postitId:n}){const r=B(a=>a.project.postits.find(l=>l.id===n)),e=B(a=>a.updatePostit),t=B(a=>a.removePostit),[o,i]=M.useState("");if(!r)return null;const s=()=>{const a=o.trim();a&&(e(r.id,{tags:Array.from(new Set([...r.tags,a]))}),i(""))};return u.jsxs("div",{className:"ins-section",children:[u.jsxs("div",{className:"ins-section-head",children:[u.jsx("span",{className:"caption",children:"포스트잇"}),u.jsx("button",{className:"ins-del",onClick:()=>t(r.id),children:"삭제"})]}),u.jsxs("label",{className:"ins-field",children:[u.jsx("span",{children:"내용"}),u.jsx("textarea",{rows:4,value:r.text,onChange:a=>e(r.id,{text:a.target.value})})]}),u.jsxs("label",{className:"ins-field",children:[u.jsx("span",{children:"태그 추가"}),u.jsxs("div",{className:"ins-tag-input",children:[u.jsx("input",{value:o,onChange:a=>i(a.target.value),onKeyDown:a=>{a.key==="Enter"&&s()},placeholder:"태그 + Enter"}),u.jsx("button",{onClick:s,children:"+"})]}),r.tags.length>0&&u.jsx("div",{className:"ins-tag-list",children:r.tags.map(a=>u.jsxs("button",{className:"ins-tag",onClick:()=>e(r.id,{tags:r.tags.filter(l=>l!==a)}),children:["#",a," ×"]},a))})]})]})}function $P({dec:n}){const r=B(o=>o.updateDecoration),e=B(o=>o.removeDecoration),t=n.kind==="arrow"?"화살표":n.kind==="ellipse"?"회색 타원":"텍스트";return u.jsxs("div",{className:"ins-section",children:[u.jsxs("div",{className:"ins-section-head",children:[u.jsxs("span",{className:"caption",children:["데코 · ",t]}),u.jsx("button",{className:"ins-del",onClick:()=>e(n.id),children:"삭제"})]}),n.kind==="text"&&u.jsxs("label",{className:"ins-field",children:[u.jsx("span",{children:"텍스트"}),u.jsx("textarea",{rows:3,value:n.text??"",onChange:o=>r(n.id,{text:o.target.value}),placeholder:"여기에 입력…"})]}),u.jsxs("p",{className:"ins-hint-mini",children:[n.kind==="arrow"?"양 끝점을 드래그해 방향 조정":n.kind==="ellipse"?"SE 핸들로 크기 조절":"더블클릭으로 내용 편집 / SE 핸들로 박스 크기 조절"," · ","Delete 키로 삭제"]})]})}function zP({nodeId:n}){const r=B(v=>v.project),e=B(v=>v.setMjMaster),t=B(v=>v.updateNode),[o,i]=M.useState(!1),[s,a]=M.useState(!1),[l,c]=M.useState(null),d=n?r.nodes.find(v=>v.id===n):void 0,h=r.mjMasterPrompt??Es(r),f=d?d.mjPrompt??Xo(d,r):"",m=()=>{e(Es(r)),c("오프라인 템플릿으로 생성됨")},x=async()=>{i(!0),c(null);try{const v=await wo({system:CC,user:EC(r,uo),maxTokens:900});let S=xi(v.text);S.split(/\s+/).filter(Boolean).length<40?(S=S.replace(/--ar.+$/,"").trim(),S=S.replace(/,\s*$/,""),S+=`, key art mood board for a video game, promotional poster composition, painterly digital illustration, masterful color theory, layered atmospheric depth, cinematic wide shot ${uo}`,c(`AI 생성 (${v.modelUsed}${v.fallback?" · 폴백":""}) — 짧은 응답 자동 보강`)):c(`AI 생성 (${v.modelUsed}${v.fallback?" · 폴백":""})`),e(S)}catch(v){v instanceof Bi?(c("AI 키 없음 — 오프라인 템플릿으로 대체"),e(Es(r))):v instanceof zt?(c("Gemini 모델이 일시적으로 혼잡합니다. 오프라인 템플릿으로 대체 — 잠시 후 AI 재시도 권장."),e(Es(r))):c(`AI 실패: ${v.message??v}`)}finally{i(!1)}},y=()=>{d&&(t(d.id,{mjPrompt:Xo(d,r)}),c("오프라인 템플릿으로 생성됨"))},E=async()=>{if(d){a(!0),c(null);try{const v=await wo({system:lp,user:cp(r,d.id,uo),preferModel:"gemini-2.5-flash",maxTokens:300});t(d.id,{mjPrompt:xi(v.text)}),c(`AI 생성 (${v.modelUsed}${v.fallback?" · 폴백":""})`)}catch(v){v instanceof Bi?(t(d.id,{mjPrompt:Xo(d,r)}),c("AI 키 없음 — 오프라인 템플릿으로 대체")):v instanceof zt?(t(d.id,{mjPrompt:Xo(d,r)}),c("Gemini 모델이 일시적으로 혼잡합니다. 오프라인 템플릿으로 대체 — 잠시 후 AI 재시도 권장.")):c(`AI 실패: ${v.message??v}`)}finally{a(!1)}}},g=async()=>{a(!0),c("전체 노드 생성 중…");let v=0,S=0;for(const C of r.nodes)try{const O=await wo({system:lp,user:cp(r,C.id,uo),preferModel:"gemini-2.5-flash",maxTokens:300});t(C.id,{mjPrompt:xi(O.text)}),v+=1}catch{t(C.id,{mjPrompt:Xo(C,r)}),S+=1}c(`완료 — AI ${v}건, 오프라인 ${S}건`),a(!1)},p=v=>{var S;return(S=navigator.clipboard)==null?void 0:S.writeText(v)};return u.jsxs("div",{className:"ins-mj",children:[u.jsxs("section",{className:"ins-mj-section",children:[u.jsxs("header",{className:"ins-mj-head",children:[u.jsx("h4",{children:"마스터 프롬프트"}),u.jsx("span",{className:"caption",children:"레벨 전체 무드보드 · 파라미터 포함"})]}),u.jsx("textarea",{className:"ins-mj-textarea ins-mono",rows:6,value:h,onChange:v=>e(v.target.value),placeholder:"Generate a master prompt..."}),u.jsxs("div",{className:"ins-mj-actions",children:[u.jsx("button",{onClick:m,children:"오프라인 재생성"}),u.jsx("button",{onClick:x,disabled:o,className:"ins-mj-ai",children:o?"생성 중…":"AI 생성"}),u.jsx("button",{onClick:()=>p(h),children:"복사"})]})]}),u.jsxs("section",{className:"ins-mj-section",children:[u.jsxs("header",{className:"ins-mj-head",children:[u.jsx("h4",{children:"노드 프롬프트"}),u.jsx("span",{className:"caption",children:d?`${d.name} · 파라미터 포함`:"노드 선택 없음"})]}),u.jsx("textarea",{className:"ins-mj-textarea ins-mono",rows:6,value:f,onChange:v=>d&&t(d.id,{mjPrompt:v.target.value}),placeholder:"노드를 선택하면 표시됩니다.",disabled:!d}),u.jsxs("div",{className:"ins-mj-actions",children:[u.jsx("button",{onClick:y,disabled:!d,children:"오프라인 재생성"}),u.jsx("button",{onClick:E,disabled:!d||s,className:"ins-mj-ai",children:s?"생성 중…":"AI 생성"}),u.jsx("button",{onClick:()=>p(f),disabled:!f,children:"복사"})]}),u.jsxs("button",{onClick:g,disabled:s||r.nodes.length===0,className:"ins-mj-all",children:["모든 노드 일괄 생성 (",r.nodes.length,")"]})]}),l&&u.jsx("p",{className:"ins-mj-note caption",children:l})]})}function BP({onClose:n}){const[r,e]=M.useState("scenarios"),[t,o]=M.useState(""),[i,s]=M.useState(_s[0]??null),[a,l]=M.useState(bs[0]??null),[c,d]=M.useState("scenario"),h=B(v=>v.setName),f=B(v=>v.setConcept),m=B(v=>v.addPostit),x=B(v=>v.updatePostit),y=B(v=>v.newProject),E=M.useMemo(()=>{if(!t.trim())return _s;const v=t.toLowerCase();return _s.filter(S=>S.title.toLowerCase().includes(v)||S.scenarioMd.toLowerCase().includes(v))},[t]),g=M.useMemo(()=>{if(!t.trim())return bs;const v=t.toLowerCase();return bs.filter(S=>S.title.toLowerCase().includes(v)||S.md.toLowerCase().includes(v))},[t]),p=v=>{const S=Ia.find(C=>C.id===v.id);S&&(y(S.title),h(S.title),f(S.concept),S.seedPostits.forEach(C=>{var I;const O=m(C.text,C.color);(I=C.tags)!=null&&I.length&&x(O,{tags:C.tags})}),n())};return Ki.createPortal(u.jsx("div",{className:"lib-backdrop",onClick:n,children:u.jsxs("div",{className:"lib-modal",onClick:v=>v.stopPropagation(),children:[u.jsxs("header",{className:"lib-header",children:[u.jsx("h2",{className:"hand",children:"참고 라이브러리"}),u.jsx("button",{onClick:n,className:"lib-x","aria-label":"닫기",children:"×"})]}),u.jsxs("div",{className:"lib-tabs",children:[u.jsxs("button",{className:r==="scenarios"?"is-active":"",onClick:()=>e("scenarios"),children:["시나리오 ",_s.length,"편"]}),u.jsxs("button",{className:r==="references"?"is-active":"",onClick:()=>e("references"),children:["데이터베이스·가이드 ",bs.length]})]}),u.jsx("div",{className:"lib-search",children:u.jsx("input",{placeholder:"검색 — 시나리오 본문도 함께 검색됨",value:t,onChange:v=>o(v.target.value)})}),u.jsxs("div",{className:"lib-body",children:[r==="scenarios"&&u.jsxs(u.Fragment,{children:[u.jsx("aside",{className:"lib-list",children:E.map(v=>u.jsxs("button",{className:`lib-item ${(i==null?void 0:i.id)===v.id?"is-active":""}`,onClick:()=>s(v),children:[u.jsxs("span",{className:"lib-item-num",children:["S",String(v.num).padStart(2,"0")]}),u.jsx("span",{className:"lib-item-title",children:v.title.replace(/^S\d+\s+/,"")})]},v.id))}),u.jsx("article",{className:"lib-view",children:i?u.jsxs(u.Fragment,{children:[u.jsxs("div",{className:"lib-view-head",children:[u.jsx("strong",{children:i.title}),u.jsxs("div",{className:"lib-view-actions",children:[i.topviewMd&&u.jsx("button",{onClick:()=>d(c==="scenario"?"topview":"scenario"),className:"lib-view-toggle",children:c==="scenario"?"Top-down 맵 보기 →":"← 시나리오로 돌아가기"}),u.jsx("button",{onClick:()=>p(i),className:"lib-apply",children:"이 시나리오로 새 프로젝트 시작"})]})]}),u.jsx(yp,{md:c==="topview"?i.topviewMd??"":i.scenarioMd})]}):u.jsx("p",{className:"lib-empty",children:"시나리오를 선택하세요"})})]}),r==="references"&&u.jsxs(u.Fragment,{children:[u.jsx("aside",{className:"lib-list",children:g.map(v=>u.jsxs("button",{className:`lib-item ${(a==null?void 0:a.id)===v.id?"is-active":""}`,onClick:()=>l(v),children:[u.jsx("span",{className:"lib-item-num",children:v.id.slice(0,2)}),u.jsx("span",{className:"lib-item-title",children:v.title.replace(/^\d+_/,"")})]},v.id))}),u.jsx("article",{className:"lib-view",children:a?u.jsxs(u.Fragment,{children:[u.jsx("div",{className:"lib-view-head",children:u.jsx("strong",{children:a.title})}),u.jsx(yp,{md:a.md})]}):u.jsx("p",{className:"lib-empty",children:"자료를 선택하세요"})})]})]})]})}),document.body)}function yp({md:n}){const r=M.useMemo(()=>HP(n),[n]);return u.jsx("div",{className:"lib-md",dangerouslySetInnerHTML:{__html:r}})}function gy(n){return n.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function HP(n){const r=n.split(/\r?\n/),e=[];let t=!1,o=!1;const i=()=>{o&&(e.push("</ul>"),o=!1)};for(const s of r){if(s.startsWith("```")){i(),t?(e.push("</pre>"),t=!1):(e.push("<pre>"),t=!0);continue}if(t){e.push(gy(s));continue}if(/^#{1,6}\s/.test(s)){i();const a=s.match(/^(#+)/)[1].length,l=Ms(s.replace(/^#+\s*/,""));e.push(`<h${a}>${l}</h${a}>`);continue}if(/^\s*[-*]\s+/.test(s)){o||(e.push("<ul>"),o=!0),e.push(`<li>${Ms(s.replace(/^\s*[-*]\s+/,""))}</li>`);continue}if(/^>\s/.test(s)){i(),e.push(`<blockquote>${Ms(s.replace(/^>\s*/,""))}</blockquote>`);continue}if(s.trim()==="---"){i(),e.push("<hr/>");continue}if(s.trim()===""){i(),e.push("");continue}i(),e.push(`<p>${Ms(s)}</p>`)}return i(),t&&e.push("</pre>"),e.join(`
`)}function Ms(n){return gy(n).replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>").replace(/\*(.+?)\*/g,"<em>$1</em>").replace(/`([^`]+)`/g,"<code>$1</code>")}function WP(){const n=B(h=>h.setApiKey),[r,e]=M.useState(1),[t,o]=M.useState(""),[i,s]=M.useState(!1),[a,l]=M.useState(null),c=()=>{localStorage.setItem("bubble-atelier::onboarded","1"),window.location.reload()},d=async()=>{if(t.trim()){s(!0),l(null),n(t.trim());try{await wo({system:"단답으로 응답하세요.",user:"안녕이라고 답하세요.",maxTokens:12}),localStorage.setItem("bubble-atelier::onboarded","1"),e(3)}catch(h){l((h==null?void 0:h.message)??"키 검증 실패"),n(void 0)}finally{s(!1)}}};return u.jsx("div",{className:"ow-backdrop",children:u.jsxs("div",{className:"ow-card paper-grain",children:[u.jsxs("header",{className:"ow-head",children:[u.jsx("span",{className:"caption",children:"버블 아틀리에"}),u.jsx("h2",{className:"hand",children:"시작하기"}),u.jsx("p",{className:"ow-subtitle",children:"레벨 디자인을 위한 컨셉 + 포스트잇 + 버블 다이어그램 워크벤치"})]}),r===1&&u.jsx("div",{className:"ow-body",children:u.jsxs("div",{className:"ow-paths",children:[u.jsxs("article",{className:"ow-path ow-path--offline",children:[u.jsx("h3",{children:"오프라인 모드로 시작"}),u.jsx("p",{children:"50개의 컨셉 템플릿과 결정론적 Midjourney 프롬프트 생성기로 즉시 작업 가능. AI 호출 없음, 비용 0."}),u.jsx("button",{onClick:c,className:"ow-btn ow-btn--ghost",children:"오프라인으로 시작"})]}),u.jsxs("article",{className:"ow-path ow-path--ai",children:[u.jsx("h3",{children:"AI 어시스턴트 활성화"}),u.jsxs("p",{children:["Google Gemini의 ",u.jsx("strong",{children:"무료"})," API 키로 컨셉 자동 생성, 비평, 노드별 MJ 프롬프트 생성. 신용카드 불필요."]}),u.jsx("button",{onClick:()=>e(2),className:"ow-btn",children:"키 등록하기"})]})]})}),r===2&&u.jsxs("div",{className:"ow-body",children:[u.jsxs("ol",{className:"ow-steps",children:[u.jsxs("li",{children:[u.jsx("strong",{children:"① 키 발급"}),u.jsxs("p",{children:["아래 주소로 이동 → 구글 계정 로그인 → ",u.jsx("em",{children:"「Get API key」"})," 클릭 → ",u.jsx("em",{children:"「Create API key」"})," 클릭"]}),u.jsx("a",{href:"https://aistudio.google.com/app/apikey",target:"_blank",rel:"noreferrer",className:"ow-link",children:"aistudio.google.com/app/apikey →"})]}),u.jsxs("li",{children:[u.jsx("strong",{children:"② 키 붙여넣기"}),u.jsx("p",{children:"발급받은 키를 아래 칸에 붙여넣으세요. 이 키는 본인 브라우저에만 저장됩니다."}),u.jsx("input",{type:"password",className:"ow-input",placeholder:"AIzaSy…",value:t,onChange:h=>o(h.target.value)}),a&&u.jsxs("div",{className:"ow-error",children:["⚠ ",a]})]})]}),u.jsxs("div",{className:"ow-actions",children:[u.jsx("button",{onClick:c,className:"ow-btn ow-btn--ghost",children:"건너뛰기 (오프라인)"}),u.jsx("button",{onClick:d,className:"ow-btn",disabled:!t.trim()||i,children:i?"검증 중…":"키 검증하고 시작"})]})]}),r===3&&u.jsxs("div",{className:"ow-body ow-success",children:[u.jsx("div",{className:"ow-checkmark hand",children:"✓"}),u.jsx("h3",{children:"준비 완료"}),u.jsxs("p",{children:["키가 정상적으로 등록되었습니다.",u.jsx("br",{}),"좌측 패널에서 컨셉 템플릿을 골라 시작하거나, 직접 포스트잇을 추가해 보세요."]}),u.jsx("button",{onClick:()=>{localStorage.setItem("bubble-atelier::onboarded","1"),window.location.reload()},className:"ow-btn",children:"시작"})]})]})})}const q=16,xp=48,vp=24,wp=8,GP=10,Sp=Math.PI/12,VP=.25,UP=.4,jr=(n,r,e)=>[r*Math.cos(n)-e*Math.sin(n),r*Math.sin(n)+e*Math.cos(n)],KP=n=>{let r=1/0,e=1/0,t=-1/0,o=-1/0;for(const i of n)for(const[s,a]of i)r=Math.min(r,s),t=Math.max(t,s),e=Math.min(e,a),o=Math.max(o,a);return{x0:r,y0:e,x1:t,y1:o}},Yo=(n,r)=>{if(!r)return KP(n);let e=1/0,t=1/0,o=-1/0,i=-1/0;const s=Math.cos(-r),a=Math.sin(-r);for(const l of n)for(const[c,d]of l){const h=c*s-d*a,f=c*a+d*s;e=Math.min(e,h),o=Math.max(o,h),t=Math.min(t,f),i=Math.max(i,f)}return{x0:e,y0:t,x1:o,y1:i}},kp=(n,r)=>n.map(e=>e.map(([t,o])=>r(t,o)));function XP({doc:n,tool:r,erase:e,rough:t,snap:o,corridorW:i,doorW:s,stairW:a,textSize:l,markerKind:c,zoneKind:d,strokeColor:h,strokeWidth:f,target:m,calibrating:x,onStatus:y}){const E=M.useRef(null),g=M.useRef(null),p=M.useRef(fe),v=M.useRef(null),S=M.useRef(0),C=M.useRef(!1),O=M.useRef(null),I=M.useRef(null),[Z,F]=M.useState([]),K=M.useRef(null),[P,Y]=M.useState([]),H=M.useRef(null),k=M.useRef([0,0]),R=M.useRef(null),j=M.useRef(null),A=M.useRef(null),w=M.useRef(null),N=M.useRef(null),z=M.useRef(null),U=M.useRef(null),[T,pn]=M.useState(null),X=M.useRef(new Map),[en,Q]=M.useState(!1),ln=M.useRef(0),cn=B(D=>D.addGeo),wn=B(D=>D.removeGeo),Nn=B(D=>D.translateGeo),Fn=B(D=>D.addStruct),dn=B(D=>D.removeStruct),un=B(D=>D.translateStruct),kn=B(D=>D.addZone),Pn=B(D=>D.removeZone),Sn=B(D=>D.translateZones),$=B(D=>D.addDoor),tn=B(D=>D.removeDoor),J=B(D=>D.addStair),b=B(D=>D.removeStair),rn=B(D=>D.addText),yn=B(D=>D.updateText),bn=B(D=>D.removeText),In=B(D=>D.translateObject),sr=B(D=>D.addTdImage),oe=B(D=>D.updateTdImage),kr=B(D=>D.removeTdImage),Oo=B(D=>D.addStroke),fl=B(D=>D.removeStroke),Oy=B(D=>D.addMarker),Ry=B(D=>D.updateMarker),Ly=B(D=>D.removeMarker),Dy=B(D=>D.addMany),Zy=B(D=>D.transformShape),Fy=B(D=>D.updateTopdown),wt=B(D=>D.project.nodes),$d=B(D=>D.project.edges),[_r,br]=n.grid,Ro=M.useMemo(()=>n.pathVisible!==!1?n.strokes??[]:[],[n.pathVisible,n.strokes]),Lo=M.useMemo(()=>yi(n.geo),[n.geo]),qi=M.useMemo(()=>kf(n.struct??[],!1),[n.struct]),zd=M.useMemo(()=>kf(n.struct??[],!0),[n.struct]),Bd=M.useMemo(()=>[...Lo,...qi],[Lo,qi]),Ce=M.useMemo(()=>{if(wt.length===0)return null;let D=1/0,L=1/0,on=-1/0,W=-1/0;for(const vn of wt){const{rx:Mn,ry:jn}=$e(vn.type,vn.size??1,vn.aspect??1);D=Math.min(D,vn.x-Mn),on=Math.max(on,vn.x+Mn),L=Math.min(L,vn.y-jn),W=Math.max(W,vn.y+jn)}const an=Math.max(on-D,1),V=Math.max(W-L,1),_=_r*q,G=br*q,nn=Math.min(_*.84/an,G*.84/V);return{s:nn,tx:(_-an*nn)/2-D*nn,ty:(G-V*nn)/2-L*nn,minX:D,minY:L,bw:an,bh:V}},[wt,_r,br]),St=M.useMemo(()=>{if(!Ce)return null;const D=n.overlay,L=D.scale||1,on=_r*q,W=br*q;return{s:Ce.s*L,tx:(Ce.tx-on/2)*L+on/2+(D.tx||0),ty:(Ce.ty-W/2)*L+W/2+(D.ty||0),minX:Ce.minX,minY:Ce.minY,bw:Ce.bw,bh:Ce.bh}},[Ce,n.overlay,_r,br]),Wt=D=>{const L=g.current;if(!L)return null;const on=L.getBoundingClientRect(),W=p.current;return[W.invertX(D.clientX-on.left)/q,W.invertY(D.clientY-on.top)/q]},pl=M.useCallback(D=>{if(o===0)return D;const L=(on,W)=>Math.max(0,Math.min(W,on));return[L(Math.round(D[0]/o)*o,_r),L(Math.round(D[1]/o)*o,br)]},[o,_r,br]),Hd=M.useRef(()=>{}),$n=M.useCallback(()=>{S.current||(S.current=requestAnimationFrame(()=>{S.current=0,Hd.current()}))},[]),Wd=M.useCallback(D=>{const L=X.current;let on=L.get(D);return on||(on=new Image,on.onload=()=>$n(),on.src=D,L.set(D,on)),on},[$n]),ml=D=>{const L=A.current,on=w.current;if(!L||L.kind!=="image"||L.id!==D.id||!on)return D;const W=L.mode==="rotate"?L.newRot:L.rot0,an=Yo(on,W),[V,_]=jr(W,(an.x0+an.x1)/2,(an.y0+an.y1)/2);return{x:V,y:_,w:an.x1-an.x0,h:an.y1-an.y0,rot:W}},Gd=M.useCallback(()=>{const D=g.current,L=E.current;if(!D||!L)return;const on=v.current??(v.current=w0()),W=window.devicePixelRatio||1,an=L.clientWidth,V=L.clientHeight;(D.width!==Math.round(an*W)||D.height!==Math.round(V*W))&&(D.width=Math.round(an*W),D.height=Math.round(V*W),D.style.width=`${an}px`,D.style.height=`${V}px`);const _=D.getContext("2d"),G=p.current,nn=_r*q,vn=br*q;_.setTransform(W,0,0,W,0,0),_.fillStyle=on.paper,_.fillRect(0,0,an,V),_.setTransform(W*G.k,0,0,W*G.k,W*G.x,W*G.y);{const[fn,xn]=k.current;for(const _n of n.images??[]){const Ln=Wd(_n.src);if(!Ln.complete||!Ln.naturalWidth)continue;const Hn=ml(_n),An=P.includes(_n.id)?[fn,xn]:[0,0];_.save(),_.translate((Hn.x+An[0])*q,(Hn.y+An[1])*q),_.rotate(Hn.rot),_.drawImage(Ln,-Hn.w/2*q,-Hn.h/2*q,Hn.w*q,Hn.h*q),_.restore()}}const Mn=(fn,xn)=>{_.strokeStyle=xn,_.lineWidth=1/G.k,_.beginPath();for(let _n=0;_n<=_r;_n+=fn)_.moveTo(_n*q,0),_.lineTo(_n*q,vn);for(let _n=0;_n<=br;_n+=fn)_.moveTo(0,_n*q),_.lineTo(nn,_n*q);_.stroke()},jn=At(G.k*q,3.5,7);jn>0&&(_.globalAlpha=jn,Mn(1,on.gridSoft),_.globalAlpha=1);const ar=At(G.k*q*Pa,6,12);ar>0&&(_.globalAlpha=ar,Mn(Pa,on.gridMajor),_.globalAlpha=1),_.strokeStyle=on.gridHard,_.lineWidth=1.2/G.k,_.strokeRect(0,0,nn,vn),S0(_,Lo,{CELL:q,cols:_r,rows:br,zoomK:G.k,wallM:n.style.wallM,hatch:n.style.hatch,shadow:n.style.shadow,colors:on,doors:n.doors,stairs:n.stairs,texts:n.texts,markers:n.markers,structHigh:qi,structLow:zd,zones:n.zones});{const[fn,xn]=k.current,_n=Ro.map(Ln=>P.includes(Ln.id)&&(fn!==0||xn!==0)?{...Ln,pts:Ln.pts.map(([Hn,An])=>[Hn+fn,An+xn])}:Ln);yu(_,_n,{CELL:q,zoomK:G.k,colors:on})}if(U.current&&U.current.length>0&&yu(_,[{id:"_live",pts:U.current,color:h,width:f}],{CELL:q,zoomK:G.k,colors:on}),n.overlay.visible&&St){const{s:fn,tx:xn,ty:_n}=St,Ln=An=>An*fn+xn,Hn=An=>An*fn+_n;_.save(),_.globalAlpha=n.overlay.opacity;for(const An of $d){const En=wt.find(Bn=>Bn.id===An.from),Gn=wt.find(Bn=>Bn.id===An.to);!En||!Gn||(_.strokeStyle=An.type==="locked"?"#B85450":An.type==="ability"?"#2C5F7C":"#1A1814",_.lineWidth=2.4*fn,_.setLineDash(An.type==="vista"?[8*fn,6*fn]:[]),_.beginPath(),_.moveTo(Ln(En.x),Hn(En.y)),_.lineTo(Ln(Gn.x),Hn(Gn.y)),_.stroke())}_.setLineDash([]);for(const An of wt){const En=Fe[An.type],{rx:Gn,ry:Bn}=$e(An.type,An.size??1,An.aspect??1);_.beginPath(),_.ellipse(Ln(An.x),Hn(An.y),Gn*fn,Bn*fn,0,0,Math.PI*2),_.fillStyle=En.fill,_.fill(),_.strokeStyle=En.stroke,_.lineWidth=En.strokeWidth*fn,_.stroke();const Dn=20*fn,rr=At(Dn*G.k,5,9);rr>0&&An.name&&(_.globalAlpha=n.overlay.opacity*rr,_.fillStyle=En.textColor,_.font=`600 ${Dn}px Pretendard, sans-serif`,_.textAlign="center",_.textBaseline="middle",_.fillText(An.name,Ln(An.x),Hn(An.y)),_.globalAlpha=n.overlay.opacity)}x&&(_.globalAlpha=1,_.strokeStyle="rgba(44,95,124,0.85)",_.lineWidth=1.4/G.k,_.setLineDash([8/G.k,5/G.k]),_.strokeRect(Ln(St.minX),Hn(St.minY),St.bw*fn,St.bh*fn),_.setLineDash([])),_.restore()}const Nr=fn=>[fn*q,Math.max(n.style.wallM*q*2.6,q*.34)];if(P.length>0){const[fn,xn]=k.current,_n=()=>{_.strokeStyle="rgba(44,95,124,0.9)",_.lineWidth=1.6/G.k,_.setLineDash([6/G.k,4/G.k])},Ln=En=>{const Gn=Math.round(En*10)/10;return Number.isInteger(Gn)?Gn.toFixed(0):Gn.toFixed(1)},Hn=(En,Gn)=>{const Bn=Yo(En,Gn),Dn=Bn.x1-Bn.x0,rr=Bn.y1-Bn.y0;if(!(Dn>0)||!(rr>0))return;const qn=`${Ln(Dn)} × ${Ln(rr)} m`,[ge,On]=jr(Gn,(Bn.x0+Bn.x1)/2,(Bn.y0+Bn.y1)/2),er=G.k,He=12.5/er,kt=ge*q,_t=On*q;_.setLineDash([]),_.font=`600 ${He}px Pretendard, sans-serif`,_.textAlign="center",_.textBaseline="middle";const We=_.measureText(qn).width,Gt=7/er,vl=4/er,Vt=We+Gt*2,ns=He+vl*2;_.fillStyle="rgba(250,246,238,0.92)",_.fillRect(kt-Vt/2,_t-ns/2,Vt,ns),_.strokeStyle="rgba(44,95,124,0.55)",_.lineWidth=1/er,_.strokeRect(kt-Vt/2,_t-ns/2,Vt,ns),_.fillStyle="#2c5f7c",_.fillText(qn,kt,_t)};for(const En of P){const Gn=Ro.find(On=>On.id===En);if(Gn){_.save(),_.translate(fn*q,xn*q),_.strokeStyle="rgba(44,95,124,0.9)",_.lineWidth=Math.max(Gn.width*q,1.2/G.k)+4/G.k,_.lineCap="round",_.lineJoin="round",_.setLineDash([7/G.k,5/G.k]),_.beginPath(),Gn.pts.forEach(([On,er],He)=>He?_.lineTo(On*q,er*q):_.moveTo(On*q,er*q)),Gn.pts.length===1&&_.lineTo(Gn.pts[0][0]*q,Gn.pts[0][1]*q),_.stroke(),_.setLineDash([]),_.restore();continue}const Bn=(n.images??[]).find(On=>On.id===En);if(Bn){const On=ml(Bn),er=ws({...Bn,...On});_.save(),_.translate(fn*q,xn*q),_n(),_.stroke(Ss(er,q)),Hn(er,On.rot),_.restore();continue}const Dn=n.geo.find(On=>On.id===En)??(n.struct??[]).find(On=>On.id===En)??(n.zones??[]).find(On=>On.id===En);if(Dn){_.save(),_.translate(fn*q,xn*q),_n(),_.stroke(Ss(Dn.poly,q)),Hn(Dn.poly,Dn.rot??0),_.restore();continue}const rr=(n.doors??[]).find(On=>On.id===En),qn=(n.stairs??[]).find(On=>On.id===En),ge=(n.texts??[]).find(On=>On.id===En);if(rr){const[On,er]=Nr(rr.w);_.save(),_.translate((rr.x+fn)*q,(rr.y+xn)*q),_.rotate(rr.angle),_n(),_.strokeRect(-On/2-2/G.k,-er/2-2/G.k,On+4/G.k,er+4/G.k),_.restore()}else if(qn){const On=qn.x2-qn.x1,er=qn.y2-qn.y1,He=Math.hypot(On,er)||1;_.save(),_.translate((qn.x1+fn)*q,(qn.y1+xn)*q),_.rotate(Math.atan2(er,On)),_n(),_.strokeRect(-3/G.k,-qn.w/2*q-3/G.k,He*q+6/G.k,qn.w*q+6/G.k),_.restore()}else if(ge){const On=gu(ge)*q;_.save(),_.translate((ge.x+fn)*q,(ge.y+xn)*q),_n(),_.strokeRect(-3/G.k,-ge.size*.7*q-3/G.k,On+6/G.k,ge.size*1.4*q+6/G.k),_.restore()}else{const On=(n.markers??[]).find(er=>er.id===En);On&&(_.save(),_n(),_.beginPath(),_.arc((On.x+fn)*q,(On.y+xn)*q,Ca*q+3/G.k,0,Math.PI*2),_.stroke(),_.restore())}}_.setLineDash([]);const An=(()=>{if(P.length!==1)return null;const En=P[0],Gn=n.geo.find(Dn=>Dn.id===En)??(n.struct??[]).find(Dn=>Dn.id===En)??(n.zones??[]).find(Dn=>Dn.id===En);if(Gn)return{poly:Gn.poly,rot:Gn.rot??0};const Bn=(n.images??[]).find(Dn=>Dn.id===En);if(Bn){const Dn=ml(Bn);return{poly:ws({...Bn,...Dn}),rot:Dn.rot}}return null})();if(An&&!H.current&&!R.current){const En=A.current,Gn=w.current??An.poly,Bn=En?En.mode==="rotate"?En.newRot:En.rot0:An.rot;w.current&&(_n(),_.stroke(Ss(w.current,q)),_.setLineDash([]));const Dn=Yo(Gn,Bn),rr=G.k,qn=wp/rr/2,ge=(We,Gt)=>{_.fillStyle="#FAF6EE",_.strokeStyle="rgba(44,95,124,0.95)",_.lineWidth=1.4/rr,_.fillRect(We*q-qn,Gt*q-qn,qn*2,qn*2),_.strokeRect(We*q-qn,Gt*q-qn,qn*2,qn*2)};for(const[We,Gt]of[[Dn.x0,Dn.y0],[Dn.x1,Dn.y0],[Dn.x1,Dn.y1],[Dn.x0,Dn.y1]]){const[vl,Vt]=jr(Bn,We,Gt);ge(vl,Vt)}const On=(Dn.x0+Dn.x1)/2,[er,He]=jr(Bn,On,Dn.y0),[kt,_t]=jr(Bn,On,Dn.y0-vp/rr/q);if(_.strokeStyle="rgba(44,95,124,0.7)",_.lineWidth=1.2/rr,_.beginPath(),_.moveTo(er*q,He*q),_.lineTo(kt*q,_t*q),_.stroke(),_.beginPath(),_.arc(kt*q,_t*q,wp*.7/rr,0,Math.PI*2),_.fillStyle="#FAF6EE",_.fill(),_.strokeStyle="rgba(44,95,124,0.95)",_.lineWidth=1.4/rr,_.stroke(),(En==null?void 0:En.mode)==="rotate"){const We=Math.round(En.newRot*180/Math.PI);_.fillStyle="rgba(44,95,124,0.95)",_.font=`${12/rr}px "JetBrains Mono", monospace`,_.textAlign="center",_.fillText(`${We}°`,kt*q,_t*q-12/rr)}}}if(R.current){const{a:fn,b:xn}=R.current;_.fillStyle="rgba(44,95,124,0.08)",_.strokeStyle="rgba(44,95,124,0.8)",_.lineWidth=1.2/G.k,_.setLineDash([5/G.k,4/G.k]);const _n=Math.min(fn[0],xn[0])*q,Ln=Math.min(fn[1],xn[1])*q,Hn=Math.abs(xn[0]-fn[0])*q,An=Math.abs(xn[1]-fn[1])*q;_.fillRect(_n,Ln,Hn,An),_.strokeRect(_n,Ln,Hn,An),_.setLineDash([])}if(O.current&&I.current&&r==="stair"){const[fn,xn]=O.current,[_n,Ln]=I.current,Hn=_n-fn,An=Ln-xn,En=Math.hypot(Hn,An);En>.01&&(_.save(),_.translate(fn*q,xn*q),_.rotate(Math.atan2(An,Hn)),_.fillStyle="rgba(44,95,124,0.16)",_.strokeStyle="rgba(44,95,124,0.9)",_.lineWidth=1.6/G.k,_.setLineDash([6/G.k,4/G.k]),_.fillRect(0,-a/2*q,En*q,a*q),_.strokeRect(0,-a/2*q,En*q,a*q),_.setLineDash([]),_.restore())}if(r==="door"&&z.current){const fn=z.current,[xn,_n]=Nr(s);_.save(),_.translate(fn.x*q,fn.y*q),_.rotate(fn.angle),_.fillStyle="rgba(44,95,124,0.16)",_.strokeStyle="rgba(44,95,124,0.9)",_.lineWidth=1.6/G.k,_.setLineDash([6/G.k,4/G.k]),_.fillRect(-xn/2,-_n/2,xn,_n),_.strokeRect(-xn/2,-_n/2,xn,_n),_.setLineDash([]),_.restore()}const Cr=()=>{const fn=r==="zone"?mu[d]:e?"184,84,80":m==="struct"?"26,24,20":m==="cover"?"201,169,97":"44,95,124";_.fillStyle=`rgba(${fn},0.18)`,_.strokeStyle=`rgba(${fn},0.9)`,_.lineWidth=1.6/G.k,_.setLineDash([6/G.k,4/G.k])};if(O.current&&I.current&&(r==="rect"||r==="ellipse")){const[fn,xn]=O.current,[_n,Ln]=I.current,Hn=r==="rect"?pu(fn,xn,_n,Ln):_f(fn,xn,_n,Ln);Cr();const An=Ss(Hn,q);_.fill(An,"evenodd"),_.stroke(An),_.setLineDash([])}if(Z.length>0&&(r==="polygon"||r==="corridor"||r==="zone")){Cr(),_.beginPath(),Z.forEach(([xn,_n],Ln)=>Ln?_.lineTo(xn*q,_n*q):_.moveTo(xn*q,_n*q));const fn=K.current;fn&&_.lineTo(fn[0]*q,fn[1]*q),(r==="polygon"||r==="zone")&&Z.length>=2&&_.closePath(),_.stroke(),_.setLineDash([]);for(const[xn,_n]of Z)_.beginPath(),_.arc(xn*q,_n*q,3.5/G.k,0,Math.PI*2),_.fillStyle="#2C5F7C",_.fill()}const Cn=K.current;if(Cn&&r!=="select"&&r!=="door"&&G.k*q>=4){_.strokeStyle="rgba(26,24,20,0.55)",_.lineWidth=1.2/G.k;const fn=5/G.k;_.beginPath(),_.moveTo(Cn[0]*q-fn,Cn[1]*q),_.lineTo(Cn[0]*q+fn,Cn[1]*q),_.moveTo(Cn[0]*q,Cn[1]*q-fn),_.lineTo(Cn[0]*q,Cn[1]*q+fn),_.stroke()}_.setTransform(1,0,0,1,0,0)},[_r,br,r,e,m,d,h,f,Lo,qi,zd,n.geo,n.struct,n.zones,n.doors,n.stairs,n.texts,n.markers,n.images,Ro,n.style,n.overlay,P,Z,s,a,x,wt,$d,St,Wd]);Hd.current=Gd,M.useEffect(()=>{$n()},[Gd,$n]),M.useEffect(()=>{F([]),Y([]),pn(null),O.current=null,I.current=null,R.current=null,j.current=null,A.current=null,w.current=null,U.current=null},[n.id]),M.useEffect(()=>{r==="draw"&&(Y([]),A.current=null,w.current=null)},[r]),M.useEffect(()=>{const D=g.current,L=E.current;if(!D||!L)return;const on=L.clientWidth,W=L.clientHeight,an=_r*q,V=br*q,_=Math.max(.02,Math.min(12,Math.min((on-xp*2)/an,(W-xp*2)/V))),G=cl().scaleExtent([_*.5,12]).translateExtent([[-an*.5,-V*.5],[an*1.5,V*1.5]]).filter(vn=>vn.type==="wheel"?!0:vn.type==="dblclick"?!1:C.current||vn.button===1).on("zoom",vn=>{p.current=vn.transform,$n()}),nn=Or(D);return nn.call(G),nn.call(G.transform,fe.translate((on-an*_)/2,(W-V*_)/2).scale(_)),()=>{nn.on(".zoom",null)}},[n.id,_r,br]),M.useEffect(()=>{const D=V=>{const _=V.target.tagName;if(!(_==="INPUT"||_==="TEXTAREA")){if(V.code==="Space"){V.type==="keydown"?(C.current=!0,V.preventDefault()):C.current=!1,E.current&&(E.current.dataset.panning=String(C.current));return}if(V.type==="keydown"){if((V.ctrlKey||V.metaKey)&&V.key.toLowerCase()==="c"){if(P.length===0){N.current&&(N.current=null,y==null||y("도형 클립보드를 비웠습니다 — 이제 Ctrl+V로 클립보드 이미지를 붙입니다"));return}const G=nn=>P.includes(nn);N.current={geo:n.geo.filter(nn=>G(nn.id)).map(nn=>({...nn,poly:nn.poly.map(vn=>vn.map(([Mn,jn])=>[Mn,jn]))})),struct:(n.struct??[]).filter(nn=>G(nn.id)).map(nn=>({...nn,poly:nn.poly.map(vn=>vn.map(([Mn,jn])=>[Mn,jn]))})),zones:(n.zones??[]).filter(nn=>G(nn.id)).map(nn=>({...nn,poly:nn.poly.map(vn=>vn.map(([Mn,jn])=>[Mn,jn]))})),doors:(n.doors??[]).filter(nn=>G(nn.id)).map(nn=>({...nn})),stairs:(n.stairs??[]).filter(nn=>G(nn.id)).map(nn=>({...nn})),texts:(n.texts??[]).filter(nn=>G(nn.id)).map(nn=>({...nn})),markers:(n.markers??[]).filter(nn=>G(nn.id)).map(nn=>({...nn})),pastes:0};return}if((V.ctrlKey||V.metaKey)&&V.key.toLowerCase()==="v"){const G=performance.now();window.setTimeout(()=>{ln.current<G&&L()},0);return}if(V.key==="Enter"&&Z.length>0&&Kd(),V.key==="Escape"&&Z.length>0?(V.stopPropagation(),F([]),$n()):V.key==="Escape"&&P.length>0&&(V.stopPropagation(),Y([]),$n()),(V.key==="Delete"||V.key==="Backspace")&&P.length>0){const G=(xn,_n)=>(xn??[]).some(Ln=>Ln.id===_n),nn=P.filter(xn=>G(n.doors,xn)),vn=P.filter(xn=>G(n.stairs,xn)),Mn=P.filter(xn=>G(n.texts,xn)),jn=P.filter(xn=>G(n.markers,xn)),ar=P.filter(xn=>G(n.struct,xn)),Nr=P.filter(xn=>G(n.zones,xn)),Cr=P.filter(xn=>G(n.images,xn)),Cn=P.filter(xn=>G(n.strokes,xn)),fn=P.filter(xn=>n.geo.some(_n=>_n.id===xn));Cn.length&&fl(n.id,Cn),Cr.length&&kr(n.id,Cr),nn.length&&tn(n.id,nn),vn.length&&b(n.id,vn),Mn.length&&bn(n.id,Mn),jn.length&&Ly(n.id,jn),ar.length&&dn(n.id,ar),Nr.length&&Pn(n.id,Nr),fn.length&&wn(n.id,fn),Y([])}}}},L=()=>{const V=N.current;if(!V)return;V.pastes+=1;const _=V.pastes*2,G=[],nn=V.geo.map(Cn=>{const fn=Tn("geo");return G.push(fn),{id:fn,op:Cn.op,poly:Cn.poly.map(xn=>xn.map(([_n,Ln])=>[_n+_,Ln+_]))}}),vn=V.struct.map(Cn=>{const fn=Tn("st");return G.push(fn),{id:fn,op:Cn.op,low:Cn.low,poly:Cn.poly.map(xn=>xn.map(([_n,Ln])=>[_n+_,Ln+_]))}}),Mn=V.zones.map(Cn=>{const fn=Tn("zn");return G.push(fn),{id:fn,kind:Cn.kind,poly:Cn.poly.map(xn=>xn.map(([_n,Ln])=>[_n+_,Ln+_]))}}),jn=V.doors.map(Cn=>{const fn=Tn("door");return G.push(fn),{...Cn,id:fn,x:Cn.x+_,y:Cn.y+_}}),ar=V.stairs.map(Cn=>{const fn=Tn("str");return G.push(fn),{...Cn,id:fn,x1:Cn.x1+_,y1:Cn.y1+_,x2:Cn.x2+_,y2:Cn.y2+_}}),Nr=V.texts.map(Cn=>{const fn=Tn("txt");return G.push(fn),{...Cn,id:fn,x:Cn.x+_,y:Cn.y+_}}),Cr=V.markers.map(Cn=>{const fn=Tn("mk");return G.push(fn),{...Cn,id:fn,x:Cn.x+_,y:Cn.y+_}});G.length&&(Dy(n.id,{geo:nn,struct:vn,zones:Mn,doors:jn,stairs:ar,texts:Nr,markers:Cr}),Y(G))},on=V=>{var Nr,Cr;const _=(Nr=V.target)==null?void 0:Nr.tagName;if(_==="INPUT"||_==="TEXTAREA")return;if(ln.current=performance.now(),N.current){L();return}const G=(Cr=V.clipboardData)==null?void 0:Cr.items,nn=G?Array.from(G).find(Cn=>Cn.kind==="file"&&Cn.type.startsWith("image/")):void 0,vn=nn==null?void 0:nn.getAsFile();if(!vn){L();return}V.preventDefault();const Mn=p.current,jn=E.current,ar=K.current??(jn?[Mn.invertX(jn.clientWidth/2)/q,Mn.invertY(jn.clientHeight/2)/q]:[_r/2,br/2]);Xd(vn,ar,0)};window.addEventListener("keydown",D,!0),window.addEventListener("keyup",D),window.addEventListener("paste",on);const W=new ResizeObserver(()=>$n());E.current&&W.observe(E.current);const an=new MutationObserver(()=>{v.current=null,$n()});return an.observe(document.documentElement,{attributes:!0,attributeFilter:["data-theme"]}),()=>{window.removeEventListener("keydown",D,!0),window.removeEventListener("keyup",D),window.removeEventListener("paste",on),W.disconnect(),an.disconnect()}},[Z,P,n.id,n.grid,n.geo,n.struct,n.zones,n.doors,n.stairs,n.texts,n.markers,n.images,$n]);const Vd=e?"subtract":"union",gl=D=>t?Ew(D):D,yl=D=>{m==="floor"?cn(n.id,{id:Tn("geo"),op:Vd,poly:D}):Fn(n.id,{id:Tn("st"),op:Vd,low:m==="cover",poly:D})},$y=()=>{const D=O.current,L=I.current;if(O.current=null,I.current=null,!D||!L)return;if(r==="stair"){Math.hypot(L[0]-D[0],L[1]-D[1])>=.5&&J(n.id,{id:Tn("str"),x1:D[0],y1:D[1],x2:L[0],y2:L[1],w:a}),$n();return}if(Math.abs(D[0]-L[0])<.01||Math.abs(D[1]-L[1])<.01){$n();return}const on=r==="rect"?pu(D[0],D[1],L[0],L[1]):_f(D[0],D[1],L[0],L[1]);yl(gl(on))},Ud=(D,L,on,W="")=>{const an=p.current;pn({wx:D,wy:L,sx:an.applyX(D*q),sy:an.applyY(L*q),value:W,id:on})},xl=()=>{const D=T;if(pn(null),!D)return;const L=D.value.trim();D.markerId?Ry(n.id,D.markerId,{label:L}):D.id?L?yn(n.id,D.id,{text:L}):bn(n.id,[D.id]):L&&rn(n.id,{id:Tn("txt"),x:D.wx,y:D.wy,text:L,size:l})},Kd=()=>{const D=[];for(const L of Z){const on=D[D.length-1];(!on||Math.abs(on[0]-L[0])>1e-6||Math.abs(on[1]-L[1])>1e-6)&&D.push(L)}if(F([]),r==="polygon")D.length>=3&&yl(gl([D]));else if(r==="zone")D.length>=3&&kn(n.id,{id:Tn("zn"),kind:d,poly:[D]});else if(r==="corridor"&&D.length>=2){const on=Iw(D,i);on&&yl(gl(on))}$n()},zy=()=>{if(P.length!==1)return null;const D=P[0],L=n.geo.find(V=>V.id===D);if(L)return{id:D,kind:"geo",poly:L.poly,rot:L.rot??0};const on=(n.struct??[]).find(V=>V.id===D);if(on)return{id:D,kind:"struct",poly:on.poly,rot:on.rot??0};const W=(n.zones??[]).find(V=>V.id===D);if(W)return{id:D,kind:"zone",poly:W.poly,rot:W.rot??0};const an=(n.images??[]).find(V=>V.id===D);return an?{id:D,kind:"image",poly:ws(an),rot:an.rot}:null},By=D=>{const L=zy();if(!L)return null;const on=p.current.k,W=GP/on/q,an=L.rot,V=Yo(L.poly,an),_=(V.x0+V.x1)/2,[G,nn]=jr(an,_,V.y0-vp/on/q);if(Math.hypot(D[0]-G,D[1]-nn)<=W){const[Mn,jn]=jr(an,_,(V.y0+V.y1)/2);return{id:L.id,kind:L.kind,mode:"rotate",base:L.poly,rot0:an,flx:0,fly:0,glx:0,gly:0,sx:1,sy:1,cwx:Mn,cwy:jn,newRot:an}}const vn=[[V.x0,V.y0],[V.x1,V.y0],[V.x1,V.y1],[V.x0,V.y1]];for(const[Mn,jn]of vn){const[ar,Nr]=jr(an,Mn,jn);if(Math.hypot(D[0]-ar,D[1]-Nr)<=W){const Cr=Mn===V.x0?V.x1:V.x0,Cn=jn===V.y0?V.y1:V.y0;return{id:L.id,kind:L.kind,mode:"scale",base:L.poly,rot0:an,flx:Cr,fly:Cn,glx:Mn,gly:jn,sx:1,sy:1,cwx:0,cwy:0,newRot:an}}}return null},Hy=D=>{if(D.button!==0||C.current)return;const L=Wt(D);if(!L)return;const on=pl(L);if(T){xl();return}if(r==="draw"){D.target.setPointerCapture(D.pointerId),U.current=[L],$n();return}if(x&&n.overlay.visible){D.target.setPointerCapture(D.pointerId),j.current={x:L[0],y:L[1],tx:n.overlay.tx||0,ty:n.overlay.ty||0};return}if(Z.length===0){const W=By(L);if(W){D.target.setPointerCapture(D.pointerId),A.current=W,w.current=null,$n();return}}if(r!=="select"&&Z.length===0){const W=Jl(L[0],L[1],n.texts??[])??ql(L[0],L[1],n.markers??[])??Pf(L[0],L[1],n.doors??[])??Tf(L[0],L[1],n.stairs??[])??Cf(L[0],L[1],n.zones??[]);if(W){D.target.setPointerCapture(D.pointerId),P.includes(W)||Y([W]),H.current=L,k.current=[0,0],$n();return}if((r==="rect"||r==="ellipse")&&!e){const an=m==="floor"?vs(L[0],L[1],n.geo):vs(L[0],L[1],n.struct??[]);if(an){D.target.setPointerCapture(D.pointerId),P.includes(an)||Y([an]),H.current=L,k.current=[0,0],$n();return}}}if(r!=="select"&&Z.length===0&&P.length>0&&(Y([]),$n()),r==="door"){const W=bf(L[0],L[1],Bd,1.2,s);W&&$(n.id,{id:Tn("door"),x:W.x,y:W.y,angle:W.angle,w:s});return}if(r!=="text"){if(r==="marker"){Oy(n.id,{id:Tn("mk"),x:on[0],y:on[1],kind:c});return}if(r==="select"){const W=Jl(L[0],L[1],n.texts??[])??ql(L[0],L[1],n.markers??[])??Pf(L[0],L[1],n.doors??[])??Tf(L[0],L[1],n.stairs??[])??Lw(L[0],L[1],Ro)??Cf(L[0],L[1],n.zones??[])??vs(L[0],L[1],n.struct??[])??vs(L[0],L[1],n.geo)??Dw(L[0],L[1],n.images??[]);D.target.setPointerCapture(D.pointerId),W?(P.includes(W)||Y([W]),H.current=L,k.current=[0,0]):(Y([]),R.current={a:L,b:L}),$n();return}if(r==="rect"||r==="ellipse"||r==="stair"){D.target.setPointerCapture(D.pointerId),O.current=on,I.current=on,$n();return}F(W=>[...W,on]),$n()}},Wy=D=>{const L=Wt(D);if(!L)return;const on=pl(L);if(K.current=r==="select"||r==="door"||r==="draw"?L:on,U.current){const an=U.current[U.current.length-1];Math.hypot(L[0]-an[0],L[1]-an[1])>=UP&&(U.current.push(L),$n());return}if(x&&j.current){const an=j.current;Fy(n.id,{overlay:{...n.overlay,tx:an.tx+(L[0]-an.x)*q,ty:an.ty+(L[1]-an.y)*q}});return}const W=A.current;if(W){if(W.mode==="scale"){const an=jr(-W.rot0,L[0],L[1]);let V=an[0],_=an[1];o&&(V=W.flx+Math.round((an[0]-W.flx)/o)*o,_=W.fly+Math.round((an[1]-W.fly)/o)*o);let G=(V-W.flx)/(W.glx-W.flx||1),nn=(_-W.fly)/(W.gly-W.fly||1);G=Math.max(.05,Math.min(40,G)),nn=Math.max(.05,Math.min(40,nn)),W.sx=G,W.sy=nn,w.current=kp(W.base,(vn,Mn)=>{const jn=jr(-W.rot0,vn,Mn);return jr(W.rot0,W.flx+(jn[0]-W.flx)*G,W.fly+(jn[1]-W.fly)*nn)})}else{const an=Math.atan2(L[1]-W.cwy,L[0]-W.cwx)+Math.PI/2;W.newRot=Math.round(an/Sp)*Sp;const V=W.newRot-W.rot0,_=Math.cos(V),G=Math.sin(V);w.current=kp(W.base,(nn,vn)=>[W.cwx+(nn-W.cwx)*_-(vn-W.cwy)*G,W.cwy+(nn-W.cwx)*G+(vn-W.cwy)*_])}$n();return}if(r==="door"&&!H.current?z.current=bf(L[0],L[1],Bd,1.2,s):z.current&&(z.current=null),y){const an=Lo.length>0;y(`(${on[0].toFixed(2)}, ${on[1].toFixed(2)}) · ${_r}m × ${br}m · 벽 ${n.style.wallM}m`+(m!=="floor"?m==="struct"?" · 대상: 구조":m==="cover"?" · 대상: 엄폐":` · 대상: 동선 · 두께 ${f}m`:"")+(e?" · 빼기 모드":"")+(t?" · 러프":"")+(o?` · 스냅 ${o}셀`:" · 스냅 끔")+(r==="draw"?" · 드래그로 자유 드로잉":an?"":" · 사각형(R)으로 첫 방을 그려보세요")+(r==="door"&&an&&!z.current?" · 벽 가까이에서 클릭하면 문이 놓입니다":"")+(x?" · 오버레이 조정 — 드래그로 이동":"")+(P.length>1?` · 선택 ${P.length}개`:""))}if(r==="select"&&R.current)R.current.b=L;else if(H.current&&P.length>0){const[an,V]=H.current;let _=L[0]-an,G=L[1]-V;o&&(_=Math.round(_/o)*o,G=Math.round(G/o)*o),k.current=[_,G]}else O.current&&(I.current=on);$n()},Gy=D=>{if(U.current){const L=U.current;U.current=null;const on=Wt(D);if(on){const W=L[L.length-1];Math.hypot(on[0]-W[0],on[1]-W[1])>1e-6&&L.push(on)}Oo(n.id,{id:Tn("stk"),pts:L,color:h,width:f}),$n();return}if(x&&j.current){j.current=null;return}if(A.current){const L=A.current,on=w.current;if(A.current=null,w.current=null,on){if(L.kind==="image"){const an=L.mode==="rotate"?L.newRot:L.rot0,V=Yo(on,an),[_,G]=jr(an,(V.x0+V.x1)/2,(V.y0+V.y1)/2);oe(n.id,L.id,{x:_,y:G,w:V.x1-V.x0,h:V.y1-V.y0,rot:an}),$n();return}let W;if(L.kind!=="zone"){const an=(n.doors??[]).filter(V=>Di(V.x,V.y,L.base)<=.45);an.length&&(W=an.map(V=>{if(L.mode==="scale"){const vn=jr(-L.rot0,V.x,V.y),[Mn,jn]=jr(L.rot0,L.flx+(vn[0]-L.flx)*L.sx,L.fly+(vn[1]-L.fly)*L.sy);return{id:V.id,x:Mn,y:jn,angle:V.angle}}const _=L.newRot-L.rot0,G=Math.cos(_),nn=Math.sin(_);return{id:V.id,x:L.cwx+(V.x-L.cwx)*G-(V.y-L.cwy)*nn,y:L.cwy+(V.x-L.cwx)*nn+(V.y-L.cwy)*G,angle:V.angle+_}}))}Zy(n.id,{kind:L.kind,id:L.id,poly:on,doors:W,rot:L.mode==="rotate"?L.newRot:void 0})}$n();return}if(r==="text"&&!H.current){const L=Wt(D);if(L){const on=pl(L);Ud(on[0],on[1])}return}if(r==="select"&&R.current){const{a:L,b:on}=R.current;R.current=null;const W=Math.min(L[0],on[0]),an=Math.max(L[0],on[0]),V=Math.min(L[1],on[1]),_=Math.max(L[1],on[1]);if(an-W>.05||_-V>.05){const G=[];for(const nn of[...n.geo,...n.struct??[],...n.zones??[]]){let vn=1/0,Mn=1/0,jn=-1/0,ar=-1/0;for(const Nr of nn.poly)for(const[Cr,Cn]of Nr)vn=Math.min(vn,Cr),jn=Math.max(jn,Cr),Mn=Math.min(Mn,Cn),ar=Math.max(ar,Cn);jn>=W&&vn<=an&&ar>=V&&Mn<=_&&G.push(nn.id)}for(const nn of n.doors??[])nn.x>=W&&nn.x<=an&&nn.y>=V&&nn.y<=_&&G.push(nn.id);for(const nn of n.stairs??[]){const vn=(nn.x1+nn.x2)/2,Mn=(nn.y1+nn.y2)/2;vn>=W&&vn<=an&&Mn>=V&&Mn<=_&&G.push(nn.id)}for(const nn of n.texts??[]){const vn=gu(nn);nn.x+vn>=W&&nn.x<=an&&nn.y+nn.size*.7>=V&&nn.y-nn.size*.7<=_&&G.push(nn.id)}for(const nn of n.markers??[])nn.x>=W&&nn.x<=an&&nn.y>=V&&nn.y<=_&&G.push(nn.id);for(const nn of Ro){const vn=Rw(nn);vn.x1>=W&&vn.x0<=an&&vn.y1>=V&&vn.y0<=_&&G.push(nn.id)}for(const nn of n.images??[]){const vn=ws(nn)[0],Mn=vn.map(ar=>ar[0]),jn=vn.map(ar=>ar[1]);Math.max(...Mn)>=W&&Math.min(...Mn)<=an&&Math.max(...jn)>=V&&Math.min(...jn)<=_&&G.push(nn.id)}Y(G)}$n();return}if(H.current&&P.length>0){const[L,on]=k.current;if(H.current=null,k.current=[0,0],L!==0||on!==0){const W=P.filter(G=>n.geo.some(nn=>nn.id===G)),an=P.filter(G=>(n.struct??[]).some(nn=>nn.id===G)),V=P.filter(G=>(n.zones??[]).some(nn=>nn.id===G));W.length&&Nn(n.id,W,L,on),an.length&&un(n.id,an,L,on),V.length&&Sn(n.id,V,L,on);const _=[...n.geo.filter(G=>W.includes(G.id)),...(n.struct??[]).filter(G=>an.includes(G.id))];for(const G of P){if(W.includes(G)||an.includes(G)||V.includes(G))continue;const nn=(n.doors??[]).find(vn=>vn.id===G);nn&&_.some(vn=>Di(nn.x,nn.y,vn.poly)<=.45)||In(n.id,G,L,on)}}$n();return}O.current&&$y()},Vy=D=>{if((r==="polygon"||r==="corridor"||r==="zone")&&Z.length>0){Kd();return}if(r==="select"){const L=Wt(D);if(!L)return;const on=Jl(L[0],L[1],n.texts??[]),W=on?(n.texts??[]).find(_=>_.id===on):null;if(W){Ud(W.x,W.y,W.id,W.text);return}const an=ql(L[0],L[1],n.markers??[]),V=an?(n.markers??[]).find(_=>_.id===an):null;if(V){const _=p.current;pn({wx:V.x,wy:V.y,sx:_.applyX((V.x+Ca+.6)*q),sy:_.applyY(V.y*q),value:V.label??"",markerId:V.id})}}},Uy=()=>{K.current=null,z.current=null,$n()},Xd=async(D,L,on=0)=>{try{const W=await sC(D);if(!W)return;const V=Math.max(8,Math.round(Math.max(_r,br)*VP))/Math.max(W.w,W.h),_=Tn("tdimg");sr(n.id,{id:_,x:L[0]+on*2,y:L[1]+on*2,w:W.w*V,h:W.h*V,rot:0,src:W.src,createdAt:Date.now()}),Y([_]),y==null||y(`이미지 배치 — ${Math.round(W.w*V)}m × ${Math.round(W.h*V)}m · 선택(V)에서 이동·모서리 크기·손잡이 회전`)}catch(W){y==null||y(`이미지 불러오기 실패 — ${W.message??W}`)}},Ky=D=>{D.dataTransfer.types.includes("Files")&&(D.preventDefault(),D.dataTransfer.dropEffect="copy",en||Q(!0))},Xy=D=>{D.currentTarget.contains(D.relatedTarget)||Q(!1)},Yy=D=>{D.preventDefault(),Q(!1);const L=Array.from(D.dataTransfer.files??[]).filter(W=>W.type.startsWith("image/"));if(L.length===0)return;const on=Wt(D);on&&L.forEach((W,an)=>void Xd(W,on,an))};return u.jsxs("div",{ref:E,className:`td-canvas-wrap${en?" is-drop-hover":""}`,"data-tool":r,"data-erase":e,"data-calibrating":x,onDragOver:Ky,onDragLeave:Xy,onDrop:Yy,children:[u.jsx("canvas",{ref:g,className:"td-canvas","data-testid":"topdown-canvas",onPointerDown:Hy,onPointerMove:Wy,onPointerUp:Gy,onDoubleClick:Vy,onPointerLeave:Uy,onContextMenu:D=>D.preventDefault()}),T&&u.jsx("input",{className:"td-text-input","data-testid":"td-text-input",autoFocus:!0,placeholder:"라벨 입력…",style:{left:T.sx,top:T.sy,fontSize:Math.max(15,l*q*p.current.k)},value:T.value,onChange:D=>pn({...T,value:D.target.value}),onBlur:xl,onKeyDown:D=>{D.key==="Enter"&&xl(),D.key==="Escape"&&(D.stopPropagation(),pn(null))}})]})}const _p=[{id:"select",label:"선택",key:"V",title:"선택 (V) — 클릭으로 도형 선택, 드래그로 이동, Delete 삭제"},{id:"rect",label:"사각형",key:"R",title:"사각형 방 (R) — 드래그. 겹치면 자동 병합"},{id:"ellipse",label:"원형",key:"O",title:"원형/타원 방 (O) — 드래그"},{id:"polygon",label:"다각형",key:"P",title:"다각형 방 (P) — 클릭으로 점, 더블클릭/Enter 완성, Esc 취소"},{id:"draw",label:"드로잉",key:"B",title:"드로잉 (B) — 드래그로 자유롭게 그리는 동선. 색·두께 설정 가능"},{id:"corridor",label:"복도",key:"C",title:"복도 (C) — 클릭으로 경로, 더블클릭/Enter 완성. 폭 설정 가능"},{id:"door",label:"문",key:"D",title:"문 (D) — 벽 가까이 클릭하면 벽에 스냅되어 배치. 선택(V) 후 Delete로 삭제"},{id:"stair",label:"계단",key:"S",title:"계단 (S) — 드래그. 드래그 방향이 올라가는 방향 (끝이 좁아짐)"},{id:"text",label:"텍스트",key:"T",title:"텍스트 (T) — 클릭 후 입력, Enter 확정. 선택(V) 더블클릭으로 수정"},{id:"marker",label:"마커",key:"M",title:"마커 (M) — 종류 선택 후 클릭 배치. 선택(V) 더블클릭으로 라벨 편집"},{id:"zone",label:"구역",key:"Z",title:"구역 (Z) — 클릭으로 다각형, Enter 완성. 안전(파랑)/위험(빨강) 반투명 채움"}];function YP(){const n=B(b=>b.project),r=B(b=>b.activeTopdownId),e=B(b=>b.exitTopdown),t=B(b=>b.setActiveTopdown),o=B(b=>b.addTopdown),i=B(b=>b.removeTopdown),s=B(b=>b.renameTopdown),a=B(b=>b.updateTopdown),l=B(b=>b.clearStrokes),[c,d]=M.useState("rect"),[h,f]=M.useState(!1),[m,x]=M.useState(!1),[y,E]=M.useState(1),[g,p]=M.useState(6),[v,S]=M.useState(2),[C,O]=M.useState(2),[I,Z]=M.useState(2),[F,K]=M.useState("start"),[P,Y]=M.useState("floor"),[H,k]=M.useState("safe"),[R,j]=M.useState("moss"),[A,w]=M.useState(2),[N,z]=M.useState(!1),[U,T]=M.useState(!1),[pn,X]=M.useState({past:0,future:0});M.useEffect(()=>{const b=B.temporal,rn=()=>{const bn=b.getState();X({past:bn.pastStates.length,future:bn.futureStates.length})};rn();const yn=b.subscribe(rn);return()=>yn()},[]);const[en,Q]=M.useState(""),[ln,cn]=M.useState(null),[wn,Nn]=M.useState(""),Fn=n.topdowns??[],dn=Fn.find(b=>b.id===r)??Fn[0]??null,un=b=>b==="draw"||b==="select",kn=b=>{P==="path"&&!un(b)||(d(b),b==="draw"&&Y("path"))},Pn=b=>{Y(b),d(rn=>b==="path"?"draw":rn==="draw"?"rect":rn)};if(M.useEffect(()=>{const b=rn=>{const yn=rn.target.tagName;if(yn==="INPUT"||yn==="TEXTAREA"||rn.ctrlKey||rn.metaKey||rn.altKey)return;if(rn.key==="Escape"){T(sr=>!sr);return}const bn=rn.key.toUpperCase(),In=_p.find(sr=>sr.key===bn);if(In){kn(In.id);return}bn==="E"&&f(sr=>!sr),bn==="F"&&x(sr=>!sr),bn==="1"&&Pn("floor"),bn==="2"&&Pn("struct"),bn==="3"&&Pn("cover"),bn==="4"&&Pn("path")};return window.addEventListener("keydown",b),()=>window.removeEventListener("keydown",b)},[P]),!dn)return u.jsxs("div",{className:"td-shell td-shell-empty",children:[u.jsx("p",{children:"평면도가 없습니다."}),u.jsx("button",{className:"td-btn",onClick:()=>o(),children:"+ 평면도 만들기"})]});const Sn=dn.grid[0],$=(b,rn)=>{cn(b),Nn(rn)},tn=()=>{ln&&wn.trim()&&s(ln,wn.trim()),cn(null)},J=(b,rn)=>{const yn=Fn.find(In=>In.id===b),bn=yn?yn.geo.length:0;bn>0&&!window.confirm(`'${rn}'에 도형 ${bn}개가 있습니다. 삭제할까요?`)||i(b)};return u.jsxs("div",{className:"td-shell","data-testid":"topdown-shell",children:[u.jsxs("div",{className:"td-bar",children:[u.jsx("button",{className:"td-btn td-back",onClick:e,title:"버블 다이어그램으로 (Esc)",children:"← 버블"}),u.jsxs("div",{className:"td-tabs",role:"tablist",children:[Fn.map(b=>u.jsx("div",{role:"tab","aria-selected":b.id===dn.id,className:`td-tab ${b.id===dn.id?"is-active":""}`,onClick:()=>t(b.id),onDoubleClick:()=>$(b.id,b.name),title:"더블클릭: 이름 바꾸기",children:ln===b.id?u.jsx("input",{autoFocus:!0,value:wn,onChange:rn=>Nn(rn.target.value),onBlur:tn,onKeyDown:rn=>{rn.key==="Enter"&&tn(),rn.key==="Escape"&&cn(null)}}):u.jsxs(u.Fragment,{children:[u.jsx("span",{className:"td-tab-name",children:b.name}),Fn.length>1&&u.jsx("button",{className:"td-tab-close",onClick:rn=>{rn.stopPropagation(),J(b.id,b.name)},title:"삭제",children:"×"})]})},b.id)),u.jsx("button",{className:"td-btn td-tab-add",onClick:()=>o(),title:"평면도 추가",children:"＋"})]}),u.jsx("div",{className:"td-spacer"}),u.jsx("div",{className:"td-group",role:"toolbar","aria-label":"도구",children:_p.map(b=>{const rn=P==="path"&&!un(b.id);return u.jsx("button",{className:`td-btn td-tool ${c===b.id?"is-active":""}`,onClick:()=>kn(b.id),disabled:rn,title:rn?"동선 레이어에서는 드로잉·선택만 사용합니다 — 바닥/구조/엄폐로 전환하세요":b.title,children:b.label},b.id)})}),u.jsxs("div",{className:"td-group",children:[u.jsx("button",{className:`td-btn td-erase ${h?"is-active":""}`,onClick:()=>f(b=>!b),title:"빼기 모드 (E) — 켜면 도형이 바닥을 파냄 (비밀통로·기둥·동굴 굴곡)",children:"빼기"}),u.jsx("button",{className:`td-btn td-rough ${m?"is-active":""}`,onClick:()=>x(b=>!b),title:"러프 모드 (F) — 켜면 새 도형의 외곽선이 거칠어짐 (동굴·자연 지형)",children:"러프"})]}),u.jsxs("div",{className:"td-group",children:[u.jsx("button",{className:"td-btn td-undo","data-testid":"td-undo",onClick:()=>Cd(),disabled:pn.past===0,title:`되돌리기 (Ctrl+Z) · ${pn.past}`,children:"↶"}),u.jsx("button",{className:"td-btn td-redo","data-testid":"td-redo",onClick:()=>Pd(),disabled:pn.future===0,title:`다시 실행 (Ctrl+Shift+Z / Ctrl+Y) · ${pn.future}`,children:"↷"})]})]}),u.jsxs("div",{className:"td-bar td-bar-sub",children:[u.jsxs("div",{className:"td-group","aria-label":"그리기 대상",children:[u.jsx("button",{className:`td-btn ${P==="floor"?"is-active":""}`,onClick:()=>Pn("floor"),title:"바닥 (1) — 플레이 공간. 그림자·해칭·외벽 자동",children:"바닥"}),u.jsx("button",{className:`td-btn td-target-struct ${P==="struct"?"is-active":""}`,onClick:()=>Pn("struct"),title:"구조 (2) — 내부 벽·기둥·검은 질량. 잉크 솔리드, 문 부착 가능",children:"구조"}),u.jsx("button",{className:`td-btn td-target-cover ${P==="cover"?"is-active":""}`,onClick:()=>Pn("cover"),title:"엄폐 (3) — 낮은 상자·난간·둔덕. 어두운 종이톤 채움",children:"엄폐"}),u.jsx("button",{className:`td-btn td-target-path ${P==="path"?"is-active":""}`,onClick:()=>Pn("path"),title:"동선 (4) — 자유 드로잉 전용 레이어. 도형 병합에 관여하지 않는 주석",children:"동선"})]}),c==="draw"&&u.jsxs(u.Fragment,{children:[u.jsx("div",{className:"td-group","aria-label":"동선 색",children:Nw.map(b=>u.jsxs("button",{className:`td-btn td-stroke-swatch ${R===b.key?"is-active":""}`,"data-stroke":b.key,onClick:()=>j(b.key),title:b.label,"aria-label":b.label,children:[u.jsx("span",{className:"td-stroke-dot"}),b.label]},b.key))}),u.jsxs("div",{className:"td-group","aria-label":"동선 두께",children:[jw.map(b=>u.jsxs("button",{className:`td-btn ${A===b?"is-active":""}`,onClick:()=>w(b),title:`선 두께 ${b}m (${b*100}uu)`,children:[b,"m"]},b)),u.jsxs("button",{className:"td-btn td-stroke-clear","data-testid":"td-stroke-clear",onClick:()=>l(dn.id),disabled:(dn.strokes??[]).length===0,title:`이 평면도의 동선 ${(dn.strokes??[]).length}획을 모두 지웁니다 (Ctrl+Z로 복구)`,children:["비우기 ",(dn.strokes??[]).length]})]})]}),c==="corridor"&&u.jsx("div",{className:"td-group","aria-label":"복도 폭",children:[2,4,6,8].map(b=>u.jsxs("button",{className:`td-btn ${g===b?"is-active":""}`,onClick:()=>p(b),title:`복도 두께 ${b}m (${b*100}uu)`,children:[b,"m"]},b))}),c==="door"&&u.jsx("div",{className:"td-group","aria-label":"문 폭",children:[2,4,6].map(b=>u.jsxs("button",{className:`td-btn ${v===b?"is-active":""}`,onClick:()=>S(b),title:`문 폭 ${b}셀 = ${b}m`,children:[b,"셀"]},b))}),c==="stair"&&u.jsx("div",{className:"td-group","aria-label":"계단 폭",children:[2,4,6].map(b=>u.jsxs("button",{className:`td-btn ${C===b?"is-active":""}`,onClick:()=>O(b),title:`계단 폭 ${b}셀 = ${b}m`,children:[b,"셀"]},b))}),c==="marker"&&u.jsx("div",{className:"td-group","aria-label":"마커 종류",children:Object.keys(ei).map(b=>u.jsxs("button",{className:`td-btn ${F===b?"is-active":""}`,onClick:()=>K(b),title:ei[b].label,children:[ei[b].glyph," ",ei[b].label]},b))}),c==="zone"&&u.jsxs("div",{className:"td-group","aria-label":"구역 종류",children:[u.jsx("button",{className:`td-btn td-zone-safe ${H==="safe"?"is-active":""}`,onClick:()=>k("safe"),title:"안전 지역 — 파란 반투명 채움",children:"안전"}),u.jsx("button",{className:`td-btn td-zone-danger ${H==="danger"?"is-active":""}`,onClick:()=>k("danger"),title:"위험 지역 — 빨간 반투명 채움",children:"위험"})]}),c==="text"&&u.jsx("div",{className:"td-group","aria-label":"텍스트 크기",children:[1,2,4].map(b=>u.jsxs("button",{className:`td-btn ${I===b?"is-active":""}`,onClick:()=>Z(b),title:`글자 높이 ${b}셀`,children:[b,"셀"]},b))}),u.jsx("div",{className:"td-group",children:u.jsxs("select",{className:"td-select",value:y,onChange:b=>E(Number(b.target.value)),title:"스냅 단위 (셀)",children:[u.jsx("option",{value:1,children:"스냅 1"}),u.jsx("option",{value:.5,children:"스냅 ½"}),u.jsx("option",{value:.25,children:"스냅 ¼"}),u.jsx("option",{value:0,children:"스냅 끔"})]})}),u.jsxs("div",{className:"td-group",children:[u.jsx("select",{className:"td-select",value:dn.grid[0],onChange:b=>{const rn=Number(b.target.value);a(dn.id,{grid:[rn,rn]})},title:"작업 범위 (셀)",children:Yv.map(b=>u.jsxs("option",{value:b,children:[b,"×",b]},b))}),u.jsxs("select",{className:"td-select",value:dn.style.wallM,onChange:b=>a(dn.id,{style:{...dn.style,wallM:Number(b.target.value)}}),title:"벽 두께 (실척)",children:[u.jsx("option",{value:.25,children:"벽 0.25m"}),u.jsx("option",{value:.5,children:"벽 0.5m"})]}),u.jsx("button",{className:`td-btn ${dn.style.hatch?"is-active":""}`,onClick:()=>a(dn.id,{style:{...dn.style,hatch:!dn.style.hatch}}),title:"외곽 해칭 켜기/끄기",children:"해칭"})]}),u.jsx("div",{className:"td-group","aria-label":"동선 표시",children:u.jsx("button",{className:`td-btn td-path-toggle ${dn.pathVisible!==!1?"is-active":""}`,"data-testid":"td-path-toggle",onClick:()=>a(dn.id,{pathVisible:dn.pathVisible===!1}),title:`동선 레이어 표시 — 끄면 획 ${(dn.strokes??[]).length}개가 도면·내보내기에서 숨겨집니다 (데이터는 보존)`,children:"동선"})}),u.jsxs("div",{className:"td-group","aria-label":"버블 오버레이",children:[u.jsx("button",{className:`td-btn td-overlay ${dn.overlay.visible?"is-active":""}`,onClick:()=>{const b=!dn.overlay.visible;a(dn.id,{overlay:{...dn.overlay,visible:b}}),b||z(!1)},title:"버블 오버레이 — 버블 다이어그램을 도면 위에 반투명으로 표시 (노드가 없으면 빈 화면)",children:"버블"}),dn.overlay.visible&&u.jsxs(u.Fragment,{children:[u.jsx("input",{className:"td-overlay-range",type:"range",min:10,max:90,step:5,value:Math.round(dn.overlay.opacity*100),onChange:b=>a(dn.id,{overlay:{...dn.overlay,opacity:Number(b.target.value)/100}}),title:`오버레이 투명도 ${Math.round(dn.overlay.opacity*100)}%`}),u.jsx("button",{className:`td-btn td-cal ${N?"is-active":""}`,onClick:()=>z(b=>!b),title:"오버레이 조정 — 켜면 캔버스 드래그로 오버레이 이동, 슬라이더로 스케일",children:"조정"}),N&&u.jsxs(u.Fragment,{children:[u.jsx("input",{className:"td-overlay-range td-cal-range",type:"range",min:30,max:300,step:5,value:Math.round((dn.overlay.scale||1)*100),onChange:b=>a(dn.id,{overlay:{...dn.overlay,scale:Number(b.target.value)/100}}),title:`오버레이 스케일 ${Math.round((dn.overlay.scale||1)*100)}%`}),u.jsx("button",{className:"td-btn",onClick:()=>a(dn.id,{overlay:{...dn.overlay,tx:0,ty:0,scale:1}}),title:"오버레이 위치·스케일을 자동 맞춤으로 되돌리기",children:"리셋"})]})]})]}),u.jsx("div",{className:"td-spacer"}),u.jsxs("div",{className:"td-group",children:[u.jsx("button",{className:"td-btn",onClick:()=>Gw(dn,`${n.name}_${dn.name}.png`),title:"현재 평면도를 PNG로",children:"PNG"}),u.jsx("button",{className:"td-btn",onClick:()=>il(n,`${n.name}.map.json`),title:"맵 전체(버블+평면도)를 JSON으로",children:"맵 JSON"})]})]}),u.jsx(XP,{doc:dn,tool:c,erase:h,rough:m,snap:y,corridorW:g,doorW:v,stairW:C,textSize:I,markerKind:F,strokeColor:R,strokeWidth:A,zoneKind:H,target:P,calibrating:N&&dn.overlay.visible,onStatus:Q}),u.jsxs("div",{className:"td-status",children:[u.jsx("span",{className:"td-status-doc",children:dn.name}),u.jsxs("span",{children:[dn.grid[0],"×",dn.grid[1],"셀 · ",Sn,"m (",Sn*100,"uu) · 도형 ",dn.geo.length," · 구조 ",(dn.struct??[]).length," · 구역 ",(dn.zones??[]).length," · 문 ",(dn.doors??[]).length," · 계단 ",(dn.stairs??[]).length," · 텍스트 ",(dn.texts??[]).length," · 마커 ",(dn.markers??[]).length]}),u.jsx("span",{className:"td-status-hover",children:en}),u.jsx("span",{className:"td-status-hint",children:"휠: 줌 · 스페이스+드래그: 이동 · E: 빼기 · F: 러프 · Ctrl+Z: 실행취소"})]}),U&&Ki.createPortal(u.jsx("div",{className:"pt-confirm-backdrop",onClick:()=>T(!1),children:u.jsxs("div",{className:"pt-confirm","data-testid":"td-exit-confirm",onClick:b=>b.stopPropagation(),children:[u.jsxs("p",{className:"pt-confirm-msg",children:["평면도를 닫고 ",u.jsx("strong",{children:"버블 다이어그램"}),"으로 돌아갈까요?",u.jsx("br",{}),"작업 내용은 그대로 저장되어 있습니다."]}),u.jsxs("div",{className:"pt-confirm-actions",children:[u.jsx("button",{className:"pt-btn","data-testid":"td-exit-cancel",autoFocus:!0,onClick:()=>T(!1),children:"취소"}),u.jsx("button",{className:"pt-btn pt-btn--danger","data-testid":"td-exit-ok",onClick:()=>{T(!1),e()},children:"나가기"})]})]})}),document.body)]})}const yy="bubble-atelier::massing",xy=1;function QP(){try{const n=localStorage.getItem(yy);if(!n)return null;const r=JSON.parse(n);if(r.v!==xy||!Array.isArray(r.docs)||r.docs.length===0)return null;const e=r.docs.map(o=>({...o,grid:Array.isArray(o.grid)?o.grid:[64,64],view:o.view??{dir:0},blocks:Array.isArray(o.blocks)?o.blocks:[]})),t=e.some(o=>o.id===r.currentId)?r.currentId:e[0].id;return{docs:e,currentId:t}}catch{return null}}const fr=tl()(ol((n,r)=>{const t=QP()??(()=>{const i=Ul(Tn("ms"));return{docs:[i],currentId:i.id}})(),o=(i,s)=>n(a=>({docs:a.docs.map(l=>l.id===i?s(l):l)}));return{...t,setActive:i=>{r().docs.some(s=>s.id===i)&&n({currentId:i})},addDoc:i=>{const s=Ul(Tn("ms"),i??`매싱 ${r().docs.length+1}`);return n(a=>({docs:[...a.docs,s],currentId:s.id})),s.id},removeDoc:i=>n(s=>{const a=s.docs.filter(l=>l.id!==i);if(a.length===0){const l=Ul(Tn("ms"));return{docs:[l],currentId:l.id}}return{docs:a,currentId:s.currentId===i?a[0].id:s.currentId}}),renameDoc:(i,s)=>o(i,a=>({...a,name:s})),updateDoc:(i,s)=>o(i,a=>({...a,...s})),addBlock:(i,s)=>o(i,a=>({...a,blocks:[...a.blocks,s]})),addBlocks:(i,s)=>o(i,a=>({...a,blocks:[...a.blocks,...s]})),updateBlock:(i,s,a)=>o(i,l=>({...l,blocks:l.blocks.map(c=>c.id===s?{...c,...a}:c)})),removeBlocks:(i,s)=>{const a=new Set(s);o(i,l=>({...l,blocks:l.blocks.filter(c=>!a.has(c.id))}))},translateBlocks:(i,s,a,l)=>{if(a===0&&l===0)return;const c=new Set(s);o(i,d=>({...d,blocks:d.blocks.map(h=>c.has(h.id)?{...h,x:h.x+a,y:h.y+l}:h)}))}}},{partialize:n=>({docs:n.docs,currentId:n.currentId}),limit:80,equality:(n,r)=>n.docs===r.docs}));let cc;fr.subscribe(n=>{cc&&window.clearTimeout(cc),cc=window.setTimeout(()=>{try{localStorage.setItem(yy,JSON.stringify({v:xy,docs:n.docs,currentId:n.currentId}))}catch(r){console.warn("매싱 저장 실패",r)}},400)});const vy=()=>fr.temporal.getState().undo(),wy=()=>fr.temporal.getState().redo(),ne=16,Fa=14;function tr(n,r,e){return[(n-r)*ne,(n+r)*(ne/2)-e*Fa]}function JP(n,r){const e=n/ne,t=r/(ne/2);return[(e+t)/2,(t-e)/2]}const Sy=[["#FAF6EE","#E3DCCB","#CDC4AE"],["#E9E2D2","#D2C9B4","#B9AE95"],["#CFC6B2","#B6AB93","#9C9078"],["#A89D85","#8F846D","#766C58"]],qP="#1A1814";function ky(n){const{x:r,y:e,z:t,w:o,d:i,h:s}=n,a=t+s;return{top:[tr(r,e,a),tr(r+o,e,a),tr(r+o,e+i,a),tr(r,e+i,a)],left:[tr(r,e+i,t),tr(r+o,e+i,t),tr(r+o,e+i,a),tr(r,e+i,a)],right:[tr(r+o,e,t),tr(r+o,e+i,t),tr(r+o,e+i,a),tr(r+o,e,a)]}}const Qt=1e-6;function nT(n,r){if(n.x>=r.x+r.w-Qt)return!0;if(r.x>=n.x+n.w-Qt)return!1;if(n.y>=r.y+r.d-Qt)return!0;if(r.y>=n.y+n.d-Qt)return!1;if(n.z>=r.z+r.h-Qt)return!0;if(r.z>=n.z+n.h-Qt)return!1;const e=Math.min(n.x+n.w,r.x+r.w)-Math.max(n.x,r.x),t=Math.min(n.y+n.d,r.y+r.d)-Math.max(n.y,r.y),o=Math.min(n.z+n.h,r.z+r.h)-Math.max(n.z,r.z);return e<=t&&e<=o?n.x+n.w/2>r.x+r.w/2:t<=o?n.y+n.d/2>r.y+r.d/2:n.z+n.h/2>r.z+r.h/2}function bp(n,r,e){let t=n;const o=(r%4+4)%4;for(let i=0;i<o;i++)t={...t,x:t.y,y:e-t.x-t.w,w:t.d,d:t.w};return t}function rT(n,r,e){const t=(e%4+4)%4;for(let o=0;o<t;o++){const i=n;n=r,r=-i}return[n,r]}const Cp=n=>(4-n%4)%4;function _y(n){return{x0:(n.x-(n.y+n.d))*ne,x1:(n.x+n.w-n.y)*ne,y0:(n.x+n.y)*(ne/2)-(n.z+n.h)*Fa,y1:(n.x+n.w+n.y+n.d)*(ne/2)-n.z*Fa}}const Ns=n=>n.x+n.w/2+n.y+n.d/2+(n.z+n.h/2)*.001,Pp=new WeakMap;function by(n){const r=Pp.get(n);if(r)return r;const e=n.length,t=n.map(_y),o=Array.from({length:e},()=>[]),i=new Array(e).fill(0);for(let d=0;d<e;d++)for(let h=d+1;h<e;h++){const f=t[d],m=t[h];f.x1<=m.x0||m.x1<=f.x0||f.y1<=m.y0||m.y1<=f.y0||(nT(n[d],n[h])?(o[h].push(d),i[d]++):(o[d].push(h),i[h]++))}const s=[];for(let d=0;d<e;d++)i[d]===0&&s.push(d);const a=()=>{let d=0;for(let h=1;h<s.length;h++)Ns(n[s[h]])<Ns(n[s[d]])&&(d=h);return s.splice(d,1)[0]},l=[],c=new Array(e).fill(!1);for(;s.length;){const d=a();c[d]=!0,l.push(n[d]);for(const h of o[d])--i[h]===0&&s.push(h)}if(l.length<e){const d=n.filter((h,f)=>!c[f]).sort((h,f)=>Ns(h)-Ns(f));l.push(...d)}return Pp.set(n,l),l}function si(n,r){n.beginPath(),r.forEach(([e,t],o)=>o?n.lineTo(e,t):n.moveTo(e,t)),n.closePath()}function uc(n,r,e){let t=!1;for(let o=0,i=e.length-1;o<e.length;i=o++){const[s,a]=e[o],[l,c]=e[i];a>r!=c>r&&n<(l-s)*(r-a)/(c-a)+s&&(t=!t)}return t}function Tp(n,r,e){const t=by(e);for(let o=t.length-1;o>=0;o--){const i=t[o],s=ky(i);if(uc(n,r,s.top)||uc(n,r,s.left)||uc(n,r,s.right))return i.id}return null}function eT(n,r,e){const[t,o]=r.grid;if(e.gridAlpha>0){n.save(),n.globalAlpha=e.gridAlpha,n.strokeStyle="rgba(44,95,124,0.10)",n.lineWidth=1/e.zoomK,n.beginPath();for(let a=0;a<=t;a++){const[l,c]=tr(a,0,0),[d,h]=tr(a,o,0);n.moveTo(l,c),n.lineTo(d,h)}for(let a=0;a<=o;a++){const[l,c]=tr(0,a,0),[d,h]=tr(t,a,0);n.moveTo(l,c),n.lineTo(d,h)}n.stroke(),n.restore()}n.strokeStyle="rgba(44,95,124,0.22)",n.lineWidth=1.4/e.zoomK,si(n,[tr(0,0,0),tr(t,0,0),tr(t,o,0),tr(0,o,0)]),n.stroke();const i=new Set(e.selIds??[]),s=by(r.blocks);for(const a of s)js(n,a,e.zoomK,!1);for(const a of s)i.has(a.id)&&js(n,a,e.zoomK,!0);e.previewBlock&&(n.save(),n.globalAlpha=.55,js(n,e.previewBlock,e.zoomK,!1),n.restore(),js(n,e.previewBlock,e.zoomK,!0))}function js(n,r,e,t){const o=ky(r);if(t){n.save(),n.strokeStyle="rgba(44,95,124,0.95)",n.lineWidth=1.8/e,n.setLineDash([6/e,4/e]),si(n,[o.top[0],o.top[1],o.right[0],o.right[1],o.left[0],o.top[3]]),n.stroke(),n.setLineDash([]),n.restore();return}const i=Sy[Math.max(0,Math.min(3,r.tone??1))];n.lineJoin="round",n.lineWidth=1.1/e,n.strokeStyle=qP,n.fillStyle=i[0],si(n,o.top),n.fill(),n.stroke(),n.fillStyle=i[1],si(n,o.left),n.fill(),n.stroke(),n.fillStyle=i[2],si(n,o.right),n.fill(),n.stroke()}function tT(n){const[r,e]=n.grid,t=Math.max(6,...n.blocks.map(o=>o.z+o.h));return{minX:-e*ne,maxX:r*ne,minY:-t*Fa,maxY:(r+e)*(ne/2)}}const Ip=48;function oT({doc:n,tool:r,heightM:e,baseMode:t,stoneZ:o,toneSel:i,onStatus:s}){var pn;const a=M.useRef(null),l=M.useRef(null),c=M.useRef(fe),d=M.useRef(0),h=M.useRef(!1),f=M.useRef(null),m=M.useRef(null),[x,y]=M.useState([]),E=M.useRef(null),g=M.useRef([0,0]),p=M.useRef(null),v=fr(X=>X.addBlock),S=fr(X=>X.addBlocks),C=fr(X=>X.updateBlock),O=fr(X=>X.removeBlocks),I=fr(X=>X.translateBlocks),Z=M.useRef(null),F=n.grid[0],K=((pn=n.view)==null?void 0:pn.dir)??0,P=M.useMemo(()=>n.blocks.map(X=>bp(X,K,F)),[n.blocks,K,F]),Y=X=>{const en=l.current;if(!en)return null;const Q=en.getBoundingClientRect(),ln=c.current;return[ln.invertX(X.clientX-Q.left),ln.invertY(X.clientY-Q.top)]},H=X=>{const en=Y(X);return en?JP(en[0],en[1]):null},k=X=>Math.max(0,Math.min(F,Math.round(X))),R=()=>{const X=f.current,en=m.current;if(!X||!en)return null;const Q=Math.min(X[0],en[0]),ln=Math.max(X[0],en[0]),cn=Math.min(X[1],en[1]),wn=Math.max(X[1],en[1]);return r==="box"?{id:"_pv",kind:"mass",x:Q,y:cn,z:0,w:Math.max(1,ln-Q),d:Math.max(1,wn-cn),h:e,tone:1}:r==="wall"?ln-Q>=wn-cn?{id:"_pv",kind:"wall",x:Q,y:X[1]-.125,z:0,w:Math.max(1,ln-Q),d:.25,h:e,tone:1}:{id:"_pv",kind:"wall",x:X[0]-.125,y:cn,z:0,w:.25,d:Math.max(1,wn-cn),h:e,tone:1}:r==="base"?{id:"_pv",kind:"base",x:Q,y:cn,z:t==="elevate"?0:-.5,w:Math.max(1,ln-Q),d:Math.max(1,wn-cn),h:.5,tone:t==="elevate"?1:2}:r==="overhead"?{id:"_pv",kind:"overhead",x:Q,y:cn,z:e,w:Math.max(1,ln-Q),d:Math.max(1,wn-cn),h:.25,tone:1}:null},j=X=>{const en=bp(X,Cp(K),F);v(n.id,{...en,id:Tn("blk")})},A=M.useCallback(()=>{const X=l.current,en=a.current;if(!X||!en)return;const Q=window.devicePixelRatio||1,ln=en.clientWidth,cn=en.clientHeight;(X.width!==Math.round(ln*Q)||X.height!==Math.round(cn*Q))&&(X.width=Math.round(ln*Q),X.height=Math.round(cn*Q),X.style.width=`${ln}px`,X.style.height=`${cn}px`);const wn=X.getContext("2d"),Nn=c.current;wn.setTransform(Q,0,0,Q,0,0),wn.fillStyle="#ECE5D6",wn.fillRect(0,0,ln,cn),wn.setTransform(Q*Nn.k,0,0,Q*Nn.k,Q*Nn.x,Q*Nn.y);const[Fn,dn]=g.current,un=new Set(x),kn=(Fn||dn)&&x.length?P.map(Pn=>un.has(Pn.id)?{...Pn,x:Pn.x+Fn,y:Pn.y+dn}:Pn):P;if(eT(wn,{...n,blocks:kn},{zoomK:Nn.k,gridAlpha:At(Nn.k*ne,3,6),selIds:x,previewBlock:R()}),p.current){const{a:Pn,b:Sn}=p.current;wn.fillStyle="rgba(44,95,124,0.08)",wn.strokeStyle="rgba(44,95,124,0.8)",wn.lineWidth=1.2/Nn.k,wn.setLineDash([5/Nn.k,4/Nn.k]);const $=Math.min(Pn[0],Sn[0]),tn=Math.min(Pn[1],Sn[1]),J=Math.abs(Sn[0]-Pn[0]),b=Math.abs(Sn[1]-Pn[1]);wn.fillRect($,tn,J,b),wn.strokeRect($,tn,J,b),wn.setLineDash([])}wn.setTransform(1,0,0,1,0,0)},[n,P,x,r,e,t,o,i]),w=M.useRef(A);w.current=A;const N=M.useCallback(()=>{d.current||(d.current=requestAnimationFrame(()=>{d.current=0,w.current()}))},[]);M.useEffect(()=>{N()},[A,N]),M.useEffect(()=>{y([]),f.current=null,m.current=null,p.current=null},[n.id]),M.useEffect(()=>{const X=l.current,en=a.current;if(!X||!en)return;const Q=en.clientWidth,ln=en.clientHeight,cn=tT(n),wn=cn.maxX-cn.minX,Nn=cn.maxY-cn.minY,Fn=Math.max(.02,Math.min(8,Math.min((Q-Ip*2)/wn,(ln-Ip*2)/Nn))),dn=cl().scaleExtent([Fn*.5,8]).translateExtent([[cn.minX-wn*.25,cn.minY-Nn*.25],[cn.maxX+wn*.25,cn.maxY+Nn*.25]]).filter(kn=>kn.type==="wheel"?!0:kn.type==="dblclick"?!1:h.current||kn.button===1).on("zoom",kn=>{c.current=kn.transform,N()}),un=Or(X);return un.call(dn),un.call(dn.transform,fe.translate((Q-(cn.minX+cn.maxX)*Fn)/2,(ln-(cn.minY+cn.maxY)*Fn)/2).scale(Fn)),()=>{un.on(".zoom",null)}},[n.id,F]),M.useEffect(()=>{const X=Q=>{const ln=Q.target.tagName;if(!(ln==="INPUT"||ln==="TEXTAREA")){if(Q.code==="Space"){Q.type==="keydown"?(h.current=!0,Q.preventDefault()):h.current=!1,a.current&&(a.current.dataset.panning=String(h.current));return}if(Q.type==="keydown"){if((Q.ctrlKey||Q.metaKey)&&Q.key.toLowerCase()==="c"){if(x.length===0)return;const cn=new Set(x);Z.current={blocks:n.blocks.filter(wn=>cn.has(wn.id)).map(wn=>({...wn})),pastes:0};return}if((Q.ctrlKey||Q.metaKey)&&Q.key.toLowerCase()==="v"){const cn=Z.current;if(!cn||cn.blocks.length===0)return;cn.pastes+=1;const wn=cn.pastes*2,Nn=[],Fn=cn.blocks.map(dn=>{const un=Tn("blk");return Nn.push(un),{...dn,id:un,x:dn.x+wn,y:dn.y+wn}});S(n.id,Fn),y(Nn);return}(Q.key==="Delete"||Q.key==="Backspace")&&x.length&&(O(n.id,x),y([])),Q.key==="Escape"&&x.length&&(Q.stopPropagation(),y([]),N())}}};window.addEventListener("keydown",X,!0),window.addEventListener("keyup",X);const en=new ResizeObserver(()=>N());return a.current&&en.observe(a.current),()=>{window.removeEventListener("keydown",X,!0),window.removeEventListener("keyup",X),en.disconnect()}},[x,n.id,n.blocks,N]);const z=X=>{if(X.button!==0||h.current)return;const en=H(X),Q=Y(X);if(!en||!Q)return;if(r==="tone"){const cn=Tp(Q[0],Q[1],P);cn&&C(n.id,cn,{tone:i});return}{const cn=Tp(Q[0],Q[1],P);if(cn){X.target.setPointerCapture(X.pointerId),x.includes(cn)||y([cn]),E.current=en,g.current=[0,0],N();return}}if(r!=="select"&&x.length>0&&(y([]),N()),r==="select"){X.target.setPointerCapture(X.pointerId),y([]),p.current={a:Q,b:Q},N();return}if(r==="column"||r==="stone"){const cn=Math.max(0,Math.min(F-1,Math.floor(en[0]))),wn=Math.max(0,Math.min(F-1,Math.floor(en[1])));j(r==="column"?{id:"_pv",kind:"column",x:cn,y:wn,z:0,w:1,d:1,h:e,tone:1}:{id:"_pv",kind:"stone",x:cn,y:wn,z:o,w:1,d:1,h:1,tone:1});return}X.target.setPointerCapture(X.pointerId);const ln=[k(en[0]),k(en[1])];f.current=ln,m.current=ln,N()},U=X=>{const en=H(X),Q=Y(X);if(!(!en||!Q)){if(s&&s(`(${en[0].toFixed(1)}, ${en[1].toFixed(1)}) · ${F}m × ${F}m · 블록 ${n.blocks.length} · 뷰 ${K+1}/4`+(r==="stone"?` · 띄움 ${o}m`:r==="tone"?` · 명도 ${i}`:r!=="select"?` · 높이 ${e}m`:"")+(x.length>1?` · 선택 ${x.length}개`:"")+(n.blocks.length===0?" · 박스(B)를 드래그해 첫 덩어리를 놓아보세요":"")),r==="select"&&p.current)p.current.b=Q;else if(E.current&&x.length){const[ln,cn]=E.current;g.current=[Math.round(en[0]-ln),Math.round(en[1]-cn)]}else f.current&&(m.current=[k(en[0]),k(en[1])]);N()}},T=()=>{if(r==="select"&&p.current){const{a:X,b:en}=p.current;p.current=null;const Q=Math.min(X[0],en[0]),ln=Math.max(X[0],en[0]),cn=Math.min(X[1],en[1]),wn=Math.max(X[1],en[1]);if(ln-Q>4||wn-cn>4){const Nn=P.filter(Fn=>{const dn=_y(Fn);return dn.x1>=Q&&dn.x0<=ln&&dn.y1>=cn&&dn.y0<=wn}).map(Fn=>Fn.id);y(Nn)}N();return}if(E.current&&x.length){const[X,en]=g.current;if(E.current=null,g.current=[0,0],X!==0||en!==0){const[Q,ln]=rT(X,en,Cp(K));I(n.id,x,Q,ln)}N();return}if(f.current){const X=R();f.current=null,m.current=null,X&&j(X),N()}};return u.jsx("div",{ref:a,className:"td-canvas-wrap","data-tool":r,children:u.jsx("canvas",{ref:l,className:"td-canvas","data-testid":"massing-canvas",onPointerDown:z,onPointerMove:U,onPointerUp:T,onContextMenu:X=>X.preventDefault()})})}const qe=(n,r,e=1,t=0,o=1)=>({kind:"stone",x:n,y:r,z:t,w:1,d:1,h:o,tone:e}),Ee=(n,r,e=3,t=1)=>({kind:"column",x:n,y:r,z:0,w:1,d:1,h:e,tone:t}),As=[qe(26,30,1),qe(31,27,2),qe(35,31,1),qe(29,34,3),qe(33,35,0)],dc=[Ee(25,26,3),Ee(36,26,2),Ee(25,36,2),Ee(36,36,3),Ee(30,31,1,2)],Ep=[{kind:"wall",x:25,y:24.875,z:0,w:12,d:.25,h:2.5,tone:1},{kind:"wall",x:23.875,y:25,z:0,w:.25,d:7,h:2,tone:2},qe(33,29,2,2)],iT=[{kind:"base",x:27,y:28,z:0,w:8,d:7,h:.5,tone:0},{kind:"overhead",x:26,y:27,z:3,w:10,d:9,h:.25,tone:3}],sT=[{kind:"base",x:25,y:26,z:0,w:12,d:9,h:.5,tone:0},Ee(25,26,3),Ee(36,26,3),Ee(25,34,3),Ee(36,34,3),{kind:"wall",x:25,y:25.875,z:0,w:12,d:.25,h:3,tone:2},{kind:"wall",x:24.875,y:26,z:0,w:.25,d:9,h:3,tone:2},{kind:"overhead",x:25,y:26,z:3,w:12,d:9,h:.25,tone:3}],aT=[{kind:"base",x:26.5,y:27,z:0,w:12,d:9,h:.5,tone:1},{kind:"base",x:23,y:30,z:0,w:18,d:2,h:.5,tone:1},{kind:"wall",x:28,y:25.875,z:0,w:8,d:.25,h:2,tone:1},qe(31,31,1),qe(34,29,1)],Mp=[{id:"pt1",name:"점·선·면 ① 점",blocks:As},{id:"pt2",name:"점·선·면 ② +선(기둥)",blocks:[...As,...dc]},{id:"pt3",name:"점·선·면 ③ +면 암시",blocks:[...As,...dc,...Ep]},{id:"pt4",name:"점·선·면 ④ 면 완성",blocks:[...As,...dc,...Ep,...iT]},{id:"def1",name:"공간 정의 — 강화",blocks:sT},{id:"def2",name:"공간 정의 — 약화",blocks:aT}],Np=[{id:"select",label:"선택",key:"V",title:"선택 (V) — 클릭 선택 · 빈 곳 드래그 = 마퀴 다중 선택 · 드래그 이동 · Delete 삭제"},{id:"box",label:"박스",key:"B",title:"박스 (B) — 바닥 드래그로 풋프린트, 높이는 프리셋. 질량(mass)"},{id:"column",label:"기둥",key:"C",title:"기둥 (C) — 클릭 배치, 1×1m. 점→선 실습"},{id:"wall",label:"벽판",key:"W",title:"벽판 (W) — 드래그 방향의 얇은 판 (두께 0.25m). 면 실습"},{id:"base",label:"바닥판",key:"G",title:"바닥판 (G) — 드래그. 올림(elevate) = 0.5m 단 / 파임(inset) = 0.5m 함몰"},{id:"overhead",label:"머리판",key:"O",title:"머리위판 (O) — 드래그. 높이 프리셋만큼 띄운 얇은 판 (두께 0.25m)"},{id:"stone",label:"점",key:"P",title:"점 (P) — 클릭 배치, 1×1×1m 돌. 띄움 프리셋으로 부유석"},{id:"tone",label:"명도",key:"T",title:"명도 (T) — 견본 선택 후 블록 클릭. Value Differentiation 실습"}],lT=[1,2,3,4,6],cT=[0,1,2,3];function uT(){var A;const n=B(w=>w.exitMassing),r=fr(w=>w.docs),e=fr(w=>w.currentId),t=fr(w=>w.setActive),o=fr(w=>w.addDoc),i=fr(w=>w.removeDoc),s=fr(w=>w.renameDoc),a=fr(w=>w.updateDoc),l=fr(w=>w.addBlocks),[c,d]=M.useState("box"),[h,f]=M.useState(3),[m,x]=M.useState("elevate"),[y,E]=M.useState(0),[g,p]=M.useState(2),[v,S]=M.useState(""),[C,O]=M.useState(null),[I,Z]=M.useState(""),[F,K]=M.useState({past:0,future:0});M.useEffect(()=>{const w=fr.temporal,N=()=>{const U=w.getState();K({past:U.pastStates.length,future:U.futureStates.length})};N();const z=w.subscribe(N);return()=>z()},[]);const P=r,Y=P.find(w=>w.id===e)??P[0]??null,H=((A=Y==null?void 0:Y.view)==null?void 0:A.dir)??0,k=w=>{Y&&a(Y.id,{view:{dir:((H+w)%4+4)%4}})};if(M.useEffect(()=>{const w=N=>{const z=N.target.tagName;if(z==="INPUT"||z==="TEXTAREA"||N.ctrlKey||N.metaKey||N.altKey)return;const U=N.key.toUpperCase(),T=Np.find(pn=>pn.key===U);if(T){d(T.id);return}U==="Q"&&k(-1),U==="E"&&k(1)};return window.addEventListener("keydown",w),()=>window.removeEventListener("keydown",w)},[Y==null?void 0:Y.id,H]),!Y)return u.jsxs("div",{className:"td-shell td-shell-empty",children:[u.jsx("p",{children:"매싱 스케치가 없습니다."}),u.jsx("button",{className:"td-btn",onClick:()=>o(),children:"+ 매싱 만들기"})]});const R=()=>{C&&I.trim()&&s(C,I.trim()),O(null)},j=(w,N)=>{const z=P.find(T=>T.id===w),U=z?z.blocks.length:0;U>0&&!window.confirm(`'${N}'에 블록 ${U}개가 있습니다. 삭제할까요?`)||i(w)};return u.jsxs("div",{className:"td-shell","data-testid":"massing-shell",children:[u.jsxs("div",{className:"td-bar",children:[u.jsx("button",{className:"td-btn td-back",onClick:n,title:"버블 다이어그램으로 (Esc)",children:"← 버블"}),u.jsxs("div",{className:"td-tabs",role:"tablist",children:[P.map(w=>u.jsx("div",{role:"tab","aria-selected":w.id===Y.id,className:`td-tab ${w.id===Y.id?"is-active":""}`,onClick:()=>t(w.id),onDoubleClick:()=>{O(w.id),Z(w.name)},title:"더블클릭: 이름 바꾸기",children:C===w.id?u.jsx("input",{autoFocus:!0,value:I,onChange:N=>Z(N.target.value),onBlur:R,onKeyDown:N=>{N.key==="Enter"&&R(),N.key==="Escape"&&O(null)}}):u.jsxs(u.Fragment,{children:[u.jsx("span",{className:"td-tab-name",children:w.name}),P.length>1&&u.jsx("button",{className:"td-tab-close",onClick:N=>{N.stopPropagation(),j(w.id,w.name)},title:"삭제",children:"×"})]})},w.id)),u.jsx("button",{className:"td-btn td-tab-add",onClick:()=>o(),title:"매싱 추가",children:"＋"})]}),u.jsx("div",{className:"td-spacer"}),u.jsx("div",{className:"td-group",role:"toolbar","aria-label":"도구",children:Np.map(w=>u.jsx("button",{className:`td-btn td-tool ${c===w.id?"is-active":""}`,onClick:()=>d(w.id),title:w.title,children:w.label},w.id))}),u.jsxs("div",{className:"td-group",children:[u.jsx("button",{className:"td-btn td-undo",onClick:()=>vy(),disabled:F.past===0,title:`되돌리기 (Ctrl+Z) · ${F.past}`,children:"↶"}),u.jsx("button",{className:"td-btn td-redo",onClick:()=>wy(),disabled:F.future===0,title:`다시 실행 (Ctrl+Shift+Z / Ctrl+Y) · ${F.future}`,children:"↷"})]})]}),u.jsxs("div",{className:"td-bar td-bar-sub",children:[c!=="stone"&&c!=="tone"&&c!=="select"&&c!=="base"&&u.jsx("div",{className:"td-group","aria-label":"블록 높이",children:lT.map(w=>u.jsxs("button",{className:`td-btn ${h===w?"is-active":""}`,onClick:()=>f(w),title:c==="overhead"?`머리위판 띄움 ${w}m`:`새 블록 높이 ${w}m`,children:[w,"m"]},w))}),c==="base"&&u.jsxs("div",{className:"td-group","aria-label":"바닥판 모드",children:[u.jsx("button",{className:`td-btn ${m==="elevate"?"is-active":""}`,onClick:()=>x("elevate"),title:"올림(elevate) — 바닥 위 0.5m 단",children:"올림"}),u.jsx("button",{className:`td-btn ${m==="inset"?"is-active":""}`,onClick:()=>x("inset"),title:"파임(inset) — 바닥 아래 0.5m 함몰",children:"파임"})]}),c==="stone"&&u.jsx("div",{className:"td-group","aria-label":"점 띄움",children:cT.map(w=>u.jsx("button",{className:`td-btn ${y===w?"is-active":""}`,onClick:()=>E(w),title:w===0?"바닥에 놓기":`공중 ${w}m — 부유석`,children:w===0?"바닥":`${w}m`},w))}),c==="tone"&&u.jsx("div",{className:"td-group","aria-label":"명도 견본",children:Sy.map((w,N)=>u.jsxs("button",{className:`td-btn ms-tone ${g===N?"is-active":""}`,onClick:()=>p(N),title:`명도 ${N} — 블록을 클릭해 적용`,children:[u.jsx("span",{className:"ms-tone-chip",style:{background:w[0],borderColor:w[2]}}),N]},N))}),u.jsx("div",{className:"td-group","aria-label":"학습 가이드",children:u.jsxs("select",{className:"td-select",value:"","data-testid":"ms-preset",onChange:w=>{const N=Mp.find(U=>U.id===w.target.value);if(!N)return;const z=o(N.name);l(z,N.blocks.map(U=>({...U,id:Tn("blk")})))},title:"학습 가이드 — CGMA 3주차 점·선·면 단계와 공간 정의 비교 장면을 새 탭으로",children:[u.jsx("option",{value:"",children:"학습 가이드…"}),Mp.map(w=>u.jsx("option",{value:w.id,children:w.name},w.id))]})}),u.jsxs("div",{className:"td-group","aria-label":"카메라 회전",children:[u.jsx("button",{className:"td-btn",onClick:()=>k(-1),title:"반시계 회전 (Q)",children:"⟲"}),u.jsxs("span",{className:"ms-dir","data-testid":"ms-dir",children:["뷰 ",H+1,"/4"]}),u.jsx("button",{className:"td-btn",onClick:()=>k(1),title:"시계 회전 (E)",children:"⟳"})]}),u.jsx("div",{className:"td-spacer"})]}),u.jsx(oT,{doc:Y,tool:c,heightM:h,baseMode:m,stoneZ:y,toneSel:g,onStatus:S}),u.jsxs("div",{className:"td-status",children:[u.jsx("span",{className:"td-status-doc",children:Y.name}),u.jsxs("span",{children:[Y.grid[0],"×",Y.grid[1],"m · 블록 ",Y.blocks.length," · 뷰 ",H+1,"/4"]}),u.jsx("span",{className:"td-status-hover",children:v}),u.jsx("span",{className:"td-status-hint",children:"휠: 줌 · 스페이스+드래그: 이동 · Q/E: 회전 · Ctrl+Z: 실행취소"})]})]})}const Cy="bubble-atelier::flow",Py=1;function dT(){try{const n=localStorage.getItem(Cy);if(!n)return null;const r=JSON.parse(n);if(r.v!==Py||!Array.isArray(r.docs)||r.docs.length===0)return null;const e=r.docs.map(o=>({...o,grid:128,start:o.start??{x:8,y:64},boxes:Array.isArray(o.boxes)?o.boxes.map(i=>({rot:0,...i})):[],discs:Array.isArray(o.discs)?o.discs:[]})),t=e.some(o=>o.id===r.currentId)?r.currentId:e[0].id;return{docs:e,currentId:t}}catch{return null}}const vr=tl()(ol((n,r)=>{const t=dT()??(()=>{const i=Kl(Tn("fl"));return{docs:[i],currentId:i.id}})(),o=(i,s)=>n(a=>({docs:a.docs.map(l=>l.id===i?s(l):l)}));return{...t,setActive:i=>{r().docs.some(s=>s.id===i)&&n({currentId:i})},addDoc:(i,s)=>{const a={...Kl(Tn("fl"),i??`흐름 ${r().docs.length+1}`),...s};return n(l=>({docs:[...l.docs,a],currentId:a.id})),a.id},removeDoc:i=>n(s=>{const a=s.docs.filter(l=>l.id!==i);if(a.length===0){const l=Kl(Tn("fl"));return{docs:[l],currentId:l.id}}return{docs:a,currentId:s.currentId===i?a[0].id:s.currentId}}),renameDoc:(i,s)=>o(i,a=>({...a,name:s})),updateDoc:(i,s)=>o(i,a=>({...a,...s})),addBox:(i,s)=>o(i,a=>({...a,boxes:[...a.boxes,s]})),addDisc:(i,s)=>o(i,a=>({...a,discs:[...a.discs,s]})),removeObjs:(i,s)=>{const a=new Set(s);o(i,l=>({...l,boxes:l.boxes.filter(c=>!a.has(c.id)),discs:l.discs.filter(c=>!a.has(c.id))}))},patchObj:(i,s,a)=>{o(i,l=>({...l,boxes:l.boxes.map(c=>c.id===s?{...c,...a}:c),discs:l.discs.map(c=>c.id===s?{...c,...a}:c)}))},translateObjs:(i,s,a,l)=>{if(a===0&&l===0)return;const c=new Set(s);o(i,d=>({...d,boxes:d.boxes.map(h=>c.has(h.id)?{...h,x:h.x+a,y:h.y+l}:h),discs:d.discs.map(h=>c.has(h.id)?{...h,x:h.x+a,y:h.y+l}:h)}))}}},{partialize:n=>({docs:n.docs,currentId:n.currentId}),limit:80,equality:(n,r)=>n.docs===r.docs}));let hc;vr.subscribe(n=>{hc&&window.clearTimeout(hc),hc=window.setTimeout(()=>{try{localStorage.setItem(Cy,JSON.stringify({v:Py,docs:n.docs,currentId:n.currentId}))}catch(r){console.warn("흐름 저장 실패",r)}},400)});const Ty=()=>vr.temporal.getState().undo(),Iy=()=>vr.temporal.getState().redo(),hn=16,jp=.6,hT=.12,fT=.5,pT=1.8,mT=1,gT=0;function yT(n,r,e,t){let o=mT,i=gT;const s=(a,l,c,d)=>{let h=a*a+l*l;if(h<c*c){const m=c/Math.sqrt(Math.max(h,1e-9));a*=m,l*=m,h=c*c}const f=h*h;o+=d*(-(c*c)*(a*a-l*l))/f,i+=d*(-(c*c)*2*a*l)/f,i+=(l>=0?1:-1)*hT*d*(c*c/h)};for(const a of e){const l=a.h/2+jp,c=a.x+a.w/2,d=a.y+a.h/2,h=Math.max(0,a.w/2+jp-l),f=a.rot??0,m=Math.cos(f),x=Math.sin(f),y=Math.max(-h,Math.min(h,(n-c)*m+(r-d)*x));s(n-(c+m*y),r-(d+x*y),l,1)}for(const a of t)a.kind==="hill"?s(n-a.x,r-a.y,a.r,fT):s(n-a.x,r-a.y,a.r+.4,1);return[o,i]}function Dd(n,r,e){const t=n.rot??0,o=n.x+n.w/2,i=n.y+n.h/2,s=Math.cos(t),a=Math.sin(t),l=r-o,c=e-i;return[l*s+c*a,-l*a+c*s]}function Ve(n,r,e){const t=n.rot??0,o=n.x+n.w/2,i=n.y+n.h/2,s=Math.cos(t),a=Math.sin(t);return[o+r*s-e*a,i+r*a+e*s]}function xT(n,r,e,t){let o=0;for(const i of e){const[s,a]=Dd(i,n,r),l=Math.max(-i.w/2,Math.min(i.w/2,s)),c=Math.max(-i.h/2,Math.min(i.h/2,a)),d=Math.hypot(s-l,a-c);o+=1/((d+.6)*(d+.6))}for(const i of t){const s=Math.hypot(n-i.x,r-i.y);if(i.kind==="hill"){const l=i.r*pT;s<l&&(o+=.9*(1-s/l));continue}const a=Math.max(0,s-i.r);o+=1/((a+.6)*(a+.6))}return o}function vT(n,r,e,t,o,i=900,s=.35){const a=r,l=(f,m)=>{const x=yT(f,m,e,t),y=x[0];let E=x[1];return E+=Math.max(-.35,Math.min(.35,(a-m)*.04)),[y,E]},c=[[n,r]];let d=n,h=r;for(let f=0;f<i;f++){let[m,x]=l(d,h),y=Math.hypot(m,x);if(y<.05)break;const E=d+m/y*(s/2),g=h+x/y*(s/2);if([m,x]=l(E,g),y=Math.hypot(m,x),y<1e-4)break;d+=m/y*s,h+=x/y*s;for(const p of e){const[v,S]=Dd(p,d,h),C=p.w/2,O=p.h/2;if(Math.abs(v)<C&&Math.abs(S)<O){const I=v+C,Z=C-v,F=S+O,K=O-S,P=Math.min(I,Z,F,K);let Y=v,H=S;P===I?Y=-C-.02:P===Z?Y=C+.02:P===F?H=-O-.02:H=O+.02,[d,h]=Ve(p,Y,H)}}for(const p of t){if(p.kind!=="pillar")continue;const v=d-p.x,S=h-p.y,C=Math.hypot(v,S);C<p.r&&C>1e-6&&(d=p.x+v/C*(p.r+.02),h=p.y+S/C*(p.r+.02))}if(c.push([d,h]),d<-2||h<-2||d>o+1||h>o+2)break}return c}function wT(n,r,e=1.5){const t=[];for(let o=2;o<=r-2;o+=e)t.push({x:n.x,y:o});return t}function ST(n,r,e){for(let t=e.length-1;t>=0;t--){const o=e[t],[i,s]=Dd(o,n,r);if(Math.abs(i)<=o.w/2&&Math.abs(s)<=o.h/2)return o.id}return null}function kT(n,r,e){for(let t=e.length-1;t>=0;t--){const o=e[t];if(Math.hypot(n-o.x,r-o.y)<=o.r+.4)return o.id}return null}const Ap=48,Op=24,Rp=8,_T=10,Lp=Math.PI/12,Dp=(n,r,e)=>[r*Math.cos(n)-e*Math.sin(n),r*Math.sin(n)+e*Math.cos(n)];function bT({doc:n,tool:r,view:e,onStatus:t}){const o=M.useRef(null),i=M.useRef(null),s=M.useRef(fe),a=M.useRef(0),l=M.useRef(!1),c=M.useRef(null),d=M.useRef(null),[h,f]=M.useState(null),m=M.useRef(null),x=M.useRef(null),y=M.useRef(null),E=vr(A=>A.addBox),g=vr(A=>A.addDisc),p=vr(A=>A.removeObjs),v=vr(A=>A.translateObjs),S=vr(A=>A.patchObj),C=vr(A=>A.updateDoc),O=n.grid,I=A=>{const w=i.current;if(!w)return null;const N=w.getBoundingClientRect(),z=s.current;return[z.invertX(A.clientX-N.left)/hn,z.invertY(A.clientY-N.top)/hn]},Z=A=>Math.max(0,Math.min(O,Math.round(A))),F=()=>{var pn,X,en;const A=m.current;let w=n.boxes,N=n.discs,z=n.start;if(A&&(A.dx||A.dy))if(((pn=A.what)==null?void 0:pn.kind)==="box"){const Q=A.what.id;w=w.map(ln=>ln.id===Q?{...ln,x:ln.x+A.dx,y:ln.y+A.dy}:ln)}else if(((X=A.what)==null?void 0:X.kind)==="disc"){const Q=A.what.id;N=N.map(ln=>ln.id===Q?{...ln,x:ln.x+A.dx,y:ln.y+A.dy}:ln)}else((en=A.what)==null?void 0:en.kind)==="start"&&(z={x:z.x+A.dx,y:z.y+A.dy});const U=x.current,T=y.current;return U&&T&&(w=w.map(Q=>Q.id===U.id?{...Q,...T}:Q),N=N.map(Q=>Q.id===U.id?{...Q,...T}:Q)),{boxes:w,discs:N,start:z}},K=A=>{if(!h)return null;const w=s.current.k,N=_T/w/hn,z=n.boxes.find(T=>T.id===h);if(z){const T=z.rot??0,pn=z.x+z.w/2,X=z.y+z.h/2,[en,Q]=Ve(z,0,-z.h/2-Op/w/hn);if(Math.hypot(A[0]-en,A[1]-Q)<=N)return{type:"rotate",id:z.id,cx:pn,cy:X};for(const[ln,cn]of[[-1,-1],[1,-1],[1,1],[-1,1]]){const[wn,Nn]=Ve(z,ln*z.w/2,cn*z.h/2);if(Math.hypot(A[0]-wn,A[1]-Nn)<=N){const[Fn,dn]=Ve(z,-ln*z.w/2,-cn*z.h/2);return{type:"resize",id:z.id,gx:ln,gy:cn,fx:Fn,fy:dn,rot:T}}}return null}const U=n.discs.find(T=>T.id===h);return U&&Math.hypot(A[0]-(U.x+U.r),A[1]-U.y)<=N?{type:"radius",id:U.id,cx:U.x,cy:U.y,kind:U.kind}:null},P=M.useCallback(()=>{var dn;const A=i.current,w=o.current;if(!A||!w)return;const N=window.devicePixelRatio||1,z=w.clientWidth,U=w.clientHeight;(A.width!==Math.round(z*N)||A.height!==Math.round(U*N))&&(A.width=Math.round(z*N),A.height=Math.round(U*N),A.style.width=`${z}px`,A.style.height=`${U}px`);const T=A.getContext("2d"),pn=s.current,X=O*hn;T.setTransform(N,0,0,N,0,0),T.fillStyle="#ECE5D6",T.fillRect(0,0,z,U),T.setTransform(N*pn.k,0,0,N*pn.k,N*pn.x,N*pn.y),T.fillStyle="#FAF6EE",T.fillRect(0,0,X,X);const en=At(pn.k*hn,3,6);if(en>0){T.globalAlpha=en,T.strokeStyle="rgba(44,95,124,0.08)",T.lineWidth=1/pn.k,T.beginPath();for(let un=0;un<=O;un+=2)T.moveTo(un*hn,0),T.lineTo(un*hn,X),T.moveTo(0,un*hn),T.lineTo(X,un*hn);T.stroke(),T.globalAlpha=1}T.strokeStyle="rgba(44,95,124,0.25)",T.lineWidth=1.4/pn.k,T.strokeRect(0,0,X,X);const{boxes:Q,discs:ln,start:cn}=F();if(e.pressure&&(Q.length||ln.length))for(let kn=0;kn<O;kn+=2)for(let Pn=0;Pn<O;Pn+=2){const Sn=xT(Pn+1,kn+1,Q,ln),$=Math.min(.34,Sn*.16);$<.015||(T.fillStyle=`rgba(44,95,124,${$.toFixed(3)})`,T.fillRect(Pn*hn,kn*hn,2*hn,2*hn))}const wn=wT(cn,O,e.lineGap),Nn=e.lineAlpha;T.strokeStyle=`rgba(26,24,20,${Nn.toFixed(2)})`,T.lineWidth=1.3/pn.k,T.lineJoin="round";for(const un of wn){const kn=vT(un.x,un.y,Q,ln,O);if(kn.length<2)continue;T.beginPath(),kn.forEach(([b,rn],yn)=>yn?T.lineTo(b*hn,rn*hn):T.moveTo(b*hn,rn*hn)),T.stroke();const[Pn,Sn]=kn[kn.length-2],[$,tn]=kn[kn.length-1],J=Math.atan2(tn-Sn,$-Pn);T.save(),T.translate($*hn,tn*hn),T.rotate(J),T.fillStyle=`rgba(26,24,20,${Math.min(1,Nn+.02).toFixed(2)})`,T.beginPath(),T.moveTo(0,0),T.lineTo(-4.5/pn.k,-2.2/pn.k),T.lineTo(-4.5/pn.k,2.2/pn.k),T.closePath(),T.fill(),T.restore()}for(const un of ln)if(un.kind==="hill")for(let kn=3;kn>=1;kn--){const Pn=un.r*kn/3;T.beginPath(),T.arc(un.x*hn,un.y*hn,Pn*hn,0,Math.PI*2),T.fillStyle=`rgba(160,124,62,${(.07+.05*(3-kn)).toFixed(2)})`,T.fill(),T.strokeStyle="rgba(110,86,44,0.45)",T.lineWidth=1/pn.k,T.stroke()}for(const un of Q){const kn=un.rot??0;T.save(),T.translate((un.x+un.w/2)*hn,(un.y+un.h/2)*hn),T.rotate(kn),T.fillStyle="#2A2520",T.fillRect(-un.w/2*hn,-un.h/2*hn,un.w*hn,un.h*hn),T.strokeStyle="#1A1814",T.lineWidth=1.2/pn.k,T.strokeRect(-un.w/2*hn,-un.h/2*hn,un.w*hn,un.h*hn),T.restore()}for(const un of ln)un.kind==="pillar"&&(T.beginPath(),T.arc(un.x*hn,un.y*hn,un.r*hn,0,Math.PI*2),T.fillStyle="#2A2520",T.fill(),T.strokeStyle="#1A1814",T.lineWidth=1.2/pn.k,T.stroke());if(e.normals){const un=(Sn,$,tn,J,b,rn)=>{const yn=Sn+tn*b,bn=$+J*b;T.strokeStyle=`rgba(184,84,80,${rn})`,T.fillStyle=`rgba(184,84,80,${rn})`,T.lineWidth=1.4/pn.k,T.beginPath(),T.moveTo(Sn*hn,$*hn),T.lineTo(yn*hn,bn*hn),T.stroke();const In=Math.atan2(J,tn);T.save(),T.translate(yn*hn,bn*hn),T.rotate(In),T.beginPath(),T.moveTo(0,0),T.lineTo(-5/pn.k,-2.6/pn.k),T.lineTo(-5/pn.k,2.6/pn.k),T.closePath(),T.fill(),T.restore()};for(const Sn of Q){const $=Sn.rot??0,tn=Sn.w/2,J=Sn.h/2,b=(rn,yn,bn,In)=>{const[sr,oe]=Ve(Sn,rn,yn),[kr,Oo]=Dp($,bn,In);un(sr,oe,kr,Oo,2.4,.85)};for(let rn=-tn+4/2;rn<=tn;rn+=4){const yn=Math.min(rn,tn-.5);b(yn,-J,0,-1),b(yn,J,0,1)}for(let rn=-J+4/2;rn<=J;rn+=4){const yn=Math.min(rn,J-.5);b(-tn,yn,-1,0),b(tn,yn,1,0)}}for(const Sn of ln){const $=Sn.kind==="hill"?10:8,tn=Sn.kind==="hill"?2.4*.6:2.4,J=Sn.kind==="hill"?.55:.85;for(let b=0;b<$;b++){const rn=b/$*Math.PI*2,yn=Math.cos(rn),bn=Math.sin(rn);un(Sn.x+yn*Sn.r,Sn.y+bn*Sn.r,yn,bn,tn,J)}}}if(h){const un=pn.k,kn=Rp/un/hn/2,Pn=(tn,J)=>{T.fillStyle="#FAF6EE",T.strokeStyle="rgba(44,95,124,0.95)",T.lineWidth=1.4/un,T.fillRect((tn-kn)*hn,(J-kn)*hn,kn*2*hn,kn*2*hn),T.strokeRect((tn-kn)*hn,(J-kn)*hn,kn*2*hn,kn*2*hn)},Sn=Q.find(tn=>tn.id===h),$=ln.find(tn=>tn.id===h);if(T.setLineDash([6/un,4/un]),T.strokeStyle="rgba(44,95,124,0.95)",T.lineWidth=1.8/un,Sn){const tn=Sn.rot??0;T.save(),T.translate((Sn.x+Sn.w/2)*hn,(Sn.y+Sn.h/2)*hn),T.rotate(tn),T.strokeRect(-Sn.w/2*hn-2/un,-Sn.h/2*hn-2/un,Sn.w*hn+4/un,Sn.h*hn+4/un),T.restore(),T.setLineDash([]);const[J,b]=Ve(Sn,0,-Sn.h/2),[rn,yn]=Ve(Sn,0,-Sn.h/2-Op/un/hn);T.strokeStyle="rgba(44,95,124,0.7)",T.lineWidth=1.2/un,T.beginPath(),T.moveTo(J*hn,b*hn),T.lineTo(rn*hn,yn*hn),T.stroke(),T.beginPath(),T.arc(rn*hn,yn*hn,Rp/un/hn*.7*hn,0,Math.PI*2),T.fillStyle="#FAF6EE",T.fill(),T.strokeStyle="rgba(44,95,124,0.95)",T.lineWidth=1.4/un,T.stroke();for(const[bn,In]of[[-1,-1],[1,-1],[1,1],[-1,1]]){const[sr,oe]=Ve(Sn,bn*Sn.w/2,In*Sn.h/2);Pn(sr,oe)}if(((dn=x.current)==null?void 0:dn.type)==="rotate"){const bn=Math.round((Sn.rot??0)*180/Math.PI);T.fillStyle="rgba(44,95,124,0.95)",T.font=`${12/un}px "JetBrains Mono", monospace`,T.textAlign="center",T.fillText(`${bn}°`,rn*hn,yn*hn-12/un)}}else $&&(T.beginPath(),T.arc($.x*hn,$.y*hn,$.r*hn+3/un,0,Math.PI*2),T.stroke(),T.setLineDash([]),Pn($.x+$.r,$.y));T.setLineDash([])}if(((un,kn,Pn)=>{T.save(),T.translate(un.x*hn,un.y*hn),T.beginPath(),T.arc(0,0,1.1*hn,0,Math.PI*2),T.fillStyle=kn,T.fill(),T.strokeStyle="#1A1814",T.lineWidth=1.2/pn.k,T.stroke(),T.fillStyle="#FAF6EE",T.font=`${1.2*hn}px Pretendard, sans-serif`,T.textAlign="center",T.textBaseline="middle",T.fillText(Pn,0,.08*hn),T.restore()})(cn,"#6B8E5A","▶"),c.current&&d.current){const[un,kn]=c.current,[Pn,Sn]=d.current;if(T.fillStyle="rgba(26,24,20,0.18)",T.strokeStyle="rgba(26,24,20,0.9)",T.lineWidth=1.6/pn.k,T.setLineDash([6/pn.k,4/pn.k]),r==="box"){const $=Math.min(un,Pn)*hn,tn=Math.min(kn,Sn)*hn,J=Math.abs(Pn-un)*hn,b=Math.abs(Sn-kn)*hn;T.fillRect($,tn,J,b),T.strokeRect($,tn,J,b)}else if(r==="pillar"||r==="hill"){const $=Math.max(r==="pillar"?1:3,Math.round(Math.hypot(Pn-un,Sn-kn)));T.beginPath(),T.arc(un*hn,kn*hn,$*hn,0,Math.PI*2),r==="hill"&&(T.fillStyle="rgba(160,124,62,0.18)"),T.fill(),T.stroke()}T.setLineDash([])}T.setTransform(1,0,0,1,0,0)},[n,h,r,e]),Y=M.useRef(P);Y.current=P;const H=M.useCallback(()=>{a.current||(a.current=requestAnimationFrame(()=>{a.current=0,Y.current()}))},[]);M.useEffect(()=>{H()},[P,H]),M.useEffect(()=>{f(null),c.current=null,d.current=null,m.current=null,x.current=null,y.current=null},[n.id]),M.useEffect(()=>{const A=i.current,w=o.current;if(!A||!w)return;const N=w.clientWidth,z=w.clientHeight,U=O*hn,T=Math.max(.05,Math.min(8,Math.min((N-Ap*2)/U,(z-Ap*2)/U))),pn=cl().scaleExtent([T*.5,8]).translateExtent([[-U*.25,-U*.25],[U*1.25,U*1.25]]).filter(en=>en.type==="wheel"?!0:en.type==="dblclick"?!1:l.current||en.button===1).on("zoom",en=>{s.current=en.transform,H()}),X=Or(A);return X.call(pn),X.call(pn.transform,fe.translate((N-U*T)/2,(z-U*T)/2).scale(T)),()=>{X.on(".zoom",null)}},[n.id,O]),M.useEffect(()=>{const A=N=>{const z=N.target.tagName;if(!(z==="INPUT"||z==="TEXTAREA")){if(N.code==="Space"){N.type==="keydown"?(l.current=!0,N.preventDefault()):l.current=!1,o.current&&(o.current.dataset.panning=String(l.current));return}N.type==="keydown"&&((N.key==="Delete"||N.key==="Backspace")&&h&&(p(n.id,[h]),f(null)),N.key==="Escape"&&h&&(N.stopPropagation(),f(null),H()))}};window.addEventListener("keydown",A,!0),window.addEventListener("keyup",A);const w=new ResizeObserver(()=>H());return o.current&&w.observe(o.current),()=>{window.removeEventListener("keydown",A,!0),window.removeEventListener("keyup",A),w.disconnect()}},[h,n.id,H]);const k=A=>{if(A.button!==0||l.current)return;const w=I(A);if(!w)return;const N=K(w);if(N){A.target.setPointerCapture(A.pointerId),x.current=N,y.current=null,H();return}if(Math.hypot(w[0]-n.start.x,w[1]-n.start.y)<=1.4){A.target.setPointerCapture(A.pointerId),m.current={what:{kind:"start"},sx:w[0],sy:w[1],dx:0,dy:0};return}const z=kT(w[0],w[1],n.discs),U=z??ST(w[0],w[1],n.boxes);if(U){f(U),A.target.setPointerCapture(A.pointerId),m.current={what:{kind:z?"disc":"box",id:U},sx:w[0],sy:w[1],dx:0,dy:0},H();return}if(f(null),r==="box"||r==="pillar"||r==="hill"){A.target.setPointerCapture(A.pointerId);const T=[Z(w[0]),Z(w[1])];c.current=T,d.current=T}H()},R=A=>{const w=I(A);if(!w)return;if(t){const z=n.boxes.length+n.discs.length;t(`(${w[0].toFixed(1)}, ${w[1].toFixed(1)}) · ${O}m × ${O}m · 질량 ${z}`+(z===0?" · 박스(B)를 흐름 위에 놓아보세요 — 흐름이 비켜 갑니다":""))}const N=x.current;if(N){if(N.type==="resize"){const z=Math.cos(N.rot),U=Math.sin(N.rot),T=w[0]-N.fx,pn=w[1]-N.fy,X=T*z+pn*U,en=-T*U+pn*z,Q=Math.max(1,Math.round(Math.abs(X))),ln=Math.max(1,Math.round(Math.abs(en))),[cn,wn]=Dp(N.rot,N.gx*Q/2,N.gy*ln/2),Nn=N.fx+cn,Fn=N.fy+wn;y.current={x:Nn-Q/2,y:Fn-ln/2,w:Q,h:ln}}else if(N.type==="rotate"){const z=Math.atan2(w[1]-N.cy,w[0]-N.cx)+Math.PI/2;y.current={rot:Math.round(z/Lp)*Lp}}else{const z=N.kind==="pillar"?1:3;y.current={r:Math.max(z,Math.round(Math.hypot(w[0]-N.cx,w[1]-N.cy)))}}H();return}m.current?(m.current.dx=Math.round(w[0]-m.current.sx),m.current.dy=Math.round(w[1]-m.current.sy)):c.current&&(d.current=[Z(w[0]),Z(w[1])]),H()},j=()=>{var N,z,U;const A=x.current;if(A){const T=y.current;x.current=null,y.current=null,T&&S(n.id,A.id,T),H();return}const w=m.current;if(w){m.current=null,(w.dx!==0||w.dy!==0)&&(((N=w.what)==null?void 0:N.kind)==="box"||((z=w.what)==null?void 0:z.kind)==="disc"?v(n.id,[w.what.id],w.dx,w.dy):((U=w.what)==null?void 0:U.kind)==="start"&&C(n.id,{start:{x:n.start.x+w.dx,y:n.start.y+w.dy}})),H();return}if(c.current&&d.current){const[T,pn]=c.current,[X,en]=d.current;if(c.current=null,d.current=null,r==="box"){const Q=Math.abs(X-T),ln=Math.abs(en-pn);if(Q>=1&&ln>=1){const cn=Tn("fb");E(n.id,{id:cn,x:Math.min(T,X),y:Math.min(pn,en),w:Q,h:ln,rot:0}),f(cn)}}else if(r==="pillar"||r==="hill"){const ln=Math.max(r==="pillar"?1:3,Math.round(Math.hypot(X-T,en-pn))),cn=Tn("fd");g(n.id,{id:cn,kind:r,x:T,y:pn,r:ln}),f(cn)}H()}};return u.jsx("div",{ref:o,className:"td-canvas-wrap","data-tool":r,children:u.jsx("canvas",{ref:i,className:"td-canvas","data-testid":"flow-canvas",onPointerDown:k,onPointerMove:R,onPointerUp:j,onContextMenu:A=>A.preventDefault()})})}const Qo=(n,r,e,t)=>({id:Tn("fb"),x:n,y:r,w:e,h:t}),Os=(n,r,e)=>({id:Tn("fd"),kind:"pillar",x:n,y:r,r:e}),Zp=(n,r,e)=>({id:Tn("fd"),kind:"hill",x:n,y:r,r:e}),Fp=[{id:"uniform",name:"균일 보이드",lesson:"어느 틈으로 가도 똑같다 — 차이 없는 선택은 무의미한 선택이다. 박스 하나를 옮겨 차이를 만들어 보세요.",seed:()=>({boxes:[40,56,72,88].flatMap(n=>[32,48,64,80].map(r=>Qo(n,r,4,4))),discs:[]})},{id:"alley",name:"골목",lesson:'두 질량 사이로 흐름이 모여 빠르고 곧게 흐른다 — "파이프 속의 물". 골목 폭을 좁혀 보세요.',seed:()=>({boxes:[Qo(46,22,38,32),Qo(46,74,38,32)],discs:[]})},{id:"turbulent",name:"난류 모서리",lesson:"벽 모서리와 기둥들이 흐름을 흩뜨려 머무름·은신의 공간을 만든다. 기둥을 더하거나 빼 보세요.",seed:()=>({boxes:[Qo(44,28,46,5),Qo(85,28,5,46)],discs:[Os(56,48,2),Os(68,42,2),Os(62,58,2),Os(76,54,2)]})},{id:"hill",name:"언덕",lesson:"언덕의 법선은 위·옆을 향한다(부분 각도) — 흐름이 막히지 않고 둘레로 비켜 흐른다. 벽(박스)과 비교해 보세요.",seed:()=>({boxes:[],discs:[Zp(56,46,10),Zp(82,80,12)]})}],$p=[{id:"select",label:"선택",key:"V",title:"선택 (V) — 빈 곳을 드래그해도 아무것도 만들지 않는 안전 모드. 질량 이동·크기·회전은 어느 도구에서나 가능"},{id:"box",label:"박스",key:"B",title:"박스 (B) — 빈 곳 드래그로 질량 배치. 기존 질량은 그냥 드래그하면 이동"},{id:"pillar",label:"기둥",key:"C",title:"기둥 (C) — 클릭·드래그로 반경. 단단한 원 — 난류·머무름 실습"},{id:"hill",label:"언덕",key:"H",title:"언덕 (H) — 클릭·드래그로 반경. 소프트 반발 — 부분 각도, 흐름이 둘레로 비켜간다"}];function CT(){const n=B(k=>k.exitFlow),r=vr(k=>k.docs),e=vr(k=>k.currentId),t=vr(k=>k.setActive),o=vr(k=>k.addDoc),i=vr(k=>k.removeDoc),s=vr(k=>k.renameDoc),[a,l]=M.useState("box"),[c,d]=M.useState(""),[h,f]=M.useState(null),[m,x]=M.useState(""),[y,E]=M.useState({past:0,future:0}),[g,p]=M.useState(!1),[v,S]=M.useState(!1),[C,O]=M.useState(1.5),[I,Z]=M.useState(.3),F={normals:g,pressure:v,lineGap:C,lineAlpha:I};M.useEffect(()=>{const k=vr.temporal,R=()=>{const A=k.getState();E({past:A.pastStates.length,future:A.futureStates.length})};R();const j=k.subscribe(R);return()=>j()},[]);const K=r,P=K.find(k=>k.id===e)??K[0]??null;if(M.useEffect(()=>{const k=R=>{const j=R.target.tagName;if(j==="INPUT"||j==="TEXTAREA"||R.ctrlKey||R.metaKey||R.altKey)return;const A=$p.find(w=>w.key===R.key.toUpperCase());A&&l(A.id)};return window.addEventListener("keydown",k),()=>window.removeEventListener("keydown",k)},[]),!P)return u.jsxs("div",{className:"td-shell td-shell-empty",children:[u.jsx("p",{children:"흐름 문서가 없습니다."}),u.jsx("button",{className:"td-btn",onClick:()=>o(),children:"+ 흐름 만들기"})]});const Y=()=>{h&&m.trim()&&s(h,m.trim()),f(null)},H=(k,R)=>{const j=K.find(w=>w.id===k),A=j?j.boxes.length+j.discs.length:0;A>0&&!window.confirm(`'${R}'에 질량 ${A}개가 있습니다. 삭제할까요?`)||i(k)};return u.jsxs("div",{className:"td-shell","data-testid":"flow-shell",children:[u.jsxs("div",{className:"td-bar",children:[u.jsx("button",{className:"td-btn td-back",onClick:n,title:"버블 다이어그램으로 (Esc)",children:"← 버블"}),u.jsxs("div",{className:"td-tabs",role:"tablist",children:[K.map(k=>u.jsx("div",{role:"tab","aria-selected":k.id===P.id,className:`td-tab ${k.id===P.id?"is-active":""}`,onClick:()=>t(k.id),onDoubleClick:()=>{f(k.id),x(k.name)},title:"더블클릭: 이름 바꾸기",children:h===k.id?u.jsx("input",{autoFocus:!0,value:m,onChange:R=>x(R.target.value),onBlur:Y,onKeyDown:R=>{R.key==="Enter"&&Y(),R.key==="Escape"&&f(null)}}):u.jsxs(u.Fragment,{children:[u.jsx("span",{className:"td-tab-name",children:k.name}),K.length>1&&u.jsx("button",{className:"td-tab-close",onClick:R=>{R.stopPropagation(),H(k.id,k.name)},title:"삭제",children:"×"})]})},k.id)),u.jsx("button",{className:"td-btn td-tab-add",onClick:()=>o(),title:"흐름 추가",children:"＋"})]}),u.jsx("div",{className:"td-spacer"}),u.jsx("div",{className:"td-group",role:"toolbar","aria-label":"도구",children:$p.map(k=>u.jsx("button",{className:`td-btn td-tool ${a===k.id?"is-active":""}`,onClick:()=>l(k.id),title:k.title,children:k.label},k.id))}),u.jsxs("div",{className:"td-group",children:[u.jsx("button",{className:"td-btn td-undo",onClick:()=>Ty(),disabled:y.past===0,title:`되돌리기 (Ctrl+Z) · ${y.past}`,children:"↶"}),u.jsx("button",{className:"td-btn td-redo",onClick:()=>Iy(),disabled:y.future===0,title:`다시 실행 (Ctrl+Shift+Z / Ctrl+Y) · ${y.future}`,children:"↷"})]})]}),u.jsxs("div",{className:"td-bar td-bar-sub",children:[u.jsxs("div",{className:"td-group","aria-label":"시각화",children:[u.jsx("button",{className:`td-btn td-zone-danger ${g?"is-active":""}`,"data-testid":"fl-normals",onClick:()=>p(k=>!k),title:"법선 화살표 — 질량 표면에서 수직으로 밀어내는 힘 (강의 normals 도해)",children:"법선"}),u.jsx("button",{className:`td-btn td-overlay ${v?"is-active":""}`,"data-testid":"fl-pressure",onClick:()=>S(k=>!k),title:"압력 그라디언트 — 질량 주변의 파란 농도, 가까울수록 강한 push (강의 magnetic lines 도해)",children:"압력"})]}),u.jsxs("div",{className:"td-group","aria-label":"유선",children:[u.jsx("span",{className:"td-bar-label",children:"간격"}),u.jsx("input",{type:"range",className:"td-overlay-range",min:.75,max:4,step:.25,value:C,onChange:k=>O(Number(k.target.value)),title:`유선 간격 ${C}m`}),u.jsx("span",{className:"td-bar-label",children:"진하기"}),u.jsx("input",{type:"range",className:"td-overlay-range",min:.1,max:.6,step:.05,value:I,onChange:k=>Z(Number(k.target.value)),title:`유선 진하기 ${Math.round(I*100)}%`})]}),u.jsx("div",{className:"td-group","aria-label":"학습 프리셋",children:u.jsxs("select",{className:"td-select",value:"","data-testid":"fl-preset",onChange:k=>{const R=Fp.find(j=>j.id===k.target.value);R&&(o(R.name,R.seed()),l("select"))},title:"학습 프리셋 — week2-02 강의 장면 4종을 새 탭으로",children:[u.jsx("option",{value:"",children:"학습 프리셋…"}),Fp.map(k=>u.jsx("option",{value:k.id,title:k.lesson,children:k.name},k.id))]})}),u.jsx("div",{className:"td-spacer"})]}),u.jsx(bT,{doc:P,tool:a,view:F,onStatus:d}),u.jsxs("div",{className:"td-status",children:[u.jsx("span",{className:"td-status-doc",children:P.name}),u.jsxs("span",{children:[P.grid,"×",P.grid,"m · 질량 ",P.boxes.length+P.discs.length]}),u.jsx("span",{className:"td-status-hover",children:c}),u.jsx("span",{className:"td-status-hint",children:"질량 드래그: 이동 · 모서리 핸들: 크기 · 손잡이: 회전(15° 스냅) · 빈 곳 드래그: 생성 · 휠: 줌 · 스페이스: 패닝"})]})]})}const Ey="bubble-atelier::pacing",My=1;function PT(){try{const n=localStorage.getItem(Ey);if(!n)return null;const r=JSON.parse(n);if(r.v!==My||!Array.isArray(r.docs)||r.docs.length===0)return null;const e=r.docs.map(o=>({id:o.id,name:o.name,updatedAt:o.updatedAt??Date.now(),segments:Array.isArray(o.segments)?o.segments:[],points:Array.isArray(o.points)?o.points:[],markers:Array.isArray(o.markers)?o.markers:[]})),t=e.some(o=>o.id===r.currentId)?r.currentId:e[0].id;return{docs:e,currentId:t}}catch{return null}}const or=tl()(ol((n,r)=>{const t=PT()??(()=>{const i=Xl(Tn("pc"));return{docs:[i],currentId:i.id}})(),o=(i,s)=>n(a=>({docs:a.docs.map(l=>l.id===i?s(l):l)}));return{...t,setActive:i=>{r().docs.some(s=>s.id===i)&&n({currentId:i})},addDoc:(i,s)=>{const a={...Xl(Tn("pc"),i??`페이싱 ${r().docs.length+1}`),...s};return n(l=>({docs:[...l.docs,a],currentId:a.id})),a.id},removeDoc:i=>n(s=>{const a=s.docs.filter(l=>l.id!==i);if(a.length===0){const l=Xl(Tn("pc"));return{docs:[l],currentId:l.id}}return{docs:a,currentId:s.currentId===i?a[0].id:s.currentId}}),renameDoc:(i,s)=>o(i,a=>({...a,name:s})),addSegment:i=>{const s=Tn("pc-s");return o(i,a=>({...a,segments:[...a.segments,{id:s,name:`구간 ${a.segments.length+1}`,width:1}]})),s},renameSegment:(i,s,a)=>o(i,l=>({...l,segments:l.segments.map(c=>c.id===s?{...c,name:a}:c)})),setSegmentWidth:(i,s,a)=>o(i,l=>({...l,segments:l.segments.map(c=>c.id===s?{...c,width:Math.max(.25,a)}:c)})),removeSegment:(i,s)=>o(i,a=>a.segments.length<=1?a:{...a,segments:a.segments.filter(l=>l.id!==s),points:a.points.filter(l=>l.segId!==s)}),addPoint:(i,s)=>o(i,a=>({...a,points:[...a.points,s]})),movePoint:(i,s,a,l,c)=>o(i,d=>({...d,points:d.points.map(h=>h.id===s?{...h,segId:a,t:zp(l),tension:Bp(c)}:h)})),removePoint:(i,s)=>o(i,a=>({...a,points:a.points.filter(l=>l.id!==s)})),addMarker:(i,s)=>o(i,a=>({...a,markers:[...a.markers,s]})),moveMarker:(i,s,a,l)=>o(i,c=>({...c,markers:c.markers.map(d=>d.id===s?{...d,at:zp(a),tension:Bp(l)}:d)})),removeMarker:(i,s)=>o(i,a=>({...a,markers:a.markers.filter(l=>l.id!==s)}))}},{partialize:n=>({docs:n.docs,currentId:n.currentId}),limit:80,equality:(n,r)=>n.docs===r.docs})),zp=n=>Math.max(0,Math.min(1,n)),Bp=n=>Math.max(0,Math.min(100,n));let fc;or.subscribe(n=>{fc&&window.clearTimeout(fc),fc=window.setTimeout(()=>{try{localStorage.setItem(Ey,JSON.stringify({v:My,docs:n.docs,currentId:n.currentId}))}catch(r){console.warn("페이싱 저장 실패",r)}},400)});const Ny=()=>or.temporal.getState().undo(),jy=()=>or.temporal.getState().redo();function hl(n){const r=n.reduce((t,o)=>t+Math.max(.25,o.width),0)||1;let e=0;return n.map(t=>{const o=Math.max(.25,t.width)/r,i={id:t.id,x0:e,x1:e+o};return e+=o,i})}function Ay(n,r,e){const t=hl(e).find(o=>o.id===n);return t?t.x0+(t.x1-t.x0)*Math.max(0,Math.min(1,r)):0}function Zd(n){return n.points.map(r=>({x:Ay(r.segId,r.t,n.segments),tension:r.tension})).sort((r,e)=>r.x-e.x)}function Fd(n){const r=n.length;if(r===0)return()=>50;if(r===1)return()=>n[0].tension;const e=n.map(a=>a.x),t=n.map(a=>a.tension),o=[],i=[];for(let a=0;a<r-1;a++)o[a]=e[a+1]-e[a]||1e-6,i[a]=(t[a+1]-t[a])/o[a];const s=[i[0]];for(let a=1;a<r-1;a++)if(i[a-1]*i[a]<=0)s[a]=0;else{const l=2*o[a]+o[a-1],c=o[a]+2*o[a-1];s[a]=(l+c)/(l/i[a-1]+c/i[a])}return s[r-1]=i[r-2],a=>{if(a<=e[0])return t[0];if(a>=e[r-1])return t[r-1];let l=0;for(;a>e[l+1];)l++;const c=o[l],d=(a-e[l])/c,h=d*d,f=h*d,m=2*f-3*h+1,x=f-2*h+d,y=-2*f+3*h,E=f-h;return m*t[l]+x*c*s[l]+y*t[l+1]+E*c*s[l+1]}}function TT(n,r,e,t){const o=Fd(Zd(n)),i=c=>t+c*(r-2*t),s=c=>e-t-c/100*(e-2*t),a=120;let l="";for(let c=0;c<=a;c++){const d=c/a;l+=(c===0?"M":"L")+i(d).toFixed(1)+","+s(o(d)).toFixed(1)+" "}return l.trim()}function IT(n){return n<=33?{band:"아늑",items:["아늑한 폭","질서 있는 배치","둥근 형태","볕"]}:n<=66?{band:"상승",items:["폭 좁힘","천장 낮춤","뾰족한 형태"]}:{band:"간극",items:["기대 장치","그걸 끊는 장치(세트)"]}}const Hp=["var(--blueprint)","var(--ochre)","var(--blueprint-deep)","var(--ochre-deep)","var(--ink-500)","var(--blueprint-soft)","var(--ochre-soft)"];function ET(n,r){const e=n.segments.findIndex(t=>t.id===r);return Hp[(e<0?0:e)%Hp.length]}const tt={W:900,H:460,pad:44};function pc(n,r){const e=r.createSVGPoint();e.x=n.clientX,e.y=n.clientY;const t=e.matrixTransform(r.getScreenCTM().inverse());return{x:t.x,y:t.y}}const mc=n=>(n-tt.pad)/(tt.W-2*tt.pad),MT=n=>(tt.H-tt.pad-n)/(tt.H-2*tt.pad)*100;function Wp(n,r){const e=hl(r),t=Math.max(0,Math.min(1,n)),o=e.find(a=>t>=a.x0&&t<a.x1)??e[e.length-1],i=o.x1-o.x0||1e-6,s=Math.max(0,Math.min(1,(t-o.x0)/i));return{segId:o.id,t:s}}function Gp(n,r){return Fd(Zd(n))(Math.max(0,Math.min(1,r)))}const NT=[0,50,100];function jT({doc:n,tool:r,selSeg:e,onSelectSeg:t,onStatus:o}){const{W:i,H:s,pad:a}=tt,l=or(R=>R.addPoint),c=or(R=>R.movePoint),d=or(R=>R.removePoint),h=or(R=>R.addMarker),f=or(R=>R.moveMarker),m=or(R=>R.removeMarker),x=M.useRef(null),y=M.useRef(null),E=M.useRef(null),g=M.useMemo(()=>hl(n.segments),[n.segments]),p=M.useMemo(()=>TT(n,i,s,a),[n,i,s,a]),v=R=>a+R*(i-2*a),S=R=>s-a-R/100*(s-2*a),C=(R,j)=>{const{x:A,y:w}=pc(j,R),N=Math.max(0,Math.min(1,mc(A))),z=Math.max(0,Math.min(100,MT(w)));return{progress:N,tension:z}},O=R=>{const j=x.current;if(j){if(r==="point"){const{progress:A,tension:w}=C(j,R),{segId:N,t:z}=Wp(A,n.segments);l(n.id,{id:Tn("pc-p"),segId:N,t:z,tension:w}),o("점 추가");return}if(r==="flag"){const{x:A}=pc(R,j),w=Math.max(0,Math.min(1,mc(A))),N=Gp(n,w);h(n.id,{id:Tn("pc-m"),kind:"flag",at:w,tension:N}),o("도착 표기 추가")}}},I=R=>{const j=x.current;if(j){if(y.current){const{progress:A,tension:w}=C(j,R),{segId:N,t:z}=Wp(A,n.segments);c(n.id,y.current,N,z,w);return}if(E.current){const{x:A}=pc(R,j),w=Math.max(0,Math.min(1,mc(A))),N=Gp(n,w);f(n.id,E.current,w,N)}}},Z=R=>{if(!y.current&&!E.current)return;y.current=null,E.current=null;const j=x.current;j&&j.hasPointerCapture(R.pointerId)&&j.releasePointerCapture(R.pointerId)},F=R=>j=>{if(j.stopPropagation(),j.altKey){d(n.id,R),o("점 삭제");return}const A=x.current;A&&(y.current=R,A.setPointerCapture(j.pointerId))},K=R=>j=>{j.preventDefault(),j.stopPropagation(),d(n.id,R),o("점 삭제")},P=R=>j=>{if(j.stopPropagation(),j.altKey){m(n.id,R),o("표기 삭제");return}const A=x.current;A&&(E.current=R,A.setPointerCapture(j.pointerId))},Y=R=>j=>{j.preventDefault(),j.stopPropagation(),m(n.id,R),o("표기 삭제")},H=(R,j,A)=>{const w=A-6-26;return u.jsxs("g",{children:[u.jsx("line",{x1:j,y1:A,x2:j,y2:w,stroke:"var(--ink-700)",strokeWidth:3.5,strokeLinecap:"round"}),u.jsx("line",{x1:j,y1:A,x2:j,y2:w,stroke:"var(--paper-50)",strokeWidth:1.5,strokeLinecap:"round"}),u.jsx("polygon",{points:`${j},${w} ${j+13},${w+5} ${j},${w+10}`,fill:"var(--ochre)",stroke:"var(--ochre-deep)",strokeWidth:1})]})},k=(R,j,A)=>({x:j+3,y:A-16,r:24});return u.jsx("div",{className:"pac-canvas",children:u.jsxs("svg",{ref:x,viewBox:`0 0 ${i} ${s}`,preserveAspectRatio:"xMidYMid meet",className:"pac-svg","data-testid":"pacing-canvas",onPointerDown:O,onPointerMove:I,onPointerUp:Z,onPointerCancel:Z,children:[u.jsxs("defs",{children:[u.jsx("pattern",{id:"pac-grid-soft",width:"20",height:"20",patternUnits:"userSpaceOnUse",children:u.jsx("path",{d:"M 20 0 L 0 0 0 20",fill:"none",stroke:"var(--grid-line-soft)",strokeWidth:1})}),u.jsx("pattern",{id:"pac-grid-hard",width:"100",height:"100",patternUnits:"userSpaceOnUse",children:u.jsx("path",{d:"M 100 0 L 0 0 0 100",fill:"none",stroke:"var(--grid-line-hard)",strokeWidth:1})})]}),u.jsx("rect",{x:0,y:0,width:i,height:s,fill:"var(--paper-100)"}),u.jsx("rect",{x:0,y:0,width:i,height:s,fill:"url(#pac-grid-soft)"}),u.jsx("rect",{x:0,y:0,width:i,height:s,fill:"url(#pac-grid-hard)"}),NT.map(R=>{const j=S(R);return u.jsxs("g",{children:[u.jsx("line",{x1:a,y1:j,x2:i-a,y2:j,stroke:"var(--grid-line-hard)",strokeWidth:1,strokeDasharray:R===0||R===100?void 0:"3 3"}),u.jsx("text",{x:a-8,y:j+3,textAnchor:"end",className:"pac-tick-label",children:R})]},`tick-${R}`)}),g.map((R,j)=>{const A=v(R.x0),w=v(R.x1),N=n.segments[j],z=!!N&&N.id===e;return u.jsxs("g",{children:[j>0&&u.jsx("line",{x1:A,y1:a,x2:A,y2:s-a,stroke:"var(--blueprint)",strokeOpacity:.5,strokeWidth:1,strokeDasharray:"4 3"}),u.jsx("text",{x:(A+w)/2,y:s-a+18,textAnchor:"middle",className:`pac-seg-label${z?" is-active":""}`,style:{cursor:t?"pointer":"default"},onClick:()=>{N&&(t==null||t(N.id))},children:(N==null?void 0:N.name)??""})]},R.id)}),u.jsx("path",{d:p,stroke:"var(--ochre)",fill:"none",strokeWidth:2.5}),n.markers.map(R=>{const j=v(R.at),A=S(R.tension),w=k(R.kind,j,A);return u.jsxs("g",{className:`pac-marker pac-marker--${R.kind}`,onPointerDown:P(R.id),onContextMenu:Y(R.id),style:{cursor:"grab",touchAction:"none"},children:[u.jsx("circle",{cx:w.x,cy:w.y,r:w.r,fill:"transparent"}),u.jsx("circle",{cx:j,cy:A,r:3,fill:"var(--ochre)",stroke:"var(--paper-50)",strokeWidth:1}),H(R,j,A)]},R.id)}),n.points.map(R=>{const j=Ay(R.segId,R.t,n.segments),A=v(j),w=S(R.tension);return u.jsxs("g",{className:"pac-point",onPointerDown:F(R.id),onContextMenu:K(R.id),style:{cursor:"grab",touchAction:"none"},children:[u.jsx("circle",{cx:A,cy:w,r:20,fill:"transparent"}),u.jsx("circle",{cx:A,cy:w,r:6,fill:"var(--paper-50)",stroke:"var(--ochre)",strokeWidth:2})]},R.id)})]})})}const AT={아늑:"var(--ink-500)",상승:"var(--blueprint)",간극:"var(--ochre-deep)"},Vp={display:"flex",flexDirection:"column",gap:"2px",fontFamily:"var(--font-body)",fontSize:"var(--fs-xs)",color:"var(--ink-500)"},Up={padding:"4px 8px",border:"1px solid var(--ink-300)",borderRadius:"var(--r-sm)",fontFamily:"var(--font-body)",fontSize:"var(--fs-sm)",color:"var(--ink-700)",background:"var(--paper-50)"},Kp={borderTop:"var(--line-thin)",paddingBottom:"var(--sp-1)"};function OT({doc:n,selectedSegId:r,onSelectSeg:e}){const t=or(p=>p.renameSegment),o=or(p=>p.setSegmentWidth),i=or(p=>p.removeSegment),s=r?n.segments.find(p=>p.id===r)??null:null,[a,l]=M.useState((s==null?void 0:s.name)??"");M.useEffect(()=>{l((s==null?void 0:s.name)??"")},[s==null?void 0:s.id,s==null?void 0:s.name]);const c=u.jsxs(u.Fragment,{children:[u.jsx("div",{className:"pac-side-title",children:"구간 — 클릭해 선택"}),u.jsx("ul",{className:"pac-seg-list","data-testid":"pac-seg-list",children:n.segments.map(p=>u.jsxs("li",{className:`pac-seg-item${p.id===r?" is-active":""}`,onClick:()=>e(p.id),children:[u.jsx("span",{className:"pac-seg-swatch",style:{background:ET(n,p.id)}}),p.name]},p.id))})]});if(!s)return u.jsxs("div",{className:"pac-side",children:[c,u.jsx("p",{className:"pac-side-hint",children:"구간을 클릭해 선택하면 권장 공간 유형과 편집 항목이 열립니다."})]});const d=hl(n.segments).find(p=>p.id===s.id),h=d?(d.x0+d.x1)/2:0,f=Fd(Zd(n))(h),{band:m,items:x}=IT(f),y=AT[m],E=n.segments.length>1,g=()=>{const p=a.trim();p&&p!==s.name?t(n.id,s.id,p):l(s.name)};return u.jsxs("div",{className:"pac-side",children:[c,u.jsxs("div",{style:Kp,children:[u.jsxs("div",{className:"pac-side-title",style:{display:"flex",alignItems:"baseline",gap:"var(--sp-2)"},children:[u.jsxs("span",{children:["유형 힌트 — ",s.name]}),u.jsx("span",{style:{fontWeight:400,color:"var(--ink-400)",fontSize:"var(--fs-2xs, 10px)"},children:"읽기 전용"})]}),u.jsxs("p",{className:"pac-side-hint",style:{display:"flex",alignItems:"center",gap:"var(--sp-2)"},children:[u.jsxs("span",{children:["대표 긴장도 ",Math.round(f)]}),u.jsx("span",{style:{padding:"1px 8px",borderRadius:"var(--r-sm)",border:`1px solid ${y}`,color:y,fontWeight:600},children:m})]}),u.jsx("ul",{style:{listStyle:"none",margin:0,padding:"var(--sp-1) var(--sp-3)",display:"flex",flexWrap:"wrap",gap:"4px"},children:x.map(p=>u.jsx("li",{style:{padding:"2px 8px",borderRadius:"var(--r-sm)",background:"var(--paper-200)",color:"var(--ink-600)",fontSize:"var(--fs-xs)",cursor:"default"},children:p},p))}),u.jsx("p",{className:"pac-side-hint",style:{paddingTop:0,fontStyle:"italic",color:"var(--ink-400)"},children:"곡선 높이에 따라 자동 계산되는 가이드 — 직접 수정하는 항목이 아닙니다."})]}),u.jsxs("div",{style:Kp,children:[u.jsx("div",{className:"pac-side-title",children:"구간 편집"}),u.jsxs("div",{style:{padding:"var(--sp-1) var(--sp-3) var(--sp-3)",display:"flex",flexDirection:"column",gap:"var(--sp-2)"},children:[u.jsxs("label",{style:Vp,children:["구간 이름",u.jsx("input",{"data-testid":"pac-seg-name",value:a,onChange:p=>l(p.target.value),onBlur:g,onKeyDown:p=>{p.key==="Enter"&&(g(),p.target.blur()),p.key==="Escape"&&l(s.name)},style:Up})]}),u.jsxs("label",{style:Vp,children:["체류 비중",u.jsx("input",{"data-testid":"pac-seg-width",type:"number",min:.25,step:.25,value:s.width,onChange:p=>{const v=parseFloat(p.target.value);Number.isNaN(v)||o(n.id,s.id,v)},style:Up})]}),u.jsx("button",{className:"td-btn","data-testid":"pac-seg-remove",onClick:()=>i(n.id,s.id),disabled:!E,title:E?"이 구간을 삭제합니다":"마지막 구간은 삭제할 수 없습니다",style:{alignSelf:"flex-start",color:"var(--ochre-deep)",borderColor:"var(--ochre-deep)"},children:"구간 삭제"})]})]})]})}const RT=[{id:"jg-seg-start",name:"시작 지점",width:1},{id:"jg-seg-ground",name:"지상 섬",width:1},{id:"jg-seg-sky",name:"공중 섬",width:.8}],LT=[{id:"jg-p01",segId:"jg-seg-start",t:.05,tension:20},{id:"jg-p02",segId:"jg-seg-start",t:.18,tension:25},{id:"jg-p03",segId:"jg-seg-start",t:.31,tension:30},{id:"jg-p04",segId:"jg-seg-start",t:.44,tension:35},{id:"jg-p05",segId:"jg-seg-start",t:.57,tension:45},{id:"jg-p06",segId:"jg-seg-start",t:.7,tension:50},{id:"jg-p07",segId:"jg-seg-start",t:.83,tension:60},{id:"jg-p08",segId:"jg-seg-start",t:.95,tension:35},{id:"jg-p09",segId:"jg-seg-ground",t:.05,tension:40},{id:"jg-p10",segId:"jg-seg-ground",t:.18,tension:45},{id:"jg-p11",segId:"jg-seg-ground",t:.31,tension:55},{id:"jg-p12",segId:"jg-seg-ground",t:.44,tension:60},{id:"jg-p13",segId:"jg-seg-ground",t:.57,tension:65},{id:"jg-p14",segId:"jg-seg-ground",t:.7,tension:55},{id:"jg-p15",segId:"jg-seg-ground",t:.83,tension:60},{id:"jg-p16",segId:"jg-seg-ground",t:.95,tension:40},{id:"jg-p17",segId:"jg-seg-sky",t:.05,tension:55},{id:"jg-p18",segId:"jg-seg-sky",t:.2,tension:60},{id:"jg-p19",segId:"jg-seg-sky",t:.35,tension:55},{id:"jg-p20",segId:"jg-seg-sky",t:.5,tension:70},{id:"jg-p21",segId:"jg-seg-sky",t:.65,tension:80},{id:"jg-p22",segId:"jg-seg-sky",t:.82,tension:85},{id:"jg-p23",segId:"jg-seg-sky",t:.97,tension:30}],DT=[{id:"jg-m-flag",kind:"flag",at:.9914,tension:30}],Xp=[{id:"joryeonggwan",name:"조령관 예시 곡선",lesson:"시작 지점(성을 보고 거절당한 뒤 물에 잠기는 지붕을 건넘) → 지상 섬(끊긴 성벽·잠긴 문을 우회) → 공중 섬(바람길을 타고 끊긴 간극을 넘어 성에 도착). 동사 넷으로 22비트를 만든 곡선 — 산·골이 두 번 교차한 뒤 마지막에 최고점과 해소가 옵니다.",seed:()=>({segments:RT.map(n=>({...n})),points:LT.map(n=>({...n})),markers:DT.map(n=>({...n}))})}],Yp=[{id:"select",label:"선택",key:"V",title:"선택 (V) — 점 이동·삭제는 도구와 무관하게 항상 가능"},{id:"point",label:"점",key:"P",title:"점 (P) — 빈 곳 클릭으로 곡선 위에 점 추가"},{id:"flag",label:"도착",key:"F",title:"도착 (F) — 레벨 끝에서 도달할 감정 지점"}];function ZT(){const n=B(H=>H.exitPacing),r=or(H=>H.docs),e=or(H=>H.currentId),t=or(H=>H.setActive),o=or(H=>H.addDoc),i=or(H=>H.removeDoc),s=or(H=>H.renameDoc),a=or(H=>H.addSegment),[l,c]=M.useState("select"),[d,h]=M.useState(""),[f,m]=M.useState(null),[x,y]=M.useState(""),[E,g]=M.useState({past:0,future:0}),[p,v]=M.useState(null),S=M.useRef(null),[C,O]=M.useState(!1);M.useEffect(()=>{const H=or.temporal,k=()=>{const j=H.getState();g({past:j.pastStates.length,future:j.futureStates.length})};k();const R=H.subscribe(k);return()=>R()},[]);const I=r,Z=I.find(H=>H.id===e)??I[0]??null;if(M.useEffect(()=>{const H=k=>{const R=k.target.tagName;if(R==="INPUT"||R==="TEXTAREA"||k.ctrlKey||k.metaKey||k.altKey)return;const j=Yp.find(A=>A.key===k.key.toUpperCase());j&&c(j.id)};return window.addEventListener("keydown",H),()=>window.removeEventListener("keydown",H)},[]),M.useEffect(()=>{var H;Z&&(Z.segments.some(k=>k.id===p)||v(((H=Z.segments[0])==null?void 0:H.id)??null))},[Z==null?void 0:Z.id,Z==null?void 0:Z.segments,p]),!Z)return u.jsxs("div",{className:"td-shell td-shell-empty",children:[u.jsx("p",{children:"페이싱 문서가 없습니다."}),u.jsx("button",{className:"td-btn",onClick:()=>o(),children:"+ 페이싱 만들기"})]});const F=()=>{f&&x.trim()&&s(f,x.trim()),m(null)},K=(H,k)=>{const R=I.find(A=>A.id===H),j=R?R.points.length+R.markers.length:0;j>0&&!window.confirm(`'${k}'에 점·표기 ${j}개가 있습니다. 삭제할까요?`)||i(H)},P=async()=>{var H;if(S.current){O(!0);try{const k=(H=getComputedStyle(document.body).getPropertyValue("--paper-100"))==null?void 0:H.trim(),R=await Eu(S.current,{pixelRatio:2,backgroundColor:k||"#fff"}),j=document.createElement("a");j.href=R,j.download=`pacing-${Z.name}.png`,j.click(),h("PNG 저장 완료")}catch(k){h(`PNG 내보내기 실패: ${k.message??k}`)}finally{O(!1)}}},Y=()=>{il(Z,`${Z.name}.json`),h("JSON 저장 완료")};return u.jsxs("div",{className:"td-shell","data-testid":"pacing-shell",children:[u.jsxs("div",{className:"td-bar",children:[u.jsx("button",{className:"td-btn td-back",onClick:n,title:"버블 다이어그램으로 (Esc)",children:"← 버블"}),u.jsxs("div",{className:"td-tabs",role:"tablist",children:[I.map(H=>u.jsx("div",{role:"tab","aria-selected":H.id===Z.id,className:`td-tab ${H.id===Z.id?"is-active":""}`,onClick:()=>t(H.id),onDoubleClick:()=>{m(H.id),y(H.name)},title:"더블클릭: 이름 바꾸기",children:f===H.id?u.jsx("input",{autoFocus:!0,value:x,onChange:k=>y(k.target.value),onBlur:F,onKeyDown:k=>{k.key==="Enter"&&F(),k.key==="Escape"&&m(null)}}):u.jsxs(u.Fragment,{children:[u.jsx("span",{className:"td-tab-name",children:H.name}),I.length>1&&u.jsx("button",{className:"td-tab-close",onClick:k=>{k.stopPropagation(),K(H.id,H.name)},title:"삭제",children:"×"})]})},H.id)),u.jsx("button",{className:"td-btn td-tab-add",onClick:()=>o(),title:"페이싱 추가",children:"＋"})]}),u.jsx("div",{className:"td-spacer"}),u.jsxs("div",{className:"td-group",role:"toolbar","aria-label":"도구",children:[Yp.map(H=>u.jsx("button",{className:`td-btn td-tool ${l===H.id?"is-active":""}`,onClick:()=>c(H.id),title:H.title,children:H.label},H.id)),u.jsx("button",{className:"td-btn",onClick:()=>v(a(Z.id)),title:"구간 추가 — 곡선 가로축에 새 구간을 덧붙이고 바로 선택(오른쪽에서 편집)",children:"구간+"})]}),u.jsxs("div",{className:"td-group",children:[u.jsx("button",{className:"td-btn td-undo",onClick:()=>Ny(),disabled:E.past===0,title:`되돌리기 (Ctrl+Z) · ${E.past}`,children:"↶"}),u.jsx("button",{className:"td-btn td-redo",onClick:()=>jy(),disabled:E.future===0,title:`다시 실행 (Ctrl+Shift+Z / Ctrl+Y) · ${E.future}`,children:"↷"})]})]}),u.jsxs("div",{className:"td-bar td-bar-sub",children:[u.jsx("div",{className:"td-spacer"}),u.jsx("div",{className:"td-group","aria-label":"학습 프리셋",children:u.jsxs("select",{className:"td-select",value:"","data-testid":"pac-preset",onChange:H=>{const k=Xp.find(R=>R.id===H.target.value);k&&(o(k.name,k.seed()),c("select"))},title:"학습 프리셋 — 50·51강 장면을 새 탭으로",children:[u.jsx("option",{value:"",children:"학습 프리셋…"}),Xp.map(H=>u.jsx("option",{value:H.id,title:H.lesson,children:H.name},H.id))]})}),u.jsxs("div",{className:"td-group","aria-label":"내보내기",children:[u.jsx("button",{className:"td-btn",onClick:P,disabled:C,title:"PNG 내보내기 — 긴장 곡선만 이미지 한 장으로 저장 (과제 제출용)",children:C?"저장 중…":"PNG 내보내기"}),u.jsx("button",{className:"td-btn",onClick:Y,title:"JSON 내보내기 — 현재 페이싱 문서 원본 저장 (백업·공유용)",children:"JSON 내보내기"})]})]}),u.jsx("div",{className:"pac-body",children:u.jsxs("div",{className:"pac-main",children:[u.jsx("div",{className:"pac-export",ref:S,children:u.jsx(jT,{doc:Z,tool:l,selSeg:p,onSelectSeg:v,onStatus:h})}),u.jsx(OT,{doc:Z,selectedSegId:p,onSelectSeg:v})]})}),u.jsxs("div",{className:"td-status",children:[u.jsx("span",{className:"td-status-doc",children:Z.name}),u.jsxs("span",{children:["구간 ",Z.segments.length," · 점 ",Z.points.length," · 표기 ",Z.markers.length]}),u.jsx("span",{className:"td-status-hover",children:d}),u.jsx("span",{className:"td-status-hint",children:"점 도구: 빈 곳 클릭해 추가 · 점 드래그: 이동 · Alt+클릭/우클릭: 삭제 · 구간+: 가로축 구간 추가"})]})]})}function FT(){const n=B(l=>l.project.ai),r=B(l=>l.mode),e=localStorage.getItem("bubble-atelier::onboarded"),[t,o]=M.useState(!1),[i,s]=M.useState(!1);M.useEffect(()=>(window.__openLibrary=()=>o(!0),()=>{window.__openLibrary=void 0}),[]),M.useEffect(()=>{const l=c=>{const d=B.getState(),h=c.target.tagName,f=h==="INPUT"||h==="TEXTAREA",m=c.ctrlKey||c.metaKey,x=d.mode!=="bubble";if(c.key==="Escape"){if(d.mode==="topdown")return;if(d.mode==="massing"){d.exitMassing();return}if(d.mode==="flow"){d.exitFlow();return}if(d.mode==="pacing"){d.exitPacing();return}d.select({kind:"none"}),s(!1)}if((c.key==="f"||c.key==="F")&&!f&&!m&&!x&&(c.preventDefault(),s(g=>!g)),(c.key==="Delete"||c.key==="Backspace")&&!f&&!x){if(d.groupSelection.length>0){d.removeGroup();return}const g=d.selection;g.kind==="node"?d.removeNode(g.id):g.kind==="edge"?d.removeEdge(g.id):g.kind==="postit"?d.removePostit(g.id):g.kind==="decoration"?d.removeDecoration(g.id):g.kind==="image"&&d.removeImage(g.id)}m&&(c.key==="a"||c.key==="A")&&!f&&!x&&(c.preventDefault(),d.selectAll());const y=d.mode==="massing"?vy:d.mode==="flow"?Ty:d.mode==="pacing"?Ny:Cd,E=d.mode==="massing"?wy:d.mode==="flow"?Iy:d.mode==="pacing"?jy:Pd;m&&(c.key==="z"||c.key==="Z")&&(c.preventDefault(),c.shiftKey?E():y()),m&&(c.key==="y"||c.key==="Y")&&(c.preventDefault(),E())};return window.addEventListener("keydown",l),()=>window.removeEventListener("keydown",l)},[]);const a=!e&&n.provider==="none"&&!n.apiKey;return r==="topdown"?u.jsxs("div",{className:"app-shell is-topdown paper-grain",children:[u.jsx(Ef,{}),u.jsx(YP,{})]}):r==="massing"?u.jsx("div",{className:"app-shell is-massing paper-grain",children:u.jsx(uT,{})}):r==="flow"?u.jsx("div",{className:"app-shell is-massing paper-grain",children:u.jsx(CT,{})}):r==="pacing"?u.jsx("div",{className:"app-shell is-massing paper-grain",children:u.jsx(ZT,{})}):u.jsxs("div",{className:`app-shell paper-grain ${i?"is-focus":""}`,children:[u.jsx(Ef,{}),u.jsx(e2,{}),u.jsxs("div",{className:"app-body",children:[u.jsx(lk,{}),u.jsx(gC,{}),u.jsx(RP,{})]}),u.jsx("button",{className:"focus-toggle",onClick:()=>s(l=>!l),title:i?"넓게 쓰기 종료 (F / Esc)":"넓게 쓰기 (F)","aria-pressed":i,children:i?u.jsxs(u.Fragment,{children:[u.jsx("svg",{width:"16",height:"16",viewBox:"0 0 16 16","aria-hidden":!0,fill:"none",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round",strokeLinejoin:"round",children:u.jsx("path",{d:"M6 2v3a1 1 0 0 1-1 1H2M14 6h-3a1 1 0 0 1-1-1V2M2 10h3a1 1 0 0 1 1 1v3M10 14v-3a1 1 0 0 1 1-1h3"})}),u.jsx("span",{children:"좁게"})]}):u.jsxs(u.Fragment,{children:[u.jsx("svg",{width:"16",height:"16",viewBox:"0 0 16 16","aria-hidden":!0,fill:"none",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round",strokeLinejoin:"round",children:u.jsx("path",{d:"M2 6V3a1 1 0 0 1 1-1h3M10 2h3a1 1 0 0 1 1 1v3M14 10v3a1 1 0 0 1-1 1h-3M6 14H3a1 1 0 0 1-1-1v-3"})}),u.jsx("span",{children:"넓게"})]})}),a&&u.jsx(WP,{}),t&&u.jsx(BP,{onClose:()=>o(!1)})]})}window.__bubbleStore=B;gc.createRoot(document.getElementById("root")).render(u.jsx(lm.StrictMode,{children:u.jsx(FT,{})}));
