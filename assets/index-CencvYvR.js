 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Pp=Z,Ip=Symbol.for("react.element"),Ep=Symbol.for("react.fragment"),Np=Object.prototype.hasOwnProperty,bp=Pp.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Op={key:!0,ref:!0,__self:!0,__source:!0};function sd(n,r,e){var t,o={},i=null,s=null;e!==void 0&&(i=""+e),r.key!==void 0&&(i=""+r.key),r.ref!==void 0&&(s=r.ref);for(t in r)Np.call(r,t)&&!Op.hasOwnProperty(t)&&(o[t]=r[t]);if(n&&n.defaultProps)for(t in r=n.defaultProps,r)o[t]===void 0&&(o[t]=r[t]);return{$$typeof:Ip,type:n,key:i,ref:s,props:o,_owner:bp.current}}Li.Fragment=Ep;Li.jsx=sd;Li.jsxs=sd;Qu.exports=Li;var u=Qu.exports,Bs={},ad={exports:{}},Un={},ld={exports:{}},cd={};/**
 * @license React
...
`,j0=`\uFEFF# S12: The Forbidden Tome (금지된 고서)
...
`,k1=`# S07: The Dark Lord's Return - Top-down Map 상세 설계\r
\r
> **"빛이 강할수록 그림자는 짙어진다."**\r
\r
## 설계 개요\r
...
3. 🔄 Batch 2 진행률 업데이트\r
`,C1=`# S08: Light of Redemption - Top-down Map 상세 설계\r
\r
...
`,b1=`# S14: Revenge of the Fallen - Top-down Map 상세 설계\r
\r
...
`,j1=`# S18: Outcast's Redemption - Top-down Map 상세 설계\r
\r
...
위의 [+ 새 메모]로 시작하세요.`:"검색 결과 없음"})}),v.map(y=>u.jsx("li",{children:u.jsx(S0,{postit:y})},y.id))]})]})}function wf(n){let r=n|0;return()=>{r=r+1831565813|0;let e=r;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}}function xf(n){let r=2166136261;for(let e=0;e<n.length;e++)r^=n.charCodeAt(e),r=Math.imul(r,16777619);return r>>>0}function Ii(n,r){const e=.6+n()*1.4,t=2+n()*2,o=4+n()*3,i=n()*Math.PI*2,s=n()*Math.PI*2,a=n()*Math.PI*2;return l=>Math.sin(l*e*Math.PI*2*r+i)*.6+Math.sin(l*t*Math.PI*2*r+s)*.3+Math.sin(l*o*Math.PI*2*r+a)*.15}const Ty=n=>Math.sin(n*Math.PI);function Sf(n){if(n.length<2)return"";const r=o=>o.toFixed(2);let e=`M ${r(n[0][0])} ${r(n[0][1])}`;if(n.length===2)return e+=` L ${r(n[1][0])} ${r(n[1][1])}`,e;e+=` L ${r((n[0][0]+n[1][0])/2)} ${r((n[0][1]+n[1][1])/2)}`;for(let o=1;o<n.length-1;o++){const i=(n[o][0]+n[o+1][0])/2,s=(n[o][1]+n[o+1][1])/2;e+=` Q ${r(n[o][0])} ${r(n[o][1])}, ${r(i)} ${r(s)}`}const t=n[n.length-1];return e+=` L ${r(t[0])} ${r(t[1])}`,e}function Py(n,r,e,t,o){const i=o.roughness??1.4,s=o.bowing,a=o.passes;if(i<=0&&s<=0)return[`M ${n} ${r} L ${e} ${t}`];const l=e-n,c=t-r,d=Math.hypot(l,c);if(d<.5)return[`M ${n} ${r} L ${e} ${t}`];const h=l/d,v=-(c/d),y=h,w=Math.max(8,Math.min(48,Math.floor(d/12)));return Array.from({length:a},(O,f)=>{const g=wf(xf(`${o.seed}|L|${f}`)),m=f%2===0?1:-1,x=s*Math.min(d,200)*.04*m*(.7+g()*.6),_=(g()-.5)*i*.8,k=(g()-.5)*i*.8,S=Ii(g,.7),I=Ii(g,2.2),$=[];$.push([n+v*_,r+y*_]);for(let F=1;F<w;F++){const Y=F/w,X=Ty(Y),V=x*X,C=(S(Y)*.65+I(Y)*.35)*i*X,j=V+C,E=n+l*Y,L=r+c*Y;$.push([E+v*j,L+y*j])}return $.push([e+v*k,t+y*k]),Sf($)})}function Iy(n,r,e,t,o){const i=o.roughness,s=o.passes,a=Math.PI*(3*(e+t)-Math.sqrt((3*e+t)*(e+3*t))),l=Math.max(20,Math.min(64,Math.floor(a/10)));return Array.from({length:s},(c,d)=>{const h=wf(xf(`${o.seed}|E|${d}`)),p=(d*.35+h()*.6)*Math.PI,v=-(.05+h()*.12),y=.08+h()*.18,w=Math.PI*2+y-v,O=Ii(h,.8),f=Ii(h,2.5),g=1+(h()-.5)*.025,m=1+(h()-.5)*.025,x=(h()-.5)*.6,_=(h()-.5)*.6,k=[];for(let S=0;S<=l;S++){const I=S/l,$=p+v+w*I,F=(O(I)*.7+f(I)*.3)*i,Y=e*g+F,X=t*m+F;k.push([n+x+Math.cos($)*Y,r+_+Math.sin($)*X])}return Sf(k)})}const Qn="#1A1814",Jr={room:{label:"방",icon:"◯",rx:56,ry:56,fill:"#7AA8C2",stroke:Qn,strokeWidth:3.6,textColor:Qn},vista:{label:"전망",icon:"◇",rx:62,ry:62,fill:"#A88BB8",stroke:Qn,strokeWidth:3.6,textColor:Qn},treasure:{label:"보물",icon:"✦",rx:56,ry:56,fill:"#D9823A",stroke:Qn,strokeWidth:3.2,textColor:Qn},boss:{label:"보스",icon:"✚",rx:74,ry:74,fill:"#CF5547",stroke:Qn,strokeWidth:4.2,textColor:Qn},hub:{label:"허브",icon:"⌬",rx:62,ry:62,fill:"#E8C552",stroke:Qn,strokeWidth:3.6,textColor:Qn},save:{label:"세이브",icon:"⚑",rx:48,ry:48,fill:"#8AAE52",stroke:Qn,strokeWidth:3.2,textColor:Qn}};function ve(n,r=1,e=1){const t=Jr[n],o=Math.sqrt(e);return{rx:t.rx*r*o,ry:t.ry*r/o}}function Ey(n){const{rx:r,ry:e}=ve(n.type,n.size??1,n.aspect??1);return n.rough?Iy(n.cx,n.cy,r,e,{seed:n.seed,roughness:2.8,passes:2}):[Ny(n.cx,n.cy,r,e)]}function Ny(n,r,e,t){return`M ${n-e} ${r}
          ...
          a ${e} ${t} 0 1 0 ${-e*2} 0 Z`.replace(/\s+/g," ")}function by(n){const r=n.replace("#",""),e=r.length===3?r.split("").map(t=>t+t).join(""):r;return{r:parseInt(e.slice(0,2),16),g:parseInt(e.slice(2,4),16),b:parseInt(e.slice(4,6),16)}}function Oy(n,r,e){const t=o=>Math.round(Math.max(0,Math.min(255,o))).toString(16).padStart(2,"0");return`#${t(n)}${t(r)}${t(e)}`}function Ay(n,r,e){const t=n/255,o=r/255,i=e/255,s=Math.max(t,o,i),a=Math.min(t,o,i),l=(s+a)/2;let c=0,d=0;if(s!==a){const h=s-a;switch(d=l>.5?h/(2-s-a):h/(s+a),s){case t:c=(o-i)/h+(o<i?6:0);break;case o:c=(i-t)/h+2;break;case i:c=(t-o)/h+4;break}c*=60}return{h:c,s:d,l}}function My(n,r,e){const t=(1-Math.abs(2*e-1))*r,o=n/60,i=t*(1-Math.abs(o%2-1));let s=0,a=0,l=0;o>=0&&o<1?(s=t,a=i):o<2?(s=i,a=t):o<3?(a=t,l=i):o<4?(a=i,l=t):o<5?(s=i,l=t):(s=t,l=i);const c=e-t/2;return{r:(s+c)*255,g:(a+c)*255,b:(l+c)*255}}function _f(n,r,e){if(r===0&&e===1)return n;const{r:t,g:o,b:i}=by(n),{h:s,s:a,l}=Ay(t,o,i);if(a<.04)return n;const c=((s+r)%360+360)%360,d=Math.max(0,Math.min(1,a*e)),h=My(c,d,l);return Oy(h.r,h.g,h.b)}function jy({node:n,rough:r,selected:e,onPointerDownNode:t,onHandlePointerDown:o,onResizePointerDown:i}){const s=Jr[n.type],a=N(_=>{var k;return((k=_.project.theme)==null?void 0:k.hueShift)??0}),l=N(_=>{var k;return((k=_.project.theme)==null?void 0:k.satScale)??1}),c=a!==0||l!==1?{...s,fill:_f(s.fill,a,l)}:s,d=n.size??1,h=n.aspect??1,{rx:p,ry:v}=ve(n.type,d,h),y=Ey({cx:0,cy:0,type:n.type,size:d,aspect:h,rough:r,seed:n.id}),w=N(_=>_.select),[O,f]=Z.useState(!1),g=[{id:"e",x:p+6,y:0,ax:-2.5,ay:-2,bx:1.5,by:0,cx:-2.5,cy:2},{id:"w",x:-p-6,y:0,ax:2.5,ay:-2,bx:-1.5,by:0,cx:2.5,cy:2},{id:"n",x:0,y:-v-6,ax:-2,ay:2.5,bx:0,by:-1.5,cx:2,cy:2.5},{id:"s",x:0,y:v+6,ax:-2,ay:-2.5,bx:0,by:1.5,cx:2,cy:-2.5}],m=Math.PI*.25,x={x:p*Math.cos(m)+4,y:v*Math.sin(m)+4};return u.jsxs("g",{"data-node":n.id,transform:`translate(${n.x} ${n.y})`,onPointerDown:_=>{_.stopPropagation(),e||w({kind:"node",id:n.id}),t(_,n.id)},onPointerEnter:()=>f(!0),onPointerLeave:()=>f(!1),className:"bn",children:[u.jsx("ellipse",{cx:"0",cy:"0",rx:p,ry:v,fill:c.fill,stroke:"none",className:"bn-fill"}),y.map((_,k)=>u.jsx("path",{d:_,fill:"none",stroke:c.stroke,strokeWidth:r?e?c.strokeWidth+.6:c.strokeWidth*.92:e?c.strokeWidth+1.4:c.strokeWidth,strokeLinejoin:"round",strokeLinecap:"round",className:k===0?"bn-shape":"bn-shape-overlay"},k)),e&&u.jsx("ellipse",{cx:"0",cy:"0",rx:p+9,ry:v+7,fill:"none",stroke:"#1A1814",strokeWidth:"1.4",strokeDasharray:"5 4",pointerEvents:"none"}),u.jsx("text",{y:-12*d,textAnchor:"middle",fontSize:16*Math.sqrt(d),fill:c.textColor,fontFamily:"var(--font-display)",pointerEvents:"none",children:c.icon}),u.jsx("foreignObject",{x:-p+8,y:2,width:p*2-16,height:v,children:u.jsx("div",{className:"bn-name",style:{fontSize:`${13*Math.sqrt(d)}px`},children:n.name})}),u.jsx("text",{y:v-8,textAnchor:"middle",fontSize:9,fill:"var(--ink-500)",fontFamily:"var(--font-mono)",letterSpacing:"0.12em",pointerEvents:"none",style:{textTransform:"uppercase"},children:c.label}),n.icons.length>0&&(()=>{const _=Math.min(n.icons.length,8),S=Math.max(1,Math.ceil(_/4))*18+10;return u.jsx("foreignObject",{x:-p-30,y:v+6,width:p*2+60,height:S,children:u.jsxs("div",{className:"bn-icon-tags",children:[n.icons.slice(0,8).map(I=>u.jsx("span",{className:"bn-icon-chip",children:I},I)),n.icons.length>8&&u.jsxs("span",{className:"bn-icon-more",children:["+",n.icons.length-8]})]})})})(),(O||e)&&g.map(_=>u.jsxs("g",{"data-handle":"out",children:[u.jsx("circle",{cx:_.x,cy:_.y,r:"6",fill:"var(--paper-50)",stroke:"var(--brick)",strokeWidth:"1.4",className:"bn-handle",onPointerDown:k=>{k.stopPropagation(),o(k,n.id)}}),u.jsx("path",{d:`M ${_.x+_.ax} ${_.y+_.ay} L ${_.x+_.bx} ${_.y+_.by} L ${_.x+_.cx} ${_.y+_.cy}`,fill:"none",stroke:"var(--brick)",strokeWidth:"1.2",strokeLinecap:"round",strokeLinejoin:"round",pointerEvents:"none"})]},_.id)),(O||e)&&u.jsxs("g",{"data-handle":"resize",children:[u.jsx("circle",{cx:x.x,cy:x.y,r:"6",fill:"var(--paper-50)",stroke:"var(--blueprint)",strokeWidth:"1.4",className:"bn-handle bn-handle-resize",onPointerDown:_=>{_.stopPropagation(),i(_,n.id)}}),u.jsx("path",{d:`M ${x.x-2} ${x.y-2} L ${x.x+2} ${x.y+2}
                M ${x.x+2} ${x.y-2} L ${x.x-2} ${x.y+2}`,stroke:"var(--blueprint)",strokeWidth:"1.1",strokeLinecap:"round",pointerEvents:"none",opacity:"0.7"})]})]})}const ns={open:{stroke:"#1A1814",width:4.8,label:"통로"},locked:{stroke:"#8F7740",width:2.8,dash:"8 5",label:"잠금"},oneway:{stroke:"#6B6760",width:1.8,label:"일방"},ability:{stroke:"#8A3D3A",width:2.2,dash:"3 4",label:"능력"},vista:{stroke:"#6B4F87",width:1.6,dash:"2 6",label:"전망"}};function mu(n,r,e,t,o,i){const s=Math.sqrt(o*o/(e*e)+i*i/(t*t));return s===0?{x:n,y:r}:{x:n+o/s,y:r+i/s}}function Zy({edge:n,from:r,to:e,rough:t,selected:o,offset:i=0,onSelect:s}){const a=ns[n.type],{startX:l,startY:c,endX:d,endY:h,arrowX:p,arrowY:v,angle:y}=Z.useMemo(()=>{const _=e.x-r.x,k=e.y-r.y,S=Math.hypot(_,k)||1,I=_/S,$=k/S,F=r.id<e.id?1:-1,Y=-$*F,X=I*F,V=Y*i,C=X*i,j=ve(r.type,r.size??1,r.aspect??1),E=ve(e.type,e.size??1,e.aspect??1),L=mu(r.x,r.y,j.rx,j.ry,_,k),T=mu(e.x,e.y,E.rx,E.ry,-_,-k),A=6,M=2;return{startX:L.x-I*A+V,startY:L.y-$*A+C,endX:T.x+I*A+V,endY:T.y+$*A+C,arrowX:T.x-I*M+V,arrowY:T.y-$*M+C,angle:Math.atan2(k,_)*180/Math.PI}},[r.x,r.y,e.x,e.y,r.id,e.id,r.type,r.size,r.aspect,e.type,e.size,e.aspect,i]),w=Z.useMemo(()=>Py(l,c,d,h,{seed:n.id,roughness:t?4.8:0,bowing:0,passes:1}),[l,c,d,h,n.id,t]),O=Math.max(13,Math.min(18,a.width*3)),f=`${-O},${-O*.6} ${O*.45},0 ${-O},${O*.6}`,g=n.type==="oneway"||n.type==="ability"||n.type==="locked",m=(l+d)/2,x=(c+h)/2;return u.jsxs("g",{"data-edge":n.id,className:"eg",onClick:_=>{_.stopPropagation(),s(n.id)},children:[u.jsx("path",{d:w[0],fill:"none",stroke:"transparent",strokeWidth:"14"}),o&&w.map((_,k)=>u.jsx("path",{d:_,fill:"none",stroke:"#CF5547",strokeWidth:a.width+8,strokeLinecap:"round",strokeLinejoin:"round"},`halo-${k}`)),w.map((_,k)=>u.jsx("path",{d:_,fill:"none",stroke:a.stroke,strokeWidth:o?a.width+1.4:a.width,strokeDasharray:a.dash,strokeLinecap:"round",strokeLinejoin:"round"},k)),g&&u.jsx("polygon",{points:f,fill:o?"#CF5547":a.stroke,stroke:"#1A1814",strokeWidth:o?2:1.4,strokeLinejoin:"round",strokeLinecap:"round",transform:`translate(${p} ${v}) rotate(${y})`}),(n.keyId||n.abilityId||n.label)&&u.jsx(Ly,{x:m,y:x,text:n.label??n.keyId??n.abilityId??"",color:a.stroke})]})}function Ly({x:n,y:r,text:e,color:t}){const o=(e.match(/[가-힯ㄱ-ㅎㅏ-ㅣ]/g)||[]).length,i=e.length-o,a=Math.max(46,o*15+i*8+28),l=26;return u.jsx("foreignObject",{x:n-a/2,y:r-l/2,width:a,height:l,style:{overflow:"visible"},children:u.jsx("div",{className:"edge-label",style:{borderColor:t,color:t},children:u.jsx("span",{children:e})})})}const Dy=180,Ry=130;function Fy({nodes:n,viewBox:r}){if(n.length===0)return null;let e=1/0,t=1/0,o=-1/0,i=-1/0;for(const c of n){const d=ve(c.type,c.size??1,c.aspect??1);e=Math.min(e,c.x-d.rx),t=Math.min(t,c.y-d.ry),o=Math.max(o,c.x+d.rx),i=Math.max(i,c.y+d.ry)}const s=Math.max(1,o-e),a=Math.max(1,i-t),l=20;return u.jsxs("svg",{className:"minimap",width:Dy,height:Ry,viewBox:`${e-l} ${t-l} ${s+l*2} ${a+l*2}`,preserveAspectRatio:"xMidYMid meet",children:[u.jsx("rect",{x:e-l,y:t-l,width:s+l*2,height:a+l*2,fill:"rgba(244, 239, 230, 0.94)"}),n.map(c=>{const d=Jr[c.type],h=ve(c.type,c.size??1,c.aspect??1);return u.jsx("ellipse",{cx:c.x,cy:c.y,rx:h.rx,ry:h.ry,fill:d.fill,stroke:d.stroke,strokeWidth:"2"},c.id)}),u.jsx("rect",{x:r.x,y:r.y,width:r.w,height:r.h,fill:"none",stroke:"var(--brick)",strokeWidth:"2",strokeDasharray:"6 4"})]})}function Hy({dec:n,selected:r,onPointerDown:e,onArrowEndpointDown:t,onResizeDown:o}){const i=N(a=>a.select),s=a=>{a.stopPropagation(),r||i({kind:"decoration",id:n.id}),e(a,n.id)};return n.kind==="arrow"?u.jsx($y,{dec:n,selected:r,onSelect:s,onEndpointDown:t}):n.kind==="ellipse"?u.jsx(By,{dec:n,selected:r,onSelect:s,onResizeDown:o}):u.jsx(zy,{dec:n,selected:r,onSelect:s,onResizeDown:o})}function $y({dec:n,selected:r,onSelect:e,onEndpointDown:t}){const o=N(S=>{var I;return((I=S.project.theme)==null?void 0:I.hueShift)??0}),i=N(S=>{var I;return((I=S.project.theme)==null?void 0:I.satScale)??1}),s=n.x,a=n.y,l=n.x2??n.x+140,c=n.y2??n.y,d=l-s,h=c-a,p=Math.hypot(d,h)||1,v=d/p,y=h/p,w=Math.atan2(h,d)*180/Math.PI,O=o!==0||i!==1?_f("#E5202B",o,i):"#E5202B",f=r?28:24,g=44,m=g*.85,x=l-v*m,_=c-y*m,k=`${-g},${-g*.7} ${g*.5},0 ${-g},${g*.7}`;return u.jsxs("g",{"data-decoration":n.id,className:"deco",children:[u.jsx("line",{x1:s,y1:a,x2:l,y2:c,stroke:"transparent",strokeWidth:Math.max(f+16,g+12),strokeLinecap:"butt",onPointerDown:e}),u.jsx("line",{x1:s,y1:a,x2:x,y2:_,stroke:O,strokeWidth:f,strokeLinecap:"butt",pointerEvents:"none"}),u.jsx("polygon",{points:k,fill:O,stroke:"none",strokeLinejoin:"round",transform:`translate(${l} ${c}) rotate(${w})`,pointerEvents:"none"}),r&&u.jsxs(u.Fragment,{children:[u.jsx("circle",{cx:s,cy:a,r:"6",fill:"var(--paper-50)",stroke:"var(--brick)",strokeWidth:"1.4",className:"deco-handle",onPointerDown:S=>t(S,n.id,"start")}),u.jsx("circle",{cx:l,cy:c,r:"6",fill:"var(--paper-50)",stroke:"var(--brick)",strokeWidth:"1.4",className:"deco-handle",onPointerDown:S=>t(S,n.id,"end")})]})]})}function By({dec:n,selected:r,onSelect:e,onResizeDown:t}){const o=n.width??140,i=n.height??90,s=o/2,a=i/2;return u.jsxs("g",{"data-decoration":n.id,transform:`translate(${n.x} ${n.y})`,className:"deco",onPointerDown:e,children:[u.jsx("ellipse",{cx:"0",cy:"0",rx:s+10,ry:a+10,fill:"transparent",stroke:"none"}),u.jsx("ellipse",{cx:"0",cy:"0",rx:s,ry:a,fill:"#C9C4B8",stroke:"none",pointerEvents:"none"}),r&&u.jsx("ellipse",{cx:"0",cy:"0",rx:s+6,ry:a+6,fill:"none",stroke:"var(--brick)",strokeWidth:"1.4",strokeDasharray:"5 4",pointerEvents:"none"}),r&&u.jsx("circle",{cx:s*.707+4,cy:a*.707+4,r:"6",fill:"var(--paper-50)",stroke:"var(--blueprint)",strokeWidth:"1.4",className:"deco-handle deco-handle-resize",onPointerDown:l=>t(l,n.id)})]})}function zy({dec:n,selected:r,onSelect:e,onResizeDown:t}){const o=N(f=>f.updateDecoration),i=n.width??180,s=n.height??40,a=n.text??"텍스트",[l,c]=Z.useState(!1),d=Z.useRef(null),h=Math.max(1,a.length),p=(a.match(/[가-힯]/g)||[]).length,v=(p*1.5+(h-p))/h,y=Math.min(48,Math.max(12,s*.7)),w=Math.min(48,Math.max(12,i/h/v*1.4)),O=Math.min(y,w);return Z.useEffect(()=>{l&&d.current&&(d.current.focus(),d.current.select())},[l]),u.jsxs("g",{"data-decoration":n.id,transform:`translate(${n.x} ${n.y})`,className:"deco",onPointerDown:f=>{l||e(f)},onDoubleClick:f=>{f.stopPropagation(),c(!0)},children:[u.jsx("rect",{x:-i/2-8,y:-s/2-8,width:i+16,height:s+16,fill:"transparent",stroke:"none"}),u.jsx("foreignObject",{x:-i/2,y:-s/2,width:i,height:s,style:{overflow:"visible"},children:l?u.jsx("textarea",{ref:d,className:"deco-text-input",style:{fontSize:`${O}px`,width:"100%",height:"100%"},value:a,onChange:f=>o(n.id,{text:f.target.value}),onBlur:()=>c(!1),onKeyDown:f=>{f.key==="Escape"&&c(!1)}}):u.jsx("div",{className:"deco-text",style:{fontSize:`${O}px`,width:"100%",height:"100%"},children:a||u.jsx("span",{className:"deco-text-placeholder",children:"더블클릭으로 편집"})})}),r&&u.jsxs(u.Fragment,{children:[u.jsx("rect",{x:-i/2-4,y:-s/2-4,width:i+8,height:s+8,fill:"none",stroke:"var(--brick)",strokeWidth:"1.4",strokeDasharray:"5 4",pointerEvents:"none"}),u.jsx("circle",{cx:i/2+4,cy:s/2+4,r:"6",fill:"var(--paper-50)",stroke:"var(--blueprint)",strokeWidth:"1.4",className:"deco-handle deco-handle-resize",onPointerDown:f=>t(f,n.id)})]})]})}var Da="http://www.w3.org/1999/xhtml";const gu={svg:"http://www.w3.org/2000/svg",xhtml:Da,xlink:"http://www.w3.org/1999/xlink",xml:"http://www.w3.org/XML/1998/namespace",xmlns:"http://www.w3.org/2000/xmlns/"};function rs(n){var r=n+="",e=r.indexOf(":");return e>=0&&(r=n.slice(0,e))!=="xmlns"&&(n=n.slice(e+1)),gu.hasOwnProperty(r)?{space:gu[r],local:n}:n}function Wy(n){return function(){var r=this.ownerDocument,e=this.namespaceURI;return e===Da&&r.documentElement.namespaceURI===Da?r.createElement(n):r.createElementNS(e,n)}}function Gy(n){return function(){return this.ownerDocument.createElementNS(n.space,n.local)}}function kf(n){var r=rs(n);return(r.local?Gy:Wy)(r)}function Vy(){}function $l(n){return n==null?Vy:function(){return this.querySelector(n)}}function Uy(n){typeof n!="function"&&(n=$l(n));for(var r=this._groups,e=r.length,t=new Array(e),o=0;o<e;++o)for(var i=r[o],s=i.length,a=t[o]=new Array(s),l,c,d=0;d<s;++d)(l=i[d])&&(c=n.call(l,l.__data__,d,i))&&("__data__"in l&&(c.__data__=l.__data__),a[d]=c);return new Vn(t,this._parents)}function Ky(n){return n==null?[]:Array.isArray(n)?n:Array.from(n)}function Qy(){return[]}function Cf(n){return n==null?Qy:function(){return this.querySelectorAll(n)}}function Xy(n){return function(){return Ky(n.apply(this,arguments))}}function Yy(n){typeof n=="function"?n=Xy(n):n=Cf(n);for(var r=this._groups,e=r.length,t=[],o=[],i=0;i<e;++i)for(var s=r[i],a=s.length,l,c=0;c<a;++c)(l=s[c])&&(t.push(n.call(l,l.__data__,c,s)),o.push(l));return new Vn(t,o)}function Tf(n){return function(){return this.matches(n)}}function Pf(n){return function(r){return r.matches(n)}}var Jy=Array.prototype.find;function qy(n){return function(){return Jy.call(this.children,n)}}function nv(){return this.firstElementChild}function rv(n){return this.select(n==null?nv:qy(typeof n=="function"?n:Pf(n)))}var ev=Array.prototype.filter;function tv(){return Array.from(this.children)}function ov(n){return function(){return ev.call(this.children,n)}}function iv(n){return this.selectAll(n==null?tv:ov(typeof n=="function"?n:Pf(n)))}function sv(n){typeof n!="function"&&(n=Tf(n));for(var r=this._groups,e=r.length,t=new Array(e),o=0;o<e;++o)for(var i=r[o],s=i.length,a=t[o]=[],l,c=0;c<s;++c)(l=i[c])&&n.call(l,l.__data__,c,i)&&a.push(l);return new Vn(t,this._parents)}function If(n){return new Array(n.length)}function av(){return new Vn(this._enter||this._groups.map(If),this._parents)}function Ei(n,r){this.ownerDocument=n.ownerDocument,this.namespaceURI=n.namespaceURI,this._next=null,this._parent=n,this.__data__=r}Ei.prototype={constructor:Ei,appendChild:function(n){return this._parent.insertBefore(n,this._next)},insertBefore:function(n,r){return this._parent.insertBefore(n,r)},querySelector:function(n){return this._parent.querySelector(n)},querySelectorAll:function(n){return this._parent.querySelectorAll(n)}};function lv(n){return function(){return n}}function cv(n,r,e,t,o,i){for(var s=0,a,l=r.length,c=i.length;s<c;++s)(a=r[s])?(a.__data__=i[s],t[s]=a):e[s]=new Ei(n,i[s]);for(;s<l;++s)(a=r[s])&&(o[s]=a)}function uv(n,r,e,t,o,i,s){var a,l,c=new Map,d=r.length,h=i.length,p=new Array(d),v;for(a=0;a<d;++a)(l=r[a])&&(p[a]=v=s.call(l,l.__data__,a,r)+"",c.has(v)?o[a]=l:c.set(v,l));for(a=0;a<h;++a)v=s.call(n,i[a],a,i)+"",(l=c.get(v))?(t[a]=l,l.__data__=i[a],c.delete(v)):e[a]=new Ei(n,i[a]);for(a=0;a<d;++a)(l=r[a])&&c.get(p[a])===l&&(o[a]=l)}function dv(n){return n.__data__}function hv(n,r){if(!arguments.length)return Array.from(this,dv);var e=r?uv:cv,t=this._parents,o=this._groups;typeof n!="function"&&(n=lv(n));for(var i=o.length,s=new Array(i),a=new Array(i),l=new Array(i),c=0;c<i;++c){var d=t[c],h=o[c],p=h.length,v=fv(n.call(d,d&&d.__data__,c,t)),y=v.length,w=a[c]=new Array(y),O=s[c]=new Array(y),f=l[c]=new Array(p);e(d,h,w,O,f,v,r);for(var g=0,m=0,x,_;g<y;++g)if(x=w[g]){for(g>=m&&(m=g+1);!(_=O[m])&&++m<y;);x._next=_||null}}return s=new Vn(s,t),s._enter=a,s._exit=l,s}function fv(n){return typeof n=="object"&&"length"in n?n:Array.from(n)}function pv(){return new Vn(this._exit||this._groups.map(If),this._parents)}function mv(n,r,e){var t=this.enter(),o=this,i=this.exit();return typeof n=="function"?(t=n(t),t&&(t=t.selection())):t=t.append(n+""),r!=null&&(o=r(o),o&&(o=o.selection())),e==null?i.remove():e(i),t&&o?t.merge(o).order():o}function gv(n){for(var r=n.selection?n.selection():n,e=this._groups,t=r._groups,o=e.length,i=t.length,s=Math.min(o,i),a=new Array(o),l=0;l<s;++l)for(var c=e[l],d=t[l],h=c.length,p=a[l]=new Array(h),v,y=0;y<h;++y)(v=c[y]||d[y])&&(p[y]=v);for(;l<o;++l)a[l]=e[l];return new Vn(a,this._parents)}function yv(){for(var n=this._groups,r=-1,e=n.length;++r<e;)for(var t=n[r],o=t.length-1,i=t[o],s;--o>=0;)(s=t[o])&&(i&&s.compareDocumentPosition(i)^4&&i.parentNode.insertBefore(s,i),i=s);return this}function vv(n){n||(n=wv);function r(h,p){return h&&p?n(h.__data__,p.__data__):!h-!p}for(var e=this._groups,t=e.length,o=new Array(t),i=0;i<t;++i){for(var s=e[i],a=s.length,l=o[i]=new Array(a),c,d=0;d<a;++d)(c=s[d])&&(l[d]=c);l.sort(r)}return new Vn(o,this._parents).order()}function wv(n,r){return n<r?-1:n>r?1:n>=r?0:NaN}function xv(){var n=arguments[0];return arguments[0]=this,n.apply(null,arguments),this}function Sv(){return Array.from(this)}function _v(){for(var n=this._groups,r=0,e=n.length;r<e;++r)for(var t=n[r],o=0,i=t.length;o<i;++o){var s=t[o];if(s)return s}return null}function kv(){let n=0;for(const r of this)++n;return n}function Cv(){return!this.node()}function Tv(n){for(var r=this._groups,e=0,t=r.length;e<t;++e)for(var o=r[e],i=0,s=o.length,a;i<s;++i)(a=o[i])&&n.call(a,a.__data__,i,o);return this}function Pv(n){return function(){this.removeAttribute(n)}}function Iv(n){return function(){this.removeAttributeNS(n.space,n.local)}}function Ev(n,r){return function(){this.setAttribute(n,r)}}function Nv(n,r){return function(){this.setAttributeNS(n.space,n.local,r)}}function bv(n,r){return function(){var e=r.apply(this,arguments);e==null?this.removeAttribute(n):this.setAttribute(n,e)}}function Ov(n,r){return function(){var e=r.apply(this,arguments);e==null?this.removeAttributeNS(n.space,n.local):this.setAttributeNS(n.space,n.local,e)}}function Av(n,r){var e=rs(n);if(arguments.length<2){var t=this.node();return e.local?t.getAttributeNS(e.space,e.local):t.getAttribute(e)}return this.each((r==null?e.local?Iv:Pv:typeof r=="function"?e.local?Ov:bv:e.local?Nv:Ev)(e,r))}function Ef(n){return n.ownerDocument&&n.ownerDocument.defaultView||n.document&&n||n.defaultView}function Mv(n){return function(){this.style.removeProperty(n)}}function jv(n,r,e){return function(){this.style.setProperty(n,r,e)}}function Zv(n,r,e){return function(){var t=r.apply(this,arguments);t==null?this.style.removeProperty(n):this.style.setProperty(n,t,e)}}function Lv(n,r,e){return arguments.length>1?this.each((r==null?Mv:typeof r=="function"?Zv:jv)(n,r,e??"")):rt(this.node(),n)}function rt(n,r){return n.style.getPropertyValue(r)||Ef(n).getComputedStyle(n,null).getPropertyValue(r)}function Dv(n){return function(){delete this[n]}}function Rv(n,r){return function(){this[n]=r}}function Fv(n,r){return function(){var e=r.apply(this,arguments);e==null?delete this[n]:this[n]=e}}function Hv(n,r){return arguments.length>1?this.each((r==null?Dv:typeof r=="function"?Fv:Rv)(n,r)):this.node()[n]}function Nf(n){return n.trim().split(/^|\s+/)}function Bl(n){return n.classList||new bf(n)}function bf(n){this._node=n,this._names=Nf(n.getAttribute("class")||"")}bf.prototype={add:function(n){var r=this._names.indexOf(n);r<0&&(this._names.push(n),this._node.setAttribute("class",this._names.join(" ")))},remove:function(n){var r=this._names.indexOf(n);r>=0&&(this._names.splice(r,1),this._node.setAttribute("class",this._names.join(" ")))},contains:function(n){return this._names.indexOf(n)>=0}};function Of(n,r){for(var e=Bl(n),t=-1,o=r.length;++t<o;)e.add(r[t])}function Af(n,r){for(var e=Bl(n),t=-1,o=r.length;++t<o;)e.remove(r[t])}function $v(n){return function(){Of(this,n)}}function Bv(n){return function(){Af(this,n)}}function zv(n,r){return function(){(r.apply(this,arguments)?Of:Af)(this,n)}}function Wv(n,r){var e=Nf(n+"");if(arguments.length<2){for(var t=Bl(this.node()),o=-1,i=e.length;++o<i;)if(!t.contains(e[o]))return!1;return!0}return this.each((typeof r=="function"?zv:r?$v:Bv)(e,r))}function Gv(){this.textContent=""}function Vv(n){return function(){this.textContent=n}}function Uv(n){return function(){var r=n.apply(this,arguments);this.textContent=r??""}}function Kv(n){return arguments.length?this.each(n==null?Gv:(typeof n=="function"?Uv:Vv)(n)):this.node().textContent}function Qv(){this.innerHTML=""}function Xv(n){return function(){this.innerHTML=n}}function Yv(n){return function(){var r=n.apply(this,arguments);this.innerHTML=r??""}}function Jv(n){return arguments.length?this.each(n==null?Qv:(typeof n=="function"?Yv:Xv)(n)):this.node().innerHTML}function qv(){this.nextSibling&&this.parentNode.appendChild(this)}function nw(){return this.each(qv)}function rw(){this.previousSibling&&this.parentNode.insertBefore(this,this.parentNode.firstChild)}function ew(){return this.each(rw)}function tw(n){var r=typeof n=="function"?n:kf(n);return this.select(function(){return this.appendChild(r.apply(this,arguments))})}function ow(){return null}function iw(n,r){var e=typeof n=="function"?n:kf(n),t=r==null?ow:typeof r=="function"?r:$l(r);return this.select(function(){return this.insertBefore(e.apply(this,arguments),t.apply(this,arguments)||null)})}function sw(){var n=this.parentNode;n&&n.removeChild(this)}function aw(){return this.each(sw)}function lw(){var n=this.cloneNode(!1),r=this.parentNode;return r?r.insertBefore(n,this.nextSibling):n}function cw(){var n=this.cloneNode(!0),r=this.parentNode;return r?r.insertBefore(n,this.nextSibling):n}function uw(n){return this.select(n?cw:lw)}function dw(n){return arguments.length?this.property("__data__",n):this.node().__data__}function hw(n){return function(r){n.call(this,r,this.__data__)}}function fw(n){return n.trim().split(/^|\s+/).map(function(r){var e="",t=r.indexOf(".");return t>=0&&(e=r.slice(t+1),r=r.slice(0,t)),{type:r,name:e}})}function pw(n){return function(){var r=this.__on;if(r){for(var e=0,t=-1,o=r.length,i;e<o;++e)i=r[e],(!n.type||i.type===n.type)&&i.name===n.name?this.removeEventListener(i.type,i.listener,i.options):r[++t]=i;++t?r.length=t:delete this.__on}}}function mw(n,r,e){return function(){var t=this.__on,o,i=hw(r);if(t){for(var s=0,a=t.length;s<a;++s)if((o=t[s]).type===n.type&&o.name===n.name){this.removeEventListener(o.type,o.listener,o.options),this.addEventListener(o.type,o.listener=i,o.options=e),o.value=r;return}}this.addEventListener(n.type,i,e),o={type:n.type,name:n.name,value:r,listener:i,options:e},t?t.push(o):this.__on=[o]}}function gw(n,r,e){var t=fw(n+""),o,i=t.length,s;if(arguments.length<2){var a=this.node().__on;if(a){for(var l=0,c=a.length,d;l<c;++l)for(o=0,d=a[l];o<i;++o)if((s=t[o]).type===d.type&&s.name===d.name)return d.value}return}for(a=r?mw:pw,o=0;o<i;++o)this.each(a(t[o],r,e));return this}function Mf(n,r,e){var t=Ef(n),o=t.CustomEvent;typeof o=="function"?o=new o(r,e):(o=t.document.createEvent("Event"),e?(o.initEvent(r,e.bubbles,e.cancelable),o.detail=e.detail):o.initEvent(r,!1,!1)),n.dispatchEvent(o)}function yw(n,r){return function(){return Mf(this,n,r)}}function vw(n,r){return function(){return Mf(this,n,r.apply(this,arguments))}}function ww(n,r){return this.each((typeof r=="function"?vw:yw)(n,r))}function*xw(){for(var n=this._groups,r=0,e=n.length;r<e;++r)for(var t=n[r],o=0,i=t.length,s;o<i;++o)(s=t[o])&&(yield s)}var jf=[null];function Vn(n,r){this._groups=n,this._parents=r}function lo(){return new Vn([[document.documentElement]],jf)}function Sw(){return this}Vn.prototype=lo.prototype={constructor:Vn,select:Uy,selectAll:Yy,selectChild:rv,selectChildren:iv,filter:sv,data:hv,enter:av,exit:pv,join:mv,merge:gv,selection:Sw,order:yv,sort:vv,call:xv,nodes:Sv,node:_v,size:kv,empty:Cv,each:Tv,attr:Av,style:Lv,property:Hv,classed:Wv,text:Kv,html:Jv,raise:nw,lower:ew,append:tw,insert:iw,remove:aw,clone:uw,datum:dw,on:gw,dispatch:ww,[Symbol.iterator]:xw};function sr(n){return typeof n=="string"?new Vn([[document.querySelector(n)]],[document.documentElement]):new Vn([[n]],jf)}function _w(n){let r;for(;r=n.sourceEvent;)n=r;return n}function ee(n,r){if(n=_w(n),r===void 0&&(r=n.currentTarget),r){var e=r.ownerSVGElement||r;if(e.createSVGPoint){var t=e.createSVGPoint();return t.x=n.clientX,t.y=n.clientY,t=t.matrixTransform(r.getScreenCTM().inverse()),[t.x,t.y]}if(r.getBoundingClientRect){var o=r.getBoundingClientRect();return[n.clientX-o.left-r.clientLeft,n.clientY-o.top-r.clientTop]}}return[n.pageX,n.pageY]}var kw={value:()=>{}};function zl(){for(var n=0,r=arguments.length,e={},t;n<r;++n){if(!(t=arguments[n]+"")||t in e||/[\s.]/.test(t))throw new Error("illegal type: "+t);e[t]=[]}return new Xo(e)}function Xo(n){this._=n}function Cw(n,r){return n.trim().split(/^|\s+/).map(function(e){var t="",o=e.indexOf(".");if(o>=0&&(t=e.slice(o+1),e=e.slice(0,o)),e&&!r.hasOwnProperty(e))throw new Error("unknown type: "+e);return{type:e,name:t}})}Xo.prototype=zl.prototype={constructor:Xo,on:function(n,r){var e=this._,t=Cw(n+"",e),o,i=-1,s=t.length;if(arguments.length<2){for(;++i<s;)if((o=(n=t[i]).type)&&(o=Tw(e[o],n.name)))return o;return}if(r!=null&&typeof r!="function")throw new Error("invalid callback: "+r);for(;++i<s;)if(o=(n=t[i]).type)e[o]=yu(e[o],n.name,r);else if(r==null)for(o in e)e[o]=yu(e[o],n.name,null);return this},copy:function(){var n={},r=this._;for(var e in r)n[e]=r[e].slice();return new Xo(n)},call:function(n,r){if((o=arguments.length-2)>0)for(var e=new Array(o),t=0,o,i;t<o;++t)e[t]=arguments[t+2];if(!this._.hasOwnProperty(n))throw new Error("unknown type: "+n);for(i=this._[n],t=0,o=i.length;t<o;++t)i[t].value.apply(r,e)},apply:function(n,r,e){if(!this._.hasOwnProperty(n))throw new Error("unknown type: "+n);for(var t=this._[n],o=0,i=t.length;o<i;++o)t[o].value.apply(r,e)}};function Tw(n,r){for(var e=0,t=n.length,o;e<t;++e)if((o=n[e]).name===r)return o.value}function yu(n,r,e){for(var t=0,o=n.length;t<o;++t)if(n[t].name===r){n[t]=kw,n=n.slice(0,t).concat(n.slice(t+1));break}return e!=null&&n.push({name:r,value:e}),n}const Ra={capture:!0,passive:!1};function Fa(n){n.preventDefault(),n.stopImmediatePropagation()}function Pw(n){var r=n.document.documentElement,e=sr(n).on("dragstart.drag",Fa,Ra);"onselectstart"in r?e.on("selectstart.drag",Fa,Ra):(r.__noselect=r.style.MozUserSelect,r.style.MozUserSelect="none")}function Iw(n,r){var e=n.document.documentElement,t=sr(n).on("dragstart.drag",null);r&&(t.on("click.drag",Fa,Ra),setTimeout(function(){t.on("click.drag",null)},0)),"onselectstart"in e?t.on("selectstart.drag",null):(e.style.MozUserSelect=e.__noselect,delete e.__noselect)}function Wl(n,r,e){n.prototype=r.prototype=e,e.constructor=n}function Zf(n,r){var e=Object.create(n.prototype);for(var t in r)e[t]=r[t];return e}function co(){}var Jt=.7,Ni=1/Jt,Ge="\\s*([+-]?\\d+)\\s*",qt="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*",yr="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*",Ew=/^#([0-9a-f]{3,8})$/,Nw=new RegExp(`^rgb\\(${Ge},${Ge},${Ge}\\)$`),bw=new RegExp(`^rgb\\(${yr},${yr},${yr}\\)$`),Ow=new RegExp(`^rgba\\(${Ge},${Ge},${Ge},${qt}\\)$`),Aw=new RegExp(`^rgba\\(${yr},${yr},${yr},${qt}\\)$`),Mw=new RegExp(`^hsl\\(${qt},${yr},${yr}\\)$`),jw=new RegExp(`^hsla\\(${qt},${yr},${yr},${qt}\\)$`),vu={aliceblue:15792383,antiquewhite:16444375,aqua:65535,aquamarine:8388564,azure:15794175,beige:16119260,bisque:16770244,black:0,blanchedalmond:16772045,blue:255,blueviolet:9055202,brown:10824234,burlywood:14596231,cadetblue:6266528,chartreuse:8388352,chocolate:13789470,coral:16744272,cornflowerblue:6591981,cornsilk:16775388,crimson:14423100,cyan:65535,darkblue:139,darkcyan:35723,darkgoldenrod:12092939,darkgray:11119017,darkgreen:25600,darkgrey:11119017,darkkhaki:12433259,darkmagenta:9109643,darkolivegreen:5597999,darkorange:16747520,darkorchid:10040012,darkred:9109504,darksalmon:15308410,darkseagreen:9419919,darkslateblue:4734347,darkslategray:3100495,darkslategrey:3100495,darkturquoise:52945,darkviolet:9699539,deeppink:16716947,deepskyblue:49151,dimgray:6908265,dimgrey:6908265,dodgerblue:2003199,firebrick:11674146,floralwhite:16775920,forestgreen:2263842,fuchsia:16711935,gainsboro:14474460,ghostwhite:16316671,gold:16766720,goldenrod:14329120,gray:8421504,green:32768,greenyellow:11403055,grey:8421504,honeydew:15794160,hotpink:16738740,indianred:13458524,indigo:4915330,ivory:16777200,khaki:15787660,lavender:15132410,lavenderblush:16773365,lawngreen:8190976,lemonchiffon:16775885,lightblue:11393254,lightcoral:15761536,lightcyan:14745599,lightgoldenrodyellow:16448210,lightgray:13882323,lightgreen:9498256,lightgrey:13882323,lightpink:16758465,lightsalmon:16752762,lightseagreen:2142890,lightskyblue:8900346,lightslategray:7833753,lightslategrey:7833753,lightsteelblue:11584734,lightyellow:16777184,lime:65280,limegreen:3329330,linen:16445670,magenta:16711935,maroon:8388608,mediumaquamarine:6737322,mediumblue:205,mediumorchid:12211667,mediumpurple:9662683,mediumseagreen:3978097,mediumslateblue:8087790,mediumspringgreen:64154,mediumturquoise:4772300,mediumvioletred:13047173,midnightblue:1644912,mintcream:16121850,mistyrose:16770273,moccasin:16770229,navajowhite:16768685,navy:128,oldlace:16643558,olive:8421376,olivedrab:7048739,orange:16753920,orangered:16729344,orchid:14315734,palegoldenrod:15657130,palegreen:10025880,paleturquoise:11529966,palevioletred:14381203,papayawhip:16773077,peachpuff:16767673,peru:13468991,pink:16761035,plum:14524637,powderblue:11591910,purple:8388736,rebeccapurple:6697881,red:16711680,rosybrown:12357519,royalblue:4286945,saddlebrown:9127187,salmon:16416882,sandybrown:16032864,seagreen:3050327,seashell:16774638,sienna:10506797,silver:12632256,skyblue:8900331,slateblue:6970061,slategray:7372944,slategrey:7372944,snow:16775930,springgreen:65407,steelblue:4620980,tan:13808780,teal:32896,thistle:14204888,tomato:16737095,turquoise:4251856,violet:15631086,wheat:16113331,white:16777215,whitesmoke:16119285,yellow:16776960,yellowgreen:10145074};Wl(co,no,{copy(n){return Object.assign(new this.constructor,this,n)},displayable(){return this.rgb().displayable()},hex:wu,formatHex:wu,formatHex8:Zw,formatHsl:Lw,formatRgb:xu,toString:xu});function wu(){return this.rgb().formatHex()}function Zw(){return this.rgb().formatHex8()}function Lw(){return Lf(this).formatHsl()}function xu(){return this.rgb().formatRgb()}function no(n){var r,e;return n=(n+"").trim().toLowerCase(),(r=Ew.exec(n))?(e=r[1].length,r=parseInt(r[1],16),e===6?Su(r):e===3?new Zn(r>>8&15|r>>4&240,r>>4&15|r&240,(r&15)<<4|r&15,1):e===8?Ao(r>>24&255,r>>16&255,r>>8&255,(r&255)/255):e===4?Ao(r>>12&15|r>>8&240,r>>8&15|r>>4&240,r>>4&15|r&240,((r&15)<<4|r&15)/255):null):(r=Nw.exec(n))?new Zn(r[1],r[2],r[3],1):(r=bw.exec(n))?new Zn(r[1]*255/100,r[2]*255/100,r[3]*255/100,1):(r=Ow.exec(n))?Ao(r[1],r[2],r[3],r[4]):(r=Aw.exec(n))?Ao(r[1]*255/100,r[2]*255/100,r[3]*255/100,r[4]):(r=Mw.exec(n))?Cu(r[1],r[2]/100,r[3]/100,1):(r=jw.exec(n))?Cu(r[1],r[2]/100,r[3]/100,r[4]):vu.hasOwnProperty(n)?Su(vu[n]):n==="transparent"?new Zn(NaN,NaN,NaN,0):null}function Su(n){return new Zn(n>>16&255,n>>8&255,n&255,1)}function Ao(n,r,e,t){return t<=0&&(n=r=e=NaN),new Zn(n,r,e,t)}function Dw(n){return n instanceof co||(n=no(n)),n?(n=n.rgb(),new Zn(n.r,n.g,n.b,n.opacity)):new Zn}function Ha(n,r,e,t){return arguments.length===1?Dw(n):new Zn(n,r,e,t??1)}function Zn(n,r,e,t){this.r=+n,this.g=+r,this.b=+e,this.opacity=+t}Wl(Zn,Ha,Zf(co,{brighter(n){return n=n==null?Ni:Math.pow(Ni,n),new Zn(this.r*n,this.g*n,this.b*n,this.opacity)},darker(n){return n=n==null?Jt:Math.pow(Jt,n),new Zn(this.r*n,this.g*n,this.b*n,this.opacity)},rgb(){return this},clamp(){return new Zn(he(this.r),he(this.g),he(this.b),bi(this.opacity))},displayable(){return-.5<=this.r&&this.r<255.5&&-.5<=this.g&&this.g<255.5&&-.5<=this.b&&this.b<255.5&&0<=this.opacity&&this.opacity<=1},hex:_u,formatHex:_u,formatHex8:Rw,formatRgb:ku,toString:ku}));function _u(){return`#${ce(this.r)}${ce(this.g)}${ce(this.b)}`}function Rw(){return`#${ce(this.r)}${ce(this.g)}${ce(this.b)}${ce((isNaN(this.opacity)?1:this.opacity)*255)}`}function ku(){const n=bi(this.opacity);return`${n===1?"rgb(":"rgba("}${he(this.r)}, ${he(this.g)}, ${he(this.b)}${n===1?")":`, ${n})`}`}function bi(n){return isNaN(n)?1:Math.max(0,Math.min(1,n))}function he(n){return Math.max(0,Math.min(255,Math.round(n)||0))}function ce(n){return n=he(n),(n<16?"0":"")+n.toString(16)}function Cu(n,r,e,t){return t<=0?n=r=e=NaN:e<=0||e>=1?n=r=NaN:r<=0&&(n=NaN),new ar(n,r,e,t)}function Lf(n){if(n instanceof ar)return new ar(n.h,n.s,n.l,n.opacity);if(n instanceof co||(n=no(n)),!n)return new ar;if(n instanceof ar)return n;n=n.rgb();var r=n.r/255,e=n.g/255,t=n.b/255,o=Math.min(r,e,t),i=Math.max(r,e,t),s=NaN,a=i-o,l=(i+o)/2;return a?(r===i?s=(e-t)/a+(e<t)*6:e===i?s=(t-r)/a+2:s=(r-e)/a+4,a/=l<.5?i+o:2-i-o,s*=60):a=l>0&&l<1?0:s,new ar(s,a,l,n.opacity)}function Fw(n,r,e,t){return arguments.length===1?Lf(n):new ar(n,r,e,t??1)}function ar(n,r,e,t){this.h=+n,this.s=+r,this.l=+e,this.opacity=+t}Wl(ar,Fw,Zf(co,{brighter(n){return n=n==null?Ni:Math.pow(Ni,n),new ar(this.h,this.s,this.l*n,this.opacity)},darker(n){return n=n==null?Jt:Math.pow(Jt,n),new ar(this.h,this.s,this.l*n,this.opacity)},rgb(){var n=this.h%360+(this.h<0)*360,r=isNaN(n)||isNaN(this.s)?0:this.s,e=this.l,t=e+(e<.5?e:1-e)*r,o=2*e-t;return new Zn(Ds(n>=240?n-240:n+120,o,t),Ds(n,o,t),Ds(n<120?n+240:n-120,o,t),this.opacity)},clamp(){return new ar(Tu(this.h),Mo(this.s),Mo(this.l),bi(this.opacity))},displayable(){return(0<=this.s&&this.s<=1||isNaN(this.s))&&0<=this.l&&this.l<=1&&0<=this.opacity&&this.opacity<=1},formatHsl(){const n=bi(this.opacity);return`${n===1?"hsl(":"hsla("}${Tu(this.h)}, ${Mo(this.s)*100}%, ${Mo(this.l)*100}%${n===1?")":`, ${n})`}`}}));function Tu(n){return n=(n||0)%360,n<0?n+360:n}function Mo(n){return Math.max(0,Math.min(1,n||0))}function Ds(n,r,e){return(n<60?r+(e-r)*n/60:n<180?e:n<240?r+(e-r)*(240-n)/60:r)*255}const Df=n=>()=>n;function Hw(n,r){return function(e){return n+e*r}}function $w(n,r,e){return n=Math.pow(n,e),r=Math.pow(r,e)-n,e=1/e,function(t){return Math.pow(n+t*r,e)}}function Bw(n){return(n=+n)==1?Rf:function(r,e){return e-r?$w(r,e,n):Df(isNaN(r)?e:r)}}function Rf(n,r){var e=r-n;return e?Hw(n,e):Df(isNaN(n)?r:n)}const Pu=function n(r){var e=Bw(r);function t(o,i){var s=e((o=Ha(o)).r,(i=Ha(i)).r),a=e(o.g,i.g),l=e(o.b,i.b),c=Rf(o.opacity,i.opacity);return function(d){return o.r=s(d),o.g=a(d),o.b=l(d),o.opacity=c(d),o+""}}return t.gamma=n,t}(1);function Lr(n,r){return n=+n,r=+r,function(e){return n*(1-e)+r*e}}var $a=/[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,Rs=new RegExp($a.source,"g");function zw(n){return function(){return n}}function Ww(n){return function(r){return n(r)+""}}function Gw(n,r){var e=$a.lastIndex=Rs.lastIndex=0,t,o,i,s=-1,a=[],l=[];for(n=n+"",r=r+"";(t=$a.exec(n))&&(o=Rs.exec(r));)(i=o.index)>e&&(i=r.slice(e,i),a[s]?a[s]+=i:a[++s]=i),(t=t[0])===(o=o[0])?a[s]?a[s]+=o:a[++s]=o:(a[++s]=null,l.push({i:s,x:Lr(t,o)})),e=Rs.lastIndex;return e<r.length&&(i=r.slice(e),a[s]?a[s]+=i:a[++s]=i),a.length<2?l[0]?Ww(l[0].x):zw(r):(r=l.length,function(c){for(var d=0,h;d<r;++d)a[(h=l[d]).i]=h.x(c);return a.join("")})}var Iu=180/Math.PI,Ba={translateX:0,translateY:0,rotate:0,skewX:0,scaleX:1,scaleY:1};function Ff(n,r,e,t,o,i){var s,a,l;return(s=Math.sqrt(n*n+r*r))&&(n/=s,r/=s),(l=n*e+r*t)&&(e-=n*l,t-=r*l),(a=Math.sqrt(e*e+t*t))&&(e/=a,t/=a,l/=a),n*t<r*e&&(n=-n,r=-r,l=-l,s=-s),{translateX:o,translateY:i,rotate:Math.atan2(r,n)*Iu,skewX:Math.atan(l)*Iu,scaleX:s,scaleY:a}}var jo;function Vw(n){const r=new(typeof DOMMatrix=="function"?DOMMatrix:WebKitCSSMatrix)(n+"");return r.isIdentity?Ba:Ff(r.a,r.b,r.c,r.d,r.e,r.f)}function Uw(n){return n==null||(jo||(jo=document.createElementNS("http://www.w3.org/2000/svg","g")),jo.setAttribute("transform",n),!(n=jo.transform.baseVal.consolidate()))?Ba:(n=n.matrix,Ff(n.a,n.b,n.c,n.d,n.e,n.f))}function Hf(n,r,e,t){function o(c){return c.length?c.pop()+" ":""}function i(c,d,h,p,v,y){if(c!==h||d!==p){var w=v.push("translate(",null,r,null,e);y.push({i:w-4,x:Lr(c,h)},{i:w-2,x:Lr(d,p)})}else(h||p)&&v.push("translate("+h+r+p+e)}function s(c,d,h,p){c!==d?(c-d>180?d+=360:d-c>180&&(c+=360),p.push({i:h.push(o(h)+"rotate(",null,t)-2,x:Lr(c,d)})):d&&h.push(o(h)+"rotate("+d+t)}function a(c,d,h,p){c!==d?p.push({i:h.push(o(h)+"skewX(",null,t)-2,x:Lr(c,d)}):d&&h.push(o(h)+"skewX("+d+t)}function l(c,d,h,p,v,y){if(c!==h||d!==p){var w=v.push(o(v)+"scale(",null,",",null,")");y.push({i:w-4,x:Lr(c,h)},{i:w-2,x:Lr(d,p)})}else(h!==1||p!==1)&&v.push(o(v)+"scale("+h+","+p+")")}return function(c,d){var h=[],p=[];return c=n(c),d=n(d),i(c.translateX,c.translateY,d.translateX,d.translateY,h,p),s(c.rotate,d.rotate,h,p),a(c.skewX,d.skewX,h,p),l(c.scaleX,c.scaleY,d.scaleX,d.scaleY,h,p),c=d=null,function(v){for(var y=-1,w=p.length,O;++y<w;)h[(O=p[y]).i]=O.x(v);return h.join("")}}}var Kw=Hf(Vw,"px, ","px)","deg)"),Qw=Hf(Uw,", ",")",")"),Xw=1e-12;function Eu(n){return((n=Math.exp(n))+1/n)/2}function Yw(n){return((n=Math.exp(n))-1/n)/2}function Jw(n){return((n=Math.exp(2*n))-1)/(n+1)}const qw=function n(r,e,t){function o(i,s){var a=i[0],l=i[1],c=i[2],d=s[0],h=s[1],p=s[2],v=d-a,y=h-l,w=v*v+y*y,O,f;if(w<Xw)f=Math.log(p/c)/r,O=function(S){return[a+S*v,l+S*y,c*Math.exp(r*S*f)]};else{var g=Math.sqrt(w),m=(p*p-c*c+t*w)/(2*c*e*g),x=(p*p-c*c-t*w)/(2*p*e*g),_=Math.log(Math.sqrt(m*m+1)-m),k=Math.log(Math.sqrt(x*x+1)-x);f=(k-_)/r,O=function(S){var I=S*f,$=Eu(_),F=c/(e*g)*($*Jw(r*I+_)-Yw(_));return[a+F*v,l+F*y,c*$/Eu(r*I+_)]}}return O.duration=f*1e3*r/Math.SQRT2,O}return o.rho=function(i){var s=Math.max(.001,+i),a=s*s,l=a*a;return n(s,a,l)},o}(Math.SQRT2,2,4);var et=0,_t=0,mt=0,$f=1e3,Oi,kt,Ai=0,we=0,es=0,ro=typeof performance=="object"&&performance.now?performance:Date,Bf=typeof window=="object"&&window.requestAnimationFrame?window.requestAnimationFrame.bind(window):function(n){setTimeout(n,17)};function Gl(){return we||(Bf(nx),we=ro.now()+es)}function nx(){we=0}function Mi(){this._call=this._time=this._next=null}Mi.prototype=zf.prototype={constructor:Mi,restart:function(n,r,e){if(typeof n!="function")throw new TypeError("callback is not a function");e=(e==null?Gl():+e)+(r==null?0:+r),!this._next&&kt!==this&&(kt?kt._next=this:Oi=this,kt=this),this._call=n,this._time=e,za()},stop:function(){this._call&&(this._call=null,this._time=1/0,za())}};function zf(n,r,e){var t=new Mi;return t.restart(n,r,e),t}function rx(){Gl(),++et;for(var n=Oi,r;n;)(r=we-n._time)>=0&&n._call.call(void 0,r),n=n._next;--et}function Nu(){we=(Ai=ro.now())+es,et=_t=0;try{rx()}finally{et=0,tx(),we=0}}function ex(){var n=ro.now(),r=n-Ai;r>$f&&(es-=r,Ai=n)}function tx(){for(var n,r=Oi,e,t=1/0;r;)r._call?(t>r._time&&(t=r._time),n=r,r=r._next):(e=r._next,r._next=null,r=n?n._next=e:Oi=e);kt=n,za(t)}function za(n){if(!et){_t&&(_t=clearTimeout(_t));var r=n-we;r>24?(n<1/0&&(_t=setTimeout(Nu,n-ro.now()-es)),mt&&(mt=clearInterval(mt))):(mt||(Ai=ro.now(),mt=setInterval(ex,$f)),et=1,Bf(Nu))}}function bu(n,r,e){var t=new Mi;return r=r==null?0:+r,t.restart(o=>{t.stop(),n(o+r)},r,e),t}var ox=zl("start","end","cancel","interrupt"),ix=[],Wf=0,Ou=1,Wa=2,Yo=3,Au=4,Ga=5,Jo=6;function ts(n,r,e,t,o,i){var s=n.__transition;if(!s)n.__transition={};else if(e in s)return;sx(n,e,{name:r,index:t,group:o,on:ox,tween:ix,time:i.time,delay:i.delay,duration:i.duration,ease:i.ease,timer:null,state:Wf})}function Vl(n,r){var e=dr(n,r);if(e.state>Wf)throw new Error("too late; already scheduled");return e}function vr(n,r){var e=dr(n,r);if(e.state>Yo)throw new Error("too late; already running");return e}function dr(n,r){var e=n.__transition;if(!e||!(e=e[r]))throw new Error("transition not found");return e}function sx(n,r,e){var t=n.__transition,o;t[r]=e,e.timer=zf(i,0,e.time);function i(c){e.state=Ou,e.timer.restart(s,e.delay,e.time),e.delay<=c&&s(c-e.delay)}function s(c){var d,h,p,v;if(e.state!==Ou)return l();for(d in t)if(v=t[d],v.name===e.name){if(v.state===Yo)return bu(s);v.state===Au?(v.state=Jo,v.timer.stop(),v.on.call("interrupt",n,n.__data__,v.index,v.group),delete t[d]):+d<r&&(v.state=Jo,v.timer.stop(),v.on.call("cancel",n,n.__data__,v.index,v.group),delete t[d])}if(bu(function(){e.state===Yo&&(e.state=Au,e.timer.restart(a,e.delay,e.time),a(c))}),e.state=Wa,e.on.call("start",n,n.__data__,e.index,e.group),e.state===Wa){for(e.state=Yo,o=new Array(p=e.tween.length),d=0,h=-1;d<p;++d)(v=e.tween[d].value.call(n,n.__data__,e.index,e.group))&&(o[++h]=v);o.length=h+1}}function a(c){for(var d=c<e.duration?e.ease.call(null,c/e.duration):(e.timer.restart(l),e.state=Ga,1),h=-1,p=o.length;++h<p;)o[h].call(n,d);e.state===Ga&&(e.on.call("end",n,n.__data__,e.index,e.group),l())}function l(){e.state=Jo,e.timer.stop(),delete t[r];for(var c in t)return;delete n.__transition}}function qo(n,r){var e=n.__transition,t,o,i=!0,s;if(e){r=r==null?null:r+"";for(s in e){if((t=e[s]).name!==r){i=!1;continue}o=t.state>Wa&&t.state<Ga,t.state=Jo,t.timer.stop(),t.on.call(o?"interrupt":"cancel",n,n.__data__,t.index,t.group),delete e[s]}i&&delete n.__transition}}function ax(n){return this.each(function(){qo(this,n)})}function lx(n,r){var e,t;return function(){var o=vr(this,n),i=o.tween;if(i!==e){t=e=i;for(var s=0,a=t.length;s<a;++s)if(t[s].name===r){t=t.slice(),t.splice(s,1);break}}o.tween=t}}function cx(n,r,e){var t,o;if(typeof e!="function")throw new Error;return function(){var i=vr(this,n),s=i.tween;if(s!==t){o=(t=s).slice();for(var a={name:r,value:e},l=0,c=o.length;l<c;++l)if(o[l].name===r){o[l]=a;break}l===c&&o.push(a)}i.tween=o}}function ux(n,r){var e=this._id;if(n+="",arguments.length<2){for(var t=dr(this.node(),e).tween,o=0,i=t.length,s;o<i;++o)if((s=t[o]).name===n)return s.value;return null}return this.each((r==null?lx:cx)(e,n,r))}function Ul(n,r,e){var t=n._id;return n.each(function(){var o=vr(this,t);(o.value||(o.value={}))[r]=e.apply(this,arguments)}),function(o){return dr(o,t).value[r]}}function Gf(n,r){var e;return(typeof r=="number"?Lr:r instanceof no?Pu:(e=no(r))?(r=e,Pu):Gw)(n,r)}function dx(n){return function(){this.removeAttribute(n)}}function hx(n){return function(){this.removeAttributeNS(n.space,n.local)}}function fx(n,r,e){var t,o=e+"",i;return function(){var s=this.getAttribute(n);return s===o?null:s===t?i:i=r(t=s,e)}}function px(n,r,e){var t,o=e+"",i;return function(){var s=this.getAttributeNS(n.space,n.local);return s===o?null:s===t?i:i=r(t=s,e)}}function mx(n,r,e){var t,o,i;return function(){var s,a=e(this),l;return a==null?void this.removeAttribute(n):(s=this.getAttribute(n),l=a+"",s===l?null:s===t&&l===o?i:(o=l,i=r(t=s,a)))}}function gx(n,r,e){var t,o,i;return function(){var s,a=e(this),l;return a==null?void this.removeAttributeNS(n.space,n.local):(s=this.getAttributeNS(n.space,n.local),l=a+"",s===l?null:s===t&&l===o?i:(o=l,i=r(t=s,a)))}}function yx(n,r){var e=rs(n),t=e==="transform"?Qw:Gf;return this.attrTween(n,typeof r=="function"?(e.local?gx:mx)(e,t,Ul(this,"attr."+n,r)):r==null?(e.local?hx:dx)(e):(e.local?px:fx)(e,t,r))}function vx(n,r){return function(e){this.setAttribute(n,r.call(this,e))}}function wx(n,r){return function(e){this.setAttributeNS(n.space,n.local,r.call(this,e))}}function xx(n,r){var e,t;function o(){var i=r.apply(this,arguments);return i!==t&&(e=(t=i)&&wx(n,i)),e}return o._value=r,o}function Sx(n,r){var e,t;function o(){var i=r.apply(this,arguments);return i!==t&&(e=(t=i)&&vx(n,i)),e}return o._value=r,o}function _x(n,r){var e="attr."+n;if(arguments.length<2)return(e=this.tween(e))&&e._value;if(r==null)return this.tween(e,null);if(typeof r!="function")throw new Error;var t=rs(n);return this.tween(e,(t.local?xx:Sx)(t,r))}function kx(n,r){return function(){Vl(this,n).delay=+r.apply(this,arguments)}}function Cx(n,r){return r=+r,function(){Vl(this,n).delay=r}}function Tx(n){var r=this._id;return arguments.length?this.each((typeof n=="function"?kx:Cx)(r,n)):dr(this.node(),r).delay}function Px(n,r){return function(){vr(this,n).duration=+r.apply(this,arguments)}}function Ix(n,r){return r=+r,function(){vr(this,n).duration=r}}function Ex(n){var r=this._id;return arguments.length?this.each((typeof n=="function"?Px:Ix)(r,n)):dr(this.node(),r).duration}function Nx(n,r){if(typeof r!="function")throw new Error;return function(){vr(this,n).ease=r}}function bx(n){var r=this._id;return arguments.length?this.each(Nx(r,n)):dr(this.node(),r).ease}function Ox(n,r){return function(){var e=r.apply(this,arguments);if(typeof e!="function")throw new Error;vr(this,n).ease=e}}function Ax(n){if(typeof n!="function")throw new Error;return this.each(Ox(this._id,n))}function Mx(n){typeof n!="function"&&(n=Tf(n));for(var r=this._groups,e=r.length,t=new Array(e),o=0;o<e;++o)for(var i=r[o],s=i.length,a=t[o]=[],l,c=0;c<s;++c)(l=i[c])&&n.call(l,l.__data__,c,i)&&a.push(l);return new br(t,this._parents,this._name,this._id)}function jx(n){if(n._id!==this._id)throw new Error;for(var r=this._groups,e=n._groups,t=r.length,o=e.length,i=Math.min(t,o),s=new Array(t),a=0;a<i;++a)for(var l=r[a],c=e[a],d=l.length,h=s[a]=new Array(d),p,v=0;v<d;++v)(p=l[v]||c[v])&&(h[v]=p);for(;a<t;++a)s[a]=r[a];return new br(s,this._parents,this._name,this._id)}function Zx(n){return(n+"").trim().split(/^|\s+/).every(function(r){var e=r.indexOf(".");return e>=0&&(r=r.slice(0,e)),!r||r==="start"})}function Lx(n,r,e){var t,o,i=Zx(r)?Vl:vr;return function(){var s=i(this,n),a=s.on;a!==t&&(o=(t=a).copy()).on(r,e),s.on=o}}function Dx(n,r){var e=this._id;return arguments.length<2?dr(this.node(),e).on.on(n):this.each(Lx(e,n,r))}function Rx(n){return function(){var r=this.parentNode;for(var e in this.__transition)if(+e!==n)return;r&&r.removeChild(this)}}function Fx(){return this.on("end.remove",Rx(this._id))}function Hx(n){var r=this._name,e=this._id;typeof n!="function"&&(n=$l(n));for(var t=this._groups,o=t.length,i=new Array(o),s=0;s<o;++s)for(var a=t[s],l=a.length,c=i[s]=new Array(l),d,h,p=0;p<l;++p)(d=a[p])&&(h=n.call(d,d.__data__,p,a))&&("__data__"in d&&(h.__data__=d.__data__),c[p]=h,ts(c[p],r,e,p,c,dr(d,e)));return new br(i,this._parents,r,e)}function $x(n){var r=this._name,e=this._id;typeof n!="function"&&(n=Cf(n));for(var t=this._groups,o=t.length,i=[],s=[],a=0;a<o;++a)for(var l=t[a],c=l.length,d,h=0;h<c;++h)if(d=l[h]){for(var p=n.call(d,d.__data__,h,l),v,y=dr(d,e),w=0,O=p.length;w<O;++w)(v=p[w])&&ts(v,r,e,w,p,y);i.push(p),s.push(d)}return new br(i,s,r,e)}var Bx=lo.prototype.constructor;function zx(){return new Bx(this._groups,this._parents)}function Wx(n,r){var e,t,o;return function(){var i=rt(this,n),s=(this.style.removeProperty(n),rt(this,n));return i===s?null:i===e&&s===t?o:o=r(e=i,t=s)}}function Vf(n){return function(){this.style.removeProperty(n)}}function Gx(n,r,e){var t,o=e+"",i;return function(){var s=rt(this,n);return s===o?null:s===t?i:i=r(t=s,e)}}function Vx(n,r,e){var t,o,i;return function(){var s=rt(this,n),a=e(this),l=a+"";return a==null&&(l=a=(this.style.removeProperty(n),rt(this,n))),s===l?null:s===t&&l===o?i:(o=l,i=r(t=s,a))}}function Ux(n,r){var e,t,o,i="style."+r,s="end."+i,a;return function(){var l=vr(this,n),c=l.on,d=l.value[i]==null?a||(a=Vf(r)):void 0;(c!==e||o!==d)&&(t=(e=c).copy()).on(s,o=d),l.on=t}}function Kx(n,r,e){var t=(n+="")=="transform"?Kw:Gf;return r==null?this.styleTween(n,Wx(n,t)).on("end.style."+n,Vf(n)):typeof r=="function"?this.styleTween(n,Vx(n,t,Ul(this,"style."+n,r))).each(Ux(this._id,n)):this.styleTween(n,Gx(n,t,r),e).on("end.style."+n,null)}function Qx(n,r,e){return function(t){this.style.setProperty(n,r.call(this,t),e)}}function Xx(n,r,e){var t,o;function i(){var s=r.apply(this,arguments);return s!==o&&(t=(o=s)&&Qx(n,s,e)),t}return i._value=r,i}function Yx(n,r,e){var t="style."+(n+="");if(arguments.length<2)return(t=this.tween(t))&&t._value;if(r==null)return this.tween(t,null);if(typeof r!="function")throw new Error;return this.tween(t,Xx(n,r,e??""))}function Jx(n){return function(){this.textContent=n}}function qx(n){return function(){var r=n(this);this.textContent=r??""}}function nS(n){return this.tween("text",typeof n=="function"?qx(Ul(this,"text",n)):Jx(n==null?"":n+""))}function rS(n){return function(r){this.textContent=n.call(this,r)}}function eS(n){var r,e;function t(){var o=n.apply(this,arguments);return o!==e&&(r=(e=o)&&rS(o)),r}return t._value=n,t}function tS(n){var r="text";if(arguments.length<1)return(r=this.tween(r))&&r._value;if(n==null)return this.tween(r,null);if(typeof n!="function")throw new Error;return this.tween(r,eS(n))}function oS(){for(var n=this._name,r=this._id,e=Uf(),t=this._groups,o=t.length,i=0;i<o;++i)for(var s=t[i],a=s.length,l,c=0;c<a;++c)if(l=s[c]){var d=dr(l,r);ts(l,n,e,c,s,{time:d.time+d.delay+d.duration,delay:0,duration:d.duration,ease:d.ease})}return new br(t,this._parents,n,e)}function iS(){var n,r,e=this,t=e._id,o=e.size();return new Promise(function(i,s){var a={value:s},l={value:function(){--o===0&&i()}};e.each(function(){var c=vr(this,t),d=c.on;d!==n&&(r=(n=d).copy(),r._.cancel.push(a),r._.interrupt.push(a),r._.end.push(l)),c.on=r}),o===0&&i()})}var sS=0;function br(n,r,e,t){this._groups=n,this._parents=r,this._name=e,this._id=t}function Uf(){return++sS}var wr=lo.prototype;br.prototype={constructor:br,select:Hx,selectAll:$x,selectChild:wr.selectChild,selectChildren:wr.selectChildren,filter:Mx,merge:jx,selection:zx,transition:oS,call:wr.call,nodes:wr.nodes,node:wr.node,size:wr.size,empty:wr.empty,each:wr.each,on:Dx,attr:yx,attrTween:_x,style:Kx,styleTween:Yx,text:nS,textTween:tS,remove:Fx,tween:ux,delay:Tx,duration:Ex,ease:bx,easeVarying:Ax,end:iS,[Symbol.iterator]:wr[Symbol.iterator]};function aS(n){return((n*=2)<=1?n*n*n:(n-=2)*n*n+2)/2}var lS={time:null,delay:0,duration:250,ease:aS};function cS(n,r){for(var e;!(e=n.__transition)||!(e=e[r]);)if(!(n=n.parentNode))throw new Error(`transition ${r} not found`);return e}function uS(n){var r,e;n instanceof br?(r=n._id,n=n._name):(r=Uf(),(e=lS).time=Gl(),n=n==null?null:n+"");for(var t=this._groups,o=t.length,i=0;i<o;++i)for(var s=t[i],a=s.length,l,c=0;c<a;++c)(l=s[c])&&ts(l,n,r,c,s,e||cS(l,r));return new br(t,this._parents,n,r)}lo.prototype.interrupt=ax;lo.prototype.transition=uS;const Zo=n=>()=>n;function dS(n,{sourceEvent:r,target:e,transform:t,dispatch:o}){Object.defineProperties(this,{type:{value:n,enumerable:!0,configurable:!0},sourceEvent:{value:r,enumerable:!0,configurable:!0},target:{value:e,enumerable:!0,configurable:!0},transform:{value:t,enumerable:!0,configurable:!0},_:{value:o}})}function Cr(n,r,e){this.k=n,this.x=r,this.y=e}Cr.prototype={constructor:Cr,scale:function(n){return n===1?this:new Cr(this.k*n,this.x,this.y)},translate:function(n,r){return n===0&r===0?this:new Cr(this.k,this.x+this.k*n,this.y+this.k*r)},apply:function(n){return[n[0]*this.k+this.x,n[1]*this.k+this.y]},applyX:function(n){return n*this.k+this.x},applyY:function(n){return n*this.k+this.y},invert:function(n){return[(n[0]-this.x)/this.k,(n[1]-this.y)/this.k]},invertX:function(n){return(n-this.x)/this.k},invertY:function(n){return(n-this.y)/this.k},rescaleX:function(n){return n.copy().domain(n.range().map(this.invertX,this).map(n.invert,n))},rescaleY:function(n){return n.copy().domain(n.range().map(this.invertY,this).map(n.invert,n))},toString:function(){return"translate("+this.x+","+this.y+") scale("+this.k+")"}};var Mt=new Cr(1,0,0);Cr.prototype;function Fs(n){n.stopImmediatePropagation()}function gt(n){n.preventDefault(),n.stopImmediatePropagation()}function hS(n){return(!n.ctrlKey||n.type==="wheel")&&!n.button}function fS(){var n=this;return n instanceof SVGElement?(n=n.ownerSVGElement||n,n.hasAttribute("viewBox")?(n=n.viewBox.baseVal,[[n.x,n.y],[n.x+n.width,n.y+n.height]]):[[0,0],[n.width.baseVal.value,n.height.baseVal.value]]):[[0,0],[n.clientWidth,n.clientHeight]]}function Mu(){return this.__zoom||Mt}function pS(n){return-n.deltaY*(n.deltaMode===1?.05:n.deltaMode?1:.002)*(n.ctrlKey?10:1)}function mS(){return navigator.maxTouchPoints||"ontouchstart"in this}function gS(n,r,e){var t=n.invertX(r[0][0])-e[0][0],o=n.invertX(r[1][0])-e[1][0],i=n.invertY(r[0][1])-e[0][1],s=n.invertY(r[1][1])-e[1][1];return n.translate(o>t?(t+o)/2:Math.min(0,t)||Math.max(0,o),s>i?(i+s)/2:Math.min(0,i)||Math.max(0,s))}function yS(){var n=hS,r=fS,e=gS,t=pS,o=mS,i=[0,1/0],s=[[-1/0,-1/0],[1/0,1/0]],a=250,l=qw,c=zl("start","zoom","end"),d,h,p,v=500,y=150,w=0,O=10;function f(C){C.property("__zoom",Mu).on("wheel.zoom",I,{passive:!1}).on("mousedown.zoom",$).on("dblclick.zoom",F).filter(o).on("touchstart.zoom",Y).on("touchmove.zoom",X).on("touchend.zoom touchcancel.zoom",V).style("-webkit-tap-highlight-color","rgba(0,0,0,0)")}f.transform=function(C,j,E,L){var T=C.selection?C.selection():C;T.property("__zoom",Mu),C!==T?_(C,j,E,L):T.interrupt().each(function(){k(this,arguments).event(L).start().zoom(null,typeof j=="function"?j.apply(this,arguments):j).end()})},f.scaleBy=function(C,j,E,L){f.scaleTo(C,function(){var T=this.__zoom.k,A=typeof j=="function"?j.apply(this,arguments):j;return T*A},E,L)},f.scaleTo=function(C,j,E,L){f.transform(C,function(){var T=r.apply(this,arguments),A=this.__zoom,M=E==null?x(T):typeof E=="function"?E.apply(this,arguments):E,B=A.invert(M),W=typeof j=="function"?j.apply(this,arguments):j;return e(m(g(A,W),M,B),T,s)},E,L)},f.translateBy=function(C,j,E,L){f.transform(C,function(){return e(this.__zoom.translate(typeof j=="function"?j.apply(this,arguments):j,typeof E=="function"?E.apply(this,arguments):E),r.apply(this,arguments),s)},null,L)},f.translateTo=function(C,j,E,L,T){f.transform(C,function(){var A=r.apply(this,arguments),M=this.__zoom,B=L==null?x(A):typeof L=="function"?L.apply(this,arguments):L;return e(Mt.translate(B[0],B[1]).scale(M.k).translate(typeof j=="function"?-j.apply(this,arguments):-j,typeof E=="function"?-E.apply(this,arguments):-E),A,s)},L,T)};function g(C,j){return j=Math.max(i[0],Math.min(i[1],j)),j===C.k?C:new Cr(j,C.x,C.y)}function m(C,j,E){var L=j[0]-E[0]*C.k,T=j[1]-E[1]*C.k;return L===C.x&&T===C.y?C:new Cr(C.k,L,T)}function x(C){return[(+C[0][0]+ +C[1][0])/2,(+C[0][1]+ +C[1][1])/2]}function _(C,j,E,L){C.on("start.zoom",function(){k(this,arguments).event(L).start()}).on("interrupt.zoom end.zoom",function(){k(this,arguments).event(L).end()}).tween("zoom",function(){var T=this,A=arguments,M=k(T,A).event(L),B=r.apply(T,A),W=E==null?x(B):typeof E=="function"?E.apply(T,A):E,vn=Math.max(B[1][0]-B[0][0],B[1][1]-B[0][1]),q=T.__zoom,wn=typeof j=="function"?j.apply(T,A):j,nn=l(q.invert(W).concat(vn/q.k),wn.invert(W).concat(vn/wn.k));return function(dn){if(dn===1)dn=wn;else{var Hn=nn(dn),st=vn/Hn[2];dn=new Cr(st,W[0]-Hn[0]*st,W[1]-Hn[1]*st)}M.zoom(null,dn)}})}function k(C,j,E){return!E&&C.__zooming||new S(C,j)}function S(C,j){this.that=C,this.args=j,this.active=0,this.sourceEvent=null,this.extent=r.apply(C,j),this.taps=0}S.prototype={event:function(C){return C&&(this.sourceEvent=C),this},start:function(){return++this.active===1&&(this.that.__zooming=this,this.emit("start")),this},zoom:function(C,j){return this.mouse&&C!=="mouse"&&(this.mouse[1]=j.invert(this.mouse[0])),this.touch0&&C!=="touch"&&(this.touch0[1]=j.invert(this.touch0[0])),this.touch1&&C!=="touch"&&(this.touch1[1]=j.invert(this.touch1[0])),this.that.__zoom=j,this.emit("zoom"),this},end:function(){return--this.active===0&&(delete this.that.__zooming,this.emit("end")),this},emit:function(C){var j=sr(this.that).datum();c.call(C,this.that,new dS(C,{sourceEvent:this.sourceEvent,target:f,transform:this.that.__zoom,dispatch:c}),j)}};function I(C,...j){if(!n.apply(this,arguments))return;var E=k(this,j).event(C),L=this.__zoom,T=Math.max(i[0],Math.min(i[1],L.k*Math.pow(2,t.apply(this,arguments)))),A=ee(C);if(E.wheel)(E.mouse[0][0]!==A[0]||E.mouse[0][1]!==A[1])&&(E.mouse[1]=L.invert(E.mouse[0]=A)),clearTimeout(E.wheel);else{if(L.k===T)return;E.mouse=[A,L.invert(A)],qo(this),E.start()}gt(C),E.wheel=setTimeout(M,y),E.zoom("mouse",e(m(g(L,T),E.mouse[0],E.mouse[1]),E.extent,s));function M(){E.wheel=null,E.end()}}function $(C,...j){if(p||!n.apply(this,arguments))return;var E=C.currentTarget,L=k(this,j,!0).event(C),T=sr(C.view).on("mousemove.zoom",W,!0).on("mouseup.zoom",vn,!0),A=ee(C,E),M=C.clientX,B=C.clientY;Pw(C.view),Fs(C),L.mouse=[A,this.__zoom.invert(A)],qo(this),L.start();function W(q){if(gt(q),!L.moved){var wn=q.clientX-M,nn=q.clientY-B;L.moved=wn*wn+nn*nn>w}L.event(q).zoom("mouse",e(m(L.that.__zoom,L.mouse[0]=ee(q,E),L.mouse[1]),L.extent,s))}function vn(q){T.on("mousemove.zoom mouseup.zoom",null),Iw(q.view,L.moved),gt(q),L.event(q).end()}}function F(C,...j){if(n.apply(this,arguments)){var E=this.__zoom,L=ee(C.changedTouches?C.changedTouches[0]:C,this),T=E.invert(L),A=E.k*(C.shiftKey?.5:2),M=e(m(g(E,A),L,T),r.apply(this,j),s);gt(C),a>0?sr(this).transition().duration(a).call(_,M,L,C):sr(this).call(f.transform,M,L,C)}}function Y(C,...j){if(n.apply(this,arguments)){var E=C.touches,L=E.length,T=k(this,j,C.changedTouches.length===L).event(C),A,M,B,W;for(Fs(C),M=0;M<L;++M)B=E[M],W=ee(B,this),W=[W,this.__zoom.invert(W),B.identifier],T.touch0?!T.touch1&&T.touch0[2]!==W[2]&&(T.touch1=W,T.taps=0):(T.touch0=W,A=!0,T.taps=1+!!d);d&&(d=clearTimeout(d)),A&&(T.taps<2&&(h=W[0],d=setTimeout(function(){d=null},v)),qo(this),T.start())}}function X(C,...j){if(this.__zooming){var E=k(this,j).event(C),L=C.changedTouches,T=L.length,A,M,B,W;for(gt(C),A=0;A<T;++A)M=L[A],B=ee(M,this),E.touch0&&E.touch0[2]===M.identifier?E.touch0[0]=B:E.touch1&&E.touch1[2]===M.identifier&&(E.touch1[0]=B);if(M=E.that.__zoom,E.touch1){var vn=E.touch0[0],q=E.touch0[1],wn=E.touch1[0],nn=E.touch1[1],dn=(dn=wn[0]-vn[0])*dn+(dn=wn[1]-vn[1])*dn,Hn=(Hn=nn[0]-q[0])*Hn+(Hn=nn[1]-q[1])*Hn;M=g(M,Math.sqrt(dn/Hn)),B=[(vn[0]+wn[0])/2,(vn[1]+wn[1])/2],W=[(q[0]+nn[0])/2,(q[1]+nn[1])/2]}else if(E.touch0)B=E.touch0[0],W=E.touch0[1];else return;E.zoom("touch",e(m(M,B,W),E.extent,s))}}function V(C,...j){if(this.__zooming){var E=k(this,j).event(C),L=C.changedTouches,T=L.length,A,M;for(Fs(C),p&&clearTimeout(p),p=setTimeout(function(){p=null},v),A=0;A<T;++A)M=L[A],E.touch0&&E.touch0[2]===M.identifier?delete E.touch0:E.touch1&&E.touch1[2]===M.identifier&&delete E.touch1;if(E.touch1&&!E.touch0&&(E.touch0=E.touch1,delete E.touch1),E.touch0)E.touch0[1]=this.__zoom.invert(E.touch0[0]);else if(E.end(),E.taps===2&&(M=ee(M,this),Math.hypot(h[0]-M[0],h[1]-M[1])<O)){var B=sr(this).on("dblclick.zoom");B&&B.apply(this,arguments)}}}return f.wheelDelta=function(C){return arguments.length?(t=typeof C=="function"?C:Zo(+C),f):t},f.filter=function(C){return arguments.length?(n=typeof C=="function"?C:Zo(!!C),f):n},f.touchable=function(C){return arguments.length?(o=typeof C=="function"?C:Zo(!!C),f):o},f.extent=function(C){return arguments.length?(r=typeof C=="function"?C:Zo([[+C[0][0],+C[0][1]],[+C[1][0],+C[1][1]]]),f):r},f.scaleExtent=function(C){return arguments.length?(i[0]=+C[0],i[1]=+C[1],f):[i[0],i[1]]},f.translateExtent=function(C){return arguments.length?(s[0][0]=+C[0][0],s[1][0]=+C[1][0],s[0][1]=+C[0][1],s[1][1]=+C[1][1],f):[[s[0][0],s[0][1]],[s[1][0],s[1][1]]]},f.constrain=function(C){return arguments.length?(e=C,f):e},f.duration=function(C){return arguments.length?(a=+C,f):a},f.interpolate=function(C){return arguments.length?(l=C,f):l},f.on=function(){var C=c.on.apply(c,arguments);return C===c?f:C},f.clickDistance=function(C){return arguments.length?(w=(C=+C)*C,f):Math.sqrt(w)},f.tapDistance=function(C){return arguments.length?(O=+C,f):O},f}function vS(n){const[r,e]=Z.useState({x:0,y:0,k:1}),t=Z.useRef(null);return Z.useEffect(()=>{const a=n.current;if(!a)return;const l=sr(a),c=yS().scaleExtent([.2,3]).filter(d=>{const h=d.target;return h&&(h.closest("[data-node]")||h.closest("[data-edge]")||h.closest("[data-handle]")||h.closest("[data-decoration]"))?d.type==="wheel":d.shiftKey&&d.type!=="wheel"?!1:!d.button}).on("zoom",d=>{const h=d.transform;e({x:h.x,y:h.y,k:h.k})});return t.current=c,l.call(c),l.call(c.transform,Mt.translate(r.x,r.y).scale(r.k)),()=>{l.on(".zoom",null)}},[]),{transform:r,fitTo:a=>{const l=n.current,c=t.current;if(!l||!c)return;const d=l.getBoundingClientRect(),h=80,p=Math.min((d.width-h*2)/a.w,(d.height-h*2)/a.h,1.5),v=d.width/2-(a.x+a.w/2)*p,y=d.height/2-(a.y+a.h/2)*p;sr(l).call(c.transform,Mt.translate(v,y).scale(p))},reset:()=>{const a=n.current,l=t.current;!a||!l||sr(a).call(l.transform,Mt)},zoomBy:a=>{const l=n.current,c=t.current;!l||!c||sr(l).call(c.scaleBy,a)}}}function Mr(n,r,e){return{x:(r-n.x)/n.k,y:(e-n.y)/n.k}}function wS(){var Xl;const n=Z.useRef(null),r=N(P=>P.project.nodes),e=N(P=>P.project.edges),t=N(P=>P.project.decorations??[]),o=N(P=>P.groupSelection),i=N(P=>P.setGroupSelection),s=N(P=>P.moveGroup),a=N(P=>P.addDecoration),l=N(P=>P.updateDecoration),c=N(P=>P.moveDecoration),d=N(P=>P.project.view),h=N(P=>P.selection),p=N(P=>P.moveNode),v=N(P=>P.resizeNode),y=N(P=>P.setNodeAspect),w=N(P=>P.addEdge),O=N(P=>P.select),f=N(P=>P.addNode),g=N(P=>P.promotePostit),{transform:m,fitTo:x,reset:_,zoomBy:k}=vS(n),[S,I]=Z.useState({kind:"none"}),[$,F]=Z.useState(!1),Y=Z.useCallback((P,z)=>{if(!n.current)return;const D=n.current.getBoundingClientRect(),H=Mr(m,P.clientX-D.left,P.clientY-D.top),G=N.getState();if(G.groupSelection.includes(z)){I({kind:"group",startWorld:H,cursorWorld:H}),P.target.setPointerCapture(P.pointerId);return}const fn=G.project.nodes.find(On=>On.id===z);fn&&(I({kind:"node",nodeId:z,startWorld:H,nodeStart:{x:fn.x,y:fn.y}}),P.target.setPointerCapture(P.pointerId))},[m]),X=Z.useCallback((P,z)=>{if(!n.current)return;const D=n.current.getBoundingClientRect(),H=Mr(m,P.clientX-D.left,P.clientY-D.top);I({kind:"edge",edgeFrom:z,cursorWorld:H}),P.target.setPointerCapture(P.pointerId)},[m]),V=Z.useCallback((P,z)=>{I({kind:"resize",nodeId:z}),P.target.setPointerCapture(P.pointerId)},[]),C=Z.useCallback((P,z)=>{if(!n.current)return;const D=n.current.getBoundingClientRect(),H=Mr(m,P.clientX-D.left,P.clientY-D.top),G=N.getState();if(G.groupSelection.includes(z)){I({kind:"group",startWorld:H,cursorWorld:H}),P.target.setPointerCapture(P.pointerId);return}const fn=G.project.decorations.find(On=>On.id===z);fn&&(I({kind:"deco-move",decId:z,startWorld:H,decStart:{x:fn.x,y:fn.y,x2:fn.x2,y2:fn.y2,width:fn.width,height:fn.height}}),P.target.setPointerCapture(P.pointerId))},[m]),j=Z.useCallback((P,z,D)=>{P.stopPropagation(),I({kind:"deco-arrow",decId:z,arrowEndpoint:D}),P.target.setPointerCapture(P.pointerId)},[]),E=Z.useCallback((P,z)=>{P.stopPropagation(),I({kind:"deco-resize",decId:z}),P.target.setPointerCapture(P.pointerId)},[]),L=Z.useCallback(P=>{if(S.kind==="none"||!n.current)return;const z=n.current.getBoundingClientRect(),D=Mr(m,P.clientX-z.left,P.clientY-z.top);if(S.kind==="node"&&S.nodeId&&S.startWorld&&S.nodeStart){const H=S.nodeStart.x+(D.x-S.startWorld.x),G=S.nodeStart.y+(D.y-S.startWorld.y);p(S.nodeId,H,G)}else if(S.kind==="edge")I({...S,cursorWorld:D});else if(S.kind==="resize"&&S.nodeId){const H=N.getState().project.nodes.find(up=>up.id===S.nodeId);if(!H)return;const G=Jr[H.type],fn=Math.abs(D.x-H.x),On=Math.abs(D.y-H.y),An=Math.SQRT2,Yl=Math.max(20,(fn-4)*An),Jl=Math.max(15,(On-4)*An),lp=Math.sqrt(Yl*Jl/(G.rx*G.ry)),cp=Yl*G.ry/(Jl*G.rx);v(S.nodeId,lp),y(S.nodeId,cp)}else if(S.kind==="deco-move"&&S.decId&&S.startWorld&&S.decStart){const H=S.decStart.x+(D.x-S.startWorld.x),G=S.decStart.y+(D.y-S.startWorld.y);c(S.decId,H,G)}else if(S.kind==="deco-arrow"&&S.decId&&S.arrowEndpoint)S.arrowEndpoint==="start"?l(S.decId,{x:D.x,y:D.y}):l(S.decId,{x2:D.x,y2:D.y});else if(S.kind==="deco-resize"&&S.decId){const H=N.getState().project.decorations.find(On=>On.id===S.decId);if(!H)return;const G=Math.max(40,(D.x-H.x)*2),fn=Math.max(20,(D.y-H.y)*2);l(S.decId,{width:G,height:fn})}else if(S.kind==="group"&&S.startWorld&&S.cursorWorld){const H=D.x-S.cursorWorld.x,G=D.y-S.cursorWorld.y;s(H,G),I({...S,cursorWorld:D})}else S.kind==="box-select"&&S.startWorld&&I({...S,boxRect:{x0:Math.min(S.startWorld.x,D.x),y0:Math.min(S.startWorld.y,D.y),x1:Math.max(S.startWorld.x,D.x),y1:Math.max(S.startWorld.y,D.y)}})},[S,m,p,v,y,c,l]),T=Z.useCallback(P=>{if(S.kind==="edge"&&S.edgeFrom){const z=document.elementFromPoint(P.clientX,P.clientY),D=z==null?void 0:z.closest("[data-node]"),H=D==null?void 0:D.getAttribute("data-node");H&&H!==S.edgeFrom&&w(S.edgeFrom,H,"open")}else if(S.kind==="box-select"&&S.boxRect){const{x0:z,y0:D,x1:H,y1:G}=S.boxRect,fn=N.getState(),On=[];fn.project.nodes.forEach(An=>{An.x>=z&&An.x<=H&&An.y>=D&&An.y<=G&&On.push(An.id)}),(fn.project.decorations??[]).forEach(An=>{An.x>=z&&An.x<=H&&An.y>=D&&An.y<=G&&On.push(An.id)}),On.length>0?i(On):i([])}I({kind:"none"})},[S,w,i]),A=Z.useCallback(P=>{if(P.target===n.current||P.target.hasAttribute("data-bg"))if(P.shiftKey&&n.current){const z=n.current.getBoundingClientRect(),D=Mr(m,P.clientX-z.left,P.clientY-z.top);I({kind:"box-select",startWorld:D,boxRect:{x0:D.x,y0:D.y,x1:D.x,y1:D.y}})}else O({kind:"none"}),i([])},[O,m,i]),M=P=>{P.dataTransfer.types.includes("application/x-postit-id")&&(P.preventDefault(),P.dataTransfer.dropEffect="copy",F(!0))},B=()=>F(!1),W=P=>{P.preventDefault(),F(!1);const z=P.dataTransfer.getData("application/x-postit-id");if(!z||!n.current)return;const D=n.current.getBoundingClientRect(),H=Mr(m,P.clientX-D.left,P.clientY-D.top);g(z,H.x,H.y)},vn=Z.useMemo(()=>{const P=t.filter(H=>H.kind==="text"),z=t.filter(H=>H.kind==="arrow");return[...t.filter(H=>H.kind==="ellipse"),...z,...P]},[t]),q=Z.useMemo(()=>{const P=new Map;e.forEach(D=>{const H=[D.from,D.to].sort().join("::");P.has(H)||P.set(H,[]),P.get(H).push(D.id)});const z=14;return e.map(D=>{const H=[D.from,D.to].sort().join("::"),G=P.get(H);if(G.length<2)return{edge:D,offset:0};const On=(G.indexOf(D.id)-(G.length-1)/2)*z;return{edge:D,offset:On}})},[e]),wn=Z.useCallback(()=>{if(r.length===0)return _();let P=1/0,z=1/0,D=-1/0,H=-1/0;for(const G of r)P=Math.min(P,G.x-100),z=Math.min(z,G.y-80),D=Math.max(D,G.x+100),H=Math.max(H,G.y+80);x({x:P,y:z,w:D-P,h:H-z})},[r,x,_]),nn=P=>{if(!n.current)return;const z=n.current.getBoundingClientRect(),D=Mr(m,z.width/2,z.height/2),H=(Math.random()-.5)*60,G=(Math.random()-.5)*60;f({x:D.x+H,y:D.y+G,type:P,name:SS(P)})},dn=P=>{if(!n.current)return;const z=n.current.getBoundingClientRect(),D=Mr(m,z.width/2,z.height/2),H=(Math.random()-.5)*80,G=(Math.random()-.5)*80;a(P,D.x+H,D.y+G)},Hn=(Xl=n.current)==null?void 0:Xl.getBoundingClientRect(),st=Hn?{x:-m.x/m.k,y:-m.y/m.k,w:Hn.width/m.k,h:Hn.height/m.k}:{x:0,y:0,w:0,h:0};return u.jsxs("div",{className:`canvas-wrap blueprint-grid ${$?"is-drop-hover":""}`,onDragOver:M,onDragLeave:B,onDrop:W,children:[u.jsxs("svg",{ref:n,className:"canvas-svg",onPointerDown:A,onPointerMove:L,onPointerUp:T,children:[u.jsx("defs",{children:u.jsx("pattern",{id:"dots",width:"20",height:"20",patternUnits:"userSpaceOnUse",children:u.jsx("circle",{cx:"1",cy:"1",r:"0.6",fill:"rgba(44, 95, 124, 0.20)"})})}),u.jsx("rect",{"data-bg":!0,x:"-100000",y:"-100000",width:"200000",height:"200000",fill:"transparent"}),u.jsxs("g",{"data-cv-world":!0,transform:`translate(${m.x} ${m.y}) scale(${m.k})`,children:[vn.map(P=>u.jsx(Hy,{dec:P,selected:h.kind==="decoration"&&h.id===P.id||o.includes(P.id),onPointerDown:C,onArrowEndpointDown:j,onResizeDown:E},P.id)),q.map(({edge:P,offset:z})=>{const D=r.find(G=>G.id===P.from),H=r.find(G=>G.id===P.to);return!D||!H?null:u.jsx(Zy,{edge:P,from:D,to:H,rough:d.edgeStyle==="rough",selected:h.kind==="edge"&&h.id===P.id,offset:z,onSelect:G=>O({kind:"edge",id:G})},P.id)}),S.kind==="edge"&&S.edgeFrom&&S.cursorWorld&&u.jsx(xS,{fromId:S.edgeFrom,cursor:S.cursorWorld}),r.map(P=>u.jsx(jy,{node:P,rough:d.edgeStyle==="rough",selected:h.kind==="node"&&h.id===P.id||o.includes(P.id),onPointerDownNode:Y,onHandlePointerDown:X,onResizePointerDown:V},P.id)),S.kind==="box-select"&&S.boxRect&&u.jsx("rect",{x:S.boxRect.x0,y:S.boxRect.y0,width:S.boxRect.x1-S.boxRect.x0,height:S.boxRect.y1-S.boxRect.y0,fill:"rgba(207, 85, 71, 0.10)",stroke:"var(--brick)",strokeWidth:"1.4",strokeDasharray:"6 4",pointerEvents:"none"})]})]}),r.length===0&&u.jsx("div",{className:"canvas-empty",children:u.jsxs("div",{className:"canvas-empty-card",children:[u.jsx("h2",{className:"hand",children:"캔버스가 비어 있습니다"}),u.jsxs("p",{children:["왼쪽 포스트잇을 끌어 와서 노드로 만들거나,",u.jsx("br",{}),"아래에서 노드 타입을 선택해 추가하세요."]}),u.jsxs("div",{className:"canvas-empty-actions",children:[u.jsx("button",{onClick:()=>nn("room"),children:"+ 방"}),u.jsx("button",{onClick:()=>nn("vista"),children:"+ 전망"}),u.jsx("button",{onClick:()=>nn("boss"),children:"+ 보스"})]})]})}),u.jsxs("div",{className:"canvas-toolbar",children:[u.jsxs("div",{className:"ct-group",role:"group","aria-label":"노드 추가",children:[u.jsx("button",{onClick:()=>nn("room"),title:"방 추가",children:"방"}),u.jsx("button",{onClick:()=>nn("vista"),title:"전망",children:"전망"}),u.jsx("button",{onClick:()=>nn("treasure"),title:"보물",children:"보물"}),u.jsx("button",{onClick:()=>nn("boss"),title:"보스",children:"보스"}),u.jsx("button",{onClick:()=>nn("hub"),title:"허브",children:"허브"}),u.jsx("button",{onClick:()=>nn("save"),title:"세이브",children:"세이브"})]}),u.jsx("span",{className:"ct-sep"}),u.jsxs("div",{className:"ct-group",role:"group","aria-label":"데코 추가",children:[u.jsx("button",{onClick:()=>dn("arrow"),title:"화살표",children:"↗ 화살표"}),u.jsx("button",{onClick:()=>dn("ellipse"),title:"회색 타원",children:"○ 타원"}),u.jsx("button",{onClick:()=>dn("text"),title:"텍스트",children:"A 텍스트"})]}),u.jsx("span",{className:"ct-sep"}),u.jsx("button",{onClick:wn,title:"화면 맞춤",children:"⇲ 맞춤"}),u.jsx("button",{onClick:()=>k(1.25),title:"확대",children:"＋"}),u.jsx("button",{onClick:()=>k(.8),title:"축소",children:"−"}),u.jsxs("span",{className:"ct-zoom caption",children:[Math.round(m.k*100),"%"]})]}),d.showMinimap&&r.length>0&&u.jsx("div",{className:"canvas-minimap",children:u.jsx(Fy,{nodes:r,viewBox:st})}),$&&u.jsx("div",{className:"canvas-drop-banner hand",children:"여기에 놓아 노드로 승격"})]})}function xS({fromId:n,cursor:r}){const e=N(t=>t.project.nodes.find(o=>o.id===n));return e?u.jsx("line",{x1:e.x,y1:e.y,x2:r.x,y2:r.y,stroke:"var(--brick)",strokeWidth:"1.6",strokeDasharray:"4 3",opacity:"0.8",pointerEvents:"none"}):null}function SS(n){return{room:"새 방",vista:"전망 지점",treasure:"보물 챔버",boss:"보스 챔버",hub:"허브 광장",save:"세이브 포인트"}[n]}const _S=["room","vista","treasure","boss","hub","save"],kS=["open","locked","oneway","ability","vista"],CS={room:"일반 방. 전투·통과·환경 인터랙션.",vista:"풍경/예고 공간. 플레이어에게 목표나 비밀을 보여줌.",treasure:"보상/획득 공간. 보물, 능력, 정보.",boss:"거대 인카운터. 일반적으로 페이싱의 클라이맥스.",hub:"여러 경로가 모이는 허브.",save:"체크포인트, 회복, 휴식."},TS={open:"열린 통로. 양방향 자유 통행.",locked:"잠금문. 키를 획득해야 통과.",oneway:"일방통행. 반대로 돌아갈 수 없음.",ability:"능력 게이트. 특정 능력 보유 시만 통과.",vista:"전망. 다른 공간이 시각적으로 보이지만 이동 불가."};function PS({onClose:n}){return u.jsxs("aside",{className:"legend",role:"dialog","aria-label":"범례",children:[u.jsxs("header",{className:"lg-head",children:[u.jsx("h3",{className:"hand",children:"표기 규약"}),u.jsx("button",{onClick:n,className:"lg-x","aria-label":"닫기",children:"×"})]}),u.jsx("p",{className:"lg-intro caption",children:"3D 게임 레벨 디자인 노드·간선 표기 규약"}),u.jsx("h4",{children:"노드"}),u.jsx("ul",{className:"lg-list",children:_S.map(r=>{const e=Jr[r];return u.jsxs("li",{children:[u.jsxs("svg",{width:"48",height:"32",viewBox:"-32 -22 64 44",children:[u.jsx("ellipse",{cx:"0",cy:"0",rx:"24",ry:"16",fill:e.fill,stroke:e.stroke,strokeWidth:e.strokeWidth}),u.jsx("text",{x:"0",y:"3",textAnchor:"middle",fontSize:"11",fill:"var(--ink-900)",children:e.icon})]}),u.jsxs("div",{children:[u.jsx("strong",{children:e.label}),u.jsx("span",{children:CS[r]})]})]},r)})}),u.jsx("h4",{children:"간선"}),u.jsx("ul",{className:"lg-list",children:kS.map(r=>{const e=ns[r];return u.jsxs("li",{children:[u.jsxs("svg",{width:"48",height:"32",viewBox:"0 0 48 32",children:[u.jsx("path",{d:"M 4 16 Q 24 4, 44 16",fill:"none",stroke:e.stroke,strokeWidth:e.width,strokeDasharray:e.dash,strokeLinecap:"round"}),(r==="oneway"||r==="ability"||r==="locked")&&u.jsx("polygon",{points:"38,12 44,16 38,20",fill:e.stroke})]}),u.jsxs("div",{children:[u.jsx("strong",{children:e.label}),u.jsx("span",{children:TS[r]})]})]},r)})})]})}function IS(){const n=N(d=>d.project.view),r=N(d=>d.setView),e=N(d=>{var h;return((h=d.project.theme)==null?void 0:h.hueShift)??0}),t=N(d=>{var h;return((h=d.project.theme)==null?void 0:h.satScale)??1}),o=N(d=>d.setHueShift),i=N(d=>d.setSatScale),s=N(d=>d.resetTheme),a=e!==0||t!==1,[l,c]=Z.useState(!1);return u.jsxs("main",{className:"canvas-shell",children:[u.jsxs("div",{className:"cs-topbar",children:[u.jsxs("div",{className:"cs-view-toggles",children:[u.jsx(Hs,{label:"펜떨림",value:n.edgeStyle==="rough",onChange:d=>r({edgeStyle:d?"rough":"clean"}),hint:"손그림 느낌의 거친 곡선"}),u.jsx(Hs,{label:"그리드",value:n.showGrid,onChange:d=>r({showGrid:d})}),u.jsx(Hs,{label:"미니맵",value:n.showMinimap,onChange:d=>r({showMinimap:d})})]}),u.jsxs("div",{className:"cs-right",children:[u.jsxs("div",{className:"cs-theme",title:"학생별 고유 팔레트 — HUE는 색조, SAT는 채도",children:[u.jsxs("div",{className:"cs-theme-row",children:[u.jsx("span",{className:"cs-theme-label",children:"HUE"}),u.jsx("input",{className:"cs-theme-slider cs-theme-slider--hue",type:"range",min:-180,max:180,step:1,value:e,onChange:d=>o(parseInt(d.target.value,10)),style:{background:`linear-gradient(to right,
                    ...
                    hsl(15,0%,55%) 0%,
                    hsl(15,50%,55%) 50%,
                    hsl(15,100%,55%) 100%)`}}),u.jsxs("span",{className:"cs-theme-value",children:[t.toFixed(2),"×"]})]}),u.jsx("button",{type:"button",className:"cs-theme-reset",onClick:s,disabled:!a,title:"기본 팔레트로 복원",children:"기본"})]}),u.jsxs("button",{className:`cs-legend-btn ${l?"is-on":""}`,onClick:()=>c(!l),children:["범례 ",l?"▾":"▸"]})]})]}),u.jsx("div",{className:`cs-canvas-area ${n.showGrid?"":"no-grid"}`,children:u.jsx(wS,{})}),l&&u.jsx(PS,{onClose:()=>c(!1)})]})}function Hs({label:n,value:r,onChange:e,hint:t}){return u.jsxs("label",{className:`cs-toggle ${r?"is-on":""}`,title:t,children:[u.jsx("input",{type:"checkbox",checked:r,onChange:o=>e(o.target.checked)}),u.jsx("span",{className:"cs-toggle-knob","aria-hidden":!0}),u.jsx("span",{className:"cs-toggle-label",children:n})]})}const ju=50,Zu=1500;function ES(){const n=N(t=>t.project.ai);if(n.provider!=="gemini")return u.jsxs("div",{className:"usage",children:[u.jsx("span",{className:"caption",children:"AI"}),u.jsx("span",{className:"usage-off",children:"오프라인 모드"})]});const r=Math.min(100,n.usage.proUsedToday/ju*100),e=Math.min(100,n.usage.flashUsedToday/Zu*100);return u.jsxs("div",{className:"usage",children:[u.jsx("span",{className:"caption",children:"오늘 사용량"}),u.jsxs("div",{className:"usage-row",children:[u.jsx("span",{className:"usage-label",children:"Pro"}),u.jsx("div",{className:"usage-bar",children:u.jsx("div",{className:"usage-fill usage-fill--pro",style:{width:`${r}%`}})}),u.jsxs("span",{className:"usage-num",children:[n.usage.proUsedToday,"/",ju]})]}),u.jsxs("div",{className:"usage-row",children:[u.jsx("span",{className:"usage-label",children:"Flash"}),u.jsx("div",{className:"usage-bar",children:u.jsx("div",{className:"usage-fill usage-fill--flash",style:{width:`${e}%`}})}),u.jsxs("span",{className:"usage-num",children:[n.usage.flashUsedToday,"/",Zu]})]})]})}const NS=["gemini-2.5-pro","gemini-2.5-flash","gemini-2.5-flash-lite","gemini-2.0-flash"],bS=["gemini-2.5-flash","gemini-2.5-flash-lite","gemini-2.0-flash","gemini-2.5-pro"],OS="https://generativelanguage.googleapis.com/v1beta/models";class Kf extends Error{constructor(r){super(`Quota exceeded for ${r}`),this.model=r}}class xe extends Error{constructor(r,e){super(`Transient ${e} on ${r}`),this.model=r,this.status=e}}class eo extends Error{constructor(){super("Gemini API key가 설정되지 않았습니다.")}}async function AS(n,r,e){var l,c,d,h;const t=`${OS}/${n}:generateContent?key=${encodeURIComponent(r)}`,o={systemInstruction:{parts:[{text:e.system}]},contents:[{role:"user",parts:[{text:e.user}]}],generationConfig:{maxOutputTokens:e.maxTokens??1024,temperature:.8}};e.responseSchema&&(o.generationConfig.responseMimeType="application/json",o.generationConfig.responseSchema=e.responseSchema,o.generationConfig.temperature=.4);const i=await fetch(t,{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify(o),signal:e.signal});if(!i.ok){if(i.status===429)throw new Kf(n);if(i.status===503||i.status===502||i.status===504)throw new xe(n,i.status);const p=await i.text();throw new Error(`Gemini ${n} ${i.status}: ${p.slice(0,200)}`)}const s=await i.json(),a=((h=(d=(c=(l=s==null?void 0:s.candidates)==null?void 0:l[0])==null?void 0:c.content)==null?void 0:d.parts)==null?void 0:h.map(p=>p.text??"").join(""))??"";if(!a)throw new Error("Gemini 응답이 비어 있습니다.");return a}async function MS(n,r,e,t=2){let o;for(let i=0;i<=t;i++)try{return await AS(n,r,e)}catch(s){if(o=s,s instanceof xe&&i<t){const a=500*Math.pow(2,i);await new Promise(l=>setTimeout(l,a));continue}throw s}throw o??new Error("재시도 실패")}async function Ve(n){const r=N.getState(),e=r.project.ai.apiKey;if(!e)throw new eo;const t=n.preferModel==="gemini-2.5-flash"?bS:NS;let o;for(let i=0;i<t.length;i++){const s=t[i];try{const a=await MS(s,e,n);return r.bumpUsage(s==="gemini-2.5-pro"?"pro":"flash"),{text:a,modelUsed:s,fallback:i>0}}catch(a){if(o=a,a instanceof Kf||a instanceof xe)continue;throw a}}throw o??new Error("알 수 없는 오류")}function Lu(n){if(!n)return null;let r=n.replace(/```(?:json|JSON)?\s*/g,"").replace(/\s*```/g,"").trim();try{return JSON.parse(r)}catch{}const e=r.indexOf("{"),t=r.indexOf("["),o=e<0?t:t<0?e:Math.min(e,t);if(o<0)return null;const s=r[o]==="{"?"}":"]",a=r.lastIndexOf(s);if(a<=o)return null;const l=r.slice(o,a+1);try{return JSON.parse(l)}catch{}const c=l.replace(/,\s*([}\]])/g,"$1");try{return JSON.parse(c)}catch{return null}}const os=`
